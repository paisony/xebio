...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginUser04.aspx.cs" Inherits="UserMst_DelConfirm" %>
...
<body>
    <form id="LoginUser04" runat="server" onprerender="RenderForm">
                                    ...
                                    <table class="TABLE_FRMTITLE">
                                        <tr>
                                            <td style="height: 18px">
                                                ...
                                                <cc:EncodedLabel ID="Formtitle" runat="server">利用者情報削除確認</cc:EncodedLabel>
                                                ...
                                                <table class="TABLE_ARTICLE">
                                                    <tr class="TR_ARTICLE">
                                                        ...
                                                        <td class="TD_ARTICLE_3" width="70%">
                                                           ...
                                                           <cc:EncodedLabel ID="LoginIdLbl" runat="server"></cc:EncodedLabel>
                                                            &nbsp;</td>
                                                    </tr>
                                                    <tr class="TR_ARTICLE">
                                                        <td class="TD_ARTICLE_1">
