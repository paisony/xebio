...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MessageConfirm.aspx.cs" Inherits="Information_MessageComfirm" %>
							                                ...
							                                <div class="inner">
								                                <table class="info-table">
												                    ...
												                    <tr>
													                    ...
													                    <td>
                                                                            <asp:Label ID="MessageConfirmLbl" runat="server"></asp:Label>
													                    </td>
												                    </tr>
												                    <tr>
													                    <th scope="col">
                                                                    ...
                                                                    <tr>
													                    ...
													                    <td>
                                                                            <asp:Button ID="ConfirmBtn" runat="server" CausesValidation="False" OnClick="CreateBtn_Click" />
