...
2015/09/16 FSWeb)Y.Tamura ログイン・メニュー画面変更
 --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InformationMenu.aspx.cs" Inherits="Information_InformationMenu" %>
							                                ...
							                                <div class="inner">
								                                <table class="info-table">
												                    ...
												                    <tr>
													                    <th scope="col">
                                                                            <span class="tbl-hdg">
                                                                                <asp:HyperLink ID="TopicLink" runat="server" NavigateUrl="TopicList.aspx">[TopicLink]</asp:HyperLink></td>
													                        </span>
														                    &nbsp;
                                                                        </th>
													                    <td>
                                                                            &nbsp;
                                                                            <cc:EncodedLabel ID="TopicCommentLbl" runat="server"></cc:EncodedLabel>
													                    </td>
												                    </tr>
												                    <tr>
													                    <th scope="col">
                                                                            <span class="tbl-hdg">
														                        <asp:HyperLink ID="MessageLink" runat="server" NavigateUrl="MessageList.aspx">[MessageLink]</asp:HyperLink>
													                        </span>
														                    &nbsp;
                                                                        </th>
													                    <td>
                                                                            &nbsp;
                                                                            <cc:EncodedLabel ID="MessageCommentLbl" runat="server"></cc:EncodedLabel>
													                    </td>
												                    </tr>
												                    <tr>
													                    <th scope="col">
                                                                            <span class="tbl-hdg">
														                        <asp:HyperLink ID="DisplayLink" runat="server" NavigateUrl="LabelDisplay.aspx">[DisplayLink]</asp:HyperLink>
													                        </span>
														                    &nbsp;
                                                                        </th>
													                    <td>
                                                                            &nbsp;
                                                                            <cc:EncodedLabel ID="DisplayCommentLbl" runat="server"></cc:EncodedLabel>
													                    </td>
												                    </tr>
								                                </table>
							                                <!-- /inner --></div>
