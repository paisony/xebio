<%@ Page language="c#" CodeFile="tf050f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tf050p01.Page.Tf050f01Page" %>
...
<head>
	...
	<title id="Windowtitle" runat="server">小口現金出納帳出力</title>
	<!--- キャッシュの無効化設定 --->
	<adv:NoCache ID="NoCache1" runat="server" />

	<!--- スクリプトヘルパー、項目テーブル、業務スクリプトのインポート --->
	<adv:SetHeader ID="SetHeader1" PgId="tf050p01" FormId="tf050f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tf050f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tf050p01" FormId="tf050f01" runat="server" />
		<!-- Js業務部品のインポート --->
...
<body>
	<form id="Tf050f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tf050p01" PgName="小口現金出納帳出力" FormId="tf050f01" FormName="小口現金出納帳出力" ></uc:Header>
										...
										<div class="inner">
											<table>
												...
												<tbody>
													<tr>
														<th scope="col">
															<span class="tbl-hdg"><asp:Label ID="Kikan_from_lbl" runat="server"></asp:Label><asp:Label ID="Kikan_from_Req" runat="server" CssClass="required">*</asp:Label></span>
														</th>
														<!--- 「期間ｆｒｏｍ」一行テキストボックス（セパレート日付以外） --->
														<!--- 「期間ｔｏ」一行テキストボックス（セパレート日付以外） --->	
														<td><label><span class="icon-in"><md:MDTextBox ID="Kikan_from" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Kikan_to" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox></span></label></td>
													</tr>
												</tbody>
											</table>
										<!-- /inner --></div>
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<asp:Label ID="Kikan_to_lbl" runat="server">出力期間ＴＯ</asp:Label>
