...
namespace com.xebio.bo.Tf050p01.Page
{
  /// <summary>
  /// Tf050p01の初期化ページです。
  /// </summary>
  public partial class Tf050p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tf050p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tf050f01", true);
				}
