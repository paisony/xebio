<%@ Page language="c#" CodeFile="tb070f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tb070p01.Page.Tb070f01Page" %>
...
<head>
	...
	<title id="Windowtitle" runat="server">仕入予定未存在リスト出力</title>
	<!--- キャッシュの無効化設定 --->
	<adv:NoCache ID="NoCache1" runat="server" />

	<!--- スクリプトヘルパー、項目テーブル、業務スクリプトのインポート --->
	<adv:SetHeader ID="SetHeader1" PgId="tb070p01" FormId="tb070f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tb070f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tb070p01" FormId="tb070f01" runat="server" />
...
<body>
	<form id="Tb070f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tb070p01" PgName="仕入予定未存在リスト出力" FormId="tb070f01" FormName="仕入予定未存在リスト出力" ></uc:Header>
