...
using com.xebio.bo.Tb070p01.Facade;
...
namespace com.xebio.bo.Tb070p01.Page
{
  /// <summary>
  /// Tb070f01のコードビハインドです。
  /// </summary>
  public partial class Tb070f01Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Tb070f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tb070f01Facade().DoLoad(facadeContext);
								...
								ControlHeaderStoreCls.InitialSetHeaderStore<Tb070f01Form>(loginInfVO, tb070f01Form);
								// 一覧画面共通処理 ----------
		...
		protected virtual void OnBTNPRINT_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Tb070f01Facade().DoBTNPRINT_FRM(facadeContext);

				Tb070f01Form f01VO = (Tb070f01Form)facadeContext.FormVO;

				// PDFファイル名を取得
				pdfNm = (string)facadeContext.GetUserObject(Tb070p01Constant.FCDUO_RRT_FLNM);
			...
			string serverPath = string.Format("{0}{1}{2}",
											FilePathManager.GetOutFilePath(Tb070p01Constant.PGID),
											Path.DirectorySeparatorChar,
											pdfNm
											);
			// クライアントファイル名
			string clientNm = string.Format("{0}.{1}",
											BoSystemReport.CreateFileName(BoSystemConstant.REPORTNM_SIIRENYUKAMISONZAILIST, 2),
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Tb070f01Form tb070f01Form = (Tb070f01Form)pageContext.GetFormVO();

						//カード部データを表示する
						RenderCard(tb070f01Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// カードデータを表示する
		/// </summary>
		/// <param name="tb070f01Form">画面FormVO</param>
		/// <param name="formInfo">画面情報</param>
		/// <param name="formResource">画面リソース</param>
		/// <param name="lang">言語設定</param>
		private void RenderCard(
			Tb070f01Form tb070f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tb070f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tb070f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Add_ymd_from,
				DataFormatUtil.GetFormatItem(tb070f01Form.Add_ymd_from,formInfo["Add_ymd_from"]));
			ControlUtil.SetControlValue(Add_ymd_to,
				DataFormatUtil.GetFormatItem(tb070f01Form.Add_ymd_to,formInfo["Add_ymd_to"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tb070f01Form)base.GetPageContext().GetFormVO());
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tb070f01_Titlebar", lang);
				header.FormName = formResource.GetString("Tb070f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
