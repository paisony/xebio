...
using com.xebio.bo.Tb060p01.Facade;
...
namespace com.xebio.bo.Tb060p01.Page
{
  /// <summary>
  /// Tb060f01のコードビハインドです。
  /// </summary>
  public partial class Tb060f01Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Tb060f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tb060f01Facade().DoLoad(facadeContext);
								...
								ControlHeaderStoreCls.InitialSetHeaderStore<Tb060f01Form>(loginInfVO, tb060f01Form);
								// 一覧画面共通処理 ----------
		...
		protected virtual void OnBTNPRINT_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				new Tb060f01Facade().DoBTNPRINT_FRM(facadeContext);

				Tb060f01Form f01VO = (Tb060f01Form)facadeContext.FormVO;

				// PDFファイル名を取得
				pdfNm = (string)facadeContext.GetUserObject(Tb060p01Constant.FCDUO_RRT_FLNM);
			...
			string serverPath = string.Format("{0}{1}{2}",
											FilePathManager.GetOutFilePath(Tb060p01Constant.PGID),
											Path.DirectorySeparatorChar,
											pdfNm
											);
			// クライアントファイル名
			string clientNm = string.Format("{0}.{1}",
											BoSystemReport.CreateFileName(BoSystemConstant.REPORTNM_SCMKENPINTOKUSOKULIST, 2),
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Tb060f01Form tb060f01Form = (Tb060f01Form)pageContext.GetFormVO();

						//カード部データを表示する
						RenderCard(tb060f01Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// カードデータを表示する
		/// </summary>
		/// <param name="tb060f01Form">画面FormVO</param>
		/// <param name="formInfo">画面情報</param>
		/// <param name="formResource">画面リソース</param>
		/// <param name="lang">言語設定</param>
		private void RenderCard(
			Tb060f01Form tb060f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tb060f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tb060f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Nyukayotei_ymd,
				DataFormatUtil.GetFormatItem(tb060f01Form.Nyukayotei_ymd,formInfo["Nyukayotei_ymd"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tb060f01Form)base.GetPageContext().GetFormVO());
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tb060f01_Titlebar", lang);
				header.FormName = formResource.GetString("Tb060f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
