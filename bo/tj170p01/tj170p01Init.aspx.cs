...
namespace com.xebio.bo.Tj170p01.Page
{
  ...
  /// Tj170p01の初期化ページです。
  /// </summary>
  public partial class Tj170p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj170p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj170f01", true);
					//efm.SetItemInfoFlg(pgId, "Tj170f02", true);
				}
