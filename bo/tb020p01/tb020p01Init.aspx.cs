...
namespace com.xebio.bo.Tb020p01.Page
{
  ...
  /// Tb020p01の初期化ページです。
  /// </summary>
  public partial class Tb020p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tb020p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tb020f01", true);
					//efm.SetItemInfoFlg(pgId, "Tb020f02", true);
				}
