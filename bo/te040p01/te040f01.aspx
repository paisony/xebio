<%@ Page language="c#" CodeFile="te040f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Te040p01.Page.Te040f01Page" %>
...
<head>
	...
	<title id="Windowtitle" runat="server">移動出荷入力（再入荷防止）</title>
	<!--- キャッシュの無効化設定 --->
	<adv:NoCache ID="NoCache1" runat="server" />

	<!--- スクリプトヘルパー、項目テーブル、業務スクリプトのインポート --->
	<adv:SetHeader ID="SetHeader1" PgId="te040p01" FormId="te040f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/te040f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="te040p01" FormId="te040f01" runat="server" />
...
<body>
	<form id="Te040f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="te040p01" PgName="移動出荷入力（再入荷防止）" FormId="te040f01" FormName="移動出荷入力（再入荷防止）" ></uc:Header>
				...
				<div class="inner-01">
					...
					<table>
						...
						<tr>
							...
							<!--- 「出荷理由」ドロップダウンリスト --->
							<td>
								<md:MDConditionDDList ID="Shukkariyu_kbn" ConditionName="shukkariyu_kbn2" CssClass="slt-ddl slt-shukkaRiyu" runat="server"></md:MDConditionDDList>
							...
							<td>
								<span class="icon-in">
									...
									<input type="button" id="Btnjuryotenpocd" name="Btnjuryotenpocd" value="" runat="server" class="icon-search"/>
								</span>
						...
						<tr>
							...
							<th>
								<span class="tbl-hdg">
									<asp:Label ID="Stop_ymd_lbl" runat="server">防止期限</asp:Label>
									<asp:Label ID="Stop_ymd_Req" runat="server" CssClass="required">*</asp:Label>
								</span>
							</th>
							<td colspan="3">
								<!--- 「防止期限」一行テキストボックス（セパレート日付以外） --->
								<span class="icon-in">
									<md:MDTextBox ID="Stop_ymd" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox>
								</span>
							</td>
						</tr>
					</table>
