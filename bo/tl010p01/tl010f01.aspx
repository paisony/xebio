<%@ Page language="c#" CodeFile="tl010f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tl010p01.Page.Tl010f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tl010p01" FormId="tl010f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tl010f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tl010p01" FormId="tl010f01" runat="server" />
...
<body>
	...
	<form id="Tl010f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tl010p01" PgName="売変検索(V)" FormId="tl010f01" FormName="売変検索 一覧" ></uc:Header>
										...
										<div class="inner">
											<table>
												...
												<tr>
													<th scope="col">
														<span class="tbl-hdg">
															<asp:Label ID="Kaishi_jyotai_lbl" runat="server">開始状態</asp:Label>
														</span>
													</th>
													<td>
														<!--- 「開始状態」ドロップダウンリスト --->
														<md:MDConditionDDList ID="Kaishi_jyotai" ConditionName="kaishi_jyotai" CssClass="slt-kaisijyotai" runat="server"></md:MDConditionDDList>
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col3 detail_center">
											...
											<asp:TextBox ID="M1baihenkaisi_ymd" CssClass="inpReadonlyCenter inpRODate" runat="server"></asp:TextBox>
										</div>
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<!--- 「営業日（隠し）２」隠しフィールド --->
			<asp:hiddenfield ID="Eigyo_ymd_hdn2" runat="server"></asp:hiddenfield>
