<%@ Page language="c#" CodeFile="tj130f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tj130p01.Page.Tj130f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tj130p01" FormId="tj130f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tj130f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tj130p01" FormId="tj130f01" runat="server" />
...
<body>
	<form id="Tj130f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tj130p01" PgName="棚卸重複検索(X)" FormId="tj130f01" FormName="棚卸重複検索 一覧" ></uc:Header>
				...
				<div class="inner">
					...
					<div class="str-result-01">
						...
						<div class="str-result-hdg-01">
							...
							<div class="col5">
								<div>点数棚卸数量</div>
								<div class="col5-1 headcell"><asp:Label ID="M1tensutanaorosinyuryoku_su_lbl" runat="server">入力数量</asp:Label></div>
								<div class="col5-2 headcell"><asp:Label ID="M1tensutanaorositeisei_su_lbl" runat="server">訂正数量</asp:Label></div>
								<div class="col5-3 headcell"><asp:Label ID="M1tensutanaorosigokei_su_lbl" runat="server">合計数量</asp:Label></div>
							</div>
							<div class="col6">
								<div>ｽｷｬﾝ数量</div>
								<div class="col6-1 headcell"><asp:Label ID="M1scan_su_lbl" runat="server">スキャン数量</asp:Label></div>
								<div class="col6-2 headcell"><asp:Label ID="M1teisei_suryo_lbl" runat="server">訂正数量</asp:Label></div>
								<div class="col6-3 headcell"><asp:Label ID="M1gokei_suryo_lbl" runat="server">合計数量</asp:Label></div>
							</div>
							...
							<asp:Repeater ID="M1" runat="server">
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col5-a1 detail_right">
										...
										<div class="col5-a2 detail_right">
										...
										<div class="col5-a3 detail_right">
