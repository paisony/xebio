...
function onLoad() {
	...
	/* hrefの値が消えてしまうので毎回設定 */
	document.all.item("Btnmoderef").href = "#tab16";
	document.all.item("Btnmodedel").href = "#tab11";
...
function onSubmit() {
	...
	switch (AdvGB_LastClickItemNm.toUpperCase()) {
		...
		case "Btnsearch".toUpperCase():
			// [選択モードNo]が「照会」「取消」の場合、ダイヤログ表示を行う。
