...
namespace com.xebio.bo.Tj130p01.Page
{
  ...
  /// Tj130p01の初期化ページです。
  /// </summary>
  public partial class Tj130p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj130p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj130f01", true);
					//efm.SetItemInfoFlg(pgId, "Tj130f02", true);
				}
