...
namespace com.xebio.bo.Ta080p01.Page
{
  ...
  /// Ta080p01の初期化ページです。
  /// </summary>
  public partial class Ta080p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Ta080p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Ta080f01", true);
					//efm.SetItemInfoFlg(pgId, "Ta080f02", true);
					//efm.SetItemInfoFlg(pgId, "Ta080f03", true);
				}
