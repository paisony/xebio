...
namespace com.xebio.bo.Ta080p01.Page
{
  ...
  /// Ta080f02のコードビハインドです。
  /// </summary>
  public partial class Ta080f02Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Ta080f02Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Ta080f02Facade().DoLoad(facadeContext);
								break;
						}
					}
					else
		...
		protected virtual void OnBTNBACK_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Ta080f02Facade().DoBTNBACK_FRM(facadeContext);
			...
			focusMno = (string)((Ta080f02Form)pageContext.GetFormVO(Ta080p01Constant.PGID, Ta080p01Constant.FORMID_02)).Dictionary[Ta080p01Constant.DIC_M1SELCETROWIDX];
		...
		protected virtual void OnPGR_PGN(object sender, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Ta080f02Facade().DoPGR_PGN(facadeContext, pageindex);
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Ta080f02Form ta080f02Form = (Ta080f02Form)pageContext.GetFormVO();

						//明細ページ情報を表示する
						ShowListPageInfo(ta080f02Form);
			
						//明細部データを表示する
						RenderList(ta080f02Form, pageContext.FormInfo, formResource, lang);

						//カード部データを表示する
						RenderCard(ta080f02Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// 明細ページ情報を表示する。
		/// </summary>
		/// <param name="ta080f02Form">画面FormVO</param>
		private void ShowListPageInfo(Ta080f02Form ta080f02Form)
		{
			//M1明細ページ情報を表示する。
			ShowM1ListPageInfo(ta080f02Form.GetList("M1"));
		...
		private void RenderList(
			Ta080f02Form ta080f02Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			//画面のM1明細部データを設定する。
			RenderM1List(ta080f02Form, formInfo, formResource, lang);
			//M1明細部のページャーにページ情報を設定する。
			RenderM1Pager(ta080f02Form);
		...
		{
			//M1明細部データソースを設定する。
			M1.DataSource = ta080f02Form.GetPageViewList("M1");
			M1.DataBind();
			...
			{
				Ta080f02M1Form ta080f02M1Form = (Ta080f02M1Form)m1DataList[index];
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1rowno"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1rowno,formInfo["M1rowno"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1apply_ymd"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1apply_ymd,formInfo["M1apply_ymd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1sinsei_sb"),
					Server.HtmlEncode(DataFormatUtil.GetFormatItem(ta080f02M1Form.M1sinsei_sb,formInfo["M1sinsei_sb"])));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hanbaiin_cd"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1hanbaiin_cd,formInfo["M1hanbaiin_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hanbaiin_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1hanbaiin_nm,formInfo["M1hanbaiin_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1irai_riyu"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1irai_riyu,formInfo["M1irai_riyu"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumon_cd"),
					Server.HtmlEncode(DataFormatUtil.GetFormatItem(ta080f02M1Form.M1bumon_cd,formInfo["M1bumon_cd"])));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumonkana_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1bumonkana_nm,formInfo["M1bumonkana_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hinsyu_cd"),
					Server.HtmlEncode(DataFormatUtil.GetFormatItem(ta080f02M1Form.M1hinsyu_cd,formInfo["M1hinsyu_cd"])));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hinsyu_ryaku_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1hinsyu_ryaku_nm,formInfo["M1hinsyu_ryaku_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1burando_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1burando_nm,formInfo["M1burando_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisya_hbn"),
					Server.HtmlEncode(DataFormatUtil.GetFormatItem(ta080f02M1Form.M1jisya_hbn,formInfo["M1jisya_hbn"])));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syohin_zokusei"),
					Server.HtmlEncode(DataFormatUtil.GetFormatItem(ta080f02M1Form.M1syohin_zokusei,formInfo["M1syohin_zokusei"])));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1maker_hbn"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1maker_hbn,formInfo["M1maker_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syonmk"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1syonmk,formInfo["M1syonmk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1iro_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1iro_nm,formInfo["M1iro_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1size_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1size_nm,formInfo["M1size_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1scan_cd"),
					Server.HtmlEncode(DataFormatUtil.GetFormatItem(ta080f02M1Form.M1scan_cd,formInfo["M1scan_cd"])));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1nyukayotei_ymd"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1nyukayotei_ymd,formInfo["M1nyukayotei_ymd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1season_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1season_nm,formInfo["M1season_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hanbaikanryo_ymd"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1hanbaikanryo_ymd,formInfo["M1hanbaikanryo_ymd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1apply_su"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1apply_su,formInfo["M1apply_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1apply_kin"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1apply_kin,formInfo["M1apply_kin"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisseki_su"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1jisseki_su,formInfo["M1jisseki_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisseki_kin"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1jisseki_kin,formInfo["M1jisseki_kin"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jotai_kbn_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1jotai_kbn_nm,formInfo["M1jotai_kbn_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1comment_nm"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1comment_nm,formInfo["M1comment_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1selectorcheckbox"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1selectorcheckbox,formInfo["M1selectorcheckbox"]));
				((System.Web.UI.WebControls.CheckBox)M1.Items[index].FindControl("M1selectorcheckbox")).Text =
					formResource.GetString("M1selectorcheckbox", lang);
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1entersyoriflg"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1entersyoriflg,formInfo["M1entersyoriflg"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1dtlirokbn"),
					DataFormatUtil.GetFormatItem(ta080f02M1Form.M1dtlirokbn,formInfo["M1dtlirokbn"]));
			...
			//M1明細部標題を設定する。
				...
				// (M1.HeaderRow.FindControl("M1sinsei_sb") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1sinsei_sb", lang), base.GetPageContext().FormInfo["M1sinsei_sb"]);
				// (M1.HeaderRow.FindControl("M1hanbaiin_cd") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1hanbaiin_cd", lang), base.GetPageContext().FormInfo["M1hanbaiin_cd"]);
				...
				// (M1.HeaderRow.FindControl("M1apply_su") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1apply_su", lang), base.GetPageContext().FormInfo["M1apply_su"]);
				// (M1.HeaderRow.FindControl("M1apply_kin") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1apply_kin", lang), base.GetPageContext().FormInfo["M1apply_kin"]);
				// (M1.HeaderRow.FindControl("M1jisseki_su") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1jisseki_su", lang), base.GetPageContext().FormInfo["M1jisseki_su"]);
				// (M1.HeaderRow.FindControl("M1jisseki_kin") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1jisseki_kin", lang), base.GetPageContext().FormInfo["M1jisseki_kin"]);
				// (M1.HeaderRow.FindControl("M1jotai_kbn_nm") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1jotai_kbn_nm", lang), base.GetPageContext().FormInfo["M1jotai_kbn_nm"]);
		...
		/// </summary>
		/// <param name="ta080f02Form">画面FormVO</param>
		private void RenderM1Pager(Ta080f02Form ta080f02Form)
		{
			Pgr.VirtualItemCount = ta080f02Form.GetList("M1").RecordCount;
			Pgr.CurrentPageIndex = ta080f02Form.GetList("M1").PageNo - 1;
			Pgr.PageSize = ta080f02Form.GetList("M1").DispRow;
		}
		#endregion
		#endregion
			...
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(ta080f02Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(ta080f02Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Yosan_ymd,
				DataFormatUtil.GetFormatItem(ta080f02Form.Yosan_ymd,formInfo["Yosan_ymd"]));
			ControlUtil.SetControlValue(Yosan_cd,
				DataFormatUtil.GetFormatItem(ta080f02Form.Yosan_cd,formInfo["Yosan_cd"]));
			ControlUtil.SetControlValue(Yosan_nm,
				DataFormatUtil.GetFormatItem(ta080f02Form.Yosan_nm,formInfo["Yosan_nm"]));
			ControlUtil.SetControlValue(Yosan_kin,
				DataFormatUtil.GetFormatItem(ta080f02Form.Yosan_kin,formInfo["Yosan_kin"]));
			ControlUtil.SetControlValue(Misinsei_su,
				DataFormatUtil.GetFormatItem(ta080f02Form.Misinsei_su,formInfo["Misinsei_su"]));
			ControlUtil.SetControlValue(Misinsei_kin,
				DataFormatUtil.GetFormatItem(ta080f02Form.Misinsei_kin,formInfo["Misinsei_kin"]));
			ControlUtil.SetControlValue(Apply_su,
				DataFormatUtil.GetFormatItem(ta080f02Form.Apply_su,formInfo["Apply_su"]));
			ControlUtil.SetControlValue(Apply_kin,
				DataFormatUtil.GetFormatItem(ta080f02Form.Apply_kin,formInfo["Apply_kin"]));
			ControlUtil.SetControlValue(Jisseki_su_bo2,
				DataFormatUtil.GetFormatItem(ta080f02Form.Jisseki_su_bo2,formInfo["Jisseki_su_bo2"]));
			ControlUtil.SetControlValue(Jisseki_kin,
				DataFormatUtil.GetFormatItem(ta080f02Form.Jisseki_kin,formInfo["Jisseki_kin"]));
			ControlUtil.SetControlValue(Zan_kin,
				DataFormatUtil.GetFormatItem(ta080f02Form.Zan_kin,formInfo["Zan_kin"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Ta080f02Form)base.GetPageContext().GetFormVO());
		...
		private void SetCardCaption(FormResource formResource, string lang)
		{
			...
			ControlUtil.SetControlValue(Jisseki_su_bo2_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Jisseki_su_bo2", lang), base.GetPageContext().FormInfo["Jisseki_su_bo2"]));
				DataFormatUtil.SetMustColorCaption(Jisseki_su_bo2_lbl, base.GetPageContext().FormInfo["Jisseki_su_bo2"]);
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Ta080f02_Titlebar", lang);
				header.FormName = formResource.GetString("Ta080f02_FormCaption", lang);
			}
		}
		#endregion
		#endregion
