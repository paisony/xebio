<%@ Page language="c#" CodeFile="tj140f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tj140p01.Page.Tj140f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tj140p01" FormId="tj140f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tj140f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tj140p01" FormId="tj140f01" runat="server" />
	<!-- Js業務部品のインポート --->
...
<body>
	<form id="Tj140f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tj140p01" PgName="棚卸終了処理(V)" FormId="tj140f01" FormName="棚卸終了処理" ></uc:Header>
			<!-------------------------------------------
                       □ヘッダー部
			-------------------------------------------->
