using com.xebio.bo.Tj140p01.Constant;
using com.xebio.bo.Tj140p01.Facade;
...
namespace com.xebio.bo.Tj140p01.Page
{
  ...
  /// Tj140f01のコードビハインドです。
  /// </summary>
  public partial class Tj140f01Page : StandardBasePage
	{
...
//					pageContext = base.GetPageContext();
					...
					{
						pageContext.SetFormVO(new Tj140f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tj140f01Facade().DoLoad(facadeContext);
								#region 共通ヘッダ処理

								// 一覧画面共通処理 ----------
								LoginInfoVO loginInfVO = LoginInfoUtil.GetLoginInfo();
								Tj140f01Form Tj140f01Form = (Tj140f01Form)facadeContext.FormVO;
								ControlHeaderStoreCls.InitialSetHeaderStore<Tj140f01Form>(loginInfVO, Tj140f01Form);
								// 一覧画面共通処理 ----------
				...
				*/
				...
				if (pageContext != null)
				{
					string msg = InfoMsgCls.GetWarningMsg(pageContext, Tj140p01Constant.PGID);
					...
					dlvo = (DLConditionVO)SessionInfoUtil.GetPgObject(Tj140p01Constant.PGID, "DLVO", pageContext.Session);
					// 使ったら削除
		...
		protected virtual void OnBTNENTER_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Tj140f01Facade().DoBTNENTER_FRM(facadeContext);
				...
				{
					// インフォメッセージの表示
					InfoMsgCls.showLoadMsg(pageContext, 1, Tj140p01Constant.PGID);
				}
				// インフォメッセージ ----------------------------------------------------------------------	
				...
				// PDFファイル名を取得
				pdfNm = (string)facadeContext.GetUserObject(Tj140p01Constant.FCDUO_RRT_FLNM);
			...
			string serverPath = string.Format("{0}{1}{2}",
											FilePathManager.GetOutFilePath(Tj140p01Constant.PGID),
											Path.DirectorySeparatorChar,
											pdfNm
											);
			// クライアントファイル名
			string clientNm = string.Format("{0}.{1}",
											BoSystemReport.CreateFileName(BoSystemConstant.REPORTNM_TANAOROSISYUKEIHYO_V, 2),
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Tj140f01Form tj140f01Form = (Tj140f01Form)pageContext.GetFormVO();

						//カード部データを表示する
						RenderCard(tj140f01Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// カードデータを表示する
		/// </summary>
		/// <param name="tj140f01Form">画面FormVO</param>
		/// <param name="formInfo">画面情報</param>
		/// <param name="formResource">画面リソース</param>
		/// <param name="lang">言語設定</param>
		private void RenderCard(
			Tj140f01Form tj140f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tj140f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tj140f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Tanaorosisyuryo_kb,
				DataFormatUtil.GetFormatItem(tj140f01Form.Tanaorosisyuryo_kb,formInfo["Tanaorosisyuryo_kb"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tj140f01Form)base.GetPageContext().GetFormVO());
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tj140f01_Titlebar", lang);
				header.FormName = formResource.GetString("Tj140f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
