<%@ Page language="c#" CodeFile="tj060f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tj060p01.Page.Tj060f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tj060p01" FormId="tj060f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tj060f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tj060p01" FormId="tj060f01" runat="server" />
...
<body>
	<form id="Tj060f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tj060p01" PgName="棚卸報告書再出力(X)" FormId="tj060f01" FormName="棚卸報告書再出力" ></uc:Header>
			<!------------------------------------------
				□ヘッダー部
			-------------------------------------------->
									...
									<div class="inner">
											...
											<table>
												...
												<tbody>
													<tr>
														...
														<td><span class="label-fromto">～</span></td>
														<td>
										...
										<table>
											...
											<tr>
												...
												<td>
													<!--- 「棚卸報告書区分」ラジオボタン --->
													<adv:ConditionRBList ID="Tanaorosi_hokokusyo_kb" ConditionName="tanaorosi_hokokusyo_x" RepeatDirection="Vertical" CssClass="h-type-01" runat="server"></adv:ConditionRBList>
												</td>
											</tr>
										</table>	
									<!-- /inner --></div>
