...
namespace com.xebio.bo.Tj060p01.Page
{
  ...
  /// Tj060p01の初期化ページです。
  /// </summary>
  public partial class Tj060p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj060p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj060f01", true);
				}
				...
				//フォーカス項目の指定
				queryList = FormFocusUtil.TakeOverFocus(null, Context);
				...
				{
					// [棚卸送信状態]にフォーカスを当てる。
					// ここでのラジオボタンへのフォーカス設定が不可能のため該当コードを{tj060f01.aspx.cs_Attribute設定}に記載
