...
using com.xebio.bo.Tj060p01.Facade;
...
namespace com.xebio.bo.Tj060p01.Page
{
  /// <summary>
  /// Tj060f01のコードビハインドです。
  /// </summary>
  public partial class Tj060f01Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Tj060f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tj060f01Facade().DoLoad(facadeContext);
								...
								ControlHeaderStoreCls.InitialSetHeaderStore<Tj060f01Form>(loginInfVO, Tj060f01Form);
								// 一覧画面共通処理 ----------

								if (string.IsNullOrEmpty(Tj060f01Form.Modeno))
								{
									// モードNoを今回に設定
									Tj060f01Form.Modeno = BoSystemConstant.MODE_KONKAI.ToString();
				...
				if (base.GetPageContext() != null)
				{
					...
					Tj060f01Form f01VO = (Tj060f01Form)fvm.GetProgramVO(base.GetPageContext().CommandInfo.ProgramId).GetFormVO(Tj060p01Constant.FORMID_01);
		...
		protected virtual void OnBTNPRINT_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Tj060f01Facade().DoBTNPRINT_FRM(facadeContext);
				...
				// PDFファイル名を取得			
				pdfNm = (string)facadeContext.GetUserObject(Tj060p01Constant.FCDUO_RRT_FLNM);
			...
			string serverPath = string.Format("{0}{1}{2}",
											FilePathManager.GetOutFilePath(Tj060p01Constant.PGID),
			...
			//FormVOを取得する
			Tj060f01Form tj060f01Form = (Tj060f01Form)pageContext.GetFormVO();

			if (tj060f01Form.Tanaorosi_hokokusyo_kb == ConditionTanaorosi_hokokusyo_x.VALUE_TANAOROSI_HOKOKUSYO_X1)
			{
				reportNm = BoSystemConstant.REPORTNM_TANAOROSISYUKEIHYO_X;
			}
			else if (tj060f01Form.Tanaorosi_hokokusyo_kb == ConditionTanaorosi_hokokusyo_x.VALUE_TANAOROSI_HOKOKUSYO_X2)
			{
				reportNm = BoSystemConstant.REPORTNM_TANAOROSIKETUBANHOKOKUSYO_X;
			}
			else if (tj060f01Form.Tanaorosi_hokokusyo_kb == ConditionTanaorosi_hokokusyo_x.VALUE_TANAOROSI_HOKOKUSYO_X3)
			{
				reportNm = BoSystemConstant.REPORTNM_TANAOROSITEISEIHOKOKUSYO_X;
			}
			else if (tj060f01Form.Tanaorosi_hokokusyo_kb == ConditionTanaorosi_hokokusyo_x.VALUE_TANAOROSI_HOKOKUSYO_X4)
			{
				reportNm = BoSystemConstant.REPORTNM_TANAOROSISYUSEIHOKOKUSYO_X;
			}
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//カード部データを表示する
						RenderCard(tj060f01Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// カードデータを表示する
		/// </summary>
		/// <param name="tj060f01Form">画面FormVO</param>
		/// <param name="formInfo">画面情報</param>
		/// <param name="formResource">画面リソース</param>
		/// <param name="lang">言語設定</param>
		private void RenderCard(
			Tj060f01Form tj060f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tj060f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tj060f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Modeno,
				DataFormatUtil.GetFormatItem(tj060f01Form.Modeno,formInfo["Modeno"]));
			ControlUtil.SetControlValue(Stkmodeno,
				DataFormatUtil.GetFormatItem(tj060f01Form.Stkmodeno,formInfo["Stkmodeno"]));
			ControlUtil.SetControlValue(Tanaorosikijun_ymd,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosikijun_ymd,formInfo["Tanaorosikijun_ymd"]));
			ControlUtil.SetControlValue(Tanaorosijissi_ymd,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosijissi_ymd,formInfo["Tanaorosijissi_ymd"]));
			ControlUtil.SetControlValue(Tanaorosikikan_from,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosikikan_from,formInfo["Tanaorosikikan_from"]));
			ControlUtil.SetControlValue(Tanaorosikikan_to,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosikikan_to,formInfo["Tanaorosikikan_to"]));
			ControlUtil.SetControlValue(Tanaorosikijun_ymd1,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosikijun_ymd1,formInfo["Tanaorosikijun_ymd1"]));
			ControlUtil.SetControlValue(Tanaorosijissi_ymd1,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosijissi_ymd1,formInfo["Tanaorosijissi_ymd1"]));
			ControlUtil.SetControlValue(Tanaorosikikan_from1,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosikikan_from1,formInfo["Tanaorosikikan_from1"]));
			ControlUtil.SetControlValue(Tanaorosikikan_to1,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosikikan_to1,formInfo["Tanaorosikikan_to1"]));
			ControlUtil.SetControlValue(Tanaorosi_hokokusyo_kb,
				DataFormatUtil.GetFormatItem(tj060f01Form.Tanaorosi_hokokusyo_kb,formInfo["Tanaorosi_hokokusyo_kb"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tj060f01Form)base.GetPageContext().GetFormVO());
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tj060f01_Titlebar", lang);
				header.FormName = formResource.GetString("Tj060f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
