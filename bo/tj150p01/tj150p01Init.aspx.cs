...
namespace com.xebio.bo.Tj150p01.Page
{
  ...
  /// Tj150p01の初期化ページです。
  /// </summary>
  public partial class Tj150p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj150p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj150f01", true);
				}
				...
				{
					// [棚卸送信状態]にフォーカスを当てる。
					// ここでのラジオボタンへのフォーカス設定が不可能なため該当コードを{tj150f01.aspx.cs_Attribute設定}に記載
