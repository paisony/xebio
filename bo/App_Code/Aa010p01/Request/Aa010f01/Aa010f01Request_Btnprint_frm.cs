namespace com.xebio.bo.Aa010p01.Request.Aa010f01
{
  /// <summary>
  /// Aa010f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Aa010f01Request_Btnprint : Aa010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Aa010f01Request_Btnprint Me = new Aa010f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Aa010f01Request_Btnprint()
		{
