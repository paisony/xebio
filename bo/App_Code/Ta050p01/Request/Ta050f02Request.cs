...
{
  /// <summary>
  /// Ta050f02Request の概要の説明です。
  /// </summary>
  public abstract class Ta050f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Ta050f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Ta050f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Ta050f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Ta050f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Ta050f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Ta050f02RequestHelper.ValidateM1InputValue(formVO, checker);
