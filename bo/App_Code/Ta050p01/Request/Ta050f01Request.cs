...
{
  /// <summary>
  /// Ta050f01Request の概要の説明です。
  /// </summary>
  public abstract class Ta050f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Ta050f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Ta050f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Ta050f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Ta050f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Ta050f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Ta050f01RequestHelper.ValidateM1InputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Ta050f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
			
			//明細部コード存在チェック
			Ta050f01RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
