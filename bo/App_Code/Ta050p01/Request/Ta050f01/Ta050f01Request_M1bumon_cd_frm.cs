...
namespace com.xebio.bo.Ta050p01.Request.Ta050f01
{
  /// <summary>
  /// Ta050f01Request_M1bumon_cd の概要の説明です。
  /// </summary>
  public sealed class Ta050f01Request_M1bumon_cd : Ta050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta050f01Request_M1bumon_cd Me = new Ta050f01Request_M1bumon_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta050f01Request_M1bumon_cd()
		{
