...
{
  /// <summary>
  /// Ta050f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta050f01Request_Pgr : Ta050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta050f01Request_Pgr Me = new Ta050f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta050f01Request_Pgr()
		{
