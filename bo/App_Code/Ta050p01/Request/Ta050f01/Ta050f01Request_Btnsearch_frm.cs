...
{
  /// <summary>
  /// Ta050f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Ta050f01Request_Btnsearch : Ta050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta050f01Request_Btnsearch Me = new Ta050f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta050f01Request_Btnsearch()
		{
