...
namespace com.xebio.bo.Ta050p01.Request.Ta050f02
{
  /// <summary>
  /// Ta050f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Ta050f02Request_Btnback : Ta050f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta050f02Request_Btnback Me = new Ta050f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta050f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Ta050f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
