...
{
  /// <summary>
  /// Ta050f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ta050f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta050f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta050f02M1ResultVO compare = null;
			if (obj is Ta050f02M1ResultVO)
			{
				compare = (Ta050f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Ta050p01.Formvo.Ta050f02M1Formのハッシュ コード。</returns>
