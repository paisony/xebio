...
namespace com.xebio.bo.Ta050p01.Codeex
{
  /// <summary>
  /// フォーム：Ta050f01 項目：Btnbumon_cd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta050f01Codeex_Btnbumon_cd_from : StandardBaseCodeex
	{
		public Ta050f01Codeex_Btnbumon_cd_from()
		{
		}
