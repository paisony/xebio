...
namespace com.xebio.bo.Ta050p01.Request
{
  /// <summary>
  /// Ta050f02RequestHelper の概要の説明です。
  /// </summary>
  public static class Ta050f02RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Ta050f02Form formVO = (Ta050f02Form)pageContext.GetFormVO();
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Ta050f02M1Form ta050f02M1Form = (Ta050f02M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1hinsyu_ryaku_nm = paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue;
				}
				if (paramCol["M1burando_nm"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1burando_nm = paramCol["M1burando_nm"][i].UnformatValue;
				}
				if (paramCol["M1jisya_hbn"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1jisya_hbn = paramCol["M1jisya_hbn"][i].UnformatValue;
				}
				if (paramCol["M1syohin_zokusei"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1syohin_zokusei = paramCol["M1syohin_zokusei"][i].UnformatValue;
				}
				if (paramCol["M1maker_hbn"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1maker_hbn = paramCol["M1maker_hbn"][i].UnformatValue;
				}
				if (paramCol["M1syonmk"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1syonmk = paramCol["M1syonmk"][i].UnformatValue;
				}
				if (paramCol["M1iro_nm"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1iro_nm = paramCol["M1iro_nm"][i].UnformatValue;
				}
				if (paramCol["M1size_nm"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1size_nm = paramCol["M1size_nm"][i].UnformatValue;
				}
				if (paramCol["M1scan_cd"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1scan_cd = paramCol["M1scan_cd"][i].UnformatValue;
				}
				if (paramCol["M1irai_su"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1irai_su = paramCol["M1irai_su"][i].UnformatValue;
				}
				if (paramCol["M1genkakin"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1genkakin = paramCol["M1genkakin"][i].UnformatValue;
				}
				if (paramCol["M1comment_nm"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1comment_nm = paramCol["M1comment_nm"][i].UnformatValue;
				}
				if (paramCol["M1comment_nm2"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1comment_nm2 = paramCol["M1comment_nm2"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					ta050f02M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Ta050f02Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Ta050f02Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Ta050f02M1Form ta050f02M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, ta050f02M1Form, i, m1List);
				if (ta050f02M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", ta050f02M1Form.M1rowno, i, m1List);
				}
				if (ta050f02M1Form.M1hinsyu_ryaku_nm != null)
				{
					checker.DoCheck("M1hinsyu_ryaku_nm", ta050f02M1Form.M1hinsyu_ryaku_nm, i, m1List);
				}
				if (ta050f02M1Form.M1burando_nm != null)
				{
					checker.DoCheck("M1burando_nm", ta050f02M1Form.M1burando_nm, i, m1List);
				}
				if (ta050f02M1Form.M1jisya_hbn != null)
				{
					checker.DoCheck("M1jisya_hbn", ta050f02M1Form.M1jisya_hbn, i, m1List);
				}
				if (ta050f02M1Form.M1syohin_zokusei != null)
				{
					checker.DoCheck("M1syohin_zokusei", ta050f02M1Form.M1syohin_zokusei, i, m1List);
				}
				if (ta050f02M1Form.M1maker_hbn != null)
				{
					checker.DoCheck("M1maker_hbn", ta050f02M1Form.M1maker_hbn, i, m1List);
				}
				if (ta050f02M1Form.M1syonmk != null)
				{
					checker.DoCheck("M1syonmk", ta050f02M1Form.M1syonmk, i, m1List);
				}
				if (ta050f02M1Form.M1iro_nm != null)
				{
					checker.DoCheck("M1iro_nm", ta050f02M1Form.M1iro_nm, i, m1List);
				}
				if (ta050f02M1Form.M1size_nm != null)
				{
					checker.DoCheck("M1size_nm", ta050f02M1Form.M1size_nm, i, m1List);
				}
				if (ta050f02M1Form.M1scan_cd != null)
				{
					checker.DoCheck("M1scan_cd", ta050f02M1Form.M1scan_cd, i, m1List);
				}
				if (ta050f02M1Form.M1irai_su != null)
				{
					checker.DoCheck("M1irai_su", ta050f02M1Form.M1irai_su, i, m1List);
				}
				if (ta050f02M1Form.M1genkakin != null)
				{
					checker.DoCheck("M1genkakin", ta050f02M1Form.M1genkakin, i, m1List);
				}
				if (ta050f02M1Form.M1comment_nm != null)
				{
					checker.DoCheck("M1comment_nm", ta050f02M1Form.M1comment_nm, i, m1List);
				}
				if (ta050f02M1Form.M1comment_nm2 != null)
				{
					checker.DoCheck("M1comment_nm2", ta050f02M1Form.M1comment_nm2, i, m1List);
				}
				if (ta050f02M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", ta050f02M1Form.M1selectorcheckbox, i, m1List);
				}
				if (ta050f02M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", ta050f02M1Form.M1entersyoriflg, i, m1List);
				}
				if (ta050f02M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", ta050f02M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Ta050f02Form formVO, StandardCodeCheckManager checker)
		{
		}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Ta050f02Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
