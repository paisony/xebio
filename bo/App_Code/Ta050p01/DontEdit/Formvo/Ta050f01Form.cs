using com.xebio.bo.Ta050p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Ta050f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta050f01Form : Ta050f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Ta050p01","Ta050f01");
