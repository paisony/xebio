...
{
  /// <summary>
  /// Ta050f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta050f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta050f01M1BaseForm compare = null;
			if (obj is Ta050f01M1BaseForm)
			{
				compare = (Ta050f01M1BaseForm)obj;
			}
			else
			{
				return false;
