...
{
  /// <summary>
  /// Ta050f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta050f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta050f02M1BaseForm compare = null;
			if (obj is Ta050f02M1BaseForm)
			{
				compare = (Ta050f02M1BaseForm)obj;
			}
			else
			{
				return false;
