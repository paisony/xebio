using com.xebio.bo.Tm030p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tm030f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tm030f01Form : Tm030f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tm030p01","Tm030f01");
