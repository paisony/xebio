...
namespace com.xebio.bo.Tm030p01.Formvo.Baseform
{
  /// <summary>
  /// Tm030f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tm030f01M1BaseForm : StandardBaseM1Form
	{
		...
		/// <summary>
		/// 項目「M1COMMENT_NM(メッセージ)」の値を取得または設定する。
		/// </summary>
		...
		{
			Tm030f01M1BaseForm compare = null;
			if (obj is Tm030f01M1BaseForm)
			{
				compare = (Tm030f01M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tm030p01.Formvo.Tm030f01M1Formのハッシュ コード。</returns>
