namespace com.xebio.bo.Tm030p01.Request.Tm030f01
{
  /// <summary>
  /// Tm030f01Request_M1tyohyo_nm の概要の説明です。
  /// </summary>
  public sealed class Tm030f01Request_M1tyohyo_nm : Tm030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm030f01Request_M1tyohyo_nm Me = new Tm030f01Request_M1tyohyo_nm();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm030f01Request_M1tyohyo_nm()
		{
