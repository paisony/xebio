...
namespace com.xebio.bo.Tm030p01.VO
{
  /// <summary>
  /// Tm030f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tm030f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tm030f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tm030f01M1ResultVO compare = null;
			if (obj is Tm030f01M1ResultVO)
			{
				compare = (Tm030f01M1ResultVO)obj;
			}
			else
			{
				return false;
