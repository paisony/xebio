...
namespace com.xebio.bo.Ti010p01.Request
{
  /// <summary>
  /// Ti010f01Request の概要の説明です。
  /// </summary>
  public abstract class Ti010f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Ti010f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Ti010f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Ti010f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Ti010f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Ti010f01Form formVO=(Ti010f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Ti010f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Ti010f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
