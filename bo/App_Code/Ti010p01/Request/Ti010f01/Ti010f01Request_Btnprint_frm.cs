namespace com.xebio.bo.Ti010p01.Request.Ti010f01
{
  /// <summary>
  /// Ti010f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Ti010f01Request_Btnprint : Ti010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ti010f01Request_Btnprint Me = new Ti010f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ti010f01Request_Btnprint()
		{
