namespace com.xebio.bo.Tj120p01.Constant
{
  /// <summary>
  /// Tj120p01の定数を定義するクラスです。
  /// </summary>
  public static class Tj120p01Constant
	{
		...
		/// プログラムID
		/// </summary>
		public const string PGID = "Tj120p01";
		#endregion
		...
		/// 一覧画面フォームID
		/// </summary>
		public const string FORMID_01 = "Tj120f01";
		/// <summary>
		/// 明細画面フォームID
		/// </summary>
		public const string FORMID_02 = "Tj120f02";
		...
		/// 検索ボタン_件数チェック
		/// </summary>
		public const string SQL_ID_01 = "TJ120P01-01";
		/// <summary>
		/// SQL-ID
		/// 検索ボタン_検索
		/// </summary>
		public const string SQL_ID_02 = "TJ120P01-02";
		/// <summary>
		/// SQL-ID
		/// Ｍ１Noリンク_検索
		/// </summary>
		public const string SQL_ID_03 = "TJ120P01-03";
		/// <summary>
		/// SQL-ID
		/// 確定ボタン_重複チェック
		/// </summary>
		public const string SQL_ID_04 = "TJ120P01-04";
		/// <summary>
		/// SQL-ID
		/// 確定ボタン_重複チェック
		/// </summary>
		public const string SQL_ID_05 = "TJ120P01-05";
		/// <summary>
		/// SQL-ID
		/// 確定ボタン_重複チェック
		/// </summary>
		public const string SQL_ID_06 = "TJ120P01-06";
		/// <summary>
		/// SQL-ID
		/// 確定ボタン_重複チェック
		/// </summary>
		public const string SQL_ID_07 = "TJ120P01-07";
		/// <summary>
		/// SQL-ID
		/// 確定ボタン_重複チェック
		/// </summary>
		public const string SQL_ID_08 = "TJ120P01-08";
		/// <summary>
		/// SQL-ID
		/// 確定ボタン_重複チェック
		/// </summary>
		public const string SQL_ID_09 = "TJ120P01-09";

		/// <summary>
		/// SQL-ID
		/// 確定ボタン_重複チェック
		/// </summary>
		public const string SQL_ID_10 = "TJ120P01-10";
		/// <summary>
		/// SQL-ID
		/// 確定ボタン_重複チェック
		/// </summary>
		public const string SQL_ID_11 = "TJ120P01-11";		
		...
		/// 置き換え条件
		/// </summary>
		public const string SQL_ID_REP_ADD_WHERE = "REP_ADD_WHERE";
		...
		/// 棚卸日
		/// </summary>
		public const string DIC_M1TANAOROSI_YMD = "DIC_TANAOROSI_YMD";
		/// <summary>
		/// 明細部 ディクショナリ
		/// 送信回数
		/// </summary>
