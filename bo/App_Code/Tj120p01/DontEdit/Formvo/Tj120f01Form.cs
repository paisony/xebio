using com.xebio.bo.Tj120p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tj120p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tj120f01Form : Tj120f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tj120p01","Tj120f01");
