...
{
  /// <summary>
  /// Tj120f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj120f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj120f01M1BaseForm compare = null;
			if (obj is Tj120f01M1BaseForm)
			{
				compare = (Tj120f01M1BaseForm)obj;
			}
			else
			{
				return false;
