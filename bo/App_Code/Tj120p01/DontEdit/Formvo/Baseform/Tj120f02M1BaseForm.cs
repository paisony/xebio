...
{
  /// <summary>
  /// Tj120f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj120f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj120f02M1BaseForm compare = null;
			if (obj is Tj120f02M1BaseForm)
			{
				compare = (Tj120f02M1BaseForm)obj;
			}
			else
			{
				return false;
