...
{
  /// <summary>
  /// Tj120f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tj120f01Request_Btnsearch : Tj120f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj120f01Request_Btnsearch Me = new Tj120f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj120f01Request_Btnsearch()
		{
