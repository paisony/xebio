...
{
  /// <summary>
  /// Tj120f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj120f01Request_Btnprint : Tj120f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj120f01Request_Btnprint Me = new Tj120f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj120f01Request_Btnprint()
		{
