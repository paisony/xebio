...
{
  /// <summary>
  /// Tj120f01Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tj120f01Request_Btnzenstk : Tj120f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj120f01Request_Btnzenstk Me = new Tj120f01Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj120f01Request_Btnzenstk()
		{
