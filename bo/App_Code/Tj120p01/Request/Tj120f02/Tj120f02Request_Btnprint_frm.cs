namespace com.xebio.bo.Tj120p01.Request.Tj120f02
{
  /// <summary>
  /// Tj120f02Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj120f02Request_Btnprint : Tj120f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj120f02Request_Btnprint Me = new Tj120f02Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj120f02Request_Btnprint()
		{
