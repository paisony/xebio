...
{
  /// <summary>
  /// Tj120f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tj120f02Request_Btnback : Tj120f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj120f02Request_Btnback Me = new Tj120f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj120f02Request_Btnback()
		{
