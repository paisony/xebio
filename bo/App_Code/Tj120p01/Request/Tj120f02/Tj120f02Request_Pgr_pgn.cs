...
{
  /// <summary>
  /// Tj120f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj120f02Request_Pgr : Tj120f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj120f02Request_Pgr Me = new Tj120f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj120f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tj120f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
