...
{
  /// <summary>
  /// Tj120f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj120f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj120f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj120f02M1ResultVO compare = null;
			if (obj is Tj120f02M1ResultVO)
			{
				compare = (Tj120f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tj120p01.Formvo.Tj120f02M1Formのハッシュ コード。</returns>
