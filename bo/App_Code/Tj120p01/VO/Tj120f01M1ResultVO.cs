...
namespace com.xebio.bo.Tj120p01.VO
{
  /// <summary>
  /// Tj120f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj120f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj120f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj120f01M1ResultVO compare = null;
			if (obj is Tj120f01M1ResultVO)
			{
				compare = (Tj120f01M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tj120p01.Formvo.Tj120f01M1Formのハッシュ コード。</returns>
