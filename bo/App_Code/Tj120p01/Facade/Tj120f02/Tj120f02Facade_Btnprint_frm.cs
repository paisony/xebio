...
{
  /// <summary>
  /// Tj120f02のFacadeクラスです
  /// 各アクションの業務ロジックを実装します。
  /// </summary>
  public partial class Tj120f02Facade : StandardBaseFacade
	{
		...
		public void DoBTNPRINT_FRM(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				#region 初期化
				//カード部を取得します。
				Tj120f02Form f02VO = (Tj120f02Form)facadeContext.FormVO;
				
				// 選択行を取得します。
				Tj120f01M1Form prevM1Vo = (Tj120f01M1Form)f02VO.Dictionary[Tj120p01Constant.DIC_M1SELCETVO];
				...
				//[棚卸日]
				inputData.AddScreenParameter(6, BoSystemFormat.formatDate((string)prevM1Vo.Dictionary[Tj120p01Constant.DIC_M1TANAOROSI_YMD])); 
				//[送信回数]
				inputData.AddScreenParameter(7,	(string)prevM1Vo.Dictionary[Tj120p01Constant.DIC_M1SOSINKAI_SU]);
