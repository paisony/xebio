  ...
  public partial class Tj120f01Facade : StandardBaseFacade
	{
		...
		public void DoBTNSEARCH_FRM(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				#region 件数チェック
				// 3 検索件数チェック
				FindSqlResultTable rtChk = FindSqlUtil.CreateFindSqlResultTable(Tj120p01Constant.SQL_ID_01, facadeContext.DBContext);
				...
				FindSqlResultTable rtSsarch = FindSqlUtil.CreateFindSqlResultTable(Tj120p01Constant.SQL_ID_02, facadeContext.DBContext);
				...
				{
					iCnt++;
					Tj120f01M1Form f01m1VO = new Tj120f01M1Form();
					...
					// [Ｍ１更新日] = T1.[更新日]
					// [Ｍ１更新時間] = T1.[更新時間]
					// [Ｍ１入力担当者コード] = T1.[登録担当者コード]
					// [Ｍ１フェイス№] = T1.[フェイス№]
					// [Ｍ１棚段] = T1.[棚段]
					// [Ｍ１棚卸日] = T1.[棚卸日]
					// [Ｍ１送信回数] = T1.[送信回数]
					// [棚卸基準日] = 2.4で取得した[棚卸基準日]
					f01m1VO.Dictionary.Add(Tj120p01Constant.DIC_M1ROWNO, iCnt.ToString());
					f01m1VO.Dictionary.Add(Tj120p01Constant.DIC_M1UPD_YMD, rec["UPD_YMD"].ToString());					// Ｍ１更新日
					f01m1VO.Dictionary.Add(Tj120p01Constant.DIC_M1UPD_TM, rec["UPD_TM"].ToString());					// Ｍ１更新時間
					f01m1VO.Dictionary.Add(Tj120p01Constant.DIC_M1NYURYOKUTAN_CD, rec["ADDTAN_CD"].ToString());			// Ｍ１入力担当者コード
					f01m1VO.Dictionary.Add(Tj120p01Constant.DIC_M1FACE_NO, rec["FACE_NO"].ToString());					// Ｍ１フェイスNo
					f01m1VO.Dictionary.Add(Tj120p01Constant.DIC_M1TANA_DAN, rec["TANA_DAN"].ToString());				// Ｍ１棚段
					f01m1VO.Dictionary.Add(Tj120p01Constant.DIC_M1TANAOROSI_YMD, rec["TANAOROSI_YMD"].ToString());		// Ｍ１棚日卸
					f01m1VO.Dictionary.Add(Tj120p01Constant.DIC_M1SOSINKAI_SU, rec["SOSINKAI_SU"].ToString());			// Ｍ１送信回数
				...
				f01VO.Dictionary[Tj120p01Constant.DIC_TANAOROSIKIJUN_YMD] = tanaorosikijun_Ymd;
		...
		/// AddWhere 検索条件設定
		/// </summary>
		/// <param name="Tj120f01Form">f01VO</param>
		/// <param name="FindSqlResultTable">reader</param>
		/// <param name="SysDateVO">sysDateVO</param>
		/// <returns></returns>
		private void AddWhere(Tj120f01Form f01VO, FindSqlResultTable reader ,string tanaorosikijun_Ymd)
		{
			...
			BoSystemSql.AddSql(reader, Tj120p01Constant.SQL_ID_REP_ADD_WHERE, sRepSql.ToString(), bindList);
		}
		#endregion
		#endregion
	}
