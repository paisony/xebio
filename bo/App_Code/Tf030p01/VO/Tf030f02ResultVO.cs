...
{
  /// <summary>
  /// Tf030f02のResultVOクラスです。
  /// </summary>
  [Serializable]
	public class Tf030f02ResultVO : StandardBaseVO
	{
		...
		/// <summary>
		/// 項目「KENPINSYA_CD(検品者)」の値
		/// </summary>
		private string _kenpinsya_cd;
		/// <summary>
		/// 項目「KENPINSYA_NM()」の値
		/// </summary>
		private string _kenpinsya_nm;
		/// <summary>
		...
		/// <summary>
		/// 項目「KENPINSYA_CD(検品者)」の値を取得または設定する。
		/// </summary>
		public virtual string Kenpinsya_cd
		{
			get
			{
				return this._kenpinsya_cd;
			}
			set
			{
				this._kenpinsya_cd = value;
			}
		}
		/// <summary>
		/// 項目「KENPINSYA_NM()」の値を取得または設定する。
		/// </summary>
		public virtual string Kenpinsya_nm
		{
			get
			{
				return this._kenpinsya_nm;
			}
			set
			{
				this._kenpinsya_nm = value;
			}
		}
		/// <summary>
		...
		/// <summary>
		/// 項目「NOHIN_YMD(納品日)」の値を取得または設定する。
		/// </summary>
		public virtual string Nohin_ymd
		{
			get
			{
				return this._nohin_ymd;
			}
			set
			{
				this._nohin_ymd = value;
			}
		}
		/// <summary>
		...
		/// <summary>
		/// 項目「GOKEI_KIN()」の値を取得または設定する。
		/// </summary>
		public virtual string Gokei_kin
		{
			get
			{
				return this._gokei_kin;
			}
			set
			{
				this._gokei_kin = value;
			}
		}
		#endregion
		...
		public override string ToString()
		{
			...
			sb.Append("Kenpinsya_cd:").Append(this._kenpinsya_cd).AppendLine();
			sb.Append("Kenpinsya_nm:").Append(this._kenpinsya_nm).AppendLine();
			...
			sb.Append("Nohin_ymd:").Append(this._nohin_ymd).AppendLine();
			sb.Append("Gokei_suryo:").Append(this._gokei_suryo).AppendLine();
			sb.Append("Gokei_kin:").Append(this._gokei_kin).AppendLine();
