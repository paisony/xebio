...
{
  /// <summary>
  /// Tf030f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tf030f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf030f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tf030f02M1ResultVO compare = null;
			if (obj is Tf030f02M1ResultVO)
			{
				compare = (Tf030f02M1ResultVO)obj;
			}
			else
			{
				return false;
