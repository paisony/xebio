...
{
  /// <summary>
  /// Tf030f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf030f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf030f01M1BaseForm compare = null;
			if (obj is Tf030f01M1BaseForm)
			{
				compare = (Tf030f01M1BaseForm)obj;
			}
			else
			{
				return false;
