...
{
  /// <summary>
  /// Tf030f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tf030f01Request_Btnsearch : Tf030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf030f01Request_Btnsearch Me = new Tf030f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf030f01Request_Btnsearch()
		{
