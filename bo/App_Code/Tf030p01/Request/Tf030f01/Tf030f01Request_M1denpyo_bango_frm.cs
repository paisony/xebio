namespace com.xebio.bo.Tf030p01.Request.Tf030f01
{
  /// <summary>
  /// Tf030f01Request_M1denpyo_bango の概要の説明です。
  /// </summary>
  public sealed class Tf030f01Request_M1denpyo_bango : Tf030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf030f01Request_M1denpyo_bango Me = new Tf030f01Request_M1denpyo_bango();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf030f01Request_M1denpyo_bango()
		{
