...
{
  /// <summary>
  /// Tf030f02Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tf030f02Request_Btnrowdel : Tf030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf030f02Request_Btnrowdel Me = new Tf030f02Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf030f02Request_Btnrowdel()
		{
