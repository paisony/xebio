...
{
  /// <summary>
  /// Tf030f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tf030f02Request_Btnenter : Tf030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf030f02Request_Btnenter Me = new Tf030f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf030f02Request_Btnenter()
		{
