...
namespace com.xebio.bo.Tf030p01.Request.Tf030f02
{
  /// <summary>
  /// Tf030f02Request_Btnrowins の概要の説明です。
  /// </summary>
  public sealed class Tf030f02Request_Btnrowins : Tf030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf030f02Request_Btnrowins Me = new Tf030f02Request_Btnrowins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf030f02Request_Btnrowins()
		{
