namespace com.xebio.bo.Tb040p01.Request.Tb040f01
{
  /// <summary>
  /// Tb040f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tb040f01Request_Btnenter : Tb040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb040f01Request_Btnenter Me = new Tb040f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb040f01Request_Btnenter()
		{
