...
namespace com.xebio.bo.Tb040p01.Formvo.Baseform
{
  /// <summary>
  /// Tb040f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb040f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tb040f01M1BaseForm compare = null;
			if (obj is Tb040f01M1BaseForm)
			{
				compare = (Tb040f01M1BaseForm)obj;
			}
			else
			{
				return false;
