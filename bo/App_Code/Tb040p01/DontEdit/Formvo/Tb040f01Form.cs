using com.xebio.bo.Tb040p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tb040f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb040f01Form : Tb040f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tb040p01","Tb040f01");
