namespace com.xebio.bo.Tj180p01.Request.Tj180f01
{
  /// <summary>
  /// Tj180f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tj180f01Request_Btnsearch : Tj180f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj180f01Request_Btnsearch Me = new Tj180f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj180f01Request_Btnsearch()
		{
