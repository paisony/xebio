  ...
  public partial class Tj100f01Facade : StandardBaseFacade
	{
		...
		/// プログラムID。
		/// </summary>
		private const string PGID = "Tj100p01";
		/// <summary>
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tj100f01";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj100f01Facade()
			: base()
		{
		}
		#endregion

		#region Tj100f01画面データを作成する。
		/// <summary>
		/// Tj100f01画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				tj100f01Form.Torimore_ketsuban = ConditionTorimore_ketsuban_kbn.VALUE_TORIMORE;
				#endregion
