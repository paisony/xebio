...
namespace com.xebio.bo.Tj100p01.Formvo.Baseform
{
  /// <summary>
  /// Tj100f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj100f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj100f01M1BaseForm compare = null;
			if (obj is Tj100f01M1BaseForm)
			{
				compare = (Tj100f01M1BaseForm)obj;
			}
			else
			{
				return false;
