...
namespace com.xebio.bo.Tj100p01.Request.Tj100f01
{
  /// <summary>
  /// Tj100f01Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tj100f01Request_Btnzenstk : Tj100f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj100f01Request_Btnzenstk Me = new Tj100f01Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj100f01Request_Btnzenstk()
		{
