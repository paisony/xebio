...
{
  /// <summary>
  /// Tj100f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tj100f01Request_Btnzenkjo : Tj100f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj100f01Request_Btnzenkjo Me = new Tj100f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj100f01Request_Btnzenkjo()
		{
