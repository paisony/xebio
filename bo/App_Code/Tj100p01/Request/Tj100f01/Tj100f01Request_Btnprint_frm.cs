...
{
  /// <summary>
  /// Tj100f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj100f01Request_Btnprint : Tj100f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj100f01Request_Btnprint Me = new Tj100f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj100f01Request_Btnprint()
		{
