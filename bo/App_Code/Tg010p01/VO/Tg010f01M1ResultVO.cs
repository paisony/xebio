...
{
  /// <summary>
  /// Tg010f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tg010f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tg010f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tg010f01M1ResultVO compare = null;
			if (obj is Tg010f01M1ResultVO)
			{
				compare = (Tg010f01M1ResultVO)obj;
			}
			else
			{
				return false;
