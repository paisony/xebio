...
namespace com.xebio.bo.Tg010p01.Codeex
{
  /// <summary>
  /// フォーム：Tg010f01 項目：Btnburando_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tg010f01Codeex_Btnburando_cd : StandardBaseCodeex
	{
		public Tg010f01Codeex_Btnburando_cd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			context.Condition.AddFindKey(" MENTF = 0");
		...
		public override void BeforeSearch(ICodeContext context)
		{
			...
			// 入力値を半角に置き換え
			string inpval = (string)context.ExeValue.InputValues["Burando_nm"];
			context.ExeValue.InputValues["Burando_nm"] = BoSystemString.ChangeZenHankaku(inpval, 1);
