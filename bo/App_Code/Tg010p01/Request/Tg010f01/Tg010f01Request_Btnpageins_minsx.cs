...
namespace com.xebio.bo.Tg010p01.Request.Tg010f01
{
  /// <summary>
  /// Tg010f01Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Tg010f01Request_Btnpageins : Tg010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg010f01Request_Btnpageins Me = new Tg010f01Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg010f01Request_Btnpageins()
		{
