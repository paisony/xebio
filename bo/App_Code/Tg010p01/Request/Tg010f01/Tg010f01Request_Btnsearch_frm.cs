...
{
  /// <summary>
  /// Tg010f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tg010f01Request_Btnsearch : Tg010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg010f01Request_Btnsearch Me = new Tg010f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg010f01Request_Btnsearch()
		{
