...
{
  /// <summary>
  /// Tg010f01Request_Btnsizstk の概要の説明です。
  /// </summary>
  public sealed class Tg010f01Request_Btnsizstk : Tg010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg010f01Request_Btnsizstk Me = new Tg010f01Request_Btnsizstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg010f01Request_Btnsizstk()
		{
