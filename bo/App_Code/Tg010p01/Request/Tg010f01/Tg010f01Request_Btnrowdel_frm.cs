...
{
  /// <summary>
  /// Tg010f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tg010f01Request_Btnrowdel : Tg010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg010f01Request_Btnrowdel Me = new Tg010f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg010f01Request_Btnrowdel()
		{
