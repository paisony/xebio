...
{
  /// <summary>
  /// Tg010f01Request_Btnseal の概要の説明です。
  /// </summary>
  public sealed class Tg010f01Request_Btnseal : Tg010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg010f01Request_Btnseal Me = new Tg010f01Request_Btnseal();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg010f01Request_Btnseal()
		{
