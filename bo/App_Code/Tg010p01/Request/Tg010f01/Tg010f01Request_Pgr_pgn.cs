...
{
  /// <summary>
  /// Tg010f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tg010f01Request_Pgr : Tg010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg010f01Request_Pgr Me = new Tg010f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg010f01Request_Pgr()
		{
