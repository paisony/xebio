using com.xebio.bo.Tg010p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tg010f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tg010f01Form : Tg010f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tg010p01","Tg010f01");
