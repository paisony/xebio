...
{
  /// <summary>
  /// Tf010f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tf010f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf010f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tf010f02M1ResultVO compare = null;
			if (obj is Tf010f02M1ResultVO)
			{
				compare = (Tf010f02M1ResultVO)obj;
			}
			else
			{
				return false;
