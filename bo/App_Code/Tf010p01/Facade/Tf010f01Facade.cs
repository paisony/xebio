  ...
  public partial class Tf010f01Facade : StandardBaseFacade
	{
		...
		/// プログラムID。
		/// </summary>
		private const string PGID = "Tf010p01";
		/// <summary>
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tf010f01";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf010f01Facade()
			: base()
		{
		}
		#endregion

		#region Tf010f01画面データを作成する。
		/// <summary>
		/// Tf010f01画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//以下に業務ロジックを記述する。
				...
				// ソート順の初期設定
				tf010f01Form.Meisai_sort = ConditionMeisai_sort_tf010f01.VALUE_MEISAI_SORT_TF010F011;
