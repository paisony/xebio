...
{
  /// <summary>
  /// Tf010f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf010f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf010f01M1BaseForm compare = null;
			if (obj is Tf010f01M1BaseForm)
			{
				compare = (Tf010f01M1BaseForm)obj;
			}
			else
			{
				return false;
