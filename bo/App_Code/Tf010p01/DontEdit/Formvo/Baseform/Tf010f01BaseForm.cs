...
namespace com.xebio.bo.Tf010p01.Formvo.Baseform
{
  /// <summary>
  /// Tf010f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf010f01BaseForm : StandardBaseForm, IFormVO
	{
		...
		/// <summary>
		/// 項目「SHINSEI_TENPO_CD_FROM(申請店舗ＦＲＯＭ)」の値
		/// </summary>
		private string _shinsei_tenpo_cd_from;
		/// <summary>
		/// 項目「SHINSEI_TENPO_NM_FROM()」の値
		/// </summary>
		private string _shinsei_tenpo_nm_from;
		/// <summary>
		/// 項目「SHINSEI_TENPO_CD_TO(申請店舗ＴＯ)」の値
		/// </summary>
		private string _shinsei_tenpo_cd_to;
		/// <summary>
		/// 項目「SHINSEI_TENPO_NM_TO()」の値
		/// </summary>
		private string _shinsei_tenpo_nm_to;
		/// <summary>
		/// 項目「GYOMURINGI_NO_FROM(業務稟議NoＦＲＯＭ)」の値
		/// </summary>
		private string _gyomuringi_no_from;
		/// <summary>
		/// 項目「GYOMURINGI_NO_TO(業務稟議NoＴＯ)」の値
		/// </summary>
		private string _gyomuringi_no_to;
		/// <summary>
		...
		/// <summary>
		/// 項目「SHINSEI_TENPO_CD_FROM(申請店舗ＦＲＯＭ)」の値を取得または設定する。
		/// </summary>
		public virtual string Shinsei_tenpo_cd_from
		{
			get
			{
				return this._shinsei_tenpo_cd_from;
			}
			set
			{
				this._shinsei_tenpo_cd_from = value;
			}
		}
		/// <summary>
		/// 項目「SHINSEI_TENPO_NM_FROM()」の値を取得または設定する。
		/// </summary>
		public virtual string Shinsei_tenpo_nm_from
		{
			get
			{
				return this._shinsei_tenpo_nm_from;
			}
			set
			{
				this._shinsei_tenpo_nm_from = value;
			}
		}
		/// <summary>
		/// 項目「SHINSEI_TENPO_CD_TO(申請店舗ＴＯ)」の値を取得または設定する。
		/// </summary>
		public virtual string Shinsei_tenpo_cd_to
		{
			get
			{
				return this._shinsei_tenpo_cd_to;
			}
			set
			{
				this._shinsei_tenpo_cd_to = value;
			}
		}
		/// <summary>
		/// 項目「SHINSEI_TENPO_NM_TO()」の値を取得または設定する。
		/// </summary>
		public virtual string Shinsei_tenpo_nm_to
		{
			get
			{
				return this._shinsei_tenpo_nm_to;
			}
			set
			{
				this._shinsei_tenpo_nm_to = value;
			}
		}
		/// <summary>
		/// 項目「GYOMURINGI_NO_FROM(業務稟議NoＦＲＯＭ)」の値を取得または設定する。
		/// </summary>
		public virtual string Gyomuringi_no_from
		{
			get
			{
				return this._gyomuringi_no_from;
			}
			set
			{
				this._gyomuringi_no_from = value;
			}
		}
		/// <summary>
		/// 項目「GYOMURINGI_NO_TO(業務稟議NoＴＯ)」の値を取得または設定する。
		/// </summary>
		public virtual string Gyomuringi_no_to
		{
			get
			{
				return this._gyomuringi_no_to;
			}
			set
			{
				this._gyomuringi_no_to = value;
			}
		}
		/// <summary>
		...
		public override string ToString()
		{
			...
			sb.Append("Shinsei_tenpo_cd_from:").Append(this._shinsei_tenpo_cd_from).AppendLine();
			sb.Append("Shinsei_tenpo_nm_from:").Append(this._shinsei_tenpo_nm_from).AppendLine();
			sb.Append("Shinsei_tenpo_cd_to:").Append(this._shinsei_tenpo_cd_to).AppendLine();
			sb.Append("Shinsei_tenpo_nm_to:").Append(this._shinsei_tenpo_nm_to).AppendLine();
			sb.Append("Gyomuringi_no_from:").Append(this._gyomuringi_no_from).AppendLine();
			sb.Append("Gyomuringi_no_to:").Append(this._gyomuringi_no_to).AppendLine();
