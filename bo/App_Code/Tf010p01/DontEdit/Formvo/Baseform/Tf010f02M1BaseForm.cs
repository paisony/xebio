...
{
  /// <summary>
  /// Tf010f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf010f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf010f02M1BaseForm compare = null;
			if (obj is Tf010f02M1BaseForm)
			{
				compare = (Tf010f02M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tf010p01.Formvo.Tf010f02M1Formのハッシュ コード。</returns>
