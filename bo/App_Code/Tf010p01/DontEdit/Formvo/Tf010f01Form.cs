using com.xebio.bo.Tf010p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tf010p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tf010f01Form : Tf010f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tf010p01","Tf010f01");
