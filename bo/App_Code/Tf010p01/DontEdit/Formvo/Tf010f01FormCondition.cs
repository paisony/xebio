...
namespace com.xebio.bo.Tf010p01.Formvo
{
  ...
  /// </summary>
  [System.Serializable]
	public class Tf010f01FormCondition : IConditionVO
	{
		...
		/// <summary>
		/// 項目「SHINSEI_TENPO_CD_FROM(申請店舗コードＦＲＯＭ)」の値
		/// </summary>
		//private string _shinsei_tenpo_cd_from;
		/// <summary>
		/// 項目「SHINSEI_TENPO_NM_FROM(申請店舗名ＦＲＯＭ)」の値
		/// </summary>
		//private string _shinsei_tenpo_nm_from;
		/// <summary>
		/// 項目「SHINSEI_TENPO_CD_TO(申請店舗コードＴＯ)」の値
		/// </summary>
		//private string _shinsei_tenpo_cd_to;
		/// <summary>
		/// 項目「SHINSEI_TENPO_NM_TO(申請店舗名ＴＯ)」の値
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「SHINSEI_TENPO_CD_FROM(申請店舗コードＦＲＯＭ)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「SHINSEI_TENPO_NM_FROM(申請店舗名ＦＲＯＭ)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「SHINSEI_TENPO_CD_TO(申請店舗コードＴＯ)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「SHINSEI_TENPO_NM_TO(申請店舗名ＴＯ)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「MEISAI_SORT(明細ソート)」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf010f01FormCondition() : base()
		{
		}
		#endregion
	}
