...
{
  /// <summary>
  /// Tf010f02Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tf010f02Request_Btnrowdel : Tf010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf010f02Request_Btnrowdel Me = new Tf010f02Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf010f02Request_Btnrowdel()
		{
