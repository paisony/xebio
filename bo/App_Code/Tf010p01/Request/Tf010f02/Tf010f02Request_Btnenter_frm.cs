...
{
  /// <summary>
  /// Tf010f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tf010f02Request_Btnenter : Tf010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf010f02Request_Btnenter Me = new Tf010f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf010f02Request_Btnenter()
		{
