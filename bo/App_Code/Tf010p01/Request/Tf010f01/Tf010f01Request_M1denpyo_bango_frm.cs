...
{
  /// <summary>
  /// Tf010f01Request_M1denpyo_bango の概要の説明です。
  /// </summary>
  public sealed class Tf010f01Request_M1denpyo_bango : Tf010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf010f01Request_M1denpyo_bango Me = new Tf010f01Request_M1denpyo_bango();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf010f01Request_M1denpyo_bango()
		{
