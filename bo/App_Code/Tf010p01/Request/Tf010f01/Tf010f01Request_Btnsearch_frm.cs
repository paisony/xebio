...
{
  /// <summary>
  /// Tf010f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tf010f01Request_Btnsearch : Tf010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf010f01Request_Btnsearch Me = new Tf010f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf010f01Request_Btnsearch()
		{
