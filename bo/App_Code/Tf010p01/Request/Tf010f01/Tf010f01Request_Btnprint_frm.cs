...
{
  /// <summary>
  /// Tf010f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tf010f01Request_Btnprint : Tf010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf010f01Request_Btnprint Me = new Tf010f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf010f01Request_Btnprint()
		{
