...
{
  /// <summary>
  /// Tf010f01Request_Btncsv の概要の説明です。
  /// </summary>
  public sealed class Tf010f01Request_Btncsv : Tf010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf010f01Request_Btncsv Me = new Tf010f01Request_Btncsv();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf010f01Request_Btncsv()
		{
