...
{
  /// <summary>
  /// フォーム：Tf010f02 項目：Sinseiriyu_kb の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tf010f02Codeex_Sinseiriyu_kb : StandardBaseCodeex
	{
		public Tf010f02Codeex_Sinseiriyu_kb()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 識別コードを条件に設定
			context.Condition.AddFindKey("SIKIBETSU_CD = 'KHRY'");
