...
{
  /// <summary>
  /// フォーム：Tf010f01 項目：Sinseiriyu_kb の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tf010f01Codeex_Sinseiriyu_kb : StandardBaseCodeex
	{
		public Tf010f01Codeex_Sinseiriyu_kb()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// 識別コードを条件に設定
			context.Condition.AddFindKey("SIKIBETSU_CD = 'KHRT'");
