...
namespace com.xebio.bo.Tc010p01.Request
{
  /// <summary>
  /// Tc010f01Request の概要の説明です。
  /// </summary>
  public abstract class Tc010f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tc010f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tc010f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tc010f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tc010f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Tc010f01Form formVO=(Tc010f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Tc010f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tc010f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
