namespace com.xebio.bo.Tc010p01.Request.Tc010f01
{
  /// <summary>
  /// Tc010f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tc010f01Request_Btnprint : Tc010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tc010f01Request_Btnprint Me = new Tc010f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tc010f01Request_Btnprint()
		{
