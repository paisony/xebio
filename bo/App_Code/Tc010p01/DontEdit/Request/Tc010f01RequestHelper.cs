...
{
  /// <summary>
  /// Tc010f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Tc010f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void ValidateCardInputValue(Tc010f01Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tc010f01Form formVO, StandardCodeCheckManager checker)
		{
