...
{
  /// <summary>
  /// Tj030f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj030f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj030f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj030f01M1ResultVO compare = null;
			if (obj is Tj030f01M1ResultVO)
			{
				compare = (Tj030f01M1ResultVO)obj;
			}
			else
			{
				return false;
