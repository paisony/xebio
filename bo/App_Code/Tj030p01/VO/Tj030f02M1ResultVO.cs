...
{
  /// <summary>
  /// Tj030f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj030f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj030f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj030f02M1ResultVO compare = null;
			if (obj is Tj030f02M1ResultVO)
			{
				compare = (Tj030f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tj030p01.Formvo.Tj030f02M1Formのハッシュ コード。</returns>
