...
{
  /// <summary>
  /// Tj030f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Tj030f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Tj030f01M1Form tj030f01M1Form = (Tj030f01M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1tana_dan"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1tana_dan = paramCol["M1tana_dan"][i].UnformatValue;
				}
				if (paramCol["M1kai_su"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1kai_su = paramCol["M1kai_su"][i].UnformatValue;
				}
				if (paramCol["M1scan_su"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1scan_su = paramCol["M1scan_su"][i].UnformatValue;
				}
				if (paramCol["M1nyuryokutan_nm"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1nyuryokutan_nm = paramCol["M1nyuryokutan_nm"][i].UnformatValue;
				}
				if (paramCol["M1nyuryoku_ymd"][i].DateFullValue != null)
				{
					tj030f01M1Form.M1nyuryoku_ymd = paramCol["M1nyuryoku_ymd"][i].DateFullValue;
				}
				if (paramCol["M1sosin_ymd"][i].DateFullValue != null)
				{
					tj030f01M1Form.M1sosin_ymd = paramCol["M1sosin_ymd"][i].DateFullValue;
				}
				if (paramCol["M1gyosya"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1gyosya = paramCol["M1gyosya"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					tj030f01M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Tj030f01Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Tj030f01Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Tj030f01M1Form tj030f01M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, tj030f01M1Form, i, m1List);
				if (tj030f01M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", tj030f01M1Form.M1rowno, i, m1List);
				}
				if (tj030f01M1Form.M1tana_dan != null)
				{
					checker.DoCheck("M1tana_dan", tj030f01M1Form.M1tana_dan, i, m1List);
				}
				if (tj030f01M1Form.M1kai_su != null)
				{
					checker.DoCheck("M1kai_su", tj030f01M1Form.M1kai_su, i, m1List);
				}
				if (tj030f01M1Form.M1scan_su != null)
				{
					checker.DoCheck("M1scan_su", tj030f01M1Form.M1scan_su, i, m1List);
				}
				if (tj030f01M1Form.M1nyuryokutan_nm != null)
				{
					checker.DoCheck("M1nyuryokutan_nm", tj030f01M1Form.M1nyuryokutan_nm, i, m1List);
				}
				if (tj030f01M1Form.M1nyuryoku_ymd != null)
				{
					checker.DoCheck("M1nyuryoku_ymd", tj030f01M1Form.M1nyuryoku_ymd, i, m1List);
				}
				if (tj030f01M1Form.M1sosin_ymd != null)
				{
					checker.DoCheck("M1sosin_ymd", tj030f01M1Form.M1sosin_ymd, i, m1List);
				}
				if (tj030f01M1Form.M1gyosya != null)
				{
					checker.DoCheck("M1gyosya", tj030f01M1Form.M1gyosya, i, m1List);
				}
				if (tj030f01M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", tj030f01M1Form.M1selectorcheckbox, i, m1List);
				}
				if (tj030f01M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", tj030f01M1Form.M1entersyoriflg, i, m1List);
				}
				if (tj030f01M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", tj030f01M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tj030f01Form formVO, StandardCodeCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Tj030f01Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
