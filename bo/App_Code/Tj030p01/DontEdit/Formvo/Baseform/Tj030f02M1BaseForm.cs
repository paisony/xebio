...
{
  /// <summary>
  /// Tj030f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj030f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj030f02M1BaseForm compare = null;
			if (obj is Tj030f02M1BaseForm)
			{
				compare = (Tj030f02M1BaseForm)obj;
			}
			else
			{
				return false;
