using com.xebio.bo.Tj030p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tj030p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tj030f01Form : Tj030f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tj030p01","Tj030f01");
