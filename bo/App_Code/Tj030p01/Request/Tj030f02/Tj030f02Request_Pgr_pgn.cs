...
namespace com.xebio.bo.Tj030p01.Request.Tj030f02
{
  /// <summary>
  /// Tj030f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj030f02Request_Pgr : Tj030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj030f02Request_Pgr Me = new Tj030f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj030f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tj030f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
