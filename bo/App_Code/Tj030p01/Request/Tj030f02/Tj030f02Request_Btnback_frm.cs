...
{
  /// <summary>
  /// Tj030f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tj030f02Request_Btnback : Tj030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj030f02Request_Btnback Me = new Tj030f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj030f02Request_Btnback()
		{
