...
{
  /// <summary>
  /// Tj030f01Request_M1face_no の概要の説明です。
  /// </summary>
  public sealed class Tj030f01Request_M1face_no : Tj030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj030f01Request_M1face_no Me = new Tj030f01Request_M1face_no();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj030f01Request_M1face_no()
		{
