...
{
  /// <summary>
  /// Tj030f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj030f01Request_Btnprint : Tj030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj030f01Request_Btnprint Me = new Tj030f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj030f01Request_Btnprint()
		{
