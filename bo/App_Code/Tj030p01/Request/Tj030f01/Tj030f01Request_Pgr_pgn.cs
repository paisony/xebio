...
{
  /// <summary>
  /// Tj030f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj030f01Request_Pgr : Tj030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj030f01Request_Pgr Me = new Tj030f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj030f01Request_Pgr()
		{
