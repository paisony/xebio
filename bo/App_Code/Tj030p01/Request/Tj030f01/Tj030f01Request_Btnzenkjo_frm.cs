...
{
  /// <summary>
  /// Tj030f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tj030f01Request_Btnzenkjo : Tj030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj030f01Request_Btnzenkjo Me = new Tj030f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj030f01Request_Btnzenkjo()
		{
