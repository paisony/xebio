...
{
  /// <summary>
  /// Tj030f01Request の概要の説明です。
  /// </summary>
  public abstract class Tj030f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tj030f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tj030f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tj030f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tj030f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tj030f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tj030f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
