  ...
  public partial class Tj030f01Facade : StandardBaseFacade
	{
		...
		/// プログラムID。
		/// </summary>
		private const string PGID = "Tj030p01";
		/// <summary>
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tj030f01";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj030f01Facade()
			: base()
		{
		}
		#endregion

		#region Tj030f01画面データを作成する。
		/// <summary>
		/// Tj030f01画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				// 前月の1日を設定する
				tj030f01Form.Nyuryoku_ymd_from = GetZebgetsu(sysDateVO.Sysdate.ToString());
				tj030f01Form.Nyuryoku_ymd_to = sysDateVO.Sysdate.ToString();					// 入力日TO
				tj030f01Form.Sosin_jyotai = ConditionSosin_jotai.VALUE_SOSIN_JOTAI1;			// 送信状態
