...
{
  /// <summary>
  /// Tm040f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tm040f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tm040f01M1BaseForm compare = null;
			if (obj is Tm040f01M1BaseForm)
			{
				compare = (Tm040f01M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tm040p01.Formvo.Tm040f01M1Formのハッシュ コード。</returns>
