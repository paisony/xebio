...
{
  /// <summary>
  /// Tm040f02のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tm040f02Form : Tm040f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tm040p01","Tm040f02");
