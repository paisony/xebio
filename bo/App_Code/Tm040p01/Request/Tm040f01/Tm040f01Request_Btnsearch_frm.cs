...
{
  /// <summary>
  /// Tm040f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tm040f01Request_Btnsearch : Tm040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm040f01Request_Btnsearch Me = new Tm040f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm040f01Request_Btnsearch()
		{
