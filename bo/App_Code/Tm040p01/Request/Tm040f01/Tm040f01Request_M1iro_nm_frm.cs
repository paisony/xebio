...
namespace com.xebio.bo.Tm040p01.Request.Tm040f01
{
  /// <summary>
  /// Tm040f01Request_M1iro_nm の概要の説明です。
  /// </summary>
  public sealed class Tm040f01Request_M1iro_nm : Tm040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm040f01Request_M1iro_nm Me = new Tm040f01Request_M1iro_nm();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm040f01Request_M1iro_nm()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tm040f01RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
