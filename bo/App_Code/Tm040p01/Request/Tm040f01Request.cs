...
{
  /// <summary>
  /// Tm040f01Request の概要の説明です。
  /// </summary>
  public abstract class Tm040f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tm040f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tm040f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tm040f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tm040f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tm040f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Tm040f01RequestHelper.ValidateM1InputValue(formVO, checker);
