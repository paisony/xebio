...
{
  /// <summary>
  /// Tm040f02Request の概要の説明です。
  /// </summary>
  public abstract class Tm040f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tm040f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tm040f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tm040f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tm040f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tm040f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Tm040f02RequestHelper.ValidateM1InputValue(formVO, checker);
