namespace com.xebio.bo.Tm040p01.Request.Tm040f02
{
  /// <summary>
  /// Tm040f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tm040f02Request_Btnenter : Tm040f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm040f02Request_Btnenter Me = new Tm040f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm040f02Request_Btnenter()
		{
