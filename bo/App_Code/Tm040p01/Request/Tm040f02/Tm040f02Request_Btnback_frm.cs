...
{
  /// <summary>
  /// Tm040f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tm040f02Request_Btnback : Tm040f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm040f02Request_Btnback Me = new Tm040f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm040f02Request_Btnback()
		{
