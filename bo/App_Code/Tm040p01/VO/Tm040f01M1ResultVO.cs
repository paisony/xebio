...
{
  /// <summary>
  /// Tm040f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tm040f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tm040f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tm040f01M1ResultVO compare = null;
			if (obj is Tm040f01M1ResultVO)
			{
				compare = (Tm040f01M1ResultVO)obj;
			}
			else
			{
				return false;
