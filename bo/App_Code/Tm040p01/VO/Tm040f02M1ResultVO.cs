...
{
  /// <summary>
  /// Tm040f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tm040f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tm040f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tm040f02M1ResultVO compare = null;
			if (obj is Tm040f02M1ResultVO)
			{
				compare = (Tm040f02M1ResultVO)obj;
			}
			else
			{
				return false;
