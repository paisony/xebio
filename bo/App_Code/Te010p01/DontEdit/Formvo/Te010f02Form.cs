using com.xebio.bo.Te010p01.Formvo.Baseform;
...
namespace com.xebio.bo.Te010p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Te010f02Form : Te010f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Te010p01","Te010f02");
