...
namespace com.xebio.bo.Te010p01.Formvo
{
  ...
  /// </summary>
  [System.Serializable]
	public class Te010f02FormCondition : IConditionVO
	{
		...
		/// <summary>
		/// 項目「SYUKKASURYO_GOKEI(出荷数量合計)」の値
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「SHUKKARIYU_NM(出荷理由名称)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「SYUKKASURYO_GOKEI(出荷数量合計)」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te010f02FormCondition() : base()
		{
		}
		#endregion
	}
