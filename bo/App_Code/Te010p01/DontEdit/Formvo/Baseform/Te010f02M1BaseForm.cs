...
{
  /// <summary>
  /// Te010f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te010f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Te010f02M1BaseForm compare = null;
			if (obj is Te010f02M1BaseForm)
			{
				compare = (Te010f02M1BaseForm)obj;
			}
			else
			{
				return false;
