...
{
  /// <summary>
  /// フォーム：Te010f01 項目：Btnkaisha_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Te010f01Codeex_Btnkaisha_cd : StandardBaseCodeex
	{
		public Te010f01Codeex_Btnkaisha_cd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			//検索条件追加
			context.Condition.AddFindKey("SIKIBETSU_CD = '" + Te010p01Constant.SIKIBETSU_CD_KAISYA + "'");
