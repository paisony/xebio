...
namespace com.xebio.bo.Te010p01.Request.Te010f02
{
  /// <summary>
  /// Te010f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Te010f02Request_Btnback : Te010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te010f02Request_Btnback Me = new Te010f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te010f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Te010f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
