...
{
  /// <summary>
  /// Te010f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Te010f01Request_Btnsearch : Te010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te010f01Request_Btnsearch Me = new Te010f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te010f01Request_Btnsearch()
		{
