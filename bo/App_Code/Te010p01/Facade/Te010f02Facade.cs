...
{
  /// <summary>
  /// Te010f02のFacadeクラスです
  /// 画面データのロード業務ロジックを実装します。
  /// </summary>
  public partial class Te010f02Facade : StandardBaseFacade
	{
		#region 定数を設定します
		/// <summary>;
		/// プログラムID。
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Te010f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te010f02Facade()
			: base()
		{
		}
		#endregion

		#region Te010f02画面データを作成する。
		/// <summary>
		/// Te010f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Te010f02Form te010f02Form = (Te010f02Form)facadeContext.FormVO;
