...
namespace com.xebio.bo.Te010p01.VO
{
  /// <summary>
  /// Te010f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te010f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te010f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te010f02M1ResultVO compare = null;
			if (obj is Te010f02M1ResultVO)
			{
				compare = (Te010f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Te010p01.Formvo.Te010f02M1Formのハッシュ コード。</returns>
