...
{
  /// <summary>
  /// Te010f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te010f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te010f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te010f01M1ResultVO compare = null;
			if (obj is Te010f01M1ResultVO)
			{
				compare = (Te010f01M1ResultVO)obj;
			}
			else
			{
				return false;
