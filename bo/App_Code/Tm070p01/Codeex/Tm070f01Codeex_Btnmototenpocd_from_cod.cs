...
namespace com.xebio.bo.Tm070p01.Codeex
{
  /// <summary>
  /// フォーム：Tm070f01 項目：Btnmototenpocd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tm070f01Codeex_Btnmototenpocd_from : StandardBaseCodeex
	{
		public Tm070f01Codeex_Btnmototenpocd_from()
		{
		}
