using com.xebio.bo.Tm070p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tm070p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tm070f01Form : Tm070f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tm070p01","Tm070f01");
