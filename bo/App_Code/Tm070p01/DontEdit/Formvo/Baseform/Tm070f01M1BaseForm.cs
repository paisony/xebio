...
namespace com.xebio.bo.Tm070p01.Formvo.Baseform
{
  /// <summary>
  /// Tm070f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tm070f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tm070f01M1BaseForm compare = null;
			if (obj is Tm070f01M1BaseForm)
			{
				compare = (Tm070f01M1BaseForm)obj;
			}
			else
			{
				return false;
