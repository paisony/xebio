...
{
  /// <summary>
  /// Tm070f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tm070f01Request_Btnrowdel : Tm070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm070f01Request_Btnrowdel Me = new Tm070f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm070f01Request_Btnrowdel()
		{
