...
namespace com.xebio.bo.Tm070p01.Request.Tm070f01
{
  /// <summary>
  /// Tm070f01Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Tm070f01Request_Btnpageins : Tm070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm070f01Request_Btnpageins Me = new Tm070f01Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm070f01Request_Btnpageins()
		{
