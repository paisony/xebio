...
{
  /// <summary>
  /// Tm070f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tm070f01Request_Btnenter : Tm070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm070f01Request_Btnenter Me = new Tm070f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm070f01Request_Btnenter()
		{
