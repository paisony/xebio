...
{
  /// <summary>
  /// Tm070f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tm070f01Request_Btnsearch : Tm070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm070f01Request_Btnsearch Me = new Tm070f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm070f01Request_Btnsearch()
		{
