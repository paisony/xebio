...
{
  /// <summary>
  /// Tm070f01Request の概要の説明です。
  /// </summary>
  public abstract class Tm070f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tm070f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tm070f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tm070f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tm070f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tm070f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			if (BoSystemControl.IsM1CommonCheck(pageContext.ButtonInfo))
			{
				Tm070f01RequestHelper.ValidateM1InputValue(formVO, checker);
			}
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tm070f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
			
			//明細部コード存在チェック
			Tm070f01RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
