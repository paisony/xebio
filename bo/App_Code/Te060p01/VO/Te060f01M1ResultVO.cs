...
namespace com.xebio.bo.Te060p01.VO
{
  /// <summary>
  /// Te060f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te060f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te060f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te060f01M1ResultVO compare = null;
			if (obj is Te060f01M1ResultVO)
			{
				compare = (Te060f01M1ResultVO)obj;
			}
			else
			{
				return false;
