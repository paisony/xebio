...
{
  /// <summary>
  /// Te060f01Request の概要の説明です。
  /// </summary>
  public abstract class Te060f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Te060f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Te060f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Te060f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Te060f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Te060f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Te060f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
