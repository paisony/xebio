...
{
  /// <summary>
  /// Te060f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Te060f01Request_Pgr : Te060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te060f01Request_Pgr Me = new Te060f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te060f01Request_Pgr()
		{
