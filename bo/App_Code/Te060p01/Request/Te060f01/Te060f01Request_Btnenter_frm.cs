...
{
  /// <summary>
  /// Te060f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Te060f01Request_Btnenter : Te060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te060f01Request_Btnenter Me = new Te060f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te060f01Request_Btnenter()
		{
