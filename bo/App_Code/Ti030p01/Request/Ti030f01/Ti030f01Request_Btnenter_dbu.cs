namespace com.xebio.bo.Ti030p01.Request.Ti030f01
{
  /// <summary>
  /// Ti030f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Ti030f01Request_Btnenter : Ti030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ti030f01Request_Btnenter Me = new Ti030f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ti030f01Request_Btnenter()
		{
