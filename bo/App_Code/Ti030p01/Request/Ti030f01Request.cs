...
{
  /// <summary>
  /// Ti030f01Request の概要の説明です。
  /// </summary>
  public abstract class Ti030f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Ti030f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Ti030f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Ti030f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Ti030f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Ti030f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Ti030f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
