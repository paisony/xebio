...
{
  /// <summary>
  /// Tg040f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tg040f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tg040f02M1BaseForm compare = null;
			if (obj is Tg040f02M1BaseForm)
			{
				compare = (Tg040f02M1BaseForm)obj;
			}
			else
			{
				return false;
