...
{
  /// <summary>
  /// Tg040f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tg040f02M1ResultVO : StandardBaseVO
	{
		...
		/// <summary>
		/// 項目「M1SURYO_HDN(数量)」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tg040f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tg040f02M1ResultVO compare = null;
			if (obj is Tg040f02M1ResultVO)
			{
				compare = (Tg040f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tg040p01.Formvo.Tg040f02M1Formのハッシュ コード。</returns>
