...
{
  /// <summary>
  /// Tg040f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tg040f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tg040f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tg040f01M1ResultVO compare = null;
			if (obj is Tg040f01M1ResultVO)
			{
				compare = (Tg040f01M1ResultVO)obj;
			}
			else
			{
				return false;
