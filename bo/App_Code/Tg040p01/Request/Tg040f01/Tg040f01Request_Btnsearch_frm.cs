...
{
  /// <summary>
  /// Tg040f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tg040f01Request_Btnsearch : Tg040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f01Request_Btnsearch Me = new Tg040f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f01Request_Btnsearch()
		{
