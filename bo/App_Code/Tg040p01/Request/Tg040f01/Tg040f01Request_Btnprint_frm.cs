...
{
  /// <summary>
  /// Tg040f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tg040f01Request_Btnprint : Tg040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f01Request_Btnprint Me = new Tg040f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f01Request_Btnprint()
		{
