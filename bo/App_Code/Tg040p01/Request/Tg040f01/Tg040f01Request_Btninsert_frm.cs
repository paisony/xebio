...
{
  /// <summary>
  /// Tg040f01Request_Btninsert の概要の説明です。
  /// </summary>
  public sealed class Tg040f01Request_Btninsert : Tg040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f01Request_Btninsert Me = new Tg040f01Request_Btninsert();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f01Request_Btninsert()
		{
