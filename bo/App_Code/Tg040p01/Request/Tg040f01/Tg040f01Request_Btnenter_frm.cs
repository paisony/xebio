...
{
  /// <summary>
  /// Tg040f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tg040f01Request_Btnenter : Tg040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f01Request_Btnenter Me = new Tg040f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f01Request_Btnenter()
		{
