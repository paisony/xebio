...
{
  /// <summary>
  /// Tg040f01Request_Btncsv の概要の説明です。
  /// </summary>
  public sealed class Tg040f01Request_Btncsv : Tg040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f01Request_Btncsv Me = new Tg040f01Request_Btncsv();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f01Request_Btncsv()
		{
