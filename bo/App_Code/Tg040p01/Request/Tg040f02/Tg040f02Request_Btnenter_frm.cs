...
{
  /// <summary>
  /// Tg040f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tg040f02Request_Btnenter : Tg040f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f02Request_Btnenter Me = new Tg040f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f02Request_Btnenter()
		{
