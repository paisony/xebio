...
{
  /// <summary>
  /// Tg040f02Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tg040f02Request_Btnrowdel : Tg040f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f02Request_Btnrowdel Me = new Tg040f02Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f02Request_Btnrowdel()
		{
