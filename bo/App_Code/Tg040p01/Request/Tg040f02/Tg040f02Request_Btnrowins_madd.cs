...
{
  /// <summary>
  /// Tg040f02Request_Btnrowins の概要の説明です。
  /// </summary>
  public sealed class Tg040f02Request_Btnrowins : Tg040f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f02Request_Btnrowins Me = new Tg040f02Request_Btnrowins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f02Request_Btnrowins()
		{
