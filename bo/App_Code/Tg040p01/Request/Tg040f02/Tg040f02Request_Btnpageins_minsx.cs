...
namespace com.xebio.bo.Tg040p01.Request.Tg040f02
{
  /// <summary>
  /// Tg040f02Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Tg040f02Request_Btnpageins : Tg040f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f02Request_Btnpageins Me = new Tg040f02Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f02Request_Btnpageins()
		{
