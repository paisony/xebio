...
{
  /// <summary>
  /// Tg040f02Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tg040f02Request_Btnzenkjo : Tg040f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg040f02Request_Btnzenkjo Me = new Tg040f02Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg040f02Request_Btnzenkjo()
		{
