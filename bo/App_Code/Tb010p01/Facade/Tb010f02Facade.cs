...
{
  /// <summary>
  /// Tb010f02のFacadeクラスです
  /// 画面データのロード業務ロジックを実装します。
  /// </summary>
  public partial class Tb010f02Facade : StandardBaseFacade
	{
		#region 定数を設定します
		/// <summary>;
		/// プログラムID。
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tb010f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb010f02Facade()
			: base()
		{
		}
		#endregion

		#region Tb010f02画面データを作成する。
		/// <summary>
		/// Tb010f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Tb010f02Form tb010f02Form = (Tb010f02Form)facadeContext.FormVO;
