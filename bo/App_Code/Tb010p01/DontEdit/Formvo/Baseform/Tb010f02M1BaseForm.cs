...
{
  /// <summary>
  /// Tb010f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb010f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tb010f02M1BaseForm compare = null;
			if (obj is Tb010f02M1BaseForm)
			{
				compare = (Tb010f02M1BaseForm)obj;
			}
			else
			{
				return false;
