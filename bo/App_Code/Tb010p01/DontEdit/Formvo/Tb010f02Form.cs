using com.xebio.bo.Tb010p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tb010p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tb010f02Form : Tb010f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tb010p01","Tb010f02");
