...
{
  /// <summary>
  /// Tb010f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tb010f01Request_Pgr : Tb010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb010f01Request_Pgr Me = new Tb010f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb010f01Request_Pgr()
		{
