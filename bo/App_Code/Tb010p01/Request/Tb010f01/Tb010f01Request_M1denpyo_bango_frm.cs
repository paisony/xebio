...
namespace com.xebio.bo.Tb010p01.Request.Tb010f01
{
  /// <summary>
  /// Tb010f01Request_M1denpyo_bango の概要の説明です。
  /// </summary>
  public sealed class Tb010f01Request_M1denpyo_bango : Tb010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb010f01Request_M1denpyo_bango Me = new Tb010f01Request_M1denpyo_bango();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb010f01Request_M1denpyo_bango()
		{
