...
{
  /// <summary>
  /// Tb010f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tb010f01Request_Btnprint : Tb010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb010f01Request_Btnprint Me = new Tb010f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb010f01Request_Btnprint()
		{
