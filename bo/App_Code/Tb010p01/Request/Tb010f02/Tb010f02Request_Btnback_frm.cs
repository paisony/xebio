...
namespace com.xebio.bo.Tb010p01.Request.Tb010f02
{
  /// <summary>
  /// Tb010f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tb010f02Request_Btnback : Tb010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb010f02Request_Btnback Me = new Tb010f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb010f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tb010f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
