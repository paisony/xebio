...
{
  /// <summary>
  /// Tb010f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tb010f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb010f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tb010f01M1ResultVO compare = null;
			if (obj is Tb010f01M1ResultVO)
			{
				compare = (Tb010f01M1ResultVO)obj;
			}
			else
			{
				return false;
