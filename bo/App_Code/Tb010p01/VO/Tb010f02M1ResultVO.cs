...
namespace com.xebio.bo.Tb010p01.VO
{
  /// <summary>
  /// Tb010f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tb010f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb010f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tb010f02M1ResultVO compare = null;
			if (obj is Tb010f02M1ResultVO)
			{
				compare = (Tb010f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tb010p01.Formvo.Tb010f02M1Formのハッシュ コード。</returns>
