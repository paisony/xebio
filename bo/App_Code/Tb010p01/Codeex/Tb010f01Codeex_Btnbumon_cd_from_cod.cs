...
namespace com.xebio.bo.Tb010p01.Codeex
{
  /// <summary>
  /// フォーム：Tb010f01 項目：Btnbumon_cd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tb010f01Codeex_Btnbumon_cd_from : StandardBaseCodeex
	{
		public Tb010f01Codeex_Btnbumon_cd_from()
		{
		}
