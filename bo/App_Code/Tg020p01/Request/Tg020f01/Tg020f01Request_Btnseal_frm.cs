namespace com.xebio.bo.Tg020p01.Request.Tg020f01
{
  /// <summary>
  /// Tg020f01Request_Btnseal の概要の説明です。
  /// </summary>
  public sealed class Tg020f01Request_Btnseal : Tg020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg020f01Request_Btnseal Me = new Tg020f01Request_Btnseal();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg020f01Request_Btnseal()
		{
