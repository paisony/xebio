...
namespace com.xebio.bo.Ta070p01.Formvo.Baseform
{
  /// <summary>
  /// Ta070f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta070f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta070f01M1BaseForm compare = null;
			if (obj is Ta070f01M1BaseForm)
			{
				compare = (Ta070f01M1BaseForm)obj;
			}
			else
			{
				return false;
