using com.xebio.bo.Ta070p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Ta070f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta070f01Form : Ta070f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Ta070p01","Ta070f01");
