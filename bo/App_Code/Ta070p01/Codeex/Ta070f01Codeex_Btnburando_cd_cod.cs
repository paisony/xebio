...
{
  /// <summary>
  /// フォーム：Ta070f01 項目：Btnburando_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta070f01Codeex_Btnburando_cd : StandardBaseCodeex
	{
		public Ta070f01Codeex_Btnburando_cd()
		{
		}
		...
		public override void BeforeSearch(ICodeContext context)
		{
			...
			// 入力値を半角に置き換え
			string inpval = (string)context.ExeValue.InputValues["Burando_nm_bo1"];
			context.ExeValue.InputValues["Burando_nm_bo1"] = BoSystemString.ChangeZenHankaku(inpval, 1);
