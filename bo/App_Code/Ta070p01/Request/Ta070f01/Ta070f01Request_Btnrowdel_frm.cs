...
{
  /// <summary>
  /// Ta070f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Ta070f01Request_Btnrowdel : Ta070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta070f01Request_Btnrowdel Me = new Ta070f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta070f01Request_Btnrowdel()
		{
