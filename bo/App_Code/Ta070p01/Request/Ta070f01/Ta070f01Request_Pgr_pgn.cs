...
{
  /// <summary>
  /// Ta070f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta070f01Request_Pgr : Ta070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta070f01Request_Pgr Me = new Ta070f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta070f01Request_Pgr()
		{
