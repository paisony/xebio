...
namespace com.xebio.bo.Ta070p01.Request.Ta070f01
{
  /// <summary>
  /// Ta070f01Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Ta070f01Request_Btnpageins : Ta070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta070f01Request_Btnpageins Me = new Ta070f01Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta070f01Request_Btnpageins()
		{
