...
{
  /// <summary>
  /// Ta070f01Request_Btninsert の概要の説明です。
  /// </summary>
  public sealed class Ta070f01Request_Btninsert : Ta070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta070f01Request_Btninsert Me = new Ta070f01Request_Btninsert();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta070f01Request_Btninsert()
		{
