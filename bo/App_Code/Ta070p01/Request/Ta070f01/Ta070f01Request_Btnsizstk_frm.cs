...
{
  /// <summary>
  /// Ta070f01Request_Btnsizstk の概要の説明です。
  /// </summary>
  public sealed class Ta070f01Request_Btnsizstk : Ta070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta070f01Request_Btnsizstk Me = new Ta070f01Request_Btnsizstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta070f01Request_Btnsizstk()
		{
