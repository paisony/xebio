...
namespace com.xebio.bo.Tg030p01.Request
{
  /// <summary>
  /// Tg030f01Request の概要の説明です。
  /// </summary>
  public abstract class Tg030f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tg030f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tg030f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tg030f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tg030f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Tg030f01Form formVO=(Tg030f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Tg030f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tg030f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
