namespace com.xebio.bo.Tg030p01.Request.Tg030f01
{
  /// <summary>
  /// Tg030f01Request_Btnseal の概要の説明です。
  /// </summary>
  public sealed class Tg030f01Request_Btnseal : Tg030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg030f01Request_Btnseal Me = new Tg030f01Request_Btnseal();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg030f01Request_Btnseal()
		{
