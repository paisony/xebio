...
namespace com.xebio.bo.Tj060p01.Request
{
  /// <summary>
  /// Tj060f01Request の概要の説明です。
  /// </summary>
  public abstract class Tj060f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tj060f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tj060f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tj060f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tj060f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Tj060f01Form formVO=(Tj060f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Tj060f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tj060f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
