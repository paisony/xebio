using com.xebio.bo.Tm050p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tm050p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tm050f01Form : Tm050f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tm050p01","Tm050f01");
