namespace com.xebio.bo.Tm050p01.Request.Tm050f01
{
  /// <summary>
  /// Tm050f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tm050f01Request_Btnenter : Tm050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm050f01Request_Btnenter Me = new Tm050f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm050f01Request_Btnenter()
		{
