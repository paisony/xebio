...
namespace com.xebio.bo.Tm050p01.Request
{
  /// <summary>
  /// Tm050f01Request の概要の説明です。
  /// </summary>
  public abstract class Tm050f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tm050f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tm050f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tm050f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tm050f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Tm050f01Form formVO=(Tm050f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Tm050f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Tm050f01RequestHelper.ValidateM1InputValue(formVO, checker);
