  ...
  public partial class Tl030f02Facade : StandardBaseFacade
	{
		...
		public void DoBTNZENKYAKKA_FRM(IFacadeContext facadeContext)
		{
			...
			////メソッドの開始処理を実行する。
			StartMethod(facadeContext, this.GetType().Name + ".DoBTNZENKYAKKA_FRM");
			...
			//メソッドの終了処理を実行する。
			EndMethod(facadeContext, this.GetType().Name + ".DoBTNZENKYAKKA_FRM");
