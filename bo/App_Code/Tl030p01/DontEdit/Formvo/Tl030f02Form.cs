using com.xebio.bo.Tl030p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tl030p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tl030f02Form : Tl030f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tl030p01","Tl030f02");
