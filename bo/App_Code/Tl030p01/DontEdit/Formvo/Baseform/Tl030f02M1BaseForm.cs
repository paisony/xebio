...
{
  /// <summary>
  /// Tl030f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tl030f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tl030f02M1BaseForm compare = null;
			if (obj is Tl030f02M1BaseForm)
			{
				compare = (Tl030f02M1BaseForm)obj;
			}
			else
			{
				return false;
