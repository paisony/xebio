...
{
  /// <summary>
  /// Tl030f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tl030f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tl030f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tl030f01M1ResultVO compare = null;
			if (obj is Tl030f01M1ResultVO)
			{
				compare = (Tl030f01M1ResultVO)obj;
			}
			else
			{
				return false;
