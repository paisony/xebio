...
{
  /// <summary>
  /// Tl030f02Request_Btnzenkyakka の概要の説明です。
  /// </summary>
  public sealed class Tl030f02Request_Btnzenkyakka : Tl030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl030f02Request_Btnzenkyakka Me = new Tl030f02Request_Btnzenkyakka();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl030f02Request_Btnzenkyakka()
		{
