...
{
  /// <summary>
  /// Tl030f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tl030f02Request_Pgr : Tl030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl030f02Request_Pgr Me = new Tl030f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl030f02Request_Pgr()
		{
