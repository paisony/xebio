...
{
  /// <summary>
  /// Tl030f02Request の概要の説明です。
  /// </summary>
  public abstract class Tl030f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tl030f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tl030f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tl030f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tl030f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tl030f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
