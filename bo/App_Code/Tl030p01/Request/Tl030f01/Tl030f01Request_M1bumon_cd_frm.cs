...
{
  /// <summary>
  /// Tl030f01Request_M1bumon_cd の概要の説明です。
  /// </summary>
  public sealed class Tl030f01Request_M1bumon_cd : Tl030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl030f01Request_M1bumon_cd Me = new Tl030f01Request_M1bumon_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl030f01Request_M1bumon_cd()
		{
