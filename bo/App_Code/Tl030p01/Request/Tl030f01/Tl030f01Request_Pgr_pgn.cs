...
{
  /// <summary>
  /// Tl030f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tl030f01Request_Pgr : Tl030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl030f01Request_Pgr Me = new Tl030f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl030f01Request_Pgr()
		{
