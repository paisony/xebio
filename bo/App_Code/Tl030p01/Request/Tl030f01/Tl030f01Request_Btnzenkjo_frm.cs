...
{
  /// <summary>
  /// Tl030f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tl030f01Request_Btnzenkjo : Tl030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl030f01Request_Btnzenkjo Me = new Tl030f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl030f01Request_Btnzenkjo()
		{
