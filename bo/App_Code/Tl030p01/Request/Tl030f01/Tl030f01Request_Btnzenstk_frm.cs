...
namespace com.xebio.bo.Tl030p01.Request.Tl030f01
{
  /// <summary>
  /// Tl030f01Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tl030f01Request_Btnzenstk : Tl030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl030f01Request_Btnzenstk Me = new Tl030f01Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl030f01Request_Btnzenstk()
		{
