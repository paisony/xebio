...
{
  /// <summary>
  /// フォーム：Tl030f01 項目：Btnlabel_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tl030f01Codeex_Btnlabel_cd : StandardBaseCodeex
	{
		public Tl030f01Codeex_Btnlabel_cd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			//店舗コードを取得する。
			String tenpo_cd = LoginInfoUtil.GetLoginInfo().TnpCd;

			// ログイン店舗情報を条件に設定
			context.Condition.AddFindKey("TENPO_CD = '" + tenpo_cd + "'");
