...
{
  /// <summary>
  /// Tm060f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tm060f01Request_Btnsearch : Tm060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm060f01Request_Btnsearch Me = new Tm060f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm060f01Request_Btnsearch()
		{
