...
{
  /// <summary>
  /// Tm060f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tm060f01Request_Btnenter : Tm060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tm060f01Request_Btnenter Me = new Tm060f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tm060f01Request_Btnenter()
		{
