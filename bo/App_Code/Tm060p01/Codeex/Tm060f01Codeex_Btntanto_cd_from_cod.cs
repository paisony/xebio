...
namespace com.xebio.bo.Tm060p01.Codeex
{
  /// <summary>
  /// フォーム：Tm060f01 項目：Btntanto_cd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tm060f01Codeex_Btntanto_cd_from : StandardBaseCodeex
	{
		public Tm060f01Codeex_Btntanto_cd_from()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			String tenpo_cd = context.ExeValue.InputValues["Head_tenpo_cd"] as string;
			//Decimal dhanbaiten_cd = Convert.ToDecimal(BoSystemString.Nvl(tenpo_cd, "0"));
			// ログイン店舗情報を条件に設定
			context.Condition.AddFindKey("HANBAIINTENPO_CD = '" + tenpo_cd + "'");
