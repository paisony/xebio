...
namespace com.xebio.bo.Tm060p01.Formvo.Baseform
{
  /// <summary>
  /// Tm060f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tm060f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tm060f01M1BaseForm compare = null;
			if (obj is Tm060f01M1BaseForm)
			{
				compare = (Tm060f01M1BaseForm)obj;
			}
			else
			{
				return false;
