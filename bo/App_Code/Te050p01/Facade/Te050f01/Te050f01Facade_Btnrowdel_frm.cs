  ...
  public partial class Te050f01Facade : StandardBaseFacade
	{
		...
		public void DoBTNROWDEL_FRM(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				IDataList m1List = te050f01Form.GetList("M1");

				// 選択行を削除
				decimal lastRow = DelRowCls.DeleteSelectRow<Te050f01Form, Te050f01M1Form>("M1", "M1rowno", (Te050f01Form)facadeContext.FormVO, null, 1);
