...
{
  /// <summary>
  /// Te050f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te050f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Te050f01M1BaseForm compare = null;
			if (obj is Te050f01M1BaseForm)
			{
				compare = (Te050f01M1BaseForm)obj;
			}
			else
			{
				return false;
