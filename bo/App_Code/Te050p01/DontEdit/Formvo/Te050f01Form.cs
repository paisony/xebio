using com.xebio.bo.Te050p01.Formvo.Baseform;
...
namespace com.xebio.bo.Te050p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Te050f01Form : Te050f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Te050p01","Te050f01");
