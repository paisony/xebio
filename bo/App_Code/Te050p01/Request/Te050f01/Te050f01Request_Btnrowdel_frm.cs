...
{
  /// <summary>
  /// Te050f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Te050f01Request_Btnrowdel : Te050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te050f01Request_Btnrowdel Me = new Te050f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te050f01Request_Btnrowdel()
		{
