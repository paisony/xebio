...
{
  /// <summary>
  /// Te050f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Te050f01Request_Btnsearch : Te050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te050f01Request_Btnsearch Me = new Te050f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te050f01Request_Btnsearch()
		{
