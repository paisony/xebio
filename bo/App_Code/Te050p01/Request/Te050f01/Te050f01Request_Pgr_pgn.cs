...
{
  /// <summary>
  /// Te050f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Te050f01Request_Pgr : Te050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te050f01Request_Pgr Me = new Te050f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te050f01Request_Pgr()
		{
