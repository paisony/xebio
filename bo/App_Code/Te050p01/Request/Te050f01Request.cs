...
namespace com.xebio.bo.Te050p01.Request
{
  /// <summary>
  /// Te050f01Request の概要の説明です。
  /// </summary>
  public abstract class Te050f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Te050f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Te050f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Te050f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Te050f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Te050f01Form formVO=(Te050f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Te050f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			if (BoSystemControl.IsM1CommonCheck(pageContext.ButtonInfo))
			{
				Te050f01RequestHelper.ValidateM1InputValue(formVO, checker);
			}
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Te050f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
			
			//明細部コード存在チェック
			Te050f01RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
