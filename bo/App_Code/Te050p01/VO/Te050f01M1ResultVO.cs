...
namespace com.xebio.bo.Te050p01.VO
{
  /// <summary>
  /// Te050f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te050f01M1ResultVO : StandardBaseVO
	{
		...
		/// <summary>
		/// 項目「M1IRO_CD(色)」の値を取得または設定する。
		/// </summary>
		public virtual string M1iro_cd
		{
			get
			{
				return this._m1iro_cd;
			}
			set
			{
				this._m1iro_cd = value;
			}
		}


		/// <summary>
		/// 項目「M1IRO_NM()」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te050f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te050f01M1ResultVO compare = null;
			if (obj is Te050f01M1ResultVO)
			{
				compare = (Te050f01M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Te050p01.Formvo.Te050f01M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1iro_cd:").Append(this._m1iro_cd).AppendLine();
