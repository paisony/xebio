...
{
  /// <summary>
  /// Tf070f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf070f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf070f02M1BaseForm compare = null;
			if (obj is Tf070f02M1BaseForm)
			{
				compare = (Tf070f02M1BaseForm)obj;
			}
			else
			{
				return false;
