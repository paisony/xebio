...
{
  /// <summary>
  /// Tf070f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tf070f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf070f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tf070f01M1ResultVO compare = null;
			if (obj is Tf070f01M1ResultVO)
			{
				compare = (Tf070f01M1ResultVO)obj;
			}
			else
			{
				return false;
