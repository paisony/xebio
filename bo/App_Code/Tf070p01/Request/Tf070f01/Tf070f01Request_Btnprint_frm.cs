...
{
  /// <summary>
  /// Tf070f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tf070f01Request_Btnprint : Tf070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf070f01Request_Btnprint Me = new Tf070f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf070f01Request_Btnprint()
		{
