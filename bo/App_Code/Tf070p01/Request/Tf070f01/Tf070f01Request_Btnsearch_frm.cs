...
{
  /// <summary>
  /// Tf070f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tf070f01Request_Btnsearch : Tf070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf070f01Request_Btnsearch Me = new Tf070f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf070f01Request_Btnsearch()
		{
