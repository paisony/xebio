...
{
  /// <summary>
  /// Tf070f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tf070f01Request_Btnenter : Tf070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf070f01Request_Btnenter Me = new Tf070f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf070f01Request_Btnenter()
		{
