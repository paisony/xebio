...
{
  /// <summary>
  /// Tf070f01Request_Btninsert の概要の説明です。
  /// </summary>
  public sealed class Tf070f01Request_Btninsert : Tf070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf070f01Request_Btninsert Me = new Tf070f01Request_Btninsert();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf070f01Request_Btninsert()
		{
