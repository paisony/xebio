...
{
  /// <summary>
  /// Tf070f01Request_M1tonanhinkanri_no の概要の説明です。
  /// </summary>
  public sealed class Tf070f01Request_M1tonanhinkanri_no : Tf070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf070f01Request_M1tonanhinkanri_no Me = new Tf070f01Request_M1tonanhinkanri_no();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf070f01Request_M1tonanhinkanri_no()
		{
