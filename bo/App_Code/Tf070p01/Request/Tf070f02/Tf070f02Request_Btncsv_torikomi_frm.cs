...
namespace com.xebio.bo.Tf070p01.Request.Tf070f02
{
  /// <summary>
  /// Tf070f02Request_Btncsv_torikomi の概要の説明です。
  /// </summary>
  public sealed class Tf070f02Request_Btncsv_torikomi : Tf070f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf070f02Request_Btncsv_torikomi Me = new Tf070f02Request_Btncsv_torikomi();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf070f02Request_Btncsv_torikomi()
		{
