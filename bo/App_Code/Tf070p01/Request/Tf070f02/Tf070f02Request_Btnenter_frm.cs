...
{
  /// <summary>
  /// Tf070f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tf070f02Request_Btnenter : Tf070f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf070f02Request_Btnenter Me = new Tf070f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf070f02Request_Btnenter()
		{
