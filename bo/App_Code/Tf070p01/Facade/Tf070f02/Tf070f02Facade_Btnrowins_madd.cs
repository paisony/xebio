  ...
  public partial class Tf070f02Facade : StandardBaseFacade
	{
		...
		public void DoBTNROWINS_MADD(IFacadeContext facadeContext)
		{
			...
			// 1-1 明細数
			// 明細数が最大行数の場合、エラー
			decimal curCnt = ((Tf070f02Form)facadeContext.FormVO).GetList("M1").Count;
			decimal maxCnt = GetMaxCntCls.GetMaxCnt(FORMID.ToUpper(), Tf070p01Constant.MAX_CNT_EDABAN_NOT_SHINKI);
			...
			// 行追加処理
			AddRowCls.AddEmptyRow<Tf070f02M1Form>("M1", "M1rowno", (Tf070f02Form)facadeContext.FormVO, 1);
			// 業務ロジック↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
