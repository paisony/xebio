  ...
  public partial class Tl010f02Facade : StandardBaseFacade
	{
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tl010f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tl010f02Facade()
			: base()
		{
		}
		#endregion

		#region Tl010f02画面データを作成する。
		/// <summary>
		/// Tl010f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				//カード部を取得します。
				Tl010f02Form tl010f02Form = (Tl010f02Form)facadeContext.FormVO;

				//モデル層処理ロジックを記述してください。
				//カード部 データを取得(要実装)........

				// ラベル情報を設定
				BoSystemLabelUtil.SetLabelInfo<Tl010f02Form>(tl010f02Form, facadeContext);
