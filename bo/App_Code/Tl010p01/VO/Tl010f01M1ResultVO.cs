...
{
  /// <summary>
  /// Tl010f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tl010f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tl010f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tl010f01M1ResultVO compare = null;
			if (obj is Tl010f01M1ResultVO)
			{
				compare = (Tl010f01M1ResultVO)obj;
			}
			else
			{
				return false;
