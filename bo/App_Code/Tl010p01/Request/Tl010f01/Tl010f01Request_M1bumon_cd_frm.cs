...
{
  /// <summary>
  /// Tl010f01Request_M1bumon_cd の概要の説明です。
  /// </summary>
  public sealed class Tl010f01Request_M1bumon_cd : Tl010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl010f01Request_M1bumon_cd Me = new Tl010f01Request_M1bumon_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl010f01Request_M1bumon_cd()
		{
