...
{
  /// <summary>
  /// Tl010f01Request_Btnseal の概要の説明です。
  /// </summary>
  public sealed class Tl010f01Request_Btnseal : Tl010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl010f01Request_Btnseal Me = new Tl010f01Request_Btnseal();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl010f01Request_Btnseal()
		{
