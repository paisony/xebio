...
{
  /// <summary>
  /// Tl010f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tl010f01Request_Btnprint : Tl010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl010f01Request_Btnprint Me = new Tl010f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl010f01Request_Btnprint()
		{
