...
namespace com.xebio.bo.Tl010p01.Request.Tl010f01
{
  /// <summary>
  /// Tl010f01Request_M1bumonkana_nm の概要の説明です。
  /// </summary>
  public sealed class Tl010f01Request_M1bumonkana_nm : Tl010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl010f01Request_M1bumonkana_nm Me = new Tl010f01Request_M1bumonkana_nm();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl010f01Request_M1bumonkana_nm()
		{
