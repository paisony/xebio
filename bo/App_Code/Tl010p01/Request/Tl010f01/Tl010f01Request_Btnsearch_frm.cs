...
{
  /// <summary>
  /// Tl010f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tl010f01Request_Btnsearch : Tl010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl010f01Request_Btnsearch Me = new Tl010f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl010f01Request_Btnsearch()
		{
