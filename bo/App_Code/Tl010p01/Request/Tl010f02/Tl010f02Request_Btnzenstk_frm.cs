...
{
  /// <summary>
  /// Tl010f02Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tl010f02Request_Btnzenstk : Tl010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl010f02Request_Btnzenstk Me = new Tl010f02Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl010f02Request_Btnzenstk()
		{
