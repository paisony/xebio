...
{
  /// <summary>
  /// Tl010f02Request_Btnseal の概要の説明です。
  /// </summary>
  public sealed class Tl010f02Request_Btnseal : Tl010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl010f02Request_Btnseal Me = new Tl010f02Request_Btnseal();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl010f02Request_Btnseal()
		{
