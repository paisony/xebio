...
{
  /// <summary>
  /// Tl010f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tl010f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tl010f02M1BaseForm compare = null;
			if (obj is Tl010f02M1BaseForm)
			{
				compare = (Tl010f02M1BaseForm)obj;
			}
			else
			{
				return false;
