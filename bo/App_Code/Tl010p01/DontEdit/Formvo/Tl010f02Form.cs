using com.xebio.bo.Tl010p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tl010f02のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tl010f02Form : Tl010f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tl010p01","Tl010f02");
