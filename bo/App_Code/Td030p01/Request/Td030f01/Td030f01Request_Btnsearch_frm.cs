...
{
  /// <summary>
  /// Td030f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Td030f01Request_Btnsearch : Td030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td030f01Request_Btnsearch Me = new Td030f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td030f01Request_Btnsearch()
		{
