namespace com.xebio.bo.Td030p01.Request.Td030f01
{
  /// <summary>
  /// Td030f01Request_M1denpyo_bango の概要の説明です。
  /// </summary>
  public sealed class Td030f01Request_M1denpyo_bango : Td030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td030f01Request_M1denpyo_bango Me = new Td030f01Request_M1denpyo_bango();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td030f01Request_M1denpyo_bango()
		{
