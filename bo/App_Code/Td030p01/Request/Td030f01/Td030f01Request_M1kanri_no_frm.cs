...
{
  /// <summary>
  /// Td030f01Request_M1kanri_no の概要の説明です。
  /// </summary>
  public sealed class Td030f01Request_M1kanri_no : Td030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td030f01Request_M1kanri_no Me = new Td030f01Request_M1kanri_no();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td030f01Request_M1kanri_no()
		{
