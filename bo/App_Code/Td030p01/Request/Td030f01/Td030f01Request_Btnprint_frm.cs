...
{
  /// <summary>
  /// Td030f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Td030f01Request_Btnprint : Td030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td030f01Request_Btnprint Me = new Td030f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td030f01Request_Btnprint()
		{
