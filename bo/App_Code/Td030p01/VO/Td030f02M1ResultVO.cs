...
{
  /// <summary>
  /// Td030f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Td030f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Td030f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Td030f02M1ResultVO compare = null;
			if (obj is Td030f02M1ResultVO)
			{
				compare = (Td030f02M1ResultVO)obj;
			}
			else
			{
				return false;
