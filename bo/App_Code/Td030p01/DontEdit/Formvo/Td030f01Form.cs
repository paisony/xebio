...
{
  /// <summary>
  /// Td030f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td030f01Form : Td030f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Td030p01","Td030f01");
