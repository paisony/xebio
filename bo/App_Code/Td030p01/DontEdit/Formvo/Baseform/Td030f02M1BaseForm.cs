...
namespace com.xebio.bo.Td030p01.Formvo.Baseform
{
  /// <summary>
  /// Td030f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td030f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Td030f02M1BaseForm compare = null;
			if (obj is Td030f02M1BaseForm)
			{
				compare = (Td030f02M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Td030p01.Formvo.Td030f02M1Formのハッシュ コード。</returns>
