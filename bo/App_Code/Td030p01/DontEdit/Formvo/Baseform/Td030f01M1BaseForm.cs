...
{
  /// <summary>
  /// Td030f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td030f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Td030f01M1BaseForm compare = null;
			if (obj is Td030f01M1BaseForm)
			{
				compare = (Td030f01M1BaseForm)obj;
			}
			else
			{
				return false;
