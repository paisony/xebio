...
{
  /// <summary>
  /// Td030f02のFacadeクラスです
  /// 画面データのロード業務ロジックを実装します。
  /// </summary>
  public partial class Td030f02Facade : StandardBaseFacade
	{
		#region 定数を設定します
		/// <summary>;
		/// プログラムID。
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Td030f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Td030f02Facade()
			: base()
		{
		}
		#endregion

		#region Td030f02画面データを作成する。
		/// <summary>
		/// Td030f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Td030f02Form td030f02Form = (Td030f02Form)facadeContext.FormVO;
