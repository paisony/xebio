namespace com.xebio.bo.Tb070p01.Request.Tb070f01
{
  /// <summary>
  /// Tb070f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tb070f01Request_Btnprint : Tb070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb070f01Request_Btnprint Me = new Tb070f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb070f01Request_Btnprint()
		{
