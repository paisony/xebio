...
{
  /// <summary>
  /// Th020f04のFacadeクラスです
  /// 画面データのロード業務ロジックを実装します。
  /// </summary>
  public partial class Th020f04Facade : StandardBaseFacade
	{
		#region 定数を設定します
		/// <summary>;
		/// プログラムID。
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Th020f04";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Th020f04Facade()
			: base()
		{
		}
		#endregion

		#region Th020f04画面データを作成する。
		/// <summary>
		/// Th020f04画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Th020f04Form th020f04Form = (Th020f04Form)facadeContext.FormVO;
