...
{
  /// <summary>
  /// Th020f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Th020f01Form : Th020f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Th020p01","Th020f01");
