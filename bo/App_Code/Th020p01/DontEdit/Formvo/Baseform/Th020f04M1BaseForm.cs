...
{
  /// <summary>
  /// Th020f04 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Th020f04M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Th020f04M1BaseForm compare = null;
			if (obj is Th020f04M1BaseForm)
			{
				compare = (Th020f04M1BaseForm)obj;
			}
			else
			{
				return false;
