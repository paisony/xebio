...
{
  /// <summary>
  /// Th020f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Th020f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Th020f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Th020f01M1ResultVO compare = null;
			if (obj is Th020f01M1ResultVO)
			{
				compare = (Th020f01M1ResultVO)obj;
			}
			else
			{
				return false;
