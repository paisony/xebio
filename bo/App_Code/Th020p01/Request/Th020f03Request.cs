...
{
  /// <summary>
  /// Th020f03Request の概要の説明です。
  /// </summary>
  public abstract class Th020f03Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Th020f03RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Th020f03RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Th020f03RequestHelper.Unformat(pageContext);
		}
		...
		{
			Th020f03RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Th020f03RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Th020f03RequestHelper.ValidateM1InputValue(formVO, checker);
