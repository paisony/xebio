...
{
  /// <summary>
  /// Th020f02Request_Meisaihead_iro_nm3 の概要の説明です。
  /// </summary>
  public sealed class Th020f02Request_Meisaihead_iro_nm3 : Th020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f02Request_Meisaihead_iro_nm3 Me = new Th020f02Request_Meisaihead_iro_nm3();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f02Request_Meisaihead_iro_nm3()
		{
