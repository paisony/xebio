...
{
  /// <summary>
  /// Th020f02Request_Meisaihead_iro_nm22 の概要の説明です。
  /// </summary>
  public sealed class Th020f02Request_Meisaihead_iro_nm22 : Th020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f02Request_Meisaihead_iro_nm22 Me = new Th020f02Request_Meisaihead_iro_nm22();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f02Request_Meisaihead_iro_nm22()
		{
