...
{
  /// <summary>
  /// Th020f02Request_Btnarea の概要の説明です。
  /// </summary>
  public sealed class Th020f02Request_Btnarea : Th020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f02Request_Btnarea Me = new Th020f02Request_Btnarea();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f02Request_Btnarea()
		{
