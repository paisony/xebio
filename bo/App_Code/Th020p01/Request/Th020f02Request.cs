...
{
  /// <summary>
  /// Th020f02Request の概要の説明です。
  /// </summary>
  public abstract class Th020f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Th020f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Th020f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Th020f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Th020f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Th020f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Th020f02RequestHelper.ValidateM1InputValue(formVO, checker);
