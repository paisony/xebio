namespace com.xebio.bo.Th020p01.Request.Th020f04
{
  /// <summary>
  /// Th020f04Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Th020f04Request_Btnback : Th020f04Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f04Request_Btnback Me = new Th020f04Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f04Request_Btnback()
		{
