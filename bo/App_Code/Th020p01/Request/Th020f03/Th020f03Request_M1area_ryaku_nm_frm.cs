namespace com.xebio.bo.Th020p01.Request.Th020f03
{
  /// <summary>
  /// Th020f03Request_M1area_ryaku_nm の概要の説明です。
  /// </summary>
  public sealed class Th020f03Request_M1area_ryaku_nm : Th020f03Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f03Request_M1area_ryaku_nm Me = new Th020f03Request_M1area_ryaku_nm();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f03Request_M1area_ryaku_nm()
		{
