...
{
  /// <summary>
  /// Th020f03Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Th020f03Request_Btnback : Th020f03Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f03Request_Btnback Me = new Th020f03Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f03Request_Btnback()
		{
