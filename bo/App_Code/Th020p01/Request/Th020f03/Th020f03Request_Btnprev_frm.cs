...
{
  /// <summary>
  /// Th020f03Request_Btnprev の概要の説明です。
  /// </summary>
  public sealed class Th020f03Request_Btnprev : Th020f03Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f03Request_Btnprev Me = new Th020f03Request_Btnprev();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f03Request_Btnprev()
		{
