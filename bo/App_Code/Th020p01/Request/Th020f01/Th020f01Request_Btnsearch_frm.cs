...
{
  /// <summary>
  /// Th020f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Th020f01Request_Btnsearch : Th020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f01Request_Btnsearch Me = new Th020f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f01Request_Btnsearch()
		{
