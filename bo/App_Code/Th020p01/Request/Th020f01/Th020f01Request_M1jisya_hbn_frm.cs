namespace com.xebio.bo.Th020p01.Request.Th020f01
{
  /// <summary>
  /// Th020f01Request_M1jisya_hbn の概要の説明です。
  /// </summary>
  public sealed class Th020f01Request_M1jisya_hbn : Th020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f01Request_M1jisya_hbn Me = new Th020f01Request_M1jisya_hbn();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f01Request_M1jisya_hbn()
		{
