...
{
  /// <summary>
  /// Th020f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Th020f01Request_Pgr : Th020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th020f01Request_Pgr Me = new Th020f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th020f01Request_Pgr()
		{
