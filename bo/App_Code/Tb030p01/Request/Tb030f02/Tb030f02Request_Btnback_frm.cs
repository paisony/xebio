...
namespace com.xebio.bo.Tb030p01.Request.Tb030f02
{
  /// <summary>
  /// Tb030f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tb030f02Request_Btnback : Tb030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb030f02Request_Btnback Me = new Tb030f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb030f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tb030f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
