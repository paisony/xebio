...
namespace com.xebio.bo.Tb030p01.Request.Tb030f01
{
  /// <summary>
  /// Tb030f01Request_M1denpyo_bango の概要の説明です。
  /// </summary>
  public sealed class Tb030f01Request_M1denpyo_bango : Tb030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb030f01Request_M1denpyo_bango Me = new Tb030f01Request_M1denpyo_bango();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb030f01Request_M1denpyo_bango()
		{
