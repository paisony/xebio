...
{
  /// <summary>
  /// Tb030f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tb030f01Request_Pgr : Tb030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb030f01Request_Pgr Me = new Tb030f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb030f01Request_Pgr()
		{
