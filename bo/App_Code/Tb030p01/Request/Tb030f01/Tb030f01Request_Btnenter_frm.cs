...
{
  /// <summary>
  /// Tb030f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tb030f01Request_Btnenter : Tb030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb030f01Request_Btnenter Me = new Tb030f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb030f01Request_Btnenter()
		{
