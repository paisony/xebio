...
{
  /// <summary>
  /// Tb030f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tb030f01Request_Btnprint : Tb030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb030f01Request_Btnprint Me = new Tb030f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb030f01Request_Btnprint()
		{
