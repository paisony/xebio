...
namespace com.xebio.bo.Tb030p01.Codeex
{
  /// <summary>
  /// フォーム：Tb030f01 項目：Btnbumon_cd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tb030f01Codeex_Btnbumon_cd_from : StandardBaseCodeex
	{
		public Tb030f01Codeex_Btnbumon_cd_from()
		{
		}
