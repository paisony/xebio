...
{
  /// <summary>
  /// Tb030f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tb030f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb030f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tb030f01M1ResultVO compare = null;
			if (obj is Tb030f01M1ResultVO)
			{
				compare = (Tb030f01M1ResultVO)obj;
			}
			else
			{
				return false;
