...
{
  /// <summary>
  /// Tb030f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tb030f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb030f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tb030f02M1ResultVO compare = null;
			if (obj is Tb030f02M1ResultVO)
			{
				compare = (Tb030f02M1ResultVO)obj;
			}
			else
			{
				return false;
