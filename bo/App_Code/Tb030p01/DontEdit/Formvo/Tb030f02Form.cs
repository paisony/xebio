using com.xebio.bo.Tb030p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tb030f02のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb030f02Form : Tb030f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tb030p01","Tb030f02");
