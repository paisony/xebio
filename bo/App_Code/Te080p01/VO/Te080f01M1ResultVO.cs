...
namespace com.xebio.bo.Te080p01.VO
{
  /// <summary>
  /// Te080f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te080f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te080f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te080f01M1ResultVO compare = null;
			if (obj is Te080f01M1ResultVO)
			{
				compare = (Te080f01M1ResultVO)obj;
			}
			else
			{
				return false;
