...
namespace com.xebio.bo.Te080p01.Codeex
{
  /// <summary>
  /// フォーム：Te080f01 項目：M1btnsyukkatencd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Te080f01Codeex_M1btnsyukkatencd : StandardBaseCodeex
	{
		public Te080f01Codeex_M1btnsyukkatencd()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// Ｍ１会社コードをパラメータに追加
			context.Condition.AddExtItemID("M1kaisya_cd");
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 親画面のＭ１会社コード取得
			decimal kaisyaCd;
			decimal.TryParse(context.ExeValue.InputValues["M1kaisya_cd"] as string, out kaisyaCd);
			// 抽出条件追加
			context.Condition.AddFindKey("KAISYA_CD = " + kaisyaCd.ToString() + " AND SAKUJYO_FLG = 0");
