...
{
  /// <summary>
  /// Te080f01Request_Btnclear の概要の説明です。
  /// </summary>
  public sealed class Te080f01Request_Btnclear : Te080f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te080f01Request_Btnclear Me = new Te080f01Request_Btnclear();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te080f01Request_Btnclear()
		{
