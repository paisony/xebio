...
{
  /// <summary>
  /// Te030f01Request の概要の説明です。
  /// </summary>
  public abstract class Te030f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Te030f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Te030f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Te030f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Te030f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Te030f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Te030f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
