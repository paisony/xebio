namespace com.xebio.bo.Te030p01.Request.Te030f01
{
  /// <summary>
  /// Te030f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Te030f01Request_Btnprint : Te030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te030f01Request_Btnprint Me = new Te030f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te030f01Request_Btnprint()
		{
