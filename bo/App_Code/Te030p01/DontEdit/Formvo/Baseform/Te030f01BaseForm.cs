...
namespace com.xebio.bo.Te030p01.Formvo.Baseform
{
  /// <summary>
  /// Te030f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te030f01BaseForm : StandardBaseForm, IFormVO
	{
		...
		/// <summary>
		/// 項目「JYURYO_YMD_FROM(入荷日FROM)」の値
		/// </summary>
		private string _jyuryo_ymd_from;
		/// <summary>
		/// 項目「JYURYO_YMD_TO(入荷日TO)」の値
		/// </summary>
		private string _jyuryo_ymd_to;
		/// <summary>
		/// 項目「JYURYO_YMD_HDN()」の値
		/// </summary>
		private string _jyuryo_ymd_hdn;
		...
		/// <summary>
		/// 項目「JYURYO_YMD_FROM(入荷日FROM)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「JYURYO_YMD_TO(入荷日TO)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「JYURYO_YMD_HDN()」の値を取得または設定する。
		/// </summary>
		public virtual string Jyuryo_ymd_hdn
		{
			get
			{
				return this._jyuryo_ymd_hdn;
			}
			set
			{
				this._jyuryo_ymd_hdn = value;
			}
		}
		#endregion
		...
		public override string ToString()
		{
			...
			sb.Append("Jyuryo_ymd_hdn:").Append(this._jyuryo_ymd_hdn).AppendLine();
