...
namespace com.xebio.bo.Tj190p01.Request.Tj190f01
{
  /// <summary>
  /// Tj190f01Request_M1bumonkana_nm の概要の説明です。
  /// </summary>
  public sealed class Tj190f01Request_M1bumonkana_nm : Tj190f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f01Request_M1bumonkana_nm Me = new Tj190f01Request_M1bumonkana_nm();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f01Request_M1bumonkana_nm()
		{
