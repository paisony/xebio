...
{
  /// <summary>
  /// Tj190f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tj190f01Request_Btnenter : Tj190f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f01Request_Btnenter Me = new Tj190f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f01Request_Btnenter()
		{
