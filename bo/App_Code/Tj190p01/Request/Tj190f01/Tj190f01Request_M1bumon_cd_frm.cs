...
{
  /// <summary>
  /// Tj190f01Request_M1bumon_cd の概要の説明です。
  /// </summary>
  public sealed class Tj190f01Request_M1bumon_cd : Tj190f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f01Request_M1bumon_cd Me = new Tj190f01Request_M1bumon_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f01Request_M1bumon_cd()
		{
