...
{
  /// <summary>
  /// Tj190f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tj190f01Request_Btnsearch : Tj190f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f01Request_Btnsearch Me = new Tj190f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f01Request_Btnsearch()
		{
