...
{
  /// <summary>
  /// Tj190f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj190f01Request_Pgr : Tj190f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f01Request_Pgr Me = new Tj190f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f01Request_Pgr()
		{
