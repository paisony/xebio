...
{
  /// <summary>
  /// Tj190f02Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tj190f02Request_Btnrowdel : Tj190f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f02Request_Btnrowdel Me = new Tj190f02Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f02Request_Btnrowdel()
		{
