...
{
  /// <summary>
  /// Tj190f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tj190f02Request_Btnback : Tj190f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f02Request_Btnback Me = new Tj190f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f02Request_Btnback()
		{
