...
namespace com.xebio.bo.Tj190p01.Request.Tj190f02
{
  /// <summary>
  /// Tj190f02Request_Btnrowins の概要の説明です。
  /// </summary>
  public sealed class Tj190f02Request_Btnrowins : Tj190f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f02Request_Btnrowins Me = new Tj190f02Request_Btnrowins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f02Request_Btnrowins()
		{
