...
{
  /// <summary>
  /// Tj190f02Request_Btnsizstk の概要の説明です。
  /// </summary>
  public sealed class Tj190f02Request_Btnsizstk : Tj190f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj190f02Request_Btnsizstk Me = new Tj190f02Request_Btnsizstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj190f02Request_Btnsizstk()
		{
