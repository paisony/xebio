...
{
  /// <summary>
  /// Tj190f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj190f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj190f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj190f02M1ResultVO compare = null;
			if (obj is Tj190f02M1ResultVO)
			{
				compare = (Tj190f02M1ResultVO)obj;
			}
			else
			{
				return false;
