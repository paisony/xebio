...
{
  /// <summary>
  /// Tj190f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj190f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj190f01M1BaseForm compare = null;
			if (obj is Tj190f01M1BaseForm)
			{
				compare = (Tj190f01M1BaseForm)obj;
			}
			else
			{
				return false;
