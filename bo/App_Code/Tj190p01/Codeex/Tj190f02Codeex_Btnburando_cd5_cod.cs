...
{
  /// <summary>
  /// フォーム：Tj190f02 項目：Btnburando_cd5 の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tj190f02Codeex_Btnburando_cd5 : StandardBaseCodeex
	{
		public Tj190f02Codeex_Btnburando_cd5()
		{
		}
		...
		public override void BeforeSearch(ICodeContext context)
		{
			...
			// 入力値を半角に置き換え
			string inpval = (string)context.ExeValue.InputValues["Burando_nm5"];
			context.ExeValue.InputValues["Burando_nm5"] = BoSystemString.ChangeZenHankaku(inpval, 1);
