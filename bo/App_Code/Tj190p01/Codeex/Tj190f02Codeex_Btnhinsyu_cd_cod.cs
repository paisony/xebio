...
{
  /// <summary>
  /// フォーム：Tj190f02 項目：Btnhinsyu_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tj190f02Codeex_Btnhinsyu_cd : StandardBaseCodeex
	{
		public Tj190f02Codeex_Btnhinsyu_cd()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// 項目追加
			context.Condition.AddExtItemID("Bumon_cd_bo");
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			// 検索条件の設定
			context.Condition.AddFindKey("Bumon_cd_bo", "BUMON_CD", SearchItemType.Equal);
