...
{
  /// <summary>
  /// フォーム：Tj190f02 項目：Btnburando_cd1 の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tj190f02Codeex_Btnburando_cd1 : StandardBaseCodeex
	{
		public Tj190f02Codeex_Btnburando_cd1()
		{
		}
		...
		public override void BeforeSearch(ICodeContext context)
		{
			...
			// 入力値を半角に置き換え
			string inpval = (string)context.ExeValue.InputValues["Burando_nm1"];
			context.ExeValue.InputValues["Burando_nm1"] = BoSystemString.ChangeZenHankaku(inpval, 1);
