...
{
  /// <summary>
  /// Te020f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Te020f01Request_Pgr : Te020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te020f01Request_Pgr Me = new Te020f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te020f01Request_Pgr()
		{
