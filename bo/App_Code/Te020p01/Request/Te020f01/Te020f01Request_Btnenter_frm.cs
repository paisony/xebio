...
{
  /// <summary>
  /// Te020f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Te020f01Request_Btnenter : Te020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te020f01Request_Btnenter Me = new Te020f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te020f01Request_Btnenter()
		{
