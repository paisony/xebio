...
{
  /// <summary>
  /// Te020f01Request_Btncsv_torikomi の概要の説明です。
  /// </summary>
  public sealed class Te020f01Request_Btncsv_torikomi : Te020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te020f01Request_Btncsv_torikomi Me = new Te020f01Request_Btncsv_torikomi();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te020f01Request_Btncsv_torikomi()
		{
