using com.xebio.bo.Te020p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Te020f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te020f01Form : Te020f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Te020p01","Te020f01");
