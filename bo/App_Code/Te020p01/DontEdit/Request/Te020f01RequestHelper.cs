...
namespace com.xebio.bo.Te020p01.Request
{
  /// <summary>
  /// Te020f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Te020f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Te020f01M1Form te020f01M1Form = (Te020f01M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					te020f01M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1bumon_cd"][i].UnformatValue != null)
				{
					te020f01M1Form.M1bumon_cd = paramCol["M1bumon_cd"][i].UnformatValue;
				}
				if (paramCol["M1bumonkana_nm"][i].UnformatValue != null)
				{
					te020f01M1Form.M1bumonkana_nm = paramCol["M1bumonkana_nm"][i].UnformatValue;
				}
				if (paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue != null)
				{
					te020f01M1Form.M1hinsyu_ryaku_nm = paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue;
				}
				if (paramCol["M1burando_nm"][i].UnformatValue != null)
				{
					te020f01M1Form.M1burando_nm = paramCol["M1burando_nm"][i].UnformatValue;
				}
				if (paramCol["M1jisya_hbn"][i].UnformatValue != null)
				{
					te020f01M1Form.M1jisya_hbn = paramCol["M1jisya_hbn"][i].UnformatValue;
				}
				if (paramCol["M1maker_hbn"][i].UnformatValue != null)
				{
					te020f01M1Form.M1maker_hbn = paramCol["M1maker_hbn"][i].UnformatValue;
				}
				if (paramCol["M1syonmk"][i].UnformatValue != null)
				{
					te020f01M1Form.M1syonmk = paramCol["M1syonmk"][i].UnformatValue;
				}
				if (paramCol["M1iro_nm"][i].UnformatValue != null)
				{
					te020f01M1Form.M1iro_nm = paramCol["M1iro_nm"][i].UnformatValue;
				}
				if (paramCol["M1size_nm"][i].UnformatValue != null)
				{
					te020f01M1Form.M1size_nm = paramCol["M1size_nm"][i].UnformatValue;
				}
				if (paramCol["M1scan_cd"][i].UnformatValue != null)
				{
					te020f01M1Form.M1scan_cd = paramCol["M1scan_cd"][i].UnformatValue;
				}
				if (paramCol["M1syukka_su"][i].UnformatValue != null)
				{
					te020f01M1Form.M1syukka_su = paramCol["M1syukka_su"][i].UnformatValue;
				}
				if (paramCol["M1gen_tnk"][i].UnformatValue != null)
				{
					te020f01M1Form.M1gen_tnk = paramCol["M1gen_tnk"][i].UnformatValue;
				}
				if (paramCol["M1genka_kin"][i].UnformatValue != null)
				{
					te020f01M1Form.M1genka_kin = paramCol["M1genka_kin"][i].UnformatValue;
				}
				if (paramCol["M1syukka_su_hdn"][i].UnformatValue != null)
				{
					te020f01M1Form.M1syukka_su_hdn = paramCol["M1syukka_su_hdn"][i].UnformatValue;
				}
				if (paramCol["M1genka_kin_hdn"][i].UnformatValue != null)
				{
					te020f01M1Form.M1genka_kin_hdn = paramCol["M1genka_kin_hdn"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					te020f01M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					te020f01M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					te020f01M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Te020f01Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Te020f01Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Te020f01M1Form te020f01M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, te020f01M1Form, i, m1List);
				if (te020f01M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", te020f01M1Form.M1rowno, i, m1List);
				}
				if (te020f01M1Form.M1bumon_cd != null)
				{
					checker.DoCheck("M1bumon_cd", te020f01M1Form.M1bumon_cd, i, m1List);
				}
				if (te020f01M1Form.M1bumonkana_nm != null)
				{
					checker.DoCheck("M1bumonkana_nm", te020f01M1Form.M1bumonkana_nm, i, m1List);
				}
				if (te020f01M1Form.M1hinsyu_ryaku_nm != null)
				{
					checker.DoCheck("M1hinsyu_ryaku_nm", te020f01M1Form.M1hinsyu_ryaku_nm, i, m1List);
				}
				if (te020f01M1Form.M1burando_nm != null)
				{
					checker.DoCheck("M1burando_nm", te020f01M1Form.M1burando_nm, i, m1List);
				}
				if (te020f01M1Form.M1jisya_hbn != null)
				{
					checker.DoCheck("M1jisya_hbn", te020f01M1Form.M1jisya_hbn, i, m1List);
				}
				if (te020f01M1Form.M1maker_hbn != null)
				{
					checker.DoCheck("M1maker_hbn", te020f01M1Form.M1maker_hbn, i, m1List);
				}
				if (te020f01M1Form.M1syonmk != null)
				{
					checker.DoCheck("M1syonmk", te020f01M1Form.M1syonmk, i, m1List);
				}
				if (te020f01M1Form.M1iro_nm != null)
				{
					checker.DoCheck("M1iro_nm", te020f01M1Form.M1iro_nm, i, m1List);
				}
				if (te020f01M1Form.M1size_nm != null)
				{
					checker.DoCheck("M1size_nm", te020f01M1Form.M1size_nm, i, m1List);
				}
				if (te020f01M1Form.M1scan_cd != null)
				{
					checker.DoCheck("M1scan_cd", te020f01M1Form.M1scan_cd, i, m1List);
				}
				if (te020f01M1Form.M1syukka_su != null)
				{
					checker.DoCheck("M1syukka_su", te020f01M1Form.M1syukka_su, i, m1List);
				}
				if (te020f01M1Form.M1gen_tnk != null)
				{
					checker.DoCheck("M1gen_tnk", te020f01M1Form.M1gen_tnk, i, m1List);
				}
				if (te020f01M1Form.M1genka_kin != null)
				{
					checker.DoCheck("M1genka_kin", te020f01M1Form.M1genka_kin, i, m1List);
				}
				if (te020f01M1Form.M1syukka_su_hdn != null)
				{
					checker.DoCheck("M1syukka_su_hdn", te020f01M1Form.M1syukka_su_hdn, i, m1List);
				}
				if (te020f01M1Form.M1genka_kin_hdn != null)
				{
					checker.DoCheck("M1genka_kin_hdn", te020f01M1Form.M1genka_kin_hdn, i, m1List);
				}
				if (te020f01M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", te020f01M1Form.M1selectorcheckbox, i, m1List);
				}
				if (te020f01M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", te020f01M1Form.M1entersyoriflg, i, m1List);
				}
				if (te020f01M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", te020f01M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Te020f01Form formVO, StandardCodeCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Te020f01Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
