  ...
  public partial class Te020f01Facade : StandardBaseFacade
	{
		...
		public void DoBTNSIZSTK_FRM(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				//	//以下に業務ロジックを記述する。
				// サイズ検索にて選択したレコードを取得
				IList<Hashtable> hachuMstInfo = (IList<Hashtable>)facadeContext.GetUserObject(Te020p01Constant.KEY_SIZE_SEARCH_RESULT);
				...
				{
					// 発注マスタ情報設定
					DoShohinCopy((Te020f01M1Form)m1List[index], hachuMstRow, setTenpoCd, true, false);
				...
				// フォーカス行インデックス設定
				facadeContext.SetUserObject(Te020p01Constant.KEY_SIZE_FOCUS_INDEX, focusIndex.ToString());
