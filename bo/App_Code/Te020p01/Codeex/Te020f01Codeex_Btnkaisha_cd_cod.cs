...
{
  /// <summary>
  /// フォーム：Te020f01 項目：Btnkaisha_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Te020f01Codeex_Btnkaisha_cd : StandardBaseCodeex
	{
		public Te020f01Codeex_Btnkaisha_cd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			//検索条件追加
			context.Condition.AddFindKey(" SIKIBETSU_CD = '" + BoSystemConstant.SIKIBETSU_CD_KAISYA + "' AND SAKUJYO_FLG = 0");

			//ソート条件の指定
			SortKey sortKey1 = new SortKey("MEISYO_CD", false, 1);
