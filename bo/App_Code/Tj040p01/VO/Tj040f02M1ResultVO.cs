...
{
  /// <summary>
  /// Tj040f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj040f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj040f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj040f02M1ResultVO compare = null;
			if (obj is Tj040f02M1ResultVO)
			{
				compare = (Tj040f02M1ResultVO)obj;
			}
			else
			{
				return false;
