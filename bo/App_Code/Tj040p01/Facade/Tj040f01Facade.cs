  ...
  public partial class Tj040f01Facade : StandardBaseFacade
	{
		...
		/// プログラムID。
		/// </summary>
		private const string PGID = "Tj040p01";
		/// <summary>
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tj040f01";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj040f01Facade()
			: base()
		{
		}
		#endregion

		#region Tj040f01画面データを作成する。
		/// <summary>
		/// Tj040f01画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
            ...
            try
            {
                ...
                // 入力日From
                tj040f01Form.Nyuryoku_ymd_from = strYmdfrom;
                // 入力日To
                tj040f01Form.Nyuryoku_ymd_to = Convert.ToString(sysDateVO.Sysdate);

                // 送信状態
                tj040f01Form.Sosin_jyotai = ConditionSosin_jotai.VALUE_SOSIN_JOTAI1;

                // 訂正フラグ
                tj040f01Form.Teisei_flg = "0";
