...
{
  /// <summary>
  /// Tj040f01Request_Btncsv の概要の説明です。
  /// </summary>
  public sealed class Tj040f01Request_Btncsv : Tj040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj040f01Request_Btncsv Me = new Tj040f01Request_Btncsv();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj040f01Request_Btncsv()
		{
