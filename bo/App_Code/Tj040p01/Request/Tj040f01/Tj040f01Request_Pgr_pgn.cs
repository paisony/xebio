...
{
  /// <summary>
  /// Tj040f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj040f01Request_Pgr : Tj040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj040f01Request_Pgr Me = new Tj040f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj040f01Request_Pgr()
		{
