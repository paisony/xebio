...
{
  /// <summary>
  /// Tj040f01Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tj040f01Request_Btnzenstk : Tj040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj040f01Request_Btnzenstk Me = new Tj040f01Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj040f01Request_Btnzenstk()
		{
