...
{
  /// <summary>
  /// Tj040f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tj040f01Request_Btnenter : Tj040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj040f01Request_Btnenter Me = new Tj040f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj040f01Request_Btnenter()
		{
