...
namespace com.xebio.bo.Tj040p01.Request.Tj040f01
{
  /// <summary>
  /// Tj040f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tj040f01Request_Btnzenkjo : Tj040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj040f01Request_Btnzenkjo Me = new Tj040f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj040f01Request_Btnzenkjo()
		{
