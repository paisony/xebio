...
{
  /// <summary>
  /// Tj040f01Request_M1face_no の概要の説明です。
  /// </summary>
  public sealed class Tj040f01Request_M1face_no : Tj040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj040f01Request_M1face_no Me = new Tj040f01Request_M1face_no();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj040f01Request_M1face_no()
		{
