...
{
  /// <summary>
  /// Tj040f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tj040f02Request_Btnback : Tj040f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj040f02Request_Btnback Me = new Tj040f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj040f02Request_Btnback()
		{
