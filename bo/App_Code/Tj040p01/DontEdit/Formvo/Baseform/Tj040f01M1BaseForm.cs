...
{
  /// <summary>
  /// Tj040f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj040f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj040f01M1BaseForm compare = null;
			if (obj is Tj040f01M1BaseForm)
			{
				compare = (Tj040f01M1BaseForm)obj;
			}
			else
			{
				return false;
