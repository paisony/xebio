...
namespace com.xebio.bo.Tj040p01.Formvo.Baseform
{
  /// <summary>
  /// Tj040f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj040f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj040f02M1BaseForm compare = null;
			if (obj is Tj040f02M1BaseForm)
			{
				compare = (Tj040f02M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tj040p01.Formvo.Tj040f02M1Formのハッシュ コード。</returns>
