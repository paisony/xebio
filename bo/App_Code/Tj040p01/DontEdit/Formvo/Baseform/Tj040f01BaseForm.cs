...
{
  /// <summary>
  /// Tj040f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj040f01BaseForm : StandardBaseForm, IFormVO
	{
		...
		/// <summary>
		/// 項目「TEISEI_FLG()」の値を取得または設定する。
		/// </summary>
		public virtual string Teisei_flg
		{
			get
			{
				return this._teisei_flg;
			}
			set
			{
				this._teisei_flg = value;
			}
		}
		/// <summary>
		...
		public override string ToString()
		{
			...
			sb.Append("Teisei_flg:").Append(this._teisei_flg).AppendLine();
