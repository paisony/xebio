...
namespace com.xebio.bo.Tj040p01.Formvo
{
  ...
  /// </summary>
  [System.Serializable]
	public class Tj040f02FormCondition : IConditionVO
	{
		...
		/// <summary>
		/// 項目「TEISEI_SURYO_HDN(訂正数量(隠し))」の値
		/// </summary>
		...
		/// <summary>
		/// 項目「TEISEITAN_CD(訂正担当者コード)」の値
		/// </summary>
		//private string _teiseitan_cd;
		/// <summary>
		/// 項目「TEISEITAN_NM(訂正担当者名称)」の値
		/// </summary>
		...
		/// <summary>
		/// 項目「GOKEISCAN_SU(合計スキャン数量)」の値
		/// </summary>
		//private string _gokeiscan_su;
		/// <summary>
		/// 項目「GOKEITEISEI_SURYO(合計訂正数量)」の値
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「TEISEI_SURYO_HDN(訂正数量(隠し))」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「TENPO_GYOSYA_NM(店舗／業者名)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「TEISEITAN_CD(訂正担当者コード)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「TEISEITAN_NM(訂正担当者名称)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「GOKEISCAN_SU(合計スキャン数量)」の値を取得または設定する。
		/// </summary>
		...
		//}
		/// <summary>
		/// 項目「GOKEITEISEI_SURYO(合計訂正数量)」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj040f02FormCondition() : base()
		{
		}
		#endregion
	}
