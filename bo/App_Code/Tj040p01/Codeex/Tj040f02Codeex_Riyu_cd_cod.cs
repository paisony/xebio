...
{
  /// <summary>
  /// フォーム：Tj040f02 項目：Riyu_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tj040f02Codeex_Riyu_cd : StandardBaseCodeex
	{
		public Tj040f02Codeex_Riyu_cd()
		{
		}
		...
		public override void BeforeSearch(ICodeContext context)
		{
			...
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			string gyomu_kb = "017";
			context.Condition.AddFindKey("GYOMU_KB = '" + gyomu_kb + "'");
