...
{
  /// <summary>
  /// Tj070f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tj070f01Request_Btnsearch : Tj070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj070f01Request_Btnsearch Me = new Tj070f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj070f01Request_Btnsearch()
		{
