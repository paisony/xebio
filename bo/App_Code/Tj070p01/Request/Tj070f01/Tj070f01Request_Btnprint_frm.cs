...
{
  /// <summary>
  /// Tj070f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj070f01Request_Btnprint : Tj070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj070f01Request_Btnprint Me = new Tj070f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj070f01Request_Btnprint()
		{
