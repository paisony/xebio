...
namespace com.xebio.bo.Tj070p01.Formvo.Baseform
{
  /// <summary>
  /// Tj070f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj070f01M1BaseForm : StandardBaseM1Form
	{
		...
		/// <summary>
		/// 項目「M1HHTJISSI_YMD(HHT実施日)」の値
		/// </summary>
		private string _m1hhtjissi_ymd;
		...
		/// <summary>
		/// 項目「M1TENPO_KAKUTEI_JOTAI_NM()」の値
		/// </summary>
		private string _m1tenpo_kakutei_jotai_nm;
		...
		/// <summary>
		/// 項目「M1SOSIN_JOTAI_NM()」の値
		/// </summary>
		private string _m1sosin_jotai_nm;
		...
		/// <summary>
		/// 項目「M1HHTJISSI_YMD(HHT実施日)」の値を取得または設定する。
		/// </summary>
		public virtual string M1hhtjissi_ymd
		{
			get
			{
				return this._m1hhtjissi_ymd;
			}
			set
			{
				this._m1hhtjissi_ymd = value;
			}
		}
		...
		/// <summary>
		/// 項目「M1TENPO_KAKUTEI_JOTAI_NM()」の値を取得または設定する。
		/// </summary>
		public virtual string M1tenpo_kakutei_jotai_nm
		{
			get
			{
				return this._m1tenpo_kakutei_jotai_nm;
			}
			set
			{
				this._m1tenpo_kakutei_jotai_nm = value;
			}
		}
		...
		/// <summary>
		/// 項目「M1SOSIN_JOTAI_NM()」の値を取得または設定する。
		/// </summary>
		public virtual string M1sosin_jotai_nm
		{
			get
			{
				return this._m1sosin_jotai_nm;
			}
			set
			{
				this._m1sosin_jotai_nm = value;
			}
		}
		...
		{
			Tj070f01M1BaseForm compare = null;
			if (obj is Tj070f01M1BaseForm)
			{
				compare = (Tj070f01M1BaseForm)obj;
			}
			else
			{
				return false;
			...
			if (_m1hhtjissi_ymd != compare.M1hhtjissi_ymd)
			{
				return false;
			}
			...
			if (_m1tenpo_kakutei_jotai_nm != compare.M1tenpo_kakutei_jotai_nm)
			{
				return false;
			}
			...
			if (_m1sosin_jotai_nm != compare.M1sosin_jotai_nm)
			{
				return false;
			}
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tj070p01.Formvo.Tj070f01M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1hhtjissi_ymd:").Append(this._m1hhtjissi_ymd).AppendLine();
			...
			str.Append("M1tenpo_kakutei_jotai_nm:").Append(this._m1tenpo_kakutei_jotai_nm).AppendLine();
			str.Append("M1md_sosin_jyokyo:").Append(this._m1md_sosin_jyokyo).AppendLine();
			str.Append("M1sosin_jotai_nm:").Append(this._m1sosin_jotai_nm).AppendLine();
