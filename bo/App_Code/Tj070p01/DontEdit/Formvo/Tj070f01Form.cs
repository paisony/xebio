using com.xebio.bo.Tj070p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tj070f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj070f01Form : Tj070f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tj070p01","Tj070f01");
