...
namespace com.xebio.bo.Tj070p01.Codeex
{
  /// <summary>
  /// フォーム：Tj070f01 項目：Btntenpocd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tj070f01Codeex_Btntenpocd_from : StandardBaseCodeex
	{
		public Tj070f01Codeex_Btntenpocd_from()
		{
		}
