...
{
  /// <summary>
  /// Tj070f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj070f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj070f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj070f01M1ResultVO compare = null;
			if (obj is Tj070f01M1ResultVO)
			{
				compare = (Tj070f01M1ResultVO)obj;
			}
			else
			{
				return false;
