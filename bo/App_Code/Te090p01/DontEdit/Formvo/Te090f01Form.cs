using com.xebio.bo.Te090p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Te090f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te090f01Form : Te090f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Te090p01","Te090f01");
