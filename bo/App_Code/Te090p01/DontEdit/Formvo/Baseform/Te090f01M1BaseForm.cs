...
{
  /// <summary>
  /// Te090f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te090f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Te090f01M1BaseForm compare = null;
			if (obj is Te090f01M1BaseForm)
			{
				compare = (Te090f01M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Te090p01.Formvo.Te090f01M1Formのハッシュ コード。</returns>
