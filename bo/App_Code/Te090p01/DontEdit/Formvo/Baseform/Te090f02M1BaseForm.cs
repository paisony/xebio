...
namespace com.xebio.bo.Te090p01.Formvo.Baseform
{
  /// <summary>
  /// Te090f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te090f02M1BaseForm : StandardBaseM1Form
	{
		...
		/// <summary>
		/// 項目「M1KAKUTEI_SU_HDN()」の値
		/// </summary>
		private string _m1kakutei_su_hdn;
		...
		/// <summary>
		/// 項目「M1KAKUTEI_SU_HDN()」の値を取得または設定する。
		/// </summary>
		public virtual string M1kakutei_su_hdn
		{
			get
			{
				return this._m1kakutei_su_hdn;
			}
			set
			{
				this._m1kakutei_su_hdn = value;
			}
		}
		...
		{
			Te090f02M1BaseForm compare = null;
			if (obj is Te090f02M1BaseForm)
			{
				compare = (Te090f02M1BaseForm)obj;
			}
			else
			{
				return false;
			...
			if (_m1kakutei_su_hdn != compare.M1kakutei_su_hdn)
			{
				return false;
			}
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Te090p01.Formvo.Te090f02M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1kakutei_su_hdn:").Append(this._m1kakutei_su_hdn).AppendLine();
