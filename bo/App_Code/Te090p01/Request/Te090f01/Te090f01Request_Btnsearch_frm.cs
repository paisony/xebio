...
{
  /// <summary>
  /// Te090f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Te090f01Request_Btnsearch : Te090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te090f01Request_Btnsearch Me = new Te090f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te090f01Request_Btnsearch()
		{
