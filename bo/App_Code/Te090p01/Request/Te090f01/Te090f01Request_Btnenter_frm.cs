...
{
  /// <summary>
  /// Te090f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Te090f01Request_Btnenter : Te090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te090f01Request_Btnenter Me = new Te090f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te090f01Request_Btnenter()
		{
