...
{
  /// <summary>
  /// Te090f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Te090f02Request_Btnenter : Te090f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te090f02Request_Btnenter Me = new Te090f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te090f02Request_Btnenter()
		{
