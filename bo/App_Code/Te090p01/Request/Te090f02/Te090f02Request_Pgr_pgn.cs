...
namespace com.xebio.bo.Te090p01.Request.Te090f02
{
  /// <summary>
  /// Te090f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Te090f02Request_Pgr : Te090f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te090f02Request_Pgr Me = new Te090f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te090f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Te090f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
