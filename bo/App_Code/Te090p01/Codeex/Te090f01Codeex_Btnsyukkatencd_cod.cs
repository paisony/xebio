...
namespace com.xebio.bo.Te090p01.Codeex
{
  /// <summary>
  /// フォーム：Te090f01 項目：Btnsyukkatencd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Te090f01Codeex_Btnsyukkatencd : StandardBaseCodeex
	{
		public Te090f01Codeex_Btnsyukkatencd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 親画面の会社コード取得
			decimal kaisyaCd;
			decimal.TryParse(context.ExeValue.InputValues["Kaisya_cd"] as string, out kaisyaCd);
			// 抽出条件追加
			context.Condition.AddFindKey("KAISYA_CD = " + kaisyaCd.ToString());
			// 業務ロジック↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
