...
{
  /// <summary>
  /// Te090f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te090f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te090f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te090f01M1ResultVO compare = null;
			if (obj is Te090f01M1ResultVO)
			{
				compare = (Te090f01M1ResultVO)obj;
			}
			else
			{
				return false;
