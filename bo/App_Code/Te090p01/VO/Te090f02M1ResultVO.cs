...
{
  /// <summary>
  /// Te090f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te090f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te090f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te090f02M1ResultVO compare = null;
			if (obj is Te090f02M1ResultVO)
			{
				compare = (Te090f02M1ResultVO)obj;
			}
			else
			{
				return false;
