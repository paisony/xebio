...
{
  /// <summary>
  /// Ta040f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Ta040f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Ta040f01Form formVO = (Ta040f01Form)pageContext.GetFormVO();
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Ta040f01M1Form ta040f01M1Form = (Ta040f01M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					ta040f01M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1henko_kbn_nm"][i].UnformatValue != null)
				{
					ta040f01M1Form.M1henko_kbn_nm = paramCol["M1henko_kbn_nm"][i].UnformatValue;
				}
				if (paramCol["M1hattyu_su"][i].UnformatValue != null)
				{
					ta040f01M1Form.M1hattyu_su = paramCol["M1hattyu_su"][i].UnformatValue;
				}
				if (paramCol["M1haibun_su"][i].UnformatValue != null)
				{
					ta040f01M1Form.M1haibun_su = paramCol["M1haibun_su"][i].UnformatValue;
				}
				if (paramCol["M1genkakin"][i].UnformatValue != null)
				{
					ta040f01M1Form.M1genkakin = paramCol["M1genkakin"][i].UnformatValue;
				}
				if (paramCol["M1kessai_ymd"][i].DateFullValue != null)
				{
					ta040f01M1Form.M1kessai_ymd = paramCol["M1kessai_ymd"][i].DateFullValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					ta040f01M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					ta040f01M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					ta040f01M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Ta040f01Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Ta040f01Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Ta040f01M1Form ta040f01M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, ta040f01M1Form, i, m1List);
				if (ta040f01M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", ta040f01M1Form.M1rowno, i, m1List);
				}
				if (ta040f01M1Form.M1henko_kbn_nm != null)
				{
					checker.DoCheck("M1henko_kbn_nm", ta040f01M1Form.M1henko_kbn_nm, i, m1List);
				}
				if (ta040f01M1Form.M1hattyu_su != null)
				{
					checker.DoCheck("M1hattyu_su", ta040f01M1Form.M1hattyu_su, i, m1List);
				}
				if (ta040f01M1Form.M1haibun_su != null)
				{
					checker.DoCheck("M1haibun_su", ta040f01M1Form.M1haibun_su, i, m1List);
				}
				if (ta040f01M1Form.M1genkakin != null)
				{
					checker.DoCheck("M1genkakin", ta040f01M1Form.M1genkakin, i, m1List);
				}
				if (ta040f01M1Form.M1kessai_ymd != null)
				{
					checker.DoCheck("M1kessai_ymd", ta040f01M1Form.M1kessai_ymd, i, m1List);
				}
				if (ta040f01M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", ta040f01M1Form.M1selectorcheckbox, i, m1List);
				}
				if (ta040f01M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", ta040f01M1Form.M1entersyoriflg, i, m1List);
				}
				if (ta040f01M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", ta040f01M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Ta040f01Form formVO, StandardCodeCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Ta040f01Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
