using com.xebio.bo.Ta040p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Ta040f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta040f01Form : Ta040f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Ta040p01","Ta040f01");
