...
namespace com.xebio.bo.Ta040p01.Formvo.Baseform
{
  /// <summary>
  /// Ta040f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta040f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta040f02M1BaseForm compare = null;
			if (obj is Ta040f02M1BaseForm)
			{
				compare = (Ta040f02M1BaseForm)obj;
			}
			else
			{
				return false;
