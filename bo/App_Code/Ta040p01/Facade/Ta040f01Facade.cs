  ...
  public partial class Ta040f01Facade : StandardBaseFacade
	{
		...
		/// プログラムID。
		/// </summary>
		private const string PGID = "Ta040p01";
		/// <summary>
		/// フォームID。
		/// </summary>
		private const string FORMID = "Ta040f01";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta040f01Facade()
			: base()
		{
		}
		#endregion

		#region Ta040f01画面データを作成する。
		/// <summary>
		/// Ta040f01画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
            ...
            //{
                ...
                //カード部を取得します。
                //Ta040f01Form ta040f01Form = (Ta040f01Form)facadeContext.FormVO;
