...
namespace com.xebio.bo.Ta040p01.Codeex
{
  /// <summary>
  /// フォーム：Ta040f01 項目：Btnbumon_cd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta040f01Codeex_Btnbumon_cd_from : StandardBaseCodeex
	{
		public Ta040f01Codeex_Btnbumon_cd_from()
		{
		}
