...
namespace com.xebio.bo.Ta040p01.Request.Ta040f01
{
  /// <summary>
  /// Ta040f01Request_M1bumon_cd の概要の説明です。
  /// </summary>
  public sealed class Ta040f01Request_M1bumon_cd : Ta040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta040f01Request_M1bumon_cd Me = new Ta040f01Request_M1bumon_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta040f01Request_M1bumon_cd()
		{
