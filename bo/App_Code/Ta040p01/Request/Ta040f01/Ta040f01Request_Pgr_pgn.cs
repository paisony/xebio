...
{
  /// <summary>
  /// Ta040f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta040f01Request_Pgr : Ta040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta040f01Request_Pgr Me = new Ta040f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta040f01Request_Pgr()
		{
