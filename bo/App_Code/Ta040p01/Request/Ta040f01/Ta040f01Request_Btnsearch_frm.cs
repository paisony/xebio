...
{
  /// <summary>
  /// Ta040f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Ta040f01Request_Btnsearch : Ta040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta040f01Request_Btnsearch Me = new Ta040f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta040f01Request_Btnsearch()
		{
