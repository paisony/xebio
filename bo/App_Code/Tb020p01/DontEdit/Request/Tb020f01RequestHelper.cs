...
{
  /// <summary>
  /// Tb020f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Tb020f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Tb020f01Form formVO = (Tb020f01Form)pageContext.GetFormVO();
			...
			paramCol["Scm_jotai"].RequestValue = RequestParameterUtil.GetRequestValue(
				page, formInfo["Scm_jotai"]);
			...
			paramCol["Nyukayotei_koguti_su"].RequestValue = RequestParameterUtil.GetRequestValue(
				page, formInfo["Nyukayotei_koguti_su"]);
		...
		public static void Unformat(IPageContext pageContext)
		{
			...
			paramCol["Scm_jotai"].UnformatValue = RequestParameterUtil.GetUnformatValue(
				paramCol["Scm_jotai"].RequestValue, formInfo["Scm_jotai"]);
			...
			paramCol["Nyukayotei_koguti_su"].UnformatValue = RequestParameterUtil.GetUnformatValue(
				paramCol["Nyukayotei_koguti_su"].RequestValue, formInfo["Nyukayotei_koguti_su"]);
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			if (paramCol["Scm_jotai"].UnformatValue != null)
			{
				formVO.Scm_jotai = paramCol["Scm_jotai"].UnformatValue;
			}
			...
			if (paramCol["Nyukayotei_koguti_su"].UnformatValue != null)
			{
				formVO.Nyukayotei_koguti_su = paramCol["Nyukayotei_koguti_su"].UnformatValue;
			}
			...
			{
				Tb020f01M1Form tb020f01M1Form = (Tb020f01M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					tb020f01M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1siiresaki_cd"][i].UnformatValue != null)
				{
					tb020f01M1Form.M1siiresaki_cd = paramCol["M1siiresaki_cd"][i].UnformatValue;
				}
				if (paramCol["M1siiresaki_ryaku_nm"][i].UnformatValue != null)
				{
					tb020f01M1Form.M1siiresaki_ryaku_nm = paramCol["M1siiresaki_ryaku_nm"][i].UnformatValue;
				}
				if (paramCol["M1nyukayotei_ymd"][i].DateFullValue != null)
				{
					tb020f01M1Form.M1nyukayotei_ymd = paramCol["M1nyukayotei_ymd"][i].DateFullValue;
				}
				if (paramCol["M1siire_kakutei_ymd"][i].DateFullValue != null)
				{
					tb020f01M1Form.M1siire_kakutei_ymd = paramCol["M1siire_kakutei_ymd"][i].DateFullValue;
				}
				if (paramCol["M1gokei_suryo"][i].UnformatValue != null)
				{
					tb020f01M1Form.M1gokei_suryo = paramCol["M1gokei_suryo"][i].UnformatValue;
				}
				if (paramCol["M1genka_kin"][i].UnformatValue != null)
				{
					tb020f01M1Form.M1genka_kin = paramCol["M1genka_kin"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					tb020f01M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					tb020f01M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					tb020f01M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Tb020f01Form formVO, StandardCheckManager checker)
		{
			...
			if (formVO.Scm_jotai != null)
			{
				checker.DoCheck("Scm_jotai", formVO.Scm_jotai);
			}
			...
			if (formVO.Nyukayotei_koguti_su != null)
			{
				checker.DoCheck("Nyukayotei_koguti_su", formVO.Nyukayotei_koguti_su);
			}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Tb020f01Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Tb020f01M1Form tb020f01M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, tb020f01M1Form, i, m1List);
				if (tb020f01M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", tb020f01M1Form.M1rowno, i, m1List);
				}
				if (tb020f01M1Form.M1siiresaki_cd != null)
				{
					checker.DoCheck("M1siiresaki_cd", tb020f01M1Form.M1siiresaki_cd, i, m1List);
				}
				if (tb020f01M1Form.M1siiresaki_ryaku_nm != null)
				{
					checker.DoCheck("M1siiresaki_ryaku_nm", tb020f01M1Form.M1siiresaki_ryaku_nm, i, m1List);
				}
				if (tb020f01M1Form.M1nyukayotei_ymd != null)
				{
					checker.DoCheck("M1nyukayotei_ymd", tb020f01M1Form.M1nyukayotei_ymd, i, m1List);
				}
				if (tb020f01M1Form.M1siire_kakutei_ymd != null)
				{
					checker.DoCheck("M1siire_kakutei_ymd", tb020f01M1Form.M1siire_kakutei_ymd, i, m1List);
				}
				if (tb020f01M1Form.M1gokei_suryo != null)
				{
					checker.DoCheck("M1gokei_suryo", tb020f01M1Form.M1gokei_suryo, i, m1List);
				}
				if (tb020f01M1Form.M1genka_kin != null)
				{
					checker.DoCheck("M1genka_kin", tb020f01M1Form.M1genka_kin, i, m1List);
				}
				if (tb020f01M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", tb020f01M1Form.M1selectorcheckbox, i, m1List);
				}
				if (tb020f01M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", tb020f01M1Form.M1entersyoriflg, i, m1List);
				}
				if (tb020f01M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", tb020f01M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tb020f01Form formVO, StandardCodeCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Tb020f01Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
