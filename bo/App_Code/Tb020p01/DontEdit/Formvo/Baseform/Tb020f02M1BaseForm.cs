...
{
  /// <summary>
  /// Tb020f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb020f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tb020f02M1BaseForm compare = null;
			if (obj is Tb020f02M1BaseForm)
			{
				compare = (Tb020f02M1BaseForm)obj;
			}
			else
			{
				return false;
