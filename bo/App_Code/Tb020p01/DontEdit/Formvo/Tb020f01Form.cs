using com.xebio.bo.Tb020p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tb020p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tb020f01Form : Tb020f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tb020p01","Tb020f01");
