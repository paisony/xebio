...
namespace com.xebio.bo.Tb020p01.VO
{
  /// <summary>
  /// Tb020f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tb020f02M1ResultVO : StandardBaseVO
	{
		...
		/// <summary>
		/// 項目「M1DENPYO_BANGO(伝票)」の値
		/// </summary>
		private string _m1denpyo_bango;

		/// <summary>
		/// 項目「M1DENPYOGYO_NO(行)」の値
		/// </summary>
		private string _m1denpyogyo_no;
		...
		/// <summary>
		/// 項目「M1DENPYO_BANGO(伝票)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1DENPYOGYO_NO(行)」の値を取得または設定する。
		/// </summary>
		public virtual string M1denpyogyo_no
		{
			get
			{
				return this._m1denpyogyo_no;
			}
			set
			{
				this._m1denpyogyo_no = value;
			}
		}
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb020f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tb020f02M1ResultVO compare = null;
			if (obj is Tb020f02M1ResultVO)
			{
				compare = (Tb020f02M1ResultVO)obj;
			}
			else
			{
				return false;
			...
			if (_m1denpyogyo_no != compare.M1denpyogyo_no)
			{
				return false;
			}
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tb020p01.Formvo.Tb020f02M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1denpyogyo_no:").Append(this._m1denpyogyo_no).AppendLine();
