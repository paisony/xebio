...
{
  /// <summary>
  /// Tb020f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tb020f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb020f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tb020f01M1ResultVO compare = null;
			if (obj is Tb020f01M1ResultVO)
			{
				compare = (Tb020f01M1ResultVO)obj;
			}
			else
			{
				return false;
