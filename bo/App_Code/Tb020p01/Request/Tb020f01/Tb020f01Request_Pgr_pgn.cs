...
{
  /// <summary>
  /// Tb020f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tb020f01Request_Pgr : Tb020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb020f01Request_Pgr Me = new Tb020f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb020f01Request_Pgr()
		{
