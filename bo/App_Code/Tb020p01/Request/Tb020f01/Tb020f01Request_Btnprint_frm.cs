...
{
  /// <summary>
  /// Tb020f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tb020f01Request_Btnprint : Tb020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb020f01Request_Btnprint Me = new Tb020f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb020f01Request_Btnprint()
		{
