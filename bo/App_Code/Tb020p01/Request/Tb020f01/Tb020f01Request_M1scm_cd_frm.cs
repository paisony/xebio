...
namespace com.xebio.bo.Tb020p01.Request.Tb020f01
{
  /// <summary>
  /// Tb020f01Request_M1scm_cd の概要の説明です。
  /// </summary>
  public sealed class Tb020f01Request_M1scm_cd : Tb020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb020f01Request_M1scm_cd Me = new Tb020f01Request_M1scm_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb020f01Request_M1scm_cd()
		{
