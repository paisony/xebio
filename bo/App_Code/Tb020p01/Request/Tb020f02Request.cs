...
{
  /// <summary>
  /// Tb020f02Request の概要の説明です。
  /// </summary>
  public abstract class Tb020f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tb020f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tb020f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tb020f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tb020f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tb020f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Tb020f02RequestHelper.ValidateM1InputValue(formVO, checker);
