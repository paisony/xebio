...
{
  /// <summary>
  /// Tb020f01Request の概要の説明です。
  /// </summary>
  public abstract class Tb020f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tb020f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tb020f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tb020f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tb020f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tb020f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Tb020f01RequestHelper.ValidateM1InputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tb020f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
			
			//明細部コード存在チェック
			Tb020f01RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
