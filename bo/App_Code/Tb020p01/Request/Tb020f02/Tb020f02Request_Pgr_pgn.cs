...
namespace com.xebio.bo.Tb020p01.Request.Tb020f02
{
  /// <summary>
  /// Tb020f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tb020f02Request_Pgr : Tb020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb020f02Request_Pgr Me = new Tb020f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb020f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tb020f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
