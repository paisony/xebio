...
{
  /// <summary>
  /// Te070f02のFacadeクラスです
  /// 画面データのロード業務ロジックを実装します。
  /// </summary>
  public partial class Te070f02Facade : StandardBaseFacade
	{
		#region 定数を設定します
		/// <summary>;
		/// プログラムID。
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Te070f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te070f02Facade()
			: base()
		{
		}
		#endregion

		#region Te070f02画面データを作成する。
		/// <summary>
		/// Te070f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Te070f02Form te070f02Form = (Te070f02Form)facadeContext.FormVO;
