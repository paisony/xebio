...
{
  /// <summary>
  /// Te070f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te070f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te070f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te070f02M1ResultVO compare = null;
			if (obj is Te070f02M1ResultVO)
			{
				compare = (Te070f02M1ResultVO)obj;
			}
			else
			{
				return false;
