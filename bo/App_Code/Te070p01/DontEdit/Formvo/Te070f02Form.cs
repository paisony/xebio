...
{
  /// <summary>
  /// Te070f02のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te070f02Form : Te070f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Te070p01","Te070f02");
