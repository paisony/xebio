using com.xebio.bo.Te070p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Te070f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te070f01Form : Te070f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Te070p01","Te070f01");
