...
namespace com.xebio.bo.Te070p01.Formvo.Baseform
{
  /// <summary>
  /// Te070f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te070f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Te070f02M1BaseForm compare = null;
			if (obj is Te070f02M1BaseForm)
			{
				compare = (Te070f02M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Te070p01.Formvo.Te070f02M1Formのハッシュ コード。</returns>
