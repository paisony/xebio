...
{
  /// <summary>
  /// Te070f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te070f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Te070f01M1BaseForm compare = null;
			if (obj is Te070f01M1BaseForm)
			{
				compare = (Te070f01M1BaseForm)obj;
			}
			else
			{
				return false;
