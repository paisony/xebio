...
{
  /// <summary>
  /// Te070f02RequestHelper の概要の説明です。
  /// </summary>
  public static class Te070f02RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Te070f02Form formVO = (Te070f02Form)pageContext.GetFormVO();
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Te070f02M1Form te070f02M1Form = (Te070f02M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					te070f02M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1bumon_cd"][i].UnformatValue != null)
				{
					te070f02M1Form.M1bumon_cd = paramCol["M1bumon_cd"][i].UnformatValue;
				}
				if (paramCol["M1bumonkana_nm"][i].UnformatValue != null)
				{
					te070f02M1Form.M1bumonkana_nm = paramCol["M1bumonkana_nm"][i].UnformatValue;
				}
				if (paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue != null)
				{
					te070f02M1Form.M1hinsyu_ryaku_nm = paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue;
				}
				if (paramCol["M1burando_nm"][i].UnformatValue != null)
				{
					te070f02M1Form.M1burando_nm = paramCol["M1burando_nm"][i].UnformatValue;
				}
				if (paramCol["M1jisya_hbn"][i].UnformatValue != null)
				{
					te070f02M1Form.M1jisya_hbn = paramCol["M1jisya_hbn"][i].UnformatValue;
				}
				if (paramCol["M1maker_hbn"][i].UnformatValue != null)
				{
					te070f02M1Form.M1maker_hbn = paramCol["M1maker_hbn"][i].UnformatValue;
				}
				if (paramCol["M1syonmk"][i].UnformatValue != null)
				{
					te070f02M1Form.M1syonmk = paramCol["M1syonmk"][i].UnformatValue;
				}
				if (paramCol["M1iro_nm"][i].UnformatValue != null)
				{
					te070f02M1Form.M1iro_nm = paramCol["M1iro_nm"][i].UnformatValue;
				}
				if (paramCol["M1size_nm"][i].UnformatValue != null)
				{
					te070f02M1Form.M1size_nm = paramCol["M1size_nm"][i].UnformatValue;
				}
				if (paramCol["M1scan_cd"][i].UnformatValue != null)
				{
					te070f02M1Form.M1scan_cd = paramCol["M1scan_cd"][i].UnformatValue;
				}
				if (paramCol["M1yotei_su"][i].UnformatValue != null)
				{
					te070f02M1Form.M1yotei_su = paramCol["M1yotei_su"][i].UnformatValue;
				}
				if (paramCol["M1kakutei_su"][i].UnformatValue != null)
				{
					te070f02M1Form.M1kakutei_su = paramCol["M1kakutei_su"][i].UnformatValue;
				}
				if (paramCol["M1gen_tnk"][i].UnformatValue != null)
				{
					te070f02M1Form.M1gen_tnk = paramCol["M1gen_tnk"][i].UnformatValue;
				}
				if (paramCol["M1genka_kin"][i].UnformatValue != null)
				{
					te070f02M1Form.M1genka_kin = paramCol["M1genka_kin"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					te070f02M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					te070f02M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					te070f02M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Te070f02Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Te070f02Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Te070f02M1Form te070f02M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, te070f02M1Form, i, m1List);
				if (te070f02M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", te070f02M1Form.M1rowno, i, m1List);
				}
				if (te070f02M1Form.M1bumon_cd != null)
				{
					checker.DoCheck("M1bumon_cd", te070f02M1Form.M1bumon_cd, i, m1List);
				}
				if (te070f02M1Form.M1bumonkana_nm != null)
				{
					checker.DoCheck("M1bumonkana_nm", te070f02M1Form.M1bumonkana_nm, i, m1List);
				}
				if (te070f02M1Form.M1hinsyu_ryaku_nm != null)
				{
					checker.DoCheck("M1hinsyu_ryaku_nm", te070f02M1Form.M1hinsyu_ryaku_nm, i, m1List);
				}
				if (te070f02M1Form.M1burando_nm != null)
				{
					checker.DoCheck("M1burando_nm", te070f02M1Form.M1burando_nm, i, m1List);
				}
				if (te070f02M1Form.M1jisya_hbn != null)
				{
					checker.DoCheck("M1jisya_hbn", te070f02M1Form.M1jisya_hbn, i, m1List);
				}
				if (te070f02M1Form.M1maker_hbn != null)
				{
					checker.DoCheck("M1maker_hbn", te070f02M1Form.M1maker_hbn, i, m1List);
				}
				if (te070f02M1Form.M1syonmk != null)
				{
					checker.DoCheck("M1syonmk", te070f02M1Form.M1syonmk, i, m1List);
				}
				if (te070f02M1Form.M1iro_nm != null)
				{
					checker.DoCheck("M1iro_nm", te070f02M1Form.M1iro_nm, i, m1List);
				}
				if (te070f02M1Form.M1size_nm != null)
				{
					checker.DoCheck("M1size_nm", te070f02M1Form.M1size_nm, i, m1List);
				}
				if (te070f02M1Form.M1scan_cd != null)
				{
					checker.DoCheck("M1scan_cd", te070f02M1Form.M1scan_cd, i, m1List);
				}
				if (te070f02M1Form.M1yotei_su != null)
				{
					checker.DoCheck("M1yotei_su", te070f02M1Form.M1yotei_su, i, m1List);
				}
				if (te070f02M1Form.M1kakutei_su != null)
				{
					checker.DoCheck("M1kakutei_su", te070f02M1Form.M1kakutei_su, i, m1List);
				}
				if (te070f02M1Form.M1gen_tnk != null)
				{
					checker.DoCheck("M1gen_tnk", te070f02M1Form.M1gen_tnk, i, m1List);
				}
				if (te070f02M1Form.M1genka_kin != null)
				{
					checker.DoCheck("M1genka_kin", te070f02M1Form.M1genka_kin, i, m1List);
				}
				if (te070f02M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", te070f02M1Form.M1selectorcheckbox, i, m1List);
				}
				if (te070f02M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", te070f02M1Form.M1entersyoriflg, i, m1List);
				}
				if (te070f02M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", te070f02M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Te070f02Form formVO, StandardCodeCheckManager checker)
		{
		}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Te070f02Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
