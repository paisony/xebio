...
namespace com.xebio.bo.Te070p01.Request.Te070f02
{
  /// <summary>
  /// Te070f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Te070f02Request_Btnback : Te070f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te070f02Request_Btnback Me = new Te070f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te070f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Te070f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
