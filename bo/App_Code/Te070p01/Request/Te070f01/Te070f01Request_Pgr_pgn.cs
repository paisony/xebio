...
{
  /// <summary>
  /// Te070f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Te070f01Request_Pgr : Te070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te070f01Request_Pgr Me = new Te070f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te070f01Request_Pgr()
		{
