...
{
  /// <summary>
  /// Te070f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Te070f01Request_Btnsearch : Te070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te070f01Request_Btnsearch Me = new Te070f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te070f01Request_Btnsearch()
		{
