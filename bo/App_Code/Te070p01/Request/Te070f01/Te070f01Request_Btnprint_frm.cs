...
{
  /// <summary>
  /// Te070f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Te070f01Request_Btnprint : Te070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te070f01Request_Btnprint Me = new Te070f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te070f01Request_Btnprint()
		{
