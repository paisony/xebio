...
{
  /// <summary>
  /// Te070f02Request の概要の説明です。
  /// </summary>
  public abstract class Te070f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Te070f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Te070f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Te070f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Te070f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Te070f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Te070f02RequestHelper.ValidateM1InputValue(formVO, checker);
