...
{
  /// <summary>
  /// Tj130f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj130f01Request_Btnprint : Tj130f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj130f01Request_Btnprint Me = new Tj130f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj130f01Request_Btnprint()
		{
