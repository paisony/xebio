...
{
  /// <summary>
  /// Tj130f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tj130f01Request_Btnenter : Tj130f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj130f01Request_Btnenter Me = new Tj130f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj130f01Request_Btnenter()
		{
