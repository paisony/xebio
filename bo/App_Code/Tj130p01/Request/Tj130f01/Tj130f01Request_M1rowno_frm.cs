...
{
  /// <summary>
  /// Tj130f01Request_M1rowno の概要の説明です。
  /// </summary>
  public sealed class Tj130f01Request_M1rowno : Tj130f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj130f01Request_M1rowno Me = new Tj130f01Request_M1rowno();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj130f01Request_M1rowno()
		{
