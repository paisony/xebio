...
namespace com.xebio.bo.Tj130p01.Request.Tj130f01
{
  /// <summary>
  /// Tj130f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tj130f01Request_Btnzenkjo : Tj130f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj130f01Request_Btnzenkjo Me = new Tj130f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj130f01Request_Btnzenkjo()
		{
