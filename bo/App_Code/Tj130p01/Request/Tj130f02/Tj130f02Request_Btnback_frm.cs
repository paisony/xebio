...
{
  /// <summary>
  /// Tj130f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tj130f02Request_Btnback : Tj130f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj130f02Request_Btnback Me = new Tj130f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj130f02Request_Btnback()
		{
