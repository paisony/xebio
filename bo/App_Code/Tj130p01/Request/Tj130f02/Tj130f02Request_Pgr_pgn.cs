...
namespace com.xebio.bo.Tj130p01.Request.Tj130f02
{
  /// <summary>
  /// Tj130f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj130f02Request_Pgr : Tj130f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj130f02Request_Pgr Me = new Tj130f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj130f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tj130f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
