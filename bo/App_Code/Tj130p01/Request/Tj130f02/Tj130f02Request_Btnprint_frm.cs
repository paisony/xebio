...
{
  /// <summary>
  /// Tj130f02Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj130f02Request_Btnprint : Tj130f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj130f02Request_Btnprint Me = new Tj130f02Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj130f02Request_Btnprint()
		{
