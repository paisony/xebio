...
{
  /// <summary>
  /// Tj130f02Request の概要の説明です。
  /// </summary>
  public abstract class Tj130f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tj130f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tj130f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tj130f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tj130f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tj130f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Tj130f02RequestHelper.ValidateM1InputValue(formVO, checker);
