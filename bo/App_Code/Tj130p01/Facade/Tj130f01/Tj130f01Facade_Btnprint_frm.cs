  ...
  public partial class Tj130f01Facade : StandardBaseFacade
	{
		...
		public void DoBTNPRINT_FRM(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				//[棚卸基準日]
				inputData.AddScreenParameter(2, BoSystemFormat.formatDate((string)f01VO.Dictionary[Tj130p01Constant.DIC_TANAOROSIKIJUN_YMD]));
				//[フェイスNoFROM]
				...
				pdfFileNm = string.Format("{0}.{1}",
											BoSystemReport.CreateFileName(BoSystemConstant.REPORTID_TANAOROSIJUFUKULIST_X),
				...
				output = reportCls.MdGeneratePDF(inputData,
												BoSystemConstant.REPORTID_TANAOROSIJUFUKULIST_X,
												Tj130p01Constant.FORMID_01,
