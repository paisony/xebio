  ...
  public partial class Tj130f01Facade : StandardBaseFacade
	{
		...
		/// プログラムID。
		/// </summary>
		private const string PGID = "Tj130p01";
		/// <summary>
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tj130f01";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj130f01Facade()
			: base()
		{
		}
		#endregion

		#region Tj130f01画面データを作成する。
		/// <summary>
		/// Tj130f01画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				//入力日FROM
				// 前月の1日を設定する
				tj130f01Form.Nyuryoku_ymd_from = GetZebgetsu(sysDateVO.Sysdate.ToString());
				// 入力日TO
				tj130f01Form.Nyuryoku_ymd_to = sysDateVO.Sysdate.ToString();
				#endregion
