...
namespace com.xebio.bo.Tj130p01.Formvo.Baseform
{
  /// <summary>
  /// Tj130f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj130f01M1BaseForm : StandardBaseM1Form
	{
		...
		/// <summary>
		/// 項目「M1TENSUTANAOROSINYURYOKU_SU(点数棚卸入力数)」の値
		/// </summary>
		private string _m1tensutanaorosinyuryoku_su;

		/// <summary>
		/// 項目「M1TENSUTANAOROSITEISEI_SU(点数棚卸訂正数)」の値
		/// </summary>
		private string _m1tensutanaorositeisei_su;

		/// <summary>
		/// 項目「M1TENSUTANAOROSIGOKEI_SU(点数棚卸合計数)」の値
		/// </summary>
		private string _m1tensutanaorosigokei_su;

		/// <summary>
		/// 項目「M1SCAN_SU(スキャン数量)」の値
		/// </summary>
		...
		/// <summary>
		/// 項目「M1TENSUTANAOROSINYURYOKU_SU(点数棚卸入力数)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1TENSUTANAOROSITEISEI_SU(点数棚卸訂正数)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1TENSUTANAOROSIGOKEI_SU(点数棚卸合計数)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1SCAN_SU(スキャン数量)」の値を取得または設定する。
		/// </summary>
		...
		{
			Tj130f01M1BaseForm compare = null;
			if (obj is Tj130f01M1BaseForm)
			{
				compare = (Tj130f01M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tj130p01.Formvo.Tj130f01M1Formのハッシュ コード。</returns>
