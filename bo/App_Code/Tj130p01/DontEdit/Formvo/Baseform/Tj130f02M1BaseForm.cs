...
{
  /// <summary>
  /// Tj130f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj130f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj130f02M1BaseForm compare = null;
			if (obj is Tj130f02M1BaseForm)
			{
				compare = (Tj130f02M1BaseForm)obj;
			}
			else
			{
				return false;
