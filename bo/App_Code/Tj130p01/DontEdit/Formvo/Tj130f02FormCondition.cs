...
{
  /// <summary>
  /// Tj130f02のFormオブジェクトです。
  /// </summary>
  [System.Serializable]
	public class Tj130f02FormCondition : IConditionVO
	{
		...
		//}
		/// <summary>
		/// 項目「RIYUCOMMENT_NM(理由コメント情報)」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj130f02FormCondition() : base()
		{
		}
		#endregion
	}
