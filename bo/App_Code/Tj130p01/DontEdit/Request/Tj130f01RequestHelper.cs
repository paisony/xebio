...
{
  /// <summary>
  /// Tj130f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Tj130f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Tj130f01Form formVO = (Tj130f01Form)pageContext.GetFormVO();
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Tj130f01M1Form tj130f01M1Form = (Tj130f01M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1face_no"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1face_no = paramCol["M1face_no"][i].UnformatValue;
				}
				if (paramCol["M1tana_dan"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1tana_dan = paramCol["M1tana_dan"][i].UnformatValue;
				}
				if (paramCol["M1kai_su"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1kai_su = paramCol["M1kai_su"][i].UnformatValue;
				}
				if (paramCol["M1tensutanaorosinyuryoku_su"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1tensutanaorosinyuryoku_su = paramCol["M1tensutanaorosinyuryoku_su"][i].UnformatValue;
				}
				if (paramCol["M1tensutanaorositeisei_su"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1tensutanaorositeisei_su = paramCol["M1tensutanaorositeisei_su"][i].UnformatValue;
				}
				if (paramCol["M1tensutanaorosigokei_su"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1tensutanaorosigokei_su = paramCol["M1tensutanaorosigokei_su"][i].UnformatValue;
				}
				if (paramCol["M1scan_su"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1scan_su = paramCol["M1scan_su"][i].UnformatValue;
				}
				if (paramCol["M1teisei_suryo"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1teisei_suryo = paramCol["M1teisei_suryo"][i].UnformatValue;
				}
				if (paramCol["M1gokei_suryo"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1gokei_suryo = paramCol["M1gokei_suryo"][i].UnformatValue;
				}
				if (paramCol["M1nyuryokutan_nm"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1nyuryokutan_nm = paramCol["M1nyuryokutan_nm"][i].UnformatValue;
				}
				if (paramCol["M1riyucomment_nm"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1riyucomment_nm = paramCol["M1riyucomment_nm"][i].UnformatValue;
				}
				if (paramCol["M1nyuryoku_ymd"][i].DateFullValue != null)
				{
					tj130f01M1Form.M1nyuryoku_ymd = paramCol["M1nyuryoku_ymd"][i].DateFullValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					tj130f01M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Tj130f01Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Tj130f01Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Tj130f01M1Form tj130f01M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, tj130f01M1Form, i, m1List);
				if (tj130f01M1Form.M1face_no != null)
				{
					checker.DoCheck("M1face_no", tj130f01M1Form.M1face_no, i, m1List);
				}
				if (tj130f01M1Form.M1tana_dan != null)
				{
					checker.DoCheck("M1tana_dan", tj130f01M1Form.M1tana_dan, i, m1List);
				}
				if (tj130f01M1Form.M1kai_su != null)
				{
					checker.DoCheck("M1kai_su", tj130f01M1Form.M1kai_su, i, m1List);
				}
				if (tj130f01M1Form.M1tensutanaorosinyuryoku_su != null)
				{
					checker.DoCheck("M1tensutanaorosinyuryoku_su", tj130f01M1Form.M1tensutanaorosinyuryoku_su, i, m1List);
				}
				if (tj130f01M1Form.M1tensutanaorositeisei_su != null)
				{
					checker.DoCheck("M1tensutanaorositeisei_su", tj130f01M1Form.M1tensutanaorositeisei_su, i, m1List);
				}
				if (tj130f01M1Form.M1tensutanaorosigokei_su != null)
				{
					checker.DoCheck("M1tensutanaorosigokei_su", tj130f01M1Form.M1tensutanaorosigokei_su, i, m1List);
				}
				if (tj130f01M1Form.M1scan_su != null)
				{
					checker.DoCheck("M1scan_su", tj130f01M1Form.M1scan_su, i, m1List);
				}
				if (tj130f01M1Form.M1teisei_suryo != null)
				{
					checker.DoCheck("M1teisei_suryo", tj130f01M1Form.M1teisei_suryo, i, m1List);
				}
				if (tj130f01M1Form.M1gokei_suryo != null)
				{
					checker.DoCheck("M1gokei_suryo", tj130f01M1Form.M1gokei_suryo, i, m1List);
				}
				if (tj130f01M1Form.M1nyuryokutan_nm != null)
				{
					checker.DoCheck("M1nyuryokutan_nm", tj130f01M1Form.M1nyuryokutan_nm, i, m1List);
				}
				if (tj130f01M1Form.M1riyucomment_nm != null)
				{
					checker.DoCheck("M1riyucomment_nm", tj130f01M1Form.M1riyucomment_nm, i, m1List);
				}
				if (tj130f01M1Form.M1nyuryoku_ymd != null)
				{
					checker.DoCheck("M1nyuryoku_ymd", tj130f01M1Form.M1nyuryoku_ymd, i, m1List);
				}
				if (tj130f01M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", tj130f01M1Form.M1selectorcheckbox, i, m1List);
				}
				if (tj130f01M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", tj130f01M1Form.M1entersyoriflg, i, m1List);
				}
				if (tj130f01M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", tj130f01M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tj130f01Form formVO, StandardCodeCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Tj130f01Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
