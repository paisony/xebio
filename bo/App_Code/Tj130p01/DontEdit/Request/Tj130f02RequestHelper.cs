...
namespace com.xebio.bo.Tj130p01.Request
{
  /// <summary>
  /// Tj130f02RequestHelper の概要の説明です。
  /// </summary>
  public static class Tj130f02RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Tj130f02Form formVO = (Tj130f02Form)pageContext.GetFormVO();
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Tj130f02M1Form tj130f02M1Form = (Tj130f02M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1bumon_cd"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1bumon_cd = paramCol["M1bumon_cd"][i].UnformatValue;
				}
				if (paramCol["M1bumonkana_nm"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1bumonkana_nm = paramCol["M1bumonkana_nm"][i].UnformatValue;
				}
				if (paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1hinsyu_ryaku_nm = paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue;
				}
				if (paramCol["M1burando_nm"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1burando_nm = paramCol["M1burando_nm"][i].UnformatValue;
				}
				if (paramCol["M1jisya_hbn"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1jisya_hbn = paramCol["M1jisya_hbn"][i].UnformatValue;
				}
				if (paramCol["M1maker_hbn"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1maker_hbn = paramCol["M1maker_hbn"][i].UnformatValue;
				}
				if (paramCol["M1syonmk"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1syonmk = paramCol["M1syonmk"][i].UnformatValue;
				}
				if (paramCol["M1iro_nm"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1iro_nm = paramCol["M1iro_nm"][i].UnformatValue;
				}
				if (paramCol["M1size_nm"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1size_nm = paramCol["M1size_nm"][i].UnformatValue;
				}
				if (paramCol["M1scan_cd"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1scan_cd = paramCol["M1scan_cd"][i].UnformatValue;
				}
				if (paramCol["M1hyoji_syohin_cd"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1hyoji_syohin_cd = paramCol["M1hyoji_syohin_cd"][i].UnformatValue;
				}
				if (paramCol["M1scan_su"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1scan_su = paramCol["M1scan_su"][i].UnformatValue;
				}
				if (paramCol["M1teisei_suryo"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1teisei_suryo = paramCol["M1teisei_suryo"][i].UnformatValue;
				}
				if (paramCol["M1gokei_suryo"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1gokei_suryo = paramCol["M1gokei_suryo"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					tj130f02M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Tj130f02Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Tj130f02Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Tj130f02M1Form tj130f02M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, tj130f02M1Form, i, m1List);
				if (tj130f02M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", tj130f02M1Form.M1rowno, i, m1List);
				}
				if (tj130f02M1Form.M1bumon_cd != null)
				{
					checker.DoCheck("M1bumon_cd", tj130f02M1Form.M1bumon_cd, i, m1List);
				}
				if (tj130f02M1Form.M1bumonkana_nm != null)
				{
					checker.DoCheck("M1bumonkana_nm", tj130f02M1Form.M1bumonkana_nm, i, m1List);
				}
				if (tj130f02M1Form.M1hinsyu_ryaku_nm != null)
				{
					checker.DoCheck("M1hinsyu_ryaku_nm", tj130f02M1Form.M1hinsyu_ryaku_nm, i, m1List);
				}
				if (tj130f02M1Form.M1burando_nm != null)
				{
					checker.DoCheck("M1burando_nm", tj130f02M1Form.M1burando_nm, i, m1List);
				}
				if (tj130f02M1Form.M1jisya_hbn != null)
				{
					checker.DoCheck("M1jisya_hbn", tj130f02M1Form.M1jisya_hbn, i, m1List);
				}
				if (tj130f02M1Form.M1maker_hbn != null)
				{
					checker.DoCheck("M1maker_hbn", tj130f02M1Form.M1maker_hbn, i, m1List);
				}
				if (tj130f02M1Form.M1syonmk != null)
				{
					checker.DoCheck("M1syonmk", tj130f02M1Form.M1syonmk, i, m1List);
				}
				if (tj130f02M1Form.M1iro_nm != null)
				{
					checker.DoCheck("M1iro_nm", tj130f02M1Form.M1iro_nm, i, m1List);
				}
				if (tj130f02M1Form.M1size_nm != null)
				{
					checker.DoCheck("M1size_nm", tj130f02M1Form.M1size_nm, i, m1List);
				}
				if (tj130f02M1Form.M1scan_cd != null)
				{
					checker.DoCheck("M1scan_cd", tj130f02M1Form.M1scan_cd, i, m1List);
				}
				if (tj130f02M1Form.M1hyoji_syohin_cd != null)
				{
					checker.DoCheck("M1hyoji_syohin_cd", tj130f02M1Form.M1hyoji_syohin_cd, i, m1List);
				}
				if (tj130f02M1Form.M1scan_su != null)
				{
					checker.DoCheck("M1scan_su", tj130f02M1Form.M1scan_su, i, m1List);
				}
				if (tj130f02M1Form.M1teisei_suryo != null)
				{
					checker.DoCheck("M1teisei_suryo", tj130f02M1Form.M1teisei_suryo, i, m1List);
				}
				if (tj130f02M1Form.M1gokei_suryo != null)
				{
					checker.DoCheck("M1gokei_suryo", tj130f02M1Form.M1gokei_suryo, i, m1List);
				}
				if (tj130f02M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", tj130f02M1Form.M1selectorcheckbox, i, m1List);
				}
				if (tj130f02M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", tj130f02M1Form.M1entersyoriflg, i, m1List);
				}
				if (tj130f02M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", tj130f02M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tj130f02Form formVO, StandardCodeCheckManager checker)
		{
		}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Tj130f02Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
