...
{
  /// <summary>
  /// Tj130f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj130f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj130f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj130f01M1ResultVO compare = null;
			if (obj is Tj130f01M1ResultVO)
			{
				compare = (Tj130f01M1ResultVO)obj;
			}
			else
			{
				return false;
