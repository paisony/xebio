...
namespace com.xebio.bo.Tj080p01.Codeex
{
  /// <summary>
  /// フォーム：Tj080f01 項目：Btntenpocd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tj080f01Codeex_Btntenpocd_from : StandardBaseCodeex
	{
		public Tj080f01Codeex_Btntenpocd_from()
		{
		}
