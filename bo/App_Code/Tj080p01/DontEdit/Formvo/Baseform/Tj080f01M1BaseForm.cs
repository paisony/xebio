...
{
  /// <summary>
  /// Tj080f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj080f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj080f01M1BaseForm compare = null;
			if (obj is Tj080f01M1BaseForm)
			{
				compare = (Tj080f01M1BaseForm)obj;
			}
			else
			{
				return false;
