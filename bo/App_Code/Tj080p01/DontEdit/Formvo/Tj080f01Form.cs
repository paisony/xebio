using com.xebio.bo.Tj080p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tj080p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tj080f01Form : Tj080f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tj080p01","Tj080f01");
