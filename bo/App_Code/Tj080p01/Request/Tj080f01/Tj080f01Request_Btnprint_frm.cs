...
{
  /// <summary>
  /// Tj080f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj080f01Request_Btnprint : Tj080f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj080f01Request_Btnprint Me = new Tj080f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj080f01Request_Btnprint()
		{
