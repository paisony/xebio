...
{
  /// <summary>
  /// Tj080f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tj080f01Request_Btnsearch : Tj080f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj080f01Request_Btnsearch Me = new Tj080f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj080f01Request_Btnsearch()
		{
