...
{
  /// <summary>
  /// Ta010f02RequestHelper の概要の説明です。
  /// </summary>
  public static class Ta010f02RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			paramCol["Hattyu_ymd"].RequestValue = RequestParameterUtil.GetRequestValue(
				page, formInfo["Hattyu_ymd"]);
			...
			for (int i = 0; i < formVO.GetList("M1").CurrentCount; i++)
			{
				...
				paramCol["M1irai_syukei"][i].RequestValue = RequestParameterUtil.GetRequestValue(
					M1.Items[i], formInfo["M1irai_syukei"]);
		...
		public static void Unformat(IPageContext pageContext)
		{
			...
			paramCol["Hattyu_ymd"].UnformatValue = RequestParameterUtil.GetUnformatValue(
				paramCol["Hattyu_ymd"].RequestValue, formInfo["Hattyu_ymd"]);
			paramCol["Hattyu_ymd"].DateFullValue = RequestParameterUtil.GetDateFullValue(
				paramCol["Hattyu_ymd"].RequestValue, formInfo["Hattyu_ymd"]);
			...
			for (int i = 0; i < formVO.GetList("M1").CurrentCount; i++)
			{
				...
				paramCol["M1irai_syukei"][i].UnformatValue = RequestParameterUtil.GetUnformatValue(
					paramCol["M1irai_syukei"][i].RequestValue, formInfo["M1irai_syukei"]);
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			if (paramCol["Hattyu_ymd"].DateFullValue != null)
			{
				formVO.Hattyu_ymd = paramCol["Hattyu_ymd"].DateFullValue;
			}
			...
			{
				Ta010f02M1Form ta010f02M1Form = (Ta010f02M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1bumonkana_nm"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1bumonkana_nm = paramCol["M1bumonkana_nm"][i].UnformatValue;
				}
				if (paramCol["M1hyoka_kb"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1hyoka_kb = paramCol["M1hyoka_kb"][i].UnformatValue;
				}
				if (paramCol["M1kahi_nm"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1kahi_nm = paramCol["M1kahi_nm"][i].UnformatValue;
				}
				if (paramCol["M1tenzaiko_su"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1tenzaiko_su = paramCol["M1tenzaiko_su"][i].UnformatValue;
				}
				if (paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1hinsyu_ryaku_nm = paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue;
				}
				if (paramCol["M1nyukayotei_su"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1nyukayotei_su = paramCol["M1nyukayotei_su"][i].UnformatValue;
				}
				if (paramCol["M1uriage_su"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1uriage_su = paramCol["M1uriage_su"][i].UnformatValue;
				}
				if (paramCol["M1burando_nm"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1burando_nm = paramCol["M1burando_nm"][i].UnformatValue;
				}
				if (paramCol["M1jido_su"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1jido_su = paramCol["M1jido_su"][i].UnformatValue;
				}
				if (paramCol["M1haibunkano_su"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1haibunkano_su = paramCol["M1haibunkano_su"][i].UnformatValue;
				}
				if (paramCol["M1jisya_hbn"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1jisya_hbn = paramCol["M1jisya_hbn"][i].UnformatValue;
				}
				if (paramCol["M1irai_syukei"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1irai_syukei = paramCol["M1irai_syukei"][i].UnformatValue;
				}
				if (paramCol["M1syohin_zokusei"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1syohin_zokusei = paramCol["M1syohin_zokusei"][i].UnformatValue;
				}
				if (paramCol["M1lot_su"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1lot_su = paramCol["M1lot_su"][i].UnformatValue;
				}
				if (paramCol["M1iro_nm"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1iro_nm = paramCol["M1iro_nm"][i].UnformatValue;
				}
				if (paramCol["M1size_nm"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1size_nm = paramCol["M1size_nm"][i].UnformatValue;
				}
				if (paramCol["M1maker_hbn"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1maker_hbn = paramCol["M1maker_hbn"][i].UnformatValue;
				}
				if (paramCol["M1syonmk"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1syonmk = paramCol["M1syonmk"][i].UnformatValue;
				}
				if (paramCol["M1hatchu_msg"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1hatchu_msg = paramCol["M1hatchu_msg"][i].UnformatValue;
				}
				if (paramCol["M1scan_cd"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1scan_cd = paramCol["M1scan_cd"][i].UnformatValue;
				}
				if (paramCol["M1irai_su"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1irai_su = paramCol["M1irai_su"][i].UnformatValue;
				}
				if (paramCol["M1genkakin"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1genkakin = paramCol["M1genkakin"][i].UnformatValue;
				}
				if (paramCol["M1irai_su_hdn"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1irai_su_hdn = paramCol["M1irai_su_hdn"][i].UnformatValue;
				}
				if (paramCol["M1gen_tnk"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1gen_tnk = paramCol["M1gen_tnk"][i].UnformatValue;
				}
				if (paramCol["M1genkakin_hdn"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1genkakin_hdn = paramCol["M1genkakin_hdn"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					ta010f02M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Ta010f02Form formVO, StandardCheckManager checker)
		{
			...
			if (formVO.Hattyu_ymd != null)
			{
				checker.DoCheck("Hattyu_ymd", formVO.Hattyu_ymd);
			}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Ta010f02Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Ta010f02M1Form ta010f02M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, ta010f02M1Form, i, m1List);
				if (ta010f02M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", ta010f02M1Form.M1rowno, i, m1List);
				}
				if (ta010f02M1Form.M1bumonkana_nm != null)
				{
					checker.DoCheck("M1bumonkana_nm", ta010f02M1Form.M1bumonkana_nm, i, m1List);
				}
				if (ta010f02M1Form.M1hyoka_kb != null)
				{
					checker.DoCheck("M1hyoka_kb", ta010f02M1Form.M1hyoka_kb, i, m1List);
				}
				if (ta010f02M1Form.M1kahi_nm != null)
				{
					checker.DoCheck("M1kahi_nm", ta010f02M1Form.M1kahi_nm, i, m1List);
				}
				if (ta010f02M1Form.M1tenzaiko_su != null)
				{
					checker.DoCheck("M1tenzaiko_su", ta010f02M1Form.M1tenzaiko_su, i, m1List);
				}
				if (ta010f02M1Form.M1hinsyu_ryaku_nm != null)
				{
					checker.DoCheck("M1hinsyu_ryaku_nm", ta010f02M1Form.M1hinsyu_ryaku_nm, i, m1List);
				}
				if (ta010f02M1Form.M1nyukayotei_su != null)
				{
					checker.DoCheck("M1nyukayotei_su", ta010f02M1Form.M1nyukayotei_su, i, m1List);
				}
				if (ta010f02M1Form.M1uriage_su != null)
				{
					checker.DoCheck("M1uriage_su", ta010f02M1Form.M1uriage_su, i, m1List);
				}
				if (ta010f02M1Form.M1burando_nm != null)
				{
					checker.DoCheck("M1burando_nm", ta010f02M1Form.M1burando_nm, i, m1List);
				}
				if (ta010f02M1Form.M1jido_su != null)
				{
					checker.DoCheck("M1jido_su", ta010f02M1Form.M1jido_su, i, m1List);
				}
				if (ta010f02M1Form.M1haibunkano_su != null)
				{
					checker.DoCheck("M1haibunkano_su", ta010f02M1Form.M1haibunkano_su, i, m1List);
				}
				if (ta010f02M1Form.M1jisya_hbn != null)
				{
					checker.DoCheck("M1jisya_hbn", ta010f02M1Form.M1jisya_hbn, i, m1List);
				}
				if (ta010f02M1Form.M1irai_syukei != null)
				{
					checker.DoCheck("M1irai_syukei", ta010f02M1Form.M1irai_syukei, i, m1List);
				}
				if (ta010f02M1Form.M1syohin_zokusei != null)
				{
					checker.DoCheck("M1syohin_zokusei", ta010f02M1Form.M1syohin_zokusei, i, m1List);
				}
				if (ta010f02M1Form.M1lot_su != null)
				{
					checker.DoCheck("M1lot_su", ta010f02M1Form.M1lot_su, i, m1List);
				}
				if (ta010f02M1Form.M1iro_nm != null)
				{
					checker.DoCheck("M1iro_nm", ta010f02M1Form.M1iro_nm, i, m1List);
				}
				if (ta010f02M1Form.M1size_nm != null)
				{
					checker.DoCheck("M1size_nm", ta010f02M1Form.M1size_nm, i, m1List);
				}
				if (ta010f02M1Form.M1maker_hbn != null)
				{
					checker.DoCheck("M1maker_hbn", ta010f02M1Form.M1maker_hbn, i, m1List);
				}
				if (ta010f02M1Form.M1syonmk != null)
				{
					checker.DoCheck("M1syonmk", ta010f02M1Form.M1syonmk, i, m1List);
				}
				if (ta010f02M1Form.M1hatchu_msg != null)
				{
					checker.DoCheck("M1hatchu_msg", ta010f02M1Form.M1hatchu_msg, i, m1List);
				}
				if (ta010f02M1Form.M1scan_cd != null)
				{
					checker.DoCheck("M1scan_cd", ta010f02M1Form.M1scan_cd, i, m1List);
				}
				if (ta010f02M1Form.M1irai_su != null)
				{
					checker.DoCheck("M1irai_su", ta010f02M1Form.M1irai_su, i, m1List);
				}
				if (ta010f02M1Form.M1genkakin != null)
				{
					checker.DoCheck("M1genkakin", ta010f02M1Form.M1genkakin, i, m1List);
				}
				if (ta010f02M1Form.M1irai_su_hdn != null)
				{
					checker.DoCheck("M1irai_su_hdn", ta010f02M1Form.M1irai_su_hdn, i, m1List);
				}
				if (ta010f02M1Form.M1gen_tnk != null)
				{
					checker.DoCheck("M1gen_tnk", ta010f02M1Form.M1gen_tnk, i, m1List);
				}
				if (ta010f02M1Form.M1genkakin_hdn != null)
				{
					checker.DoCheck("M1genkakin_hdn", ta010f02M1Form.M1genkakin_hdn, i, m1List);
				}
				if (ta010f02M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", ta010f02M1Form.M1selectorcheckbox, i, m1List);
				}
				if (ta010f02M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", ta010f02M1Form.M1entersyoriflg, i, m1List);
				}
				if (ta010f02M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", ta010f02M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Ta010f02Form formVO, StandardCodeCheckManager checker)
		{
		}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Ta010f02Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
