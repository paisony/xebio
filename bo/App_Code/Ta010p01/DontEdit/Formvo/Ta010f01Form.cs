using com.xebio.bo.Ta010p01.Formvo.Baseform;
...
namespace com.xebio.bo.Ta010p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Ta010f01Form : Ta010f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Ta010p01","Ta010f01");
