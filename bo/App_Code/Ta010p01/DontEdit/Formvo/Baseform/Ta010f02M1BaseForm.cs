...
{
  /// <summary>
  /// Ta010f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta010f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta010f02M1BaseForm compare = null;
			if (obj is Ta010f02M1BaseForm)
			{
				compare = (Ta010f02M1BaseForm)obj;
			}
			else
			{
				return false;
