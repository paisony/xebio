...
{
  /// <summary>
  /// Ta010f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ta010f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta010f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta010f01M1ResultVO compare = null;
			if (obj is Ta010f01M1ResultVO)
			{
				compare = (Ta010f01M1ResultVO)obj;
			}
			else
			{
				return false;
