...
namespace com.xebio.bo.Ta010p01.VO
{
  /// <summary>
  /// Ta010f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ta010f02M1ResultVO : StandardBaseVO
	{
		...
		/// 項目「M1HYOKA_KB(評価)」の値
		/// </summary>
		private string _m1hyoka_kb;

		/// <summary>
		/// 項目「M1KAHI_NM(補充)」の値
		/// </summary>
		private string _m1kahi_nm;
		...
		/// <summary>
		/// 項目「M1IRAI_SYUKEI(依頼集計)」の値
		/// </summary>
		private string _m1irai_syukei;
		...
		/// <summary>
		/// 項目「M1HYOKA_KB(評価)」の値を取得または設定する。
		/// </summary>
		public virtual string M1hyoka_kb
		{
			get
			{
				return this._m1hyoka_kb;
			}
			set
			{
				this._m1hyoka_kb = value;
			}
		}

		/// <summary>
		/// 項目「M1KAHI_NM(補充)」の値を取得または設定する。
		/// </summary>
		public virtual string M1kahi_nm
		{
			get
			{
				return this._m1kahi_nm;
			}
			set
			{
				this._m1kahi_nm = value;
			}
		}
		...
		/// <summary>
		/// 項目「M1URIAGE_SU(売上)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1IRAI_SYUKEI(依頼集計)」の値を取得または設定する。
		/// </summary>
		public virtual string M1irai_syukei
		{
			get
			{
				return this._m1irai_syukei;
			}
			set
			{
				this._m1irai_syukei = value;
			}
		}
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta010f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta010f02M1ResultVO compare = null;
			if (obj is Ta010f02M1ResultVO)
			{
				compare = (Ta010f02M1ResultVO)obj;
			}
			else
			{
				return false;
			...
			if (_m1hyoka_kb != compare.M1hyoka_kb)
			{
				return false;
			}
			if (_m1kahi_nm != compare.M1kahi_nm)
			{
				return false;
			}
			...
			if (_m1irai_syukei != compare.M1irai_syukei)
			{
				return false;
			}
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Ta010p01.Formvo.Ta010f02M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1hyoka_kb:").Append(this._m1hyoka_kb).AppendLine();
			str.Append("M1kahi_nm:").Append(this._m1kahi_nm).AppendLine();
			...
			str.Append("M1irai_syukei:").Append(this._m1irai_syukei).AppendLine();
