...
{
  /// <summary>
  /// フォーム：Ta010f02 項目：Irairiyu_cd1 の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta010f02Codeex_Irairiyu_cd1 : StandardBaseCodeex
	{
		public Ta010f02Codeex_Irairiyu_cd1()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 業務区分の条件追加
			context.Condition.AddFindKey("GYOMU_KB = '" + Ta010p01Constant.RIYU_GYOMU_HOJYU + "'");
