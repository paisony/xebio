...
{
  /// <summary>
  /// フォーム：Ta010f01 項目：Irairiyu_cd2 の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta010f01Codeex_Irairiyu_cd2 : StandardBaseCodeex
	{
		public Ta010f01Codeex_Irairiyu_cd2()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 業務区分の条件追加
			context.Condition.AddFindKey("GYOMU_KB = '" + Ta010p01Constant.RIYU_GYOMU_TANPIN + "'");
