...
{
  /// <summary>
  /// Ta010f02Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Ta010f02Request_Btnzenkjo : Ta010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta010f02Request_Btnzenkjo Me = new Ta010f02Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta010f02Request_Btnzenkjo()
		{
