...
{
  /// <summary>
  /// Ta010f02Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Ta010f02Request_Btnrowdel : Ta010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta010f02Request_Btnrowdel Me = new Ta010f02Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta010f02Request_Btnrowdel()
		{
