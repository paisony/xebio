...
{
  /// <summary>
  /// Ta010f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Ta010f02Request_Btnenter : Ta010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta010f02Request_Btnenter Me = new Ta010f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta010f02Request_Btnenter()
		{
