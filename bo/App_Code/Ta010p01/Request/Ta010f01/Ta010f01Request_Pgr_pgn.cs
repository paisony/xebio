...
{
  /// <summary>
  /// Ta010f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta010f01Request_Pgr : Ta010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta010f01Request_Pgr Me = new Ta010f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta010f01Request_Pgr()
		{
