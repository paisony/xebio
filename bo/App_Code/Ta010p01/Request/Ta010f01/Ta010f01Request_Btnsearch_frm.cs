...
{
  /// <summary>
  /// Ta010f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Ta010f01Request_Btnsearch : Ta010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta010f01Request_Btnsearch Me = new Ta010f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta010f01Request_Btnsearch()
		{
