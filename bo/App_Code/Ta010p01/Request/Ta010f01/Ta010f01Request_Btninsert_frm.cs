...
{
  /// <summary>
  /// Ta010f01Request_Btninsert の概要の説明です。
  /// </summary>
  public sealed class Ta010f01Request_Btninsert : Ta010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta010f01Request_Btninsert Me = new Ta010f01Request_Btninsert();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta010f01Request_Btninsert()
		{
