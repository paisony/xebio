...
{
  /// <summary>
  /// Ta010f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Ta010f01Request_Btnzenkjo : Ta010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta010f01Request_Btnzenkjo Me = new Ta010f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta010f01Request_Btnzenkjo()
		{
