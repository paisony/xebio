namespace com.xebio.bo.Tg090p01.Request.Tg090f01
{
  /// <summary>
  /// Tg090f01Request_Btncsv の概要の説明です。
  /// </summary>
  public sealed class Tg090f01Request_Btncsv : Tg090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg090f01Request_Btncsv Me = new Tg090f01Request_Btncsv();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg090f01Request_Btncsv()
		{
