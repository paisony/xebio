...
namespace com.xebio.bo.Tg090p01.Request
{
  /// <summary>
  /// Tg090f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Tg090f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Tg090f01Form formVO = (Tg090f01Form)pageContext.GetFormVO();
			...
			paramCol["Tyotatsu_kb"].RequestValue = RequestParameterUtil.GetRequestValue(
				page, formInfo["Tyotatsu_kb"]);
		...
		public static void Unformat(IPageContext pageContext)
		{
			...
			paramCol["Tyotatsu_kb"].UnformatValue = RequestParameterUtil.GetUnformatValue(
				paramCol["Tyotatsu_kb"].RequestValue, formInfo["Tyotatsu_kb"]);
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			if (paramCol["Tyotatsu_kb"].UnformatValue != null)
			{
				formVO.Tyotatsu_kb = paramCol["Tyotatsu_kb"].UnformatValue;
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
		...
		public static void ValidateCardInputValue(Tg090f01Form formVO, StandardCheckManager checker)
		{
			...
			if (formVO.Tyotatsu_kb != null)
			{
				checker.DoCheck("Tyotatsu_kb", formVO.Tyotatsu_kb);
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tg090f01Form formVO, StandardCodeCheckManager checker)
		{
