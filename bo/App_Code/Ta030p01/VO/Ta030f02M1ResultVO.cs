...
{
  /// <summary>
  /// Ta030f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ta030f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta030f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta030f02M1ResultVO compare = null;
			if (obj is Ta030f02M1ResultVO)
			{
				compare = (Ta030f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Ta030p01.Formvo.Ta030f02M1Formのハッシュ コード。</returns>
