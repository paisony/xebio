...
{
  /// <summary>
  /// Ta030f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta030f01Request_Pgr : Ta030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta030f01Request_Pgr Me = new Ta030f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta030f01Request_Pgr()
		{
