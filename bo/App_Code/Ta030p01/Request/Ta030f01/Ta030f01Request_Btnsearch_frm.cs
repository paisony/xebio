...
{
  /// <summary>
  /// Ta030f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Ta030f01Request_Btnsearch : Ta030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta030f01Request_Btnsearch Me = new Ta030f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta030f01Request_Btnsearch()
		{
