...
namespace com.xebio.bo.Ta030p01.Request.Ta030f01
{
  /// <summary>
  /// Ta030f01Request_M1bumon_cd_bo の概要の説明です。
  /// </summary>
  public sealed class Ta030f01Request_M1bumon_cd_bo : Ta030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta030f01Request_M1bumon_cd_bo Me = new Ta030f01Request_M1bumon_cd_bo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta030f01Request_M1bumon_cd_bo()
		{
