...
namespace com.xebio.bo.Ta030p01.Request.Ta030f02
{
  /// <summary>
  /// Ta030f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Ta030f02Request_Btnback : Ta030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta030f02Request_Btnback Me = new Ta030f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta030f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Ta030f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
