...
{
  /// <summary>
  /// Ta030f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta030f02Request_Pgr : Ta030f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta030f02Request_Pgr Me = new Ta030f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta030f02Request_Pgr()
		{
