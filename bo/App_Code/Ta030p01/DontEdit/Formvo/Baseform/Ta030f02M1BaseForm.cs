...
{
  /// <summary>
  /// Ta030f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta030f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta030f02M1BaseForm compare = null;
			if (obj is Ta030f02M1BaseForm)
			{
				compare = (Ta030f02M1BaseForm)obj;
			}
			else
			{
				return false;
