...
{
  /// <summary>
  /// Ta030f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta030f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta030f01M1BaseForm compare = null;
			if (obj is Ta030f01M1BaseForm)
			{
				compare = (Ta030f01M1BaseForm)obj;
			}
			else
			{
				return false;
