...
namespace com.xebio.bo.Ta030p01.Formvo.Baseform
{
  ...
  /// </summary>
  [Serializable]
	public class Ta030f01BaseForm : StandardBaseForm, IFormVO
	{
		...
		/// <summary>
		/// 項目「HATTYU_YMD_FROM(発注日)」の値を取得または設定する。
		/// </summary>
