  ...
  public partial class Tb090f02Facade : StandardBaseFacade
	{
		...
		/// プログラムID。
		/// </summary>
		private const string PGID = "Tb090p01";
		/// <summary>
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tb090f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb090f02Facade()
			: base()
		{
		}
		#endregion

		#region Tb090f02画面データを作成する。
		/// <summary>
		/// Tb090f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Tb090f02Form tb090f02Form = (Tb090f02Form)facadeContext.FormVO;
