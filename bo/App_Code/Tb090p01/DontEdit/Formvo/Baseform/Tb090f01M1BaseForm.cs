...
{
  /// <summary>
  /// Tb090f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb090f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tb090f01M1BaseForm compare = null;
			if (obj is Tb090f01M1BaseForm)
			{
				compare = (Tb090f01M1BaseForm)obj;
			}
			else
			{
				return false;
