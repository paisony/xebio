...
{
  /// <summary>
  /// Tb090f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb090f01BaseForm : StandardBaseForm, IFormVO
	{
		...
		/// <summary>
		/// 項目「KAKUTEI_SB(確定種別)」の値
		/// </summary>
		private string _kakutei_sb;
		/// <summary>
		/// 項目「SEARCHCNT()」の値
		/// </summary>
		...
		/// <summary>
		/// 項目「KAKUTEI_SB(確定種別)」の値を取得または設定する。
		/// </summary>
		public virtual string Kakutei_sb
		{
			get
			{
				return this._kakutei_sb;
			}
			set
			{
				this._kakutei_sb = value;
			}
		}
		/// <summary>
		...
		public override string ToString()
		{
			...
			sb.Append("Kakutei_sb:").Append(this._kakutei_sb).AppendLine();
