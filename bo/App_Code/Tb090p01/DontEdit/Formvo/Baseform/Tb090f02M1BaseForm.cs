...
{
  /// <summary>
  /// Tb090f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb090f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tb090f02M1BaseForm compare = null;
			if (obj is Tb090f02M1BaseForm)
			{
				compare = (Tb090f02M1BaseForm)obj;
			}
			else
			{
				return false;
