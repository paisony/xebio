using com.xebio.bo.Tb090p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tb090p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tb090f01Form : Tb090f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tb090p01","Tb090f01");
