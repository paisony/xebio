...
{
  /// <summary>
  /// Tb090f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tb090f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb090f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tb090f02M1ResultVO compare = null;
			if (obj is Tb090f02M1ResultVO)
			{
				compare = (Tb090f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tb090p01.Formvo.Tb090f02M1Formのハッシュ コード。</returns>
