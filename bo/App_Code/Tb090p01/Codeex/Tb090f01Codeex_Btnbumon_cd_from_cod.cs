...
namespace com.xebio.bo.Tb090p01.Codeex
{
  /// <summary>
  /// フォーム：Tb090f01 項目：Btnbumon_cd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tb090f01Codeex_Btnbumon_cd_from : StandardBaseCodeex
	{
		public Tb090f01Codeex_Btnbumon_cd_from()
		{
		}
