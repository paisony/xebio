...
{
  /// <summary>
  /// Tb090f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tb090f01Request_Btnenter : Tb090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb090f01Request_Btnenter Me = new Tb090f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb090f01Request_Btnenter()
		{
