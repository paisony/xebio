...
{
  /// <summary>
  /// Tb090f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tb090f01Request_Pgr : Tb090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb090f01Request_Pgr Me = new Tb090f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb090f01Request_Pgr()
		{
