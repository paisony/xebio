...
{
  /// <summary>
  /// Tb090f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tb090f01Request_Btnsearch : Tb090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb090f01Request_Btnsearch Me = new Tb090f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb090f01Request_Btnsearch()
		{
