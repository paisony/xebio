...
namespace com.xebio.bo.Tb090p01.Request.Tb090f01
{
  /// <summary>
  /// Tb090f01Request_M1motodenpyo_bango の概要の説明です。
  /// </summary>
  public sealed class Tb090f01Request_M1motodenpyo_bango : Tb090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb090f01Request_M1motodenpyo_bango Me = new Tb090f01Request_M1motodenpyo_bango();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb090f01Request_M1motodenpyo_bango()
		{
