...
namespace com.xebio.bo.Tb090p01.Request.Tb090f02
{
  /// <summary>
  /// Tb090f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tb090f02Request_Btnback : Tb090f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb090f02Request_Btnback Me = new Tb090f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb090f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tb090f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
