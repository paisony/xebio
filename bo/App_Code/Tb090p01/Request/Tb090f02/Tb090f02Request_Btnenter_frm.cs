...
{
  /// <summary>
  /// Tb090f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tb090f02Request_Btnenter : Tb090f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb090f02Request_Btnenter Me = new Tb090f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb090f02Request_Btnenter()
		{
