...
namespace com.xebio.bo.Tj010p01.Request
{
  /// <summary>
  /// Tj010f01Request の概要の説明です。
  /// </summary>
  public abstract class Tj010f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tj010f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tj010f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tj010f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tj010f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Tj010f01Form formVO=(Tj010f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Tj010f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tj010f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
