namespace com.xebio.bo.Tj010p01.Request.Tj010f01
{
  /// <summary>
  /// Tj010f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tj010f01Request_Btnenter : Tj010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj010f01Request_Btnenter Me = new Tj010f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj010f01Request_Btnenter()
		{
