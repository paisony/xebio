...
{
  /// <summary>
  /// Th010f01Request_M1old_jisya_hbn の概要の説明です。
  /// </summary>
  public sealed class Th010f01Request_M1old_jisya_hbn : Th010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th010f01Request_M1old_jisya_hbn Me = new Th010f01Request_M1old_jisya_hbn();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th010f01Request_M1old_jisya_hbn()
		{
