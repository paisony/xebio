...
{
  /// <summary>
  /// Th010f01Request_Btncsv の概要の説明です。
  /// </summary>
  public sealed class Th010f01Request_Btncsv : Th010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th010f01Request_Btncsv Me = new Th010f01Request_Btncsv();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th010f01Request_Btncsv()
		{
