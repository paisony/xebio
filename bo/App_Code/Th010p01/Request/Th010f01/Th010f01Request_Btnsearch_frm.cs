...
{
  /// <summary>
  /// Th010f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Th010f01Request_Btnsearch : Th010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th010f01Request_Btnsearch Me = new Th010f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th010f01Request_Btnsearch()
		{
