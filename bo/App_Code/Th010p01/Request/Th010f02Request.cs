...
{
  /// <summary>
  /// Th010f02Request の概要の説明です。
  /// </summary>
  public abstract class Th010f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Th010f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Th010f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Th010f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Th010f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Th010f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Th010f02RequestHelper.ValidateM1InputValue(formVO, checker);
