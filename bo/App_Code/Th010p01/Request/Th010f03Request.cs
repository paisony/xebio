...
{
  /// <summary>
  /// Th010f03Request の概要の説明です。
  /// </summary>
  public abstract class Th010f03Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Th010f03RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Th010f03RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Th010f03RequestHelper.Unformat(pageContext);
		}
		...
		{
			Th010f03RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Th010f03RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Th010f03RequestHelper.ValidateM1InputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Th010f03RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
			
			//明細部コード存在チェック
			Th010f03RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
