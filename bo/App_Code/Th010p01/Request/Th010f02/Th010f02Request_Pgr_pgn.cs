...
namespace com.xebio.bo.Th010p01.Request.Th010f02
{
  /// <summary>
  /// Th010f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Th010f02Request_Pgr : Th010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th010f02Request_Pgr Me = new Th010f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th010f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Th010f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
