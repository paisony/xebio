...
{
  /// <summary>
  /// Th010f02Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Th010f02Request_Btnsearch : Th010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th010f02Request_Btnsearch Me = new Th010f02Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th010f02Request_Btnsearch()
		{
