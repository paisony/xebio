...
{
  /// <summary>
  /// Th010f02Request_M1old_jisya_hbn の概要の説明です。
  /// </summary>
  public sealed class Th010f02Request_M1old_jisya_hbn : Th010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Th010f02Request_M1old_jisya_hbn Me = new Th010f02Request_M1old_jisya_hbn();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Th010f02Request_M1old_jisya_hbn()
		{
