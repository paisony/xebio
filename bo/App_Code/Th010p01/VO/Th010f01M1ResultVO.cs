...
{
  /// <summary>
  /// Th010f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Th010f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Th010f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Th010f01M1ResultVO compare = null;
			if (obj is Th010f01M1ResultVO)
			{
				compare = (Th010f01M1ResultVO)obj;
			}
			else
			{
				return false;
