...
{
  /// <summary>
  /// Th010f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Th010f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Th010f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Th010f02M1ResultVO compare = null;
			if (obj is Th010f02M1ResultVO)
			{
				compare = (Th010f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Th010p01.Formvo.Th010f02M1Formのハッシュ コード。</returns>
