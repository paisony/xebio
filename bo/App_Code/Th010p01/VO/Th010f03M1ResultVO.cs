...
{
  /// <summary>
  /// Th010f03 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Th010f03M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Th010f03M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Th010f03M1ResultVO compare = null;
			if (obj is Th010f03M1ResultVO)
			{
				compare = (Th010f03M1ResultVO)obj;
			}
			else
			{
				return false;
