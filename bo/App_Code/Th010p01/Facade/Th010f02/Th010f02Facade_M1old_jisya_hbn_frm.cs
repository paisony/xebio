			...
			try
			{
				...
				if (prevVo.Syohinmst_serchstk.Equals(ConditionSyohinmst_serchstk2.VALUE_SYOHINMST_SERCHSTK13))
				{
					...
					if (prevM1Vo.Dictionary[Th010p01Constant.DIC_M1TENKAI_KB].ToString().Equals("2"))
					{
						...
						bindVO.Value = BoSystemFormat.formatJisyaHbn((string)prevM1Vo.Dictionary[Th010p01Constant.DIC_M1OLD_XEBIO_CD]);
					...
					if (prevVo.Syohinmst_serchstk.Equals(ConditionSyohinmst_serchstk2.VALUE_SYOHINMST_SERCHSTK13))
					{
						...
						nextVo.Dictionary[Th010p01Constant.DIC_M1ID] = Th010p01Constant.M1OLD_JISYA_HBN;
