...
{
  /// <summary>
  /// Th010f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Th010f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Th010f02M1BaseForm compare = null;
			if (obj is Th010f02M1BaseForm)
			{
				compare = (Th010f02M1BaseForm)obj;
			}
			else
			{
				return false;
