...
{
  /// <summary>
  /// Th010f03 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Th010f03M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Th010f03M1BaseForm compare = null;
			if (obj is Th010f03M1BaseForm)
			{
				compare = (Th010f03M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Th010p01.Formvo.Th010f03M1Formのハッシュ コード。</returns>
