using com.xebio.bo.Th010p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Th010f02のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Th010f02Form : Th010f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Th010p01","Th010f02");
