...
namespace com.xebio.bo.Th010p01.Codeex
{
  /// <summary>
  /// フォーム：Th010f01 項目：Btnhinsyu_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Th010f01Codeex_Btnhinsyu_cd : StandardBaseCodeex
	{
		public Th010f01Codeex_Btnhinsyu_cd()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// 項目追加
			context.Condition.AddExtItemID("Bumon_cd");
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			String sBumonCd = exeValues.InputValues["Bumon_cd"] as string;

			if (!string.IsNullOrEmpty(sBumonCd))
			{
				// 検索条件の設定
				context.Condition.AddFindKey("Bumon_cd", "BUMON_CD", SearchItemType.Equal);
			}
