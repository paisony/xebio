...
namespace com.xebio.bo.Tk040p01.Codeex
{
  /// <summary>
  /// フォーム：Tk040f01 項目：Btnbumon_cd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tk040f01Codeex_Btnbumon_cd_from : StandardBaseCodeex
	{
		public Tk040f01Codeex_Btnbumon_cd_from()
		{
		}
