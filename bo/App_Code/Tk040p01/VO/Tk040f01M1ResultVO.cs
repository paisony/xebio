...
{
  /// <summary>
  /// Tk040f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tk040f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tk040f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tk040f01M1ResultVO compare = null;
			if (obj is Tk040f01M1ResultVO)
			{
				compare = (Tk040f01M1ResultVO)obj;
			}
			else
			{
				return false;
