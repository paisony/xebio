...
{
  /// <summary>
  /// Tk040f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tk040f01Request_Btnsearch : Tk040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk040f01Request_Btnsearch Me = new Tk040f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk040f01Request_Btnsearch()
		{
