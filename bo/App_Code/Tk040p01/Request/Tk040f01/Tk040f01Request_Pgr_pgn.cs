...
namespace com.xebio.bo.Tk040p01.Request.Tk040f01
{
  /// <summary>
  /// Tk040f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tk040f01Request_Pgr : Tk040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk040f01Request_Pgr Me = new Tk040f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk040f01Request_Pgr()
		{
...
//
		...
		public override void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//明細部の入力項目
			Tk040f01RequestHelper.ValidateM1InputValue(formVO, checker);
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tk040f01RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
