...
{
  /// <summary>
  /// Tk040f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tk040f01Request_Btnprint : Tk040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk040f01Request_Btnprint Me = new Tk040f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk040f01Request_Btnprint()
		{
