...
namespace com.xebio.bo.Tk040p01.Formvo.Baseform
{
  /// <summary>
  /// Tk040f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tk040f01M1BaseForm : StandardBaseM1Form
	{
		...
		/// <summary>
		/// 項目「M1TANAOROSI_SU(数量)」の値
		/// </summary>
		private string _m1tanaorosi_su;
		...
		/// <summary>
		/// 項目「M1SCAN_CD(ｽｷｬﾝｺｰﾄﾞ)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1TANAOROSI_SU(数量)」の値を取得または設定する。
		/// </summary>
		public virtual string M1tanaorosi_su
		{
			get
			{
				return this._m1tanaorosi_su;
			}
			set
			{
				this._m1tanaorosi_su = value;
			}
		}
		...
		{
			Tk040f01M1BaseForm compare = null;
			if (obj is Tk040f01M1BaseForm)
			{
				compare = (Tk040f01M1BaseForm)obj;
			}
			else
			{
				return false;
			...
			if (_m1tanaorosi_su != compare.M1tanaorosi_su)
			{
				return false;
			}
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tk040p01.Formvo.Tk040f01M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1tanaorosi_su:").Append(this._m1tanaorosi_su).AppendLine();
