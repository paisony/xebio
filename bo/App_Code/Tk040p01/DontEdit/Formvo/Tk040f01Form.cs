using com.xebio.bo.Tk040p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tk040f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tk040f01Form : Tk040f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tk040p01","Tk040f01");
