namespace com.xebio.bo.Tj050p01.Request.Tj050f01
{
  /// <summary>
  /// Tj050f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj050f01Request_Btnprint : Tj050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj050f01Request_Btnprint Me = new Tj050f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj050f01Request_Btnprint()
		{
