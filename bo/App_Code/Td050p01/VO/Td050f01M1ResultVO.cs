...
{
  /// <summary>
  /// Td050f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Td050f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Td050f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Td050f01M1ResultVO compare = null;
			if (obj is Td050f01M1ResultVO)
			{
				compare = (Td050f01M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Td050p01.Formvo.Td050f01M1Formのハッシュ コード。</returns>
