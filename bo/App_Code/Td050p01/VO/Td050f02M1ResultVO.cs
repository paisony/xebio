...
{
  /// <summary>
  /// Td050f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Td050f02M1ResultVO : StandardBaseVO
	{
		...
		/// <summary>
		/// 項目「M1YOTEI_SU(予定数)」の値
		/// </summary>
		private string _m1yotei_su;

		/// <summary>
		/// 項目「M1KAKUTEI_SU(確定数)」の値
		/// </summary>
		...
		/// <summary>
		/// 項目「M1TEISEI_SURYO_HDN()」の値
		/// </summary>
		private string _m1teisei_suryo_hdn;
		...
		/// <summary>
		/// 項目「M1YOTEI_SU(予定数)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1KAKUTEI_SU(確定数)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1TEISEI_SURYO_HDN()」の値を取得または設定する。
		/// </summary>
		public virtual string M1teisei_suryo_hdn
		{
			get
			{
				return this._m1teisei_suryo_hdn;
			}
			set
			{
				this._m1teisei_suryo_hdn = value;
			}
		}
		...
		/// インスタンスを生成します。
		/// </summary>
		public Td050f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Td050f02M1ResultVO compare = null;
			if (obj is Td050f02M1ResultVO)
			{
				compare = (Td050f02M1ResultVO)obj;
			}
			else
			{
				return false;
			...
			if (_m1teisei_suryo_hdn != compare.M1teisei_suryo_hdn)
			{
				return false;
			}
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Td050p01.Formvo.Td050f02M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1teisei_suryo_hdn:").Append(this._m1teisei_suryo_hdn).AppendLine();
