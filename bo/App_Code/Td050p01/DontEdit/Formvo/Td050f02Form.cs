using com.xebio.bo.Td050p01.Formvo.Baseform;
...
namespace com.xebio.bo.Td050p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Td050f02Form : Td050f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Td050p01","Td050f02");
