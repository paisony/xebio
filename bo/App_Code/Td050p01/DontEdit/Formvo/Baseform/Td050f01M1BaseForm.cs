...
{
  /// <summary>
  /// Td050f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td050f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Td050f01M1BaseForm compare = null;
			if (obj is Td050f01M1BaseForm)
			{
				compare = (Td050f01M1BaseForm)obj;
			}
			else
			{
				return false;
