...
{
  /// <summary>
  /// Td050f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td050f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Td050f02M1BaseForm compare = null;
			if (obj is Td050f02M1BaseForm)
			{
				compare = (Td050f02M1BaseForm)obj;
			}
			else
			{
				return false;
