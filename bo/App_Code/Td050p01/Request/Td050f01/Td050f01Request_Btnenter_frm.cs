...
{
  /// <summary>
  /// Td050f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Td050f01Request_Btnenter : Td050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td050f01Request_Btnenter Me = new Td050f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td050f01Request_Btnenter()
		{
