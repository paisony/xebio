...
{
  /// <summary>
  /// Td050f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Td050f01Request_Pgr : Td050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td050f01Request_Pgr Me = new Td050f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td050f01Request_Pgr()
		{
