...
namespace com.xebio.bo.Td050p01.Request.Td050f01
{
  /// <summary>
  /// Td050f01Request_M1motodenpyo_bango の概要の説明です。
  /// </summary>
  public sealed class Td050f01Request_M1motodenpyo_bango : Td050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td050f01Request_M1motodenpyo_bango Me = new Td050f01Request_M1motodenpyo_bango();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td050f01Request_M1motodenpyo_bango()
		{
