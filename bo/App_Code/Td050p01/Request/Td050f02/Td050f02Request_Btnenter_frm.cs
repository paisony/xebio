...
{
  /// <summary>
  /// Td050f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Td050f02Request_Btnenter : Td050f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td050f02Request_Btnenter Me = new Td050f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td050f02Request_Btnenter()
		{
