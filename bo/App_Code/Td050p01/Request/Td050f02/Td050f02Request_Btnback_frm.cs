...
namespace com.xebio.bo.Td050p01.Request.Td050f02
{
  /// <summary>
  /// Td050f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Td050f02Request_Btnback : Td050f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td050f02Request_Btnback Me = new Td050f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td050f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Td050f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
