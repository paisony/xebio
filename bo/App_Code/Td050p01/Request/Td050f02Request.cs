...
{
  /// <summary>
  /// Td050f02Request の概要の説明です。
  /// </summary>
  public abstract class Td050f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Td050f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Td050f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Td050f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Td050f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Td050f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Td050f02RequestHelper.ValidateM1InputValue(formVO, checker);
