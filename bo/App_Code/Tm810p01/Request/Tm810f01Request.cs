...
{
  /// <summary>
  /// Tm810f01Request の概要の説明です。
  /// </summary>
  public abstract class Tm810f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tm810f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tm810f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tm810f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tm810f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//明細部の入力項目
			Tm810f01RequestHelper.ValidateM1InputValue(formVO, checker);
