using com.xebio.bo.Tm810p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tm810f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tm810f01Form : Tm810f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tm810p01","Tm810f01");
