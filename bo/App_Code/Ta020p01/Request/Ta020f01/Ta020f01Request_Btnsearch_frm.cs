...
{
  /// <summary>
  /// Ta020f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Ta020f01Request_Btnsearch : Ta020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f01Request_Btnsearch Me = new Ta020f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f01Request_Btnsearch()
		{
