...
{
  /// <summary>
  /// Ta020f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Ta020f01Request_Btnzenkjo : Ta020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f01Request_Btnzenkjo Me = new Ta020f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f01Request_Btnzenkjo()
		{
