...
{
  /// <summary>
  /// Ta020f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Ta020f01Request_Btnenter : Ta020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f01Request_Btnenter Me = new Ta020f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f01Request_Btnenter()
		{
