...
{
  /// <summary>
  /// Ta020f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta020f01Request_Pgr : Ta020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f01Request_Pgr Me = new Ta020f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f01Request_Pgr()
		{
