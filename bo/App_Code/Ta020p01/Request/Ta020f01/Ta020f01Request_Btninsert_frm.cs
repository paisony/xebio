...
{
  /// <summary>
  /// Ta020f01Request_Btninsert の概要の説明です。
  /// </summary>
  public sealed class Ta020f01Request_Btninsert : Ta020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f01Request_Btninsert Me = new Ta020f01Request_Btninsert();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f01Request_Btninsert()
		{
