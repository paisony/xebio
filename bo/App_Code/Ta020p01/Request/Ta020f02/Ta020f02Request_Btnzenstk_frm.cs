...
{
  /// <summary>
  /// Ta020f02Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Ta020f02Request_Btnzenstk : Ta020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f02Request_Btnzenstk Me = new Ta020f02Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f02Request_Btnzenstk()
		{
