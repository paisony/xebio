...
{
  /// <summary>
  /// Ta020f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Ta020f02Request_Btnenter : Ta020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f02Request_Btnenter Me = new Ta020f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f02Request_Btnenter()
		{
