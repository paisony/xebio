...
{
  /// <summary>
  /// Ta020f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Ta020f02Request_Btnback : Ta020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f02Request_Btnback Me = new Ta020f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f02Request_Btnback()
		{
