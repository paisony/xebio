...
namespace com.xebio.bo.Ta020p01.Request.Ta020f02
{
  /// <summary>
  /// Ta020f02Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Ta020f02Request_Btnpageins : Ta020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta020f02Request_Btnpageins Me = new Ta020f02Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta020f02Request_Btnpageins()
		{
