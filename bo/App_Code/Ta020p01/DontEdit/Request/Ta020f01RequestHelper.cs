...
{
  /// <summary>
  /// Ta020f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Ta020f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Ta020f01Form formVO = (Ta020f01Form)pageContext.GetFormVO();
			...
			paramCol["Irai_ymd_from"].RequestValue = RequestParameterUtil.GetRequestValue(
				page, formInfo["Irai_ymd_from"]);
			paramCol["Irai_ymd_to"].RequestValue = RequestParameterUtil.GetRequestValue(
				page, formInfo["Irai_ymd_to"]);
		...
		public static void Unformat(IPageContext pageContext)
		{
			...
			paramCol["Irai_ymd_from"].UnformatValue = RequestParameterUtil.GetUnformatValue(
				paramCol["Irai_ymd_from"].RequestValue, formInfo["Irai_ymd_from"]);
			paramCol["Irai_ymd_from"].DateFullValue = RequestParameterUtil.GetDateFullValue(
				paramCol["Irai_ymd_from"].RequestValue, formInfo["Irai_ymd_from"]);
			paramCol["Irai_ymd_to"].UnformatValue = RequestParameterUtil.GetUnformatValue(
				paramCol["Irai_ymd_to"].RequestValue, formInfo["Irai_ymd_to"]);
			paramCol["Irai_ymd_to"].DateFullValue = RequestParameterUtil.GetDateFullValue(
				paramCol["Irai_ymd_to"].RequestValue, formInfo["Irai_ymd_to"]);
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			if (paramCol["Irai_ymd_from"].DateFullValue != null)
			{
				formVO.Irai_ymd_from = paramCol["Irai_ymd_from"].DateFullValue;
			}
			if (paramCol["Irai_ymd_to"].DateFullValue != null)
			{
				formVO.Irai_ymd_to = paramCol["Irai_ymd_to"].DateFullValue;
			}
			...
			{
				Ta020f01M1Form ta020f01M1Form = (Ta020f01M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1hattyu_ymd"][i].DateFullValue != null)
				{
					ta020f01M1Form.M1hattyu_ymd = paramCol["M1hattyu_ymd"][i].DateFullValue;
				}
				if (paramCol["M1itemsu"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1itemsu = paramCol["M1itemsu"][i].UnformatValue;
				}
				if (paramCol["M1genkakin"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1genkakin = paramCol["M1genkakin"][i].UnformatValue;
				}
				if (paramCol["M1hanbaiin_nm"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1hanbaiin_nm = paramCol["M1hanbaiin_nm"][i].UnformatValue;
				}
				if (paramCol["M1irai_riyu"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1irai_riyu = paramCol["M1irai_riyu"][i].UnformatValue;
				}
				if (paramCol["M1sinsei_jotainm"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1sinsei_jotainm = paramCol["M1sinsei_jotainm"][i].UnformatValue;
				}
				if (paramCol["M1apply_ymd"][i].DateFullValue != null)
				{
					ta020f01M1Form.M1apply_ymd = paramCol["M1apply_ymd"][i].DateFullValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					ta020f01M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Ta020f01Form formVO, StandardCheckManager checker)
		{
			...
			if (formVO.Irai_ymd_from != null)
			{
				checker.DoCheck("Irai_ymd_from", formVO.Irai_ymd_from);
			}
			if (formVO.Irai_ymd_to != null)
			{
				checker.DoCheck("Irai_ymd_to", formVO.Irai_ymd_to);
			}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Ta020f01Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Ta020f01M1Form ta020f01M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, ta020f01M1Form, i, m1List);
				if (ta020f01M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", ta020f01M1Form.M1rowno, i, m1List);
				}
				if (ta020f01M1Form.M1hattyu_ymd != null)
				{
					checker.DoCheck("M1hattyu_ymd", ta020f01M1Form.M1hattyu_ymd, i, m1List);
				}
				if (ta020f01M1Form.M1itemsu != null)
				{
					checker.DoCheck("M1itemsu", ta020f01M1Form.M1itemsu, i, m1List);
				}
				if (ta020f01M1Form.M1genkakin != null)
				{
					checker.DoCheck("M1genkakin", ta020f01M1Form.M1genkakin, i, m1List);
				}
				if (ta020f01M1Form.M1hanbaiin_nm != null)
				{
					checker.DoCheck("M1hanbaiin_nm", ta020f01M1Form.M1hanbaiin_nm, i, m1List);
				}
				if (ta020f01M1Form.M1irai_riyu != null)
				{
					checker.DoCheck("M1irai_riyu", ta020f01M1Form.M1irai_riyu, i, m1List);
				}
				if (ta020f01M1Form.M1sinsei_jotainm != null)
				{
					checker.DoCheck("M1sinsei_jotainm", ta020f01M1Form.M1sinsei_jotainm, i, m1List);
				}
				if (ta020f01M1Form.M1apply_ymd != null)
				{
					checker.DoCheck("M1apply_ymd", ta020f01M1Form.M1apply_ymd, i, m1List);
				}
				if (ta020f01M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", ta020f01M1Form.M1selectorcheckbox, i, m1List);
				}
				if (ta020f01M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", ta020f01M1Form.M1entersyoriflg, i, m1List);
				}
				if (ta020f01M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", ta020f01M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Ta020f01Form formVO, StandardCodeCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Ta020f01Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
