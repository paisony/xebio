...
{
  /// <summary>
  /// Ta020f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta020f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta020f01M1BaseForm compare = null;
			if (obj is Ta020f01M1BaseForm)
			{
				compare = (Ta020f01M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Ta020p01.Formvo.Ta020f01M1Formのハッシュ コード。</returns>
