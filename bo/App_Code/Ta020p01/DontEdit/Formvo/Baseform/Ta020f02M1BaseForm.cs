...
namespace com.xebio.bo.Ta020p01.Formvo.Baseform
{
  /// <summary>
  /// Ta020f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta020f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta020f02M1BaseForm compare = null;
			if (obj is Ta020f02M1BaseForm)
			{
				compare = (Ta020f02M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Ta020p01.Formvo.Ta020f02M1Formのハッシュ コード。</returns>
