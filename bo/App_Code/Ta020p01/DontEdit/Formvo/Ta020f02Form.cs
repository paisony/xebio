using com.xebio.bo.Ta020p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Ta020f02のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta020f02Form : Ta020f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Ta020p01","Ta020f02");
