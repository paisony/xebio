...
{
  /// <summary>
  /// フォーム：Ta020f02 項目：Irairiyu_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta020f02Codeex_Irairiyu_cd : StandardBaseCodeex
	{
		public Ta020f02Codeex_Irairiyu_cd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			//検索条件追加
			context.Condition.AddFindKey("GYOMU_KB = '" + Ta020p01Constant.RIYU_GYOMU_SYUTUKA + "'");
