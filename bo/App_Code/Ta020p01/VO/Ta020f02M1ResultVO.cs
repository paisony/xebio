...
{
  /// <summary>
  /// Ta020f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ta020f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta020f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta020f02M1ResultVO compare = null;
			if (obj is Ta020f02M1ResultVO)
			{
				compare = (Ta020f02M1ResultVO)obj;
			}
			else
			{
				return false;
