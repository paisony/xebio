using com.xebio.bo.Tl020p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tl020f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tl020f01Form : Tl020f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tl020p01","Tl020f01");
