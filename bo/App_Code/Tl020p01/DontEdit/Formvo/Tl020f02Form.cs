...
{
  /// <summary>
  /// Tl020f02のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tl020f02Form : Tl020f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tl020p01","Tl020f02");
