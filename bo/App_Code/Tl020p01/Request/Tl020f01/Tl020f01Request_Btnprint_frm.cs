...
{
  /// <summary>
  /// Tl020f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tl020f01Request_Btnprint : Tl020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl020f01Request_Btnprint Me = new Tl020f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl020f01Request_Btnprint()
		{
