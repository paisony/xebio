...
{
  /// <summary>
  /// Tl020f01Request_M1bumon_cd の概要の説明です。
  /// </summary>
  public sealed class Tl020f01Request_M1bumon_cd : Tl020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl020f01Request_M1bumon_cd Me = new Tl020f01Request_M1bumon_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl020f01Request_M1bumon_cd()
		{
