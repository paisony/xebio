...
{
  /// <summary>
  /// Tl020f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tl020f01Request_Btnsearch : Tl020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl020f01Request_Btnsearch Me = new Tl020f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl020f01Request_Btnsearch()
		{
