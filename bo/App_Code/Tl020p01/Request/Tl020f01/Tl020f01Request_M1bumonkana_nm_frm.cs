...
{
  /// <summary>
  /// Tl020f01Request_M1bumonkana_nm の概要の説明です。
  /// </summary>
  public sealed class Tl020f01Request_M1bumonkana_nm : Tl020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl020f01Request_M1bumonkana_nm Me = new Tl020f01Request_M1bumonkana_nm();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl020f01Request_M1bumonkana_nm()
		{
