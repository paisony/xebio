...
{
  /// <summary>
  /// Tl020f01Request_Btnseal の概要の説明です。
  /// </summary>
  public sealed class Tl020f01Request_Btnseal : Tl020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl020f01Request_Btnseal Me = new Tl020f01Request_Btnseal();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl020f01Request_Btnseal()
		{
