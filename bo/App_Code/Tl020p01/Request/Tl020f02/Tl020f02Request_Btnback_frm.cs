...
namespace com.xebio.bo.Tl020p01.Request.Tl020f02
{
  /// <summary>
  /// Tl020f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tl020f02Request_Btnback : Tl020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tl020f02Request_Btnback Me = new Tl020f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tl020f02Request_Btnback()
		{
