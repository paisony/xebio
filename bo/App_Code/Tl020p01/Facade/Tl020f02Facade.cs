  ...
  public partial class Tl020f02Facade : StandardBaseFacade
	{
		...
		/// プログラムID。
		/// </summary>
		private const string PGID = "Tl020p01";
		/// <summary>
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tl020f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tl020f02Facade()
			: base()
		{
		}
		#endregion

		#region Tl020f02画面データを作成する。
		/// <summary>
		/// Tl020f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				//カード部を取得します。
				Tl020f02Form tl020f02Form = (Tl020f02Form)facadeContext.FormVO;

				//モデル層処理ロジックを記述してください。
				//カード部 データを取得(要実装)........

				// ラベル情報を設定
				BoSystemLabelUtil.SetLabelInfo<Tl020f02Form>(tl020f02Form, facadeContext);
