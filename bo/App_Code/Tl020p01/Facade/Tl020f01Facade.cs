  ...
  public partial class Tl020f01Facade : StandardBaseFacade
	{
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tl020f01";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tl020f01Facade()
			: base()
		{
		}
		#endregion

		#region Tl020f01画面データを作成する。
		/// <summary>
		/// Tl020f01画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			try
			{
				...
				// ラベル情報を設定
				BoSystemLabelUtil.SetLabelInfo<Tl020f01Form>(tl020f01Form, facadeContext);
