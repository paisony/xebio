  ...
  public partial class Tl020f01Facade : StandardBaseFacade
	{
		...
		/// <returns></returns>
		private void ReplaceWhereSeal(Tl020f01Form formVO, FindSqlResultTable reader)
		{
			...
			int iCnt = 1;
			sRepSqlKakutei.Append(" AND (MDCT0030.TENPO_CD,MDCT0030.BAIHENKAISI_YMD, MDCT0030.BAIHEN_NO, MDCT0030.BUMON_CD) IN (");
			sRepSqlKakuteiMax.Append(" AND (MDCT0030_MAX.TENPO_CD,MDCT0030_MAX.BAIHENKAISI_YMD, MDCT0030_MAX.BAIHEN_NO, MDCT0030_MAX.BUMON_CD) IN (");
			...
			int iCnt2 = 1;
			sRepSqlSiji.Append(" AND (MDCT0010.TENPO_CD,MDCT0010.BAIHENKAISI_YMD, MDCT0010.BAIHEN_NO, MDCT0010.BUMON_CD, MDCT0010.BAIHENSAGYOKAISI_YMD, MDCT0010.BAIHEN_RIYTU) IN (");
			sRepSqlSijiMax.Append(" AND (MDCT0010_MAX.TENPO_CD,MDCT0010_MAX.BAIHENKAISI_YMD, MDCT0010_MAX.BAIHEN_NO, MDCT0010_MAX.BUMON_CD, MDCT0010_MAX.BAIHENSAGYOKAISI_YMD, MDCT0010_MAX.BAIHEN_RIYTU) IN (");
				...
				if (BoSystemConstant.CHECKBOX_ON.Equals(m1formVO.M1selectorcheckbox))
				{
					...
					switch (m1formVO.Dictionary[Tl020p01Constant.DIC_M1SINSEIMOTO_KBN].ToString())
					{
						case ConditionSinseimoto.VALUE_SINSEIMOTO2:		// 店舗
							...
							// 検索条件1 確定
							sRepSqlKakutei.Append(" ( ");
							sRepSqlKakutei.Append(" :BIND1_TENPO_CD").Append(iCnt.ToString("000"));
							...
							// 検索条件2 確定 最大売変No
							sRepSqlKakuteiMax.Append(" ( ");
							sRepSqlKakuteiMax.Append(" :BIND2_TENPO_CD").Append(iCnt.ToString("000"));
						...
						case ConditionSinseimoto.VALUE_SINSEIMOTO1:		// 本部
							...
							// 検索条件3 指示
							sRepSqlSiji.Append(" ( ");
							sRepSqlSiji.Append(" :BIND3_TENPO_CD").Append(iCnt2.ToString("000"));
							...
							// 検索条件4 指示 最大売変No
							sRepSqlSijiMax.Append(" ( ");
							sRepSqlSijiMax.Append(" :BIND4_TENPO_CD").Append(iCnt2.ToString("000"));
