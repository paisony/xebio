...
{
  /// <summary>
  /// Tl020f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tl020f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tl020f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tl020f02M1ResultVO compare = null;
			if (obj is Tl020f02M1ResultVO)
			{
				compare = (Tl020f02M1ResultVO)obj;
			}
			else
			{
				return false;
