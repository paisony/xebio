...
{
  /// <summary>
  /// Tj090f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj090f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj090f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj090f01M1ResultVO compare = null;
			if (obj is Tj090f01M1ResultVO)
			{
				compare = (Tj090f01M1ResultVO)obj;
			}
			else
			{
				return false;
