...
{
  /// <summary>
  /// Tj090f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj090f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj090f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj090f02M1ResultVO compare = null;
			if (obj is Tj090f02M1ResultVO)
			{
				compare = (Tj090f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tj090p01.Formvo.Tj090f02M1Formのハッシュ コード。</returns>
