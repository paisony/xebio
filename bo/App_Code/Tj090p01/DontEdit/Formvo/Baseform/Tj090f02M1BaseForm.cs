...
{
  /// <summary>
  /// Tj090f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj090f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj090f02M1BaseForm compare = null;
			if (obj is Tj090f02M1BaseForm)
			{
				compare = (Tj090f02M1BaseForm)obj;
			}
			else
			{
				return false;
