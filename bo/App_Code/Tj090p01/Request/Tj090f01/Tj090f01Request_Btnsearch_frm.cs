namespace com.xebio.bo.Tj090p01.Request.Tj090f01
{
  /// <summary>
  /// Tj090f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tj090f01Request_Btnsearch : Tj090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f01Request_Btnsearch Me = new Tj090f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f01Request_Btnsearch()
		{
