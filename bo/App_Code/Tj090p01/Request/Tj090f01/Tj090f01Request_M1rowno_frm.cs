...
{
  /// <summary>
  /// Tj090f01Request_M1rowno の概要の説明です。
  /// </summary>
  public sealed class Tj090f01Request_M1rowno : Tj090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f01Request_M1rowno Me = new Tj090f01Request_M1rowno();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f01Request_M1rowno()
		{
