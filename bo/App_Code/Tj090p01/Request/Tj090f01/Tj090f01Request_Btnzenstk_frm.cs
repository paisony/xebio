...
{
  /// <summary>
  /// Tj090f01Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tj090f01Request_Btnzenstk : Tj090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f01Request_Btnzenstk Me = new Tj090f01Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f01Request_Btnzenstk()
		{
