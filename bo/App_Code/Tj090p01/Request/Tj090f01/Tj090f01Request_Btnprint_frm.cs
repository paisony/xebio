...
{
  /// <summary>
  /// Tj090f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj090f01Request_Btnprint : Tj090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f01Request_Btnprint Me = new Tj090f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f01Request_Btnprint()
		{
