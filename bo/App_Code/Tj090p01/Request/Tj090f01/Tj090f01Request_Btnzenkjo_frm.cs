...
{
  /// <summary>
  /// Tj090f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tj090f01Request_Btnzenkjo : Tj090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f01Request_Btnzenkjo Me = new Tj090f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f01Request_Btnzenkjo()
		{
