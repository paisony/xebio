...
{
  /// <summary>
  /// Tj090f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj090f01Request_Pgr : Tj090f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f01Request_Pgr Me = new Tj090f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f01Request_Pgr()
		{
