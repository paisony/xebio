...
{
  /// <summary>
  /// Tj090f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tj090f02Request_Btnenter : Tj090f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f02Request_Btnenter Me = new Tj090f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f02Request_Btnenter()
		{
