...
namespace com.xebio.bo.Tj090p01.Request.Tj090f02
{
  /// <summary>
  /// Tj090f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj090f02Request_Pgr : Tj090f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f02Request_Pgr Me = new Tj090f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tj090f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
