...
{
  /// <summary>
  /// Tj090f02Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj090f02Request_Btnprint : Tj090f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj090f02Request_Btnprint Me = new Tj090f02Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj090f02Request_Btnprint()
		{
