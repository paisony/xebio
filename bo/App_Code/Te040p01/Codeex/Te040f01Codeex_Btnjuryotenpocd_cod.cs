...
namespace com.xebio.bo.Te040p01.Codeex
{
  /// <summary>
  /// フォーム：Te040f01 項目：Btnjuryotenpocd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Te040f01Codeex_Btnjuryotenpocd : StandardBaseCodeex
	{
		public Te040f01Codeex_Btnjuryotenpocd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			//検索条件追加
			Decimal dKaisya = Convert.ToDecimal(BoSystemString.Nvl(context.ExeValue.InputValues["Kaisya_cd"].ToString(), "0"));
