using com.xebio.bo.Te040p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Te040f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te040f01Form : Te040f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Te040p01","Te040f01");
