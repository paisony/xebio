...
namespace com.xebio.bo.Te040p01.Formvo.Baseform
{
  /// <summary>
  /// Te040f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te040f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Te040f01M1BaseForm compare = null;
			if (obj is Te040f01M1BaseForm)
			{
				compare = (Te040f01M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Te040p01.Formvo.Te040f01M1Formのハッシュ コード。</returns>
