...
{
  /// <summary>
  /// Te040f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te040f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te040f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te040f01M1ResultVO compare = null;
			if (obj is Te040f01M1ResultVO)
			{
				compare = (Te040f01M1ResultVO)obj;
			}
			else
			{
				return false;
