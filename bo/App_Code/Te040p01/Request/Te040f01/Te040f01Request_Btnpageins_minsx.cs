...
namespace com.xebio.bo.Te040p01.Request.Te040f01
{
  /// <summary>
  /// Te040f01Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Te040f01Request_Btnpageins : Te040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te040f01Request_Btnpageins Me = new Te040f01Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te040f01Request_Btnpageins()
		{
