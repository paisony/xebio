...
{
  /// <summary>
  /// Te040f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Te040f01Request_Btnenter : Te040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te040f01Request_Btnenter Me = new Te040f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te040f01Request_Btnenter()
		{
