...
{
  /// <summary>
  /// Te040f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Te040f01Request_Btnrowdel : Te040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te040f01Request_Btnrowdel Me = new Te040f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te040f01Request_Btnrowdel()
		{
