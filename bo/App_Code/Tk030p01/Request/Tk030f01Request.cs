...
{
  /// <summary>
  /// Tk030f01Request の概要の説明です。
  /// </summary>
  public abstract class Tk030f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tk030f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tk030f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tk030f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tk030f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tk030f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tk030f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
