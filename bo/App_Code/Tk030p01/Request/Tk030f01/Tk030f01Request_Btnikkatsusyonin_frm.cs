...
{
  /// <summary>
  /// Tk030f01Request_Btnikkatsusyonin の概要の説明です。
  /// </summary>
  public sealed class Tk030f01Request_Btnikkatsusyonin : Tk030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk030f01Request_Btnikkatsusyonin Me = new Tk030f01Request_Btnikkatsusyonin();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk030f01Request_Btnikkatsusyonin()
		{
