...
{
  /// <summary>
  /// Tk030f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tk030f01Request_Pgr : Tk030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk030f01Request_Pgr Me = new Tk030f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk030f01Request_Pgr()
		{
