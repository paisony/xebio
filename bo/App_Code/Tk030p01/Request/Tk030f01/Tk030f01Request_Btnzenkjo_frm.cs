...
{
  /// <summary>
  /// Tk030f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tk030f01Request_Btnzenkjo : Tk030f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk030f01Request_Btnzenkjo Me = new Tk030f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk030f01Request_Btnzenkjo()
		{
