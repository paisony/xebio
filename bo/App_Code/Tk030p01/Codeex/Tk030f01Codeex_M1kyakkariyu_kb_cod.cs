...
namespace com.xebio.bo.Tk030p01.Codeex
{
  /// <summary>
  /// フォーム：Tk030f01 項目：M1kyakkariyu_kb の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tk030f01Codeex_M1kyakkariyu_kb : StandardBaseCodeex
	{
		public Tk030f01Codeex_M1kyakkariyu_kb()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// 項目追加
			context.Condition.AddFindKey("SIKIBETSU_CD = '" + Tk030p01Constant.MEISHO_SIKIBETSU_CD_KYAKKARIYU + "'");
