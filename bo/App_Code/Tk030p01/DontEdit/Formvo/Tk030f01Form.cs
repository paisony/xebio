using com.xebio.bo.Tk030p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tk030p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tk030f01Form : Tk030f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tk030p01","Tk030f01");
