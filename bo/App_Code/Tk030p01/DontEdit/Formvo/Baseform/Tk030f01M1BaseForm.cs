...
{
  /// <summary>
  /// Tk030f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tk030f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tk030f01M1BaseForm compare = null;
			if (obj is Tk030f01M1BaseForm)
			{
				compare = (Tk030f01M1BaseForm)obj;
			}
			else
			{
				return false;
