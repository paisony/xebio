...
namespace com.xebio.bo.Tk030p01.VO
{
  /// <summary>
  /// Tk030f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tk030f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tk030f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tk030f01M1ResultVO compare = null;
			if (obj is Tk030f01M1ResultVO)
			{
				compare = (Tk030f01M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tk030p01.Formvo.Tk030f01M1Formのハッシュ コード。</returns>
