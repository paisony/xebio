...
{
  /// <summary>
  /// Tg050f01Request の概要の説明です。
  /// </summary>
  public abstract class Tg050f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tg050f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tg050f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tg050f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tg050f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tg050f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tg050f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
