...
{
  /// <summary>
  /// Ta080f01Request の概要の説明です。
  /// </summary>
  public abstract class Ta080f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Ta080f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Ta080f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Ta080f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Ta080f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Ta080f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Ta080f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
