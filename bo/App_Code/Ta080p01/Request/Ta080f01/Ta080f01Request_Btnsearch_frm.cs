...
{
  /// <summary>
  /// Ta080f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Ta080f01Request_Btnsearch : Ta080f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta080f01Request_Btnsearch Me = new Ta080f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta080f01Request_Btnsearch()
		{
