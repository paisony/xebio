...
{
  /// <summary>
  /// Ta080f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Ta080f01Request_Btnzenkjo : Ta080f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta080f01Request_Btnzenkjo Me = new Ta080f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta080f01Request_Btnzenkjo()
		{
