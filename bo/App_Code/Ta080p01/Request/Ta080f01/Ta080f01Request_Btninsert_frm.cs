...
{
  /// <summary>
  /// Ta080f01Request_Btninsert の概要の説明です。
  /// </summary>
  public sealed class Ta080f01Request_Btninsert : Ta080f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta080f01Request_Btninsert Me = new Ta080f01Request_Btninsert();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta080f01Request_Btninsert()
		{
