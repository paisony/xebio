...
{
  /// <summary>
  /// Ta080f01Request_M1yosan_cd の概要の説明です。
  /// </summary>
  public sealed class Ta080f01Request_M1yosan_cd : Ta080f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta080f01Request_M1yosan_cd Me = new Ta080f01Request_M1yosan_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta080f01Request_M1yosan_cd()
		{
