...
{
	/// <summary>
	/// Ta080f03Request_Btnsearch の概要の説明です。
	/// </summary>
	public sealed class Ta080f03Request_Btnsearch : Ta080f03Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta080f03Request_Btnsearch Me = new Ta080f03Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta080f03Request_Btnsearch()
		{
