...
{
	/// <summary>
	/// Ta080f03Request_Btnenter の概要の説明です。
	/// </summary>
	public sealed class Ta080f03Request_Btnenter : Ta080f03Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta080f03Request_Btnenter Me = new Ta080f03Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta080f03Request_Btnenter()
		{
