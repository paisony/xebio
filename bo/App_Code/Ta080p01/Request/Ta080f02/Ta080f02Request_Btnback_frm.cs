...
namespace com.xebio.bo.Ta080p01.Request.Ta080f02
{
  /// <summary>
  /// Ta080f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Ta080f02Request_Btnback : Ta080f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta080f02Request_Btnback Me = new Ta080f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta080f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Ta080f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
