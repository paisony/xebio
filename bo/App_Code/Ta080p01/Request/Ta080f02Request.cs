...
{
  /// <summary>
  /// Ta080f02Request の概要の説明です。
  /// </summary>
  public abstract class Ta080f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Ta080f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Ta080f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Ta080f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Ta080f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Ta080f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Ta080f02RequestHelper.ValidateM1InputValue(formVO, checker);
