...
{
  /// <summary>
  /// フォーム：Ta080f03 項目：Sortkb1 の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta080f03Codeex_Sortkb1 : StandardBaseCodeex
	{
		public Ta080f03Codeex_Sortkb1()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// を設定してください。
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			context.Condition.AddFindKey(" SIKIBETSU_CD = 'HTNJ'");
			context.Condition.ClearSortKey();
			context.Condition.AddSortKey(new SortKey("TO_NUMBER(MEISYO_CD)", false, 1));
