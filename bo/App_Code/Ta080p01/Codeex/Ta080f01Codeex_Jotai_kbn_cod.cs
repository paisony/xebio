...
{
  /// <summary>
  /// フォーム：Ta080f01 項目：Jotai_kbn の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta080f01Codeex_Jotai_kbn : StandardBaseCodeex
	{
		public Ta080f01Codeex_Jotai_kbn()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			// 識別コード = HJJT
			context.Condition.AddFindKey(" SIKIBETSU_CD = 'HJJT'");
			// 55:店舗出荷を非表示
			context.Condition.AddFindKey(" MEISYO_CD <> '55'");
			//ソート条件の指定
			SortKey sortKey1 = new SortKey("MEISYOKANA_NM", false, 1);
