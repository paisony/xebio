...
{
  /// <summary>
  /// フォーム：Ta080f03 項目：M1irairiyu_cd2 の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta080f03Codeex_M1irairiyu_cd2 : StandardBaseCodeex
	{
		public Ta080f03Codeex_M1irairiyu_cd2()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			context.Condition.AddFindKey(" GYOMU_KB = '012'");
