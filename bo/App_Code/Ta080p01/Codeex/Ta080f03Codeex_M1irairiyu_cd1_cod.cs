...
namespace com.xebio.bo.Ta080p01.Codeex
{
  /// <summary>
  /// フォーム：Ta080f03 項目：M1irairiyu_cd1 の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta080f03Codeex_M1irairiyu_cd1 : StandardBaseCodeex
	{
		public Ta080f03Codeex_M1irairiyu_cd1()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// 業務ロジック↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
			// 選択モードをパラメータに追加
			context.Condition.AddExtItemID("Stkmodeno");
			// 業務ロジック↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// 親画面の選択モードを取得する。
			String mode = context.ExeValue.InputValues["Stkmodeno"] as string;

			context.Condition.AddFindKey(" GYOMU_KB = '002'");
			if (!mode.Equals(BoSystemConstant.MODE_REF_TOROKURIREKI))
			{
				// 登録履歴修正以外の場合
