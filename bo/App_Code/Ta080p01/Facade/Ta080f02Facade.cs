...
{
  /// <summary>
  /// Ta080f02のFacadeクラスです
  /// 画面データのロード業務ロジックを実装します。
  /// </summary>
  public partial class Ta080f02Facade : StandardBaseFacade
	{
		#region 定数を設定します
		/// <summary>;
		/// プログラムID。
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Ta080f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta080f02Facade()
			: base()
		{
		}
		#endregion

		#region Ta080f02画面データを作成する。
		/// <summary>
		/// Ta080f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Ta080f02Form ta080f02Form = (Ta080f02Form)facadeContext.FormVO;
