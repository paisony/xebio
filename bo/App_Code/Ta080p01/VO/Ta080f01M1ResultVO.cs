...
{
  /// <summary>
  /// Ta080f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ta080f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta080f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta080f01M1ResultVO compare = null;
			if (obj is Ta080f01M1ResultVO)
			{
				compare = (Ta080f01M1ResultVO)obj;
			}
			else
			{
				return false;
