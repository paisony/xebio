...
namespace com.xebio.bo.Ta080p01.VO
{
  ...
  /// </summary>
  [Serializable]
	public class Ta080f03M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta080f03M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta080f03M1ResultVO compare = null;
			if (obj is Ta080f03M1ResultVO)
			{
				compare = (Ta080f03M1ResultVO)obj;
			}
			else
			{
				return false;
