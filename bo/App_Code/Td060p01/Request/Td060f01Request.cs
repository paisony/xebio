...
{
  /// <summary>
  /// Td060f01Request の概要の説明です。
  /// </summary>
  public abstract class Td060f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Td060f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Td060f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Td060f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Td060f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Td060f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Td060f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
