namespace com.xebio.bo.Td060p01.Request.Td060f01
{
  /// <summary>
  /// Td060f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Td060f01Request_Btnprint : Td060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td060f01Request_Btnprint Me = new Td060f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td060f01Request_Btnprint()
		{
