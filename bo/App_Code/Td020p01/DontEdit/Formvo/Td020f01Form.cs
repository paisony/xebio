using com.xebio.bo.Td020p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Td020f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td020f01Form : Td020f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Td020p01","Td020f01");
