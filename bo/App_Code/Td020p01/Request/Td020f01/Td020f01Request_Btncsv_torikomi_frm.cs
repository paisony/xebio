...
{
  /// <summary>
  /// Td020f01Request_Btncsv_torikomi の概要の説明です。
  /// </summary>
  public sealed class Td020f01Request_Btncsv_torikomi : Td020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td020f01Request_Btncsv_torikomi Me = new Td020f01Request_Btncsv_torikomi();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td020f01Request_Btncsv_torikomi()
		{
