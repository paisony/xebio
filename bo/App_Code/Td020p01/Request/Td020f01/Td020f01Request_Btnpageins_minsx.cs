...
namespace com.xebio.bo.Td020p01.Request.Td020f01
{
  /// <summary>
  /// Td020f01Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Td020f01Request_Btnpageins : Td020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td020f01Request_Btnpageins Me = new Td020f01Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td020f01Request_Btnpageins()
		{
