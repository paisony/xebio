...
{
  /// <summary>
  /// Td020f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Td020f01Request_Btnrowdel : Td020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td020f01Request_Btnrowdel Me = new Td020f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td020f01Request_Btnrowdel()
		{
