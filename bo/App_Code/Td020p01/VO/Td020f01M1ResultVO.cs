...
namespace com.xebio.bo.Td020p01.VO
{
  /// <summary>
  /// Td020f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Td020f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Td020f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Td020f01M1ResultVO compare = null;
			if (obj is Td020f01M1ResultVO)
			{
				compare = (Td020f01M1ResultVO)obj;
			}
			else
			{
				return false;
