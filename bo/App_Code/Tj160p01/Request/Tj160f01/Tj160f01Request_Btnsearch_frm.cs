...
{
  /// <summary>
  /// Tj160f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tj160f01Request_Btnsearch : Tj160f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj160f01Request_Btnsearch Me = new Tj160f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj160f01Request_Btnsearch()
		{
