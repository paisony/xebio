...
{
  /// <summary>
  /// Tj160f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj160f01Request_Btnprint : Tj160f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj160f01Request_Btnprint Me = new Tj160f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj160f01Request_Btnprint()
		{
