using com.xebio.bo.Tj160p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tj160p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tj160f01Form : Tj160f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tj160p01","Tj160f01");
