...
{
  /// <summary>
  /// Tj160f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj160f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj160f01M1BaseForm compare = null;
			if (obj is Tj160f01M1BaseForm)
			{
				compare = (Tj160f01M1BaseForm)obj;
			}
			else
			{
				return false;
