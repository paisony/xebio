...
{
  /// <summary>
  /// Tf040f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tf040f01Request_Pgr : Tf040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf040f01Request_Pgr Me = new Tf040f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf040f01Request_Pgr()
		{
