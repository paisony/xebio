...
namespace com.xebio.bo.Tf040p01.Request.Tf040f01
{
  /// <summary>
  /// Tf040f01Request_Btnrowins の概要の説明です。
  /// </summary>
  public sealed class Tf040f01Request_Btnrowins : Tf040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf040f01Request_Btnrowins Me = new Tf040f01Request_Btnrowins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf040f01Request_Btnrowins()
		{
