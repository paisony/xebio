...
{
  /// <summary>
  /// Tf040f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tf040f01Request_Btnenter : Tf040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf040f01Request_Btnenter Me = new Tf040f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf040f01Request_Btnenter()
		{
