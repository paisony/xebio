...
{
  /// <summary>
  /// Tf040f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tf040f01Request_Btnrowdel : Tf040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf040f01Request_Btnrowdel Me = new Tf040f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf040f01Request_Btnrowdel()
		{
