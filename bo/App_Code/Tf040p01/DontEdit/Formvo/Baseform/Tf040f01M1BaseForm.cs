...
{
  /// <summary>
  /// Tf040f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf040f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf040f01M1BaseForm compare = null;
			if (obj is Tf040f01M1BaseForm)
			{
				compare = (Tf040f01M1BaseForm)obj;
			}
			else
			{
				return false;
