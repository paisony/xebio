using com.xebio.bo.Tf040p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tf040p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tf040f01Form : Tf040f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tf040p01","Tf040f01");
