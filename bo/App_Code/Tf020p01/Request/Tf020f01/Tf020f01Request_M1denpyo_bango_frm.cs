...
{
  /// <summary>
  /// Tf020f01Request_M1denpyo_bango の概要の説明です。
  /// </summary>
  public sealed class Tf020f01Request_M1denpyo_bango : Tf020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf020f01Request_M1denpyo_bango Me = new Tf020f01Request_M1denpyo_bango();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf020f01Request_M1denpyo_bango()
		{
