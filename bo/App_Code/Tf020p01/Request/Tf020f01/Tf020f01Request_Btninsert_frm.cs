...
{
  /// <summary>
  /// Tf020f01Request_Btninsert の概要の説明です。
  /// </summary>
  public sealed class Tf020f01Request_Btninsert : Tf020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf020f01Request_Btninsert Me = new Tf020f01Request_Btninsert();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf020f01Request_Btninsert()
		{
