...
{
  /// <summary>
  /// Tf020f02Request_Btncsv_torikomi の概要の説明です。
  /// </summary>
  public sealed class Tf020f02Request_Btncsv_torikomi : Tf020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf020f02Request_Btncsv_torikomi Me = new Tf020f02Request_Btncsv_torikomi();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf020f02Request_Btncsv_torikomi()
		{
