...
namespace com.xebio.bo.Tf020p01.Request.Tf020f02
{
  /// <summary>
  /// Tf020f02Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Tf020f02Request_Btnpageins : Tf020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf020f02Request_Btnpageins Me = new Tf020f02Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf020f02Request_Btnpageins()
		{
