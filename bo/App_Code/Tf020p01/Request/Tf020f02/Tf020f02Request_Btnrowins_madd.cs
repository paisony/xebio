...
{
  /// <summary>
  /// Tf020f02Request_Btnrowins の概要の説明です。
  /// </summary>
  public sealed class Tf020f02Request_Btnrowins : Tf020f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf020f02Request_Btnrowins Me = new Tf020f02Request_Btnrowins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf020f02Request_Btnrowins()
		{
