...
{
  /// <summary>
  /// Tf020f01Request の概要の説明です。
  /// </summary>
  public abstract class Tf020f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tf020f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tf020f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tf020f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tf020f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tf020f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tf020f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
