...
namespace com.xebio.bo.Tf020p01.Codeex
{
  /// <summary>
  /// フォーム：Tf020f01 項目：Btnkamokucd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tf020f01Codeex_Btnkamokucd_from : StandardBaseCodeex
	{
		public Tf020f01Codeex_Btnkamokucd_from()
		{
		}
