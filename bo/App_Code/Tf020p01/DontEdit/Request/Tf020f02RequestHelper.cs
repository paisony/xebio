...
{
  /// <summary>
  /// Tf020f02RequestHelper の概要の説明です。
  /// </summary>
  public static class Tf020f02RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Tf020f02M1Form tf020f02M1Form = (Tf020f02M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1bumon_cd"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1bumon_cd = paramCol["M1bumon_cd"][i].UnformatValue;
				}
				if (paramCol["M1bumonkana_nm"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1bumonkana_nm = paramCol["M1bumonkana_nm"][i].UnformatValue;
				}
				if (paramCol["M1burando_nm"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1burando_nm = paramCol["M1burando_nm"][i].UnformatValue;
				}
				if (paramCol["M1maker_hbn"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1maker_hbn = paramCol["M1maker_hbn"][i].UnformatValue;
				}
				if (paramCol["M1iro_nm"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1iro_nm = paramCol["M1iro_nm"][i].UnformatValue;
				}
				if (paramCol["M1scan_cd"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1scan_cd = paramCol["M1scan_cd"][i].UnformatValue;
				}
				if (paramCol["M1suryo"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1suryo = paramCol["M1suryo"][i].UnformatValue;
				}
				if (paramCol["M1gen_tnk"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1gen_tnk = paramCol["M1gen_tnk"][i].UnformatValue;
				}
				if (paramCol["M1genka_kin"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1genka_kin = paramCol["M1genka_kin"][i].UnformatValue;
				}
				if (paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1hinsyu_ryaku_nm = paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue;
				}
				if (paramCol["M1jisya_hbn"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1jisya_hbn = paramCol["M1jisya_hbn"][i].UnformatValue;
				}
				if (paramCol["M1syonmk"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1syonmk = paramCol["M1syonmk"][i].UnformatValue;
				}
				if (paramCol["M1size_nm"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1size_nm = paramCol["M1size_nm"][i].UnformatValue;
				}
				if (paramCol["M1genbaika_tnk"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1genbaika_tnk = paramCol["M1genbaika_tnk"][i].UnformatValue;
				}
				if (paramCol["M1gokeibaika_kin"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1gokeibaika_kin = paramCol["M1gokeibaika_kin"][i].UnformatValue;
				}
				if (paramCol["M1suryo_hdn"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1suryo_hdn = paramCol["M1suryo_hdn"][i].UnformatValue;
				}
				if (paramCol["M1genka_kin_hdn"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1genka_kin_hdn = paramCol["M1genka_kin_hdn"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					tf020f02M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Tf020f02Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Tf020f02Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Tf020f02M1Form tf020f02M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, tf020f02M1Form, i, m1List);
				if (tf020f02M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", tf020f02M1Form.M1rowno, i, m1List);
				}
				if (tf020f02M1Form.M1bumon_cd != null)
				{
					checker.DoCheck("M1bumon_cd", tf020f02M1Form.M1bumon_cd, i, m1List);
				}
				if (tf020f02M1Form.M1bumonkana_nm != null)
				{
					checker.DoCheck("M1bumonkana_nm", tf020f02M1Form.M1bumonkana_nm, i, m1List);
				}
				if (tf020f02M1Form.M1burando_nm != null)
				{
					checker.DoCheck("M1burando_nm", tf020f02M1Form.M1burando_nm, i, m1List);
				}
				if (tf020f02M1Form.M1maker_hbn != null)
				{
					checker.DoCheck("M1maker_hbn", tf020f02M1Form.M1maker_hbn, i, m1List);
				}
				if (tf020f02M1Form.M1iro_nm != null)
				{
					checker.DoCheck("M1iro_nm", tf020f02M1Form.M1iro_nm, i, m1List);
				}
				if (tf020f02M1Form.M1scan_cd != null)
				{
					checker.DoCheck("M1scan_cd", tf020f02M1Form.M1scan_cd, i, m1List);
				}
				if (tf020f02M1Form.M1suryo != null)
				{
					checker.DoCheck("M1suryo", tf020f02M1Form.M1suryo, i, m1List);
				}
				if (tf020f02M1Form.M1gen_tnk != null)
				{
					checker.DoCheck("M1gen_tnk", tf020f02M1Form.M1gen_tnk, i, m1List);
				}
				if (tf020f02M1Form.M1genka_kin != null)
				{
					checker.DoCheck("M1genka_kin", tf020f02M1Form.M1genka_kin, i, m1List);
				}
				if (tf020f02M1Form.M1hinsyu_ryaku_nm != null)
				{
					checker.DoCheck("M1hinsyu_ryaku_nm", tf020f02M1Form.M1hinsyu_ryaku_nm, i, m1List);
				}
				if (tf020f02M1Form.M1jisya_hbn != null)
				{
					checker.DoCheck("M1jisya_hbn", tf020f02M1Form.M1jisya_hbn, i, m1List);
				}
				if (tf020f02M1Form.M1syonmk != null)
				{
					checker.DoCheck("M1syonmk", tf020f02M1Form.M1syonmk, i, m1List);
				}
				if (tf020f02M1Form.M1size_nm != null)
				{
					checker.DoCheck("M1size_nm", tf020f02M1Form.M1size_nm, i, m1List);
				}
				if (tf020f02M1Form.M1genbaika_tnk != null)
				{
					checker.DoCheck("M1genbaika_tnk", tf020f02M1Form.M1genbaika_tnk, i, m1List);
				}
				if (tf020f02M1Form.M1gokeibaika_kin != null)
				{
					checker.DoCheck("M1gokeibaika_kin", tf020f02M1Form.M1gokeibaika_kin, i, m1List);
				}
				if (tf020f02M1Form.M1suryo_hdn != null)
				{
					checker.DoCheck("M1suryo_hdn", tf020f02M1Form.M1suryo_hdn, i, m1List);
				}
				if (tf020f02M1Form.M1genka_kin_hdn != null)
				{
					checker.DoCheck("M1genka_kin_hdn", tf020f02M1Form.M1genka_kin_hdn, i, m1List);
				}
				if (tf020f02M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", tf020f02M1Form.M1selectorcheckbox, i, m1List);
				}
				if (tf020f02M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", tf020f02M1Form.M1entersyoriflg, i, m1List);
				}
				if (tf020f02M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", tf020f02M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tf020f02Form formVO, StandardCodeCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Tf020f02Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
