using com.xebio.bo.Tf020p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tf020p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tf020f02Form : Tf020f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tf020p01","Tf020f02");
