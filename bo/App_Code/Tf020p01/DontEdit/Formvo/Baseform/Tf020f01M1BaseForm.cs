...
{
  /// <summary>
  /// Tf020f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf020f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf020f01M1BaseForm compare = null;
			if (obj is Tf020f01M1BaseForm)
			{
				compare = (Tf020f01M1BaseForm)obj;
			}
			else
			{
				return false;
