...
{
  /// <summary>
  /// Tf020f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf020f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf020f02M1BaseForm compare = null;
			if (obj is Tf020f02M1BaseForm)
			{
				compare = (Tf020f02M1BaseForm)obj;
			}
			else
			{
				return false;
