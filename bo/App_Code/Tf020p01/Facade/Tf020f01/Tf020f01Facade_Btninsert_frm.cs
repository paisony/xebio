  ...
  public partial class Tf020f01Facade : StandardBaseFacade
	{
		...
		public void DoBTNINSERT_FRM(IFacadeContext facadeContext)
		{
			...
			//	BeginTransactionWithConnect(facadeContext);
				...
				// 申請日
				nextVo.Apply_ymd = sysDateVO.Sysdate.ToString();
				// 申請理由区分(商品破損)
				...
				// 承認状態
				IList<Hashtable> syoninJotai = V01015Check.SearchMeisyo("KHSN", ConditionSyonin_jotai.VALUE_SYONIN_JOTAI3, facadeContext);
				nextVo.Syonin_flg_nm = ((Hashtable)syoninJotai[0])["MEISYO_NM"].ToString();
