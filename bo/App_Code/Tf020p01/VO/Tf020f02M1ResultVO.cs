...
{
  /// <summary>
  /// Tf020f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tf020f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf020f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tf020f02M1ResultVO compare = null;
			if (obj is Tf020f02M1ResultVO)
			{
				compare = (Tf020f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tf020p01.Formvo.Tf020f02M1Formのハッシュ コード。</returns>
