...
namespace com.xebio.bo.Tb050p01.VO
{
  /// <summary>
  /// Tb050f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tb050f01M1ResultVO : StandardBaseVO
	{
		...
		/// <summary>
		/// 項目「M1KENSU_HDN(検数)」の値
		/// </summary>
		private string _m1kensu_hdn;

		/// <summary>
		/// 項目「M1GENKA_KIN_HDN(原価金額)」の値
		/// </summary>
		...
		/// <summary>
		/// 項目「M1KENSU_HDN(検数)」の値を取得または設定する。
		/// </summary>
		...
		/// <summary>
		/// 項目「M1GENKA_KIN_HDN(原価金額)」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tb050f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tb050f01M1ResultVO compare = null;
			if (obj is Tb050f01M1ResultVO)
			{
				compare = (Tb050f01M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tb050p01.Formvo.Tb050f01M1Formのハッシュ コード。</returns>
