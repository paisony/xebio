...
{
  /// <summary>
  /// Tb050f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tb050f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tb050f01M1BaseForm compare = null;
			if (obj is Tb050f01M1BaseForm)
			{
				compare = (Tb050f01M1BaseForm)obj;
			}
			else
			{
				return false;
