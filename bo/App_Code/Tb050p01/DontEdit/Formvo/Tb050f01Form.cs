using com.xebio.bo.Tb050p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tb050p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tb050f01Form : Tb050f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tb050p01","Tb050f01");
