...
{
  /// <summary>
  /// Tb050f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tb050f01Request_Btnrowdel : Tb050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb050f01Request_Btnrowdel Me = new Tb050f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb050f01Request_Btnrowdel()
		{
