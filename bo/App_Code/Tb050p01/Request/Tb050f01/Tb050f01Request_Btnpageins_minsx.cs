...
namespace com.xebio.bo.Tb050p01.Request.Tb050f01
{
  /// <summary>
  /// Tb050f01Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Tb050f01Request_Btnpageins : Tb050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb050f01Request_Btnpageins Me = new Tb050f01Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb050f01Request_Btnpageins()
		{
