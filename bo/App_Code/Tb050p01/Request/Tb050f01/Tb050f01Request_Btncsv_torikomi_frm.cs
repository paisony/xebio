...
{
  /// <summary>
  /// Tb050f01Request_Btncsv_torikomi の概要の説明です。
  /// </summary>
  public sealed class Tb050f01Request_Btncsv_torikomi : Tb050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb050f01Request_Btncsv_torikomi Me = new Tb050f01Request_Btncsv_torikomi();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb050f01Request_Btncsv_torikomi()
		{
