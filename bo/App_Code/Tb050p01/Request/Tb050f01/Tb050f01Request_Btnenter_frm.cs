...
{
  /// <summary>
  /// Tb050f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tb050f01Request_Btnenter : Tb050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb050f01Request_Btnenter Me = new Tb050f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb050f01Request_Btnenter()
		{
