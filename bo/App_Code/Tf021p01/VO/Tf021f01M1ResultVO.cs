...
{
  /// <summary>
  /// Tf021f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tf021f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf021f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tf021f01M1ResultVO compare = null;
			if (obj is Tf021f01M1ResultVO)
			{
				compare = (Tf021f01M1ResultVO)obj;
			}
			else
			{
				return false;
