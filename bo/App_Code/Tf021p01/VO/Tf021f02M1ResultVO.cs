...
{
  /// <summary>
  /// Tf021f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tf021f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf021f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tf021f02M1ResultVO compare = null;
			if (obj is Tf021f02M1ResultVO)
			{
				compare = (Tf021f02M1ResultVO)obj;
			}
			else
			{
				return false;
