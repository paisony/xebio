...
{
  /// <summary>
  /// Tf021f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Tf021f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Tf021f01Form formVO = (Tf021f01Form)pageContext.GetFormVO();
			...
			paramCol["Kanri_no_from"].RequestValue = RequestParameterUtil.GetRequestValue(
				page, formInfo["Kanri_no_from"]);
			paramCol["Kanri_no_to"].RequestValue = RequestParameterUtil.GetRequestValue(
				page, formInfo["Kanri_no_to"]);
		...
		public static void Unformat(IPageContext pageContext)
		{
			...
			paramCol["Kanri_no_from"].UnformatValue = RequestParameterUtil.GetUnformatValue(
				paramCol["Kanri_no_from"].RequestValue, formInfo["Kanri_no_from"]);
			paramCol["Kanri_no_to"].UnformatValue = RequestParameterUtil.GetUnformatValue(
				paramCol["Kanri_no_to"].RequestValue, formInfo["Kanri_no_to"]);
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			if (paramCol["Kanri_no_from"].UnformatValue != null)
			{
				formVO.Kanri_no_from = paramCol["Kanri_no_from"].UnformatValue;
			}
			if (paramCol["Kanri_no_to"].UnformatValue != null)
			{
				formVO.Kanri_no_to = paramCol["Kanri_no_to"].UnformatValue;
			}
			...
			{
				Tf021f01M1Form tf021f01M1Form = (Tf021f01M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1add_ymd"][i].DateFullValue != null)
				{
					tf021f01M1Form.M1add_ymd = paramCol["M1add_ymd"][i].DateFullValue;
				}
				if (paramCol["M1apply_ymd"][i].DateFullValue != null)
				{
					tf021f01M1Form.M1apply_ymd = paramCol["M1apply_ymd"][i].DateFullValue;
				}
				if (paramCol["M1kakutei_ymd"][i].DateFullValue != null)
				{
					tf021f01M1Form.M1kakutei_ymd = paramCol["M1kakutei_ymd"][i].DateFullValue;
				}
				if (paramCol["M1kamoku_cd"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1kamoku_cd = paramCol["M1kamoku_cd"][i].UnformatValue;
				}
				if (paramCol["M1kamoku_nm"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1kamoku_nm = paramCol["M1kamoku_nm"][i].UnformatValue;
				}
				if (paramCol["M1itemsu"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1itemsu = paramCol["M1itemsu"][i].UnformatValue;
				}
				if (paramCol["M1genkakin"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1genkakin = paramCol["M1genkakin"][i].UnformatValue;
				}
				if (paramCol["M1baika_tnk"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1baika_tnk = paramCol["M1baika_tnk"][i].UnformatValue;
				}
				if (paramCol["M1sinseitan_nm"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1sinseitan_nm = paramCol["M1sinseitan_nm"][i].UnformatValue;
				}
				if (paramCol["M1gyomuringi_no"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1gyomuringi_no = paramCol["M1gyomuringi_no"][i].UnformatValue;
				}
				if (paramCol["M1jyuri_no"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1jyuri_no = paramCol["M1jyuri_no"][i].UnformatValue;
				}
				if (paramCol["M1syonin_flg_nm"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1syonin_flg_nm = paramCol["M1syonin_flg_nm"][i].UnformatValue;
				}
				if (paramCol["M1sinseiriyu"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1sinseiriyu = paramCol["M1sinseiriyu"][i].UnformatValue;
				}
				if (paramCol["M1kyakkariyu"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1kyakkariyu = paramCol["M1kyakkariyu"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					tf021f01M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Tf021f01Form formVO, StandardCheckManager checker)
		{
			...
			if (formVO.Kanri_no_from != null)
			{
				checker.DoCheck("Kanri_no_from", formVO.Kanri_no_from);
			}
			if (formVO.Kanri_no_to != null)
			{
				checker.DoCheck("Kanri_no_to", formVO.Kanri_no_to);
			}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Tf021f01Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Tf021f01M1Form tf021f01M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, tf021f01M1Form, i, m1List);
				if (tf021f01M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", tf021f01M1Form.M1rowno, i, m1List);
				}
				if (tf021f01M1Form.M1add_ymd != null)
				{
					checker.DoCheck("M1add_ymd", tf021f01M1Form.M1add_ymd, i, m1List);
				}
				if (tf021f01M1Form.M1apply_ymd != null)
				{
					checker.DoCheck("M1apply_ymd", tf021f01M1Form.M1apply_ymd, i, m1List);
				}
				if (tf021f01M1Form.M1kakutei_ymd != null)
				{
					checker.DoCheck("M1kakutei_ymd", tf021f01M1Form.M1kakutei_ymd, i, m1List);
				}
				if (tf021f01M1Form.M1kamoku_cd != null)
				{
					checker.DoCheck("M1kamoku_cd", tf021f01M1Form.M1kamoku_cd, i, m1List);
				}
				if (tf021f01M1Form.M1kamoku_nm != null)
				{
					checker.DoCheck("M1kamoku_nm", tf021f01M1Form.M1kamoku_nm, i, m1List);
				}
				if (tf021f01M1Form.M1itemsu != null)
				{
					checker.DoCheck("M1itemsu", tf021f01M1Form.M1itemsu, i, m1List);
				}
				if (tf021f01M1Form.M1genkakin != null)
				{
					checker.DoCheck("M1genkakin", tf021f01M1Form.M1genkakin, i, m1List);
				}
				if (tf021f01M1Form.M1baika_tnk != null)
				{
					checker.DoCheck("M1baika_tnk", tf021f01M1Form.M1baika_tnk, i, m1List);
				}
				if (tf021f01M1Form.M1sinseitan_nm != null)
				{
					checker.DoCheck("M1sinseitan_nm", tf021f01M1Form.M1sinseitan_nm, i, m1List);
				}
				if (tf021f01M1Form.M1gyomuringi_no != null)
				{
					checker.DoCheck("M1gyomuringi_no", tf021f01M1Form.M1gyomuringi_no, i, m1List);
				}
				if (tf021f01M1Form.M1jyuri_no != null)
				{
					checker.DoCheck("M1jyuri_no", tf021f01M1Form.M1jyuri_no, i, m1List);
				}
				if (tf021f01M1Form.M1syonin_flg_nm != null)
				{
					checker.DoCheck("M1syonin_flg_nm", tf021f01M1Form.M1syonin_flg_nm, i, m1List);
				}
				if (tf021f01M1Form.M1sinseiriyu != null)
				{
					checker.DoCheck("M1sinseiriyu", tf021f01M1Form.M1sinseiriyu, i, m1List);
				}
				if (tf021f01M1Form.M1kyakkariyu != null)
				{
					checker.DoCheck("M1kyakkariyu", tf021f01M1Form.M1kyakkariyu, i, m1List);
				}
				if (tf021f01M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", tf021f01M1Form.M1selectorcheckbox, i, m1List);
				}
				if (tf021f01M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", tf021f01M1Form.M1entersyoriflg, i, m1List);
				}
				if (tf021f01M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", tf021f01M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tf021f01Form formVO, StandardCodeCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Tf021f01Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
