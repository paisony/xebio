...
{
  /// <summary>
  /// Tf021f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf021f02M1BaseForm : StandardBaseM1Form
	{
		...
		/// <summary>
		/// 項目「M1GOKEIBAIKA_KIN(売価金額)」の値
		/// </summary>
		private string _m1gokeibaika_kin;
		...
		/// <summary>
		/// 項目「M1GOKEIBAIKA_KIN(売価金額)」の値を取得または設定する。
		/// </summary>
		public virtual string M1gokeibaika_kin
		{
			get
			{
				return this._m1gokeibaika_kin;
			}
			set
			{
				this._m1gokeibaika_kin = value;
			}
		}
		...
		{
			Tf021f02M1BaseForm compare = null;
			if (obj is Tf021f02M1BaseForm)
			{
				compare = (Tf021f02M1BaseForm)obj;
			}
			else
			{
				return false;
			...
			if (_m1gokeibaika_kin != compare.M1gokeibaika_kin)
			{
				return false;
			}
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tf021p01.Formvo.Tf021f02M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1gokeibaika_kin:").Append(this._m1gokeibaika_kin).AppendLine();
