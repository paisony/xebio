...
{
  /// <summary>
  /// Tf021f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf021f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf021f01M1BaseForm compare = null;
			if (obj is Tf021f01M1BaseForm)
			{
				compare = (Tf021f01M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tf021p01.Formvo.Tf021f01M1Formのハッシュ コード。</returns>
