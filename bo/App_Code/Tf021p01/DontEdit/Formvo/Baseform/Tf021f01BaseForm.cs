...
namespace com.xebio.bo.Tf021p01.Formvo.Baseform
{
  /// <summary>
  /// Tf021f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf021f01BaseForm : StandardBaseForm, IFormVO
	{
		...
		/// <summary>
		/// 項目「KANRI_NO_FROM(管理NoＦＲＯＭ)」の値
		/// </summary>
		private string _kanri_no_from;
		/// <summary>
		/// 項目「KANRI_NO_TO(管理NoＴＯ)」の値
		/// </summary>
		private string _kanri_no_to;
		/// <summary>
		...
		/// <summary>
		/// 項目「KANRI_NO_FROM(管理NoＦＲＯＭ)」の値を取得または設定する。
		/// </summary>
		public virtual string Kanri_no_from
		{
			get
			{
				return this._kanri_no_from;
			}
			set
			{
				this._kanri_no_from = value;
			}
		}
		/// <summary>
		/// 項目「KANRI_NO_TO(管理NoＴＯ)」の値を取得または設定する。
		/// </summary>
		public virtual string Kanri_no_to
		{
			get
			{
				return this._kanri_no_to;
			}
			set
			{
				this._kanri_no_to = value;
			}
		}
		/// <summary>
		...
		public override string ToString()
		{
			...
			sb.Append("Kanri_no_from:").Append(this._kanri_no_from).AppendLine();
			sb.Append("Kanri_no_to:").Append(this._kanri_no_to).AppendLine();
