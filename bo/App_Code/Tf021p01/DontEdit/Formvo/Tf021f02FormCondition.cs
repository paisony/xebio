...
{
  /// <summary>
  /// Tf021f02のFormオブジェクトです。
  /// </summary>
  [System.Serializable]
	public class Tf021f02FormCondition : IConditionVO
	{
		...
		//}
		/// <summary>
		/// 項目「GENKA_KIN_GOKEI(合計原価金額)」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tf021f02FormCondition() : base()
		{
		}
		#endregion
	}
