using com.xebio.bo.Tf021p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tf021p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tf021f02Form : Tf021f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tf021p01","Tf021f02");
