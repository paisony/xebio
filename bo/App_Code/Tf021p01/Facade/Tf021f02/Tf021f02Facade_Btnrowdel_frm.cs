  ...
  public partial class Tf021f02Facade : StandardBaseFacade
	{
		...
		public void DoBTNROWDEL_FRM(IFacadeContext facadeContext)
		{
			...
			//	BeginTransactionWithConnect(facadeContext);
				...
				decimal lastRow = DelRowCls.DeleteSelectRow<Tf021f02Form, Tf021f02M1Form>("M1", "M1rowno", (Tf021f02Form)facadeContext.FormVO, alList, addRowflg);
				...
				// フォーカス行をコードビハインドに戻す
				facadeContext.SetUserObject(Tf021p01Constant.FCDUO_FOCUSROW, lastRow);
