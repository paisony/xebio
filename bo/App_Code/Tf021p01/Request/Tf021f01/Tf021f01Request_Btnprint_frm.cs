...
{
  /// <summary>
  /// Tf021f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tf021f01Request_Btnprint : Tf021f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf021f01Request_Btnprint Me = new Tf021f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf021f01Request_Btnprint()
		{
