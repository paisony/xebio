...
{
  /// <summary>
  /// Tf021f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tf021f01Request_Btnsearch : Tf021f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf021f01Request_Btnsearch Me = new Tf021f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf021f01Request_Btnsearch()
		{
