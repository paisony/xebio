...
{
  /// <summary>
  /// Tf021f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tf021f01Request_Btnenter : Tf021f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf021f01Request_Btnenter Me = new Tf021f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf021f01Request_Btnenter()
		{
