...
{
  /// <summary>
  /// Tf021f01Request_M1kanri_no の概要の説明です。
  /// </summary>
  public sealed class Tf021f01Request_M1kanri_no : Tf021f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf021f01Request_M1kanri_no Me = new Tf021f01Request_M1kanri_no();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf021f01Request_M1kanri_no()
		{
