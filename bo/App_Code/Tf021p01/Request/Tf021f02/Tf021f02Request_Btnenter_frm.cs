...
{
  /// <summary>
  /// Tf021f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tf021f02Request_Btnenter : Tf021f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf021f02Request_Btnenter Me = new Tf021f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf021f02Request_Btnenter()
		{
