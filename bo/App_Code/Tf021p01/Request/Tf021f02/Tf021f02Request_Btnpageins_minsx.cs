...
namespace com.xebio.bo.Tf021p01.Request.Tf021f02
{
  /// <summary>
  /// Tf021f02Request_Btnpageins の概要の説明です。
  /// </summary>
  public sealed class Tf021f02Request_Btnpageins : Tf021f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf021f02Request_Btnpageins Me = new Tf021f02Request_Btnpageins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf021f02Request_Btnpageins()
		{
...
//
		...
		public override void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//明細部の入力項目
			Tf021f02RequestHelper.ValidateM1InputValue(formVO, checker);
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tf021f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
