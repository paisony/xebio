...
{
  /// <summary>
  /// Tf021f02Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Tf021f02Request_Btnrowdel : Tf021f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf021f02Request_Btnrowdel Me = new Tf021f02Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf021f02Request_Btnrowdel()
		{
