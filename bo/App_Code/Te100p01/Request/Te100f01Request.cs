...
namespace com.xebio.bo.Te100p01.Request
{
  /// <summary>
  /// Te100f01Request の概要の説明です。
  /// </summary>
  public abstract class Te100f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Te100f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Te100f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Te100f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Te100f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Te100f01Form formVO=(Te100f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Te100f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Te100f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
