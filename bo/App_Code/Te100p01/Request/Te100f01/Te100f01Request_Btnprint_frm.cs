namespace com.xebio.bo.Te100p01.Request.Te100f01
{
  /// <summary>
  /// Te100f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Te100f01Request_Btnprint : Te100f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te100f01Request_Btnprint Me = new Te100f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te100f01Request_Btnprint()
		{
