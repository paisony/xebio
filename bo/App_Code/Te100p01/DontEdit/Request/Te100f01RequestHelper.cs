...
{
  /// <summary>
  /// Te100f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Te100f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void ValidateCardInputValue(Te100f01Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Te100f01Form formVO, StandardCodeCheckManager checker)
		{
