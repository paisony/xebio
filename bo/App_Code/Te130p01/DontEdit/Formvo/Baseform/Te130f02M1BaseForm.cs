...
{
  /// <summary>
  /// Te130f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Te130f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Te130f02M1BaseForm compare = null;
			if (obj is Te130f02M1BaseForm)
			{
				compare = (Te130f02M1BaseForm)obj;
			}
			else
			{
				return false;
