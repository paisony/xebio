using com.xebio.bo.Te130p01.Formvo.Baseform;
...
namespace com.xebio.bo.Te130p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Te130f02Form : Te130f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Te130p01","Te130f02");
