...
namespace com.xebio.bo.Te130p01.VO
{
  /// <summary>
  /// Te130f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te130f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te130f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te130f02M1ResultVO compare = null;
			if (obj is Te130f02M1ResultVO)
			{
				compare = (Te130f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Te130p01.Formvo.Te130f02M1Formのハッシュ コード。</returns>
