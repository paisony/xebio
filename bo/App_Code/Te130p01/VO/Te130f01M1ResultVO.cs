...
{
  /// <summary>
  /// Te130f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Te130f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te130f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Te130f01M1ResultVO compare = null;
			if (obj is Te130f01M1ResultVO)
			{
				compare = (Te130f01M1ResultVO)obj;
			}
			else
			{
				return false;
