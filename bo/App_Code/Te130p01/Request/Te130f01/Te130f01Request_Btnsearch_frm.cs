...
{
  /// <summary>
  /// Te130f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Te130f01Request_Btnsearch : Te130f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te130f01Request_Btnsearch Me = new Te130f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te130f01Request_Btnsearch()
		{
