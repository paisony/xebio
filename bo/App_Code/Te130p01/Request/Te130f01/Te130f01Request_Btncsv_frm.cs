...
{
  /// <summary>
  /// Te130f01Request_Btncsv の概要の説明です。
  /// </summary>
  public sealed class Te130f01Request_Btncsv : Te130f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te130f01Request_Btncsv Me = new Te130f01Request_Btncsv();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te130f01Request_Btncsv()
		{
