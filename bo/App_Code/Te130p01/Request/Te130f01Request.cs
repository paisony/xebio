...
{
  /// <summary>
  /// Te130f01Request の概要の説明です。
  /// </summary>
  public abstract class Te130f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Te130f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Te130f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Te130f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Te130f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Te130f01RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Te130f01RequestHelper.ValidateM1InputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Te130f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
			
			//明細部コード存在チェック
			Te130f01RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
