...
namespace com.xebio.bo.Te130p01.Request.Te130f02
{
  /// <summary>
  /// Te130f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Te130f02Request_Pgr : Te130f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Te130f02Request_Pgr Me = new Te130f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Te130f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Te130f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
