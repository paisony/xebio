...
{
  /// <summary>
  /// Te130f02のFacadeクラスです
  /// 画面データのロード業務ロジックを実装します。
  /// </summary>
  public partial class Te130f02Facade : StandardBaseFacade
	{
		#region 定数を設定します
		/// <summary>;
		/// プログラムID。
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Te130f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Te130f02Facade()
			: base()
		{
		}
		#endregion

		#region Te130f02画面データを作成する。
		/// <summary>
		/// Te130f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Te130f02Form te130f02Form = (Te130f02Form)facadeContext.FormVO;
