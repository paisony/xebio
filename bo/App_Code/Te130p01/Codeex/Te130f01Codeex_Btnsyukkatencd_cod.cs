...
{
  /// <summary>
  /// フォーム：Te130f01 項目：Btnsyukkatencd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Te130f01Codeex_Btnsyukkatencd : StandardBaseCodeex
	{
		public Te130f01Codeex_Btnsyukkatencd()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			context.Condition.AddExtItemID("Syukkakaisya_cd");
			// メソッド終了時の共通処理
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// を設定してください。
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			Decimal dKaisya = Convert.ToDecimal(BoSystemString.Nvl(context.ExeValue.InputValues["Syukkakaisya_cd"].ToString(), "0"));
