...
namespace com.xebio.bo.Te130p01.Codeex
{
  /// <summary>
  /// フォーム：Te130f01 項目：Btntenpocd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Te130f01Codeex_Btntenpocd : StandardBaseCodeex
	{
		public Te130f01Codeex_Btntenpocd()
		{
		}
...
//			context.Condition.AddExtItemID("Kaisya_cd1");
//			context.Condition.AddExtItemID("Kaisya_cd2");
			context.Condition.AddExtItemID("Jyuryokaisya_cd");
			// メソッド終了時の共通処理
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// メソッド終了時の共通処理
			//		Decimal dKaisya1 = Convert.ToDecimal(BoSystemString.Nvl(context.ExeValue.InputValues["Jyuryokaisya_cd"].ToString(), "0"));
	//		context.Condition.AddFindKey("Jyuryokaisya_cd = " + dKaisya1.ToString());
	//		Decimal dkaisya = 0;
			
			Decimal dKaisya = Convert.ToDecimal(BoSystemString.Nvl(context.ExeValue.InputValues["Jyuryokaisya_cd"].ToString(), "0"));
			context.Condition.AddFindKey("KAISYA_CD = " + dKaisya.ToString());
