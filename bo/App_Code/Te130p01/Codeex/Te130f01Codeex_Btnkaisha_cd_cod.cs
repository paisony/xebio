...
{
  /// <summary>
  /// フォーム：Te130f01 項目：Btnkaisha_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Te130f01Codeex_Btnkaisha_cd : StandardBaseCodeex
	{
		public Te130f01Codeex_Btnkaisha_cd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// を設定してください。
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			context.Condition.AddFindKey("SIKIBETSU_CD = 'KASY'");
