namespace com.xebio.bo.Ta060p01.Constant
{
  /// <summary>
  /// Ta060p01の定数を定義するクラスです。
  /// </summary>
  public static class Ta060p01Constant
    {
        ...
        /// プログラムID
        /// </summary>
        public const string PGID = "Ta060p01";
        #endregion
        ...
        /// 一覧画面フォームID
        /// </summary>
        public const string FORMID_01 = "Ta060f01";
        /// <summary>
        /// 明細画面フォームID
        /// </summary>
        public const string FORMID_02 = "Ta060f02";
        #endregion

        #region SQL-ID
        /// <summary>
        /// 出荷要望結果 [出荷要望結果TBL(H)]件数チェック
        /// </summary>
        public const string SQL_ID_01 = "TA060P01-01";
        /// <summary>
        /// 出荷要望結果 [出荷要望結果TBL(H)]検索
        /// </summary>
        public const string SQL_ID_02 = "TA060P01-02";
        /// <summary>
        /// 出荷要望結果 [出荷要望結果TBL(B)]検索
        /// </summary>
        public const string SQL_ID_03 = "TA060P01-03";
