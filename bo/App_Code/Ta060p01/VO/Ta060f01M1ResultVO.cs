...
{
  /// <summary>
  /// Ta060f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ta060f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta060f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta060f01M1ResultVO compare = null;
			if (obj is Ta060f01M1ResultVO)
			{
				compare = (Ta060f01M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Ta060p01.Formvo.Ta060f01M1Formのハッシュ コード。</returns>
