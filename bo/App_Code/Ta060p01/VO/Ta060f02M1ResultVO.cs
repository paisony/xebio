...
namespace com.xebio.bo.Ta060p01.VO
{
  /// <summary>
  /// Ta060f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ta060f02M1ResultVO : StandardBaseVO
	{
		...
		/// <summary>
		/// 項目「M1COMMENT_NM2()」の値を取得または設定する。
		/// </summary>
		public virtual string M1comment_nm2
		{
			get
			{
				return this._m1comment_nm2;
			}
			set
			{
				this._m1comment_nm2 = value;
			}
		}
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ta060f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ta060f02M1ResultVO compare = null;
			if (obj is Ta060f02M1ResultVO)
			{
				compare = (Ta060f02M1ResultVO)obj;
			}
			else
			{
				return false;
			...
			if (_m1comment_nm2 != compare.M1comment_nm2)
			{
				return false;
			}
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Ta060p01.Formvo.Ta060f02M1Formのハッシュ コード。</returns>
		...
		public override string ToString()
		{
			...
			str.Append("M1comment_nm2:").Append(this._m1comment_nm2).AppendLine();
