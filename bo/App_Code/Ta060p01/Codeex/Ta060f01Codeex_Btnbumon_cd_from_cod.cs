...
namespace com.xebio.bo.Ta060p01.Codeex
{
  /// <summary>
  /// フォーム：Ta060f01 項目：Btnbumon_cd_from の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Ta060f01Codeex_Btnbumon_cd_from : StandardBaseCodeex
	{
		public Ta060f01Codeex_Btnbumon_cd_from()
		{
		}
