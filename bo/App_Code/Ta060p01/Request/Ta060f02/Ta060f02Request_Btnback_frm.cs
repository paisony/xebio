...
namespace com.xebio.bo.Ta060p01.Request.Ta060f02
{
  /// <summary>
  /// Ta060f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Ta060f02Request_Btnback : Ta060f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta060f02Request_Btnback Me = new Ta060f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta060f02Request_Btnback()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Ta060f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
