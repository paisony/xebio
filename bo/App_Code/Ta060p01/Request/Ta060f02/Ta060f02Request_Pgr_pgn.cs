...
{
  /// <summary>
  /// Ta060f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta060f02Request_Pgr : Ta060f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta060f02Request_Pgr Me = new Ta060f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta060f02Request_Pgr()
		{
