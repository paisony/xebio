...
namespace com.xebio.bo.Ta060p01.Request.Ta060f01
{
  /// <summary>
  /// Ta060f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Ta060f01Request_Pgr : Ta060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ta060f01Request_Pgr Me = new Ta060f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ta060f01Request_Pgr()
		{
