...
{
  /// <summary>
  /// Ta060f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta060f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta060f02M1BaseForm compare = null;
			if (obj is Ta060f02M1BaseForm)
			{
				compare = (Ta060f02M1BaseForm)obj;
			}
			else
			{
				return false;
