...
{
  /// <summary>
  /// Ta060f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Ta060f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Ta060f01M1BaseForm compare = null;
			if (obj is Ta060f01M1BaseForm)
			{
				compare = (Ta060f01M1BaseForm)obj;
			}
			else
			{
				return false;
