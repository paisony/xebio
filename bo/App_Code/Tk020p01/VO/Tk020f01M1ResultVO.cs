...
{
  /// <summary>
  /// Tk020f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tk020f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tk020f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tk020f01M1ResultVO compare = null;
			if (obj is Tk020f01M1ResultVO)
			{
				compare = (Tk020f01M1ResultVO)obj;
			}
			else
			{
				return false;
