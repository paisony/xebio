...
{
  /// <summary>
  /// Tk020f01Request_Btnzenkjo の概要の説明です。
  /// </summary>
  public sealed class Tk020f01Request_Btnzenkjo : Tk020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk020f01Request_Btnzenkjo Me = new Tk020f01Request_Btnzenkjo();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk020f01Request_Btnzenkjo()
		{
