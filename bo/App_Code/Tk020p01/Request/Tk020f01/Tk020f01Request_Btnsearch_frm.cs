...
{
  /// <summary>
  /// Tk020f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tk020f01Request_Btnsearch : Tk020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk020f01Request_Btnsearch Me = new Tk020f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk020f01Request_Btnsearch()
		{
