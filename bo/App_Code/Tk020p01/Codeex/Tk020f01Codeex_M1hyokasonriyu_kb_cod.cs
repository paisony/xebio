...
{
	/// <summary>
	/// フォーム：Tk020f01 項目：M1hyokasonriyu_kb の拡張コード参照クラスです。
	/// </summary>
	[Serializable]
	public class Tk020f01Codeex_M1hyokasonriyu_kb : StandardBaseCodeex
	{
		public Tk020f01Codeex_M1hyokasonriyu_kb()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// 項目追加
			context.Condition.AddFindKey("SIKIBETSU_CD = '" + Tk020p01Constant.MEISHO_SIKIBETSU_CD_RIYU + "'");
