...
namespace com.xebio.bo.Tk020p01.Codeex
{
	/// <summary>
	/// フォーム：Tk020f01 項目：M1hyokasonsyubetsu_kb の拡張コード参照クラスです。
	/// </summary>
	[Serializable]
	public class Tk020f01Codeex_M1hyokasonsyubetsu_kb : StandardBaseCodeex
	{
		public Tk020f01Codeex_M1hyokasonsyubetsu_kb()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// 項目追加
			context.Condition.AddFindKey("SIKIBETSU_CD = '" + Tk020p01Constant.MEISHO_SIKIBETSU_CD_SYUBETSU + "'");
