using com.xebio.bo.Tk020p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tk020f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tk020f01Form : Tk020f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tk020p01","Tk020f01");
