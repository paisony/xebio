...
namespace com.xebio.bo.Tj150p01.Request
{
  /// <summary>
  /// Tj150f01Request の概要の説明です。
  /// </summary>
  public abstract class Tj150f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tj150f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tj150f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tj150f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tj150f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Tj150f01Form formVO=(Tj150f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Tj150f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tj150f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
