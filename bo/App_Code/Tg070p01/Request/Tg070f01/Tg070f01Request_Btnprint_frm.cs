namespace com.xebio.bo.Tg070p01.Request.Tg070f01
{
  /// <summary>
  /// Tg070f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tg070f01Request_Btnprint : Tg070f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tg070f01Request_Btnprint Me = new Tg070f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tg070f01Request_Btnprint()
		{
