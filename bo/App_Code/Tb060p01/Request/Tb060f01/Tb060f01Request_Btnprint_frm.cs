namespace com.xebio.bo.Tb060p01.Request.Tb060f01
{
  /// <summary>
  /// Tb060f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tb060f01Request_Btnprint : Tb060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tb060f01Request_Btnprint Me = new Tb060f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tb060f01Request_Btnprint()
		{
