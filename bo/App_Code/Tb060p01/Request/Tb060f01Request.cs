...
namespace com.xebio.bo.Tb060p01.Request
{
  /// <summary>
  /// Tb060f01Request の概要の説明です。
  /// </summary>
  public abstract class Tb060f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tb060f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tb060f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tb060f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tb060f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//フォームVOを取得する。
			Tb060f01Form formVO=(Tb060f01Form)pageContext.GetFormVO();
		
			//カード部の入力項目
			Tb060f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tb060f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
