...
{
  /// <summary>
  /// Tb060f01RequestHelper の概要の説明です。
  /// </summary>
  public static class Tb060f01RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void ValidateCardInputValue(Tb060f01Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Tb060f01Form formVO, StandardCodeCheckManager checker)
		{
