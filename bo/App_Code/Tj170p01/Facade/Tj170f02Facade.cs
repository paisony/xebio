...
{
  /// <summary>
  /// Tj170f02のFacadeクラスです
  /// 画面データのロード業務ロジックを実装します。
  /// </summary>
  public partial class Tj170f02Facade : StandardBaseFacade
	{
		#region 定数を設定します
		/// <summary>;
		/// プログラムID。
		...
		/// フォームID。
		/// </summary>
		private const string FORMID = "Tj170f02";
		#endregion
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj170f02Facade()
			: base()
		{
		}
		#endregion

		#region Tj170f02画面データを作成する。
		/// <summary>
		/// Tj170f02画面データを作成する。
		/// </summary>
		...
		public void DoLoad(IFacadeContext facadeContext)
		{
			...
			//	//カード部を取得します。
			//	Tj170f02Form tj170f02Form = (Tj170f02Form)facadeContext.FormVO;
