...
{
  /// <summary>
  /// Tj170f02Request の概要の説明です。
  /// </summary>
  public abstract class Tj170f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tj170f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tj170f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tj170f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tj170f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tj170f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Tj170f02RequestHelper.ValidateM1InputValue(formVO, checker);
