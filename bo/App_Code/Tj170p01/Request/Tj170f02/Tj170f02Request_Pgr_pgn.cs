...
namespace com.xebio.bo.Tj170p01.Request.Tj170f02
{
  /// <summary>
  /// Tj170f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj170f02Request_Pgr : Tj170f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj170f02Request_Pgr Me = new Tj170f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj170f02Request_Pgr()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Tj170f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
