...
{
  /// <summary>
  /// Tj170f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tj170f02Request_Btnback : Tj170f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj170f02Request_Btnback Me = new Tj170f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj170f02Request_Btnback()
		{
