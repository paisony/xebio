...
namespace com.xebio.bo.Tj170p01.Request.Tj170f01
{
  /// <summary>
  /// Tj170f01Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tj170f01Request_Btnzenstk : Tj170f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj170f01Request_Btnzenstk Me = new Tj170f01Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj170f01Request_Btnzenstk()
		{
