...
{
  /// <summary>
  /// Tj170f01Request_M1syohingun1_cd の概要の説明です。
  /// </summary>
  public sealed class Tj170f01Request_M1syohingun1_cd : Tj170f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj170f01Request_M1syohingun1_cd Me = new Tj170f01Request_M1syohingun1_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj170f01Request_M1syohingun1_cd()
		{
