...
{
  /// <summary>
  /// Tj170f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tj170f01Request_Pgr : Tj170f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj170f01Request_Pgr Me = new Tj170f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj170f01Request_Pgr()
		{
