using com.xebio.bo.Tj170p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tj170p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tj170f02Form : Tj170f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tj170p01","Tj170f02");
