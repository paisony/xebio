...
{
  /// <summary>
  /// Tj170f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj170f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj170f02M1BaseForm compare = null;
			if (obj is Tj170f02M1BaseForm)
			{
				compare = (Tj170f02M1BaseForm)obj;
			}
			else
			{
				return false;
