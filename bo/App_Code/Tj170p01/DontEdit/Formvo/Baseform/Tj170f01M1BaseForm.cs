...
{
  /// <summary>
  /// Tj170f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj170f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj170f01M1BaseForm compare = null;
			if (obj is Tj170f01M1BaseForm)
			{
				compare = (Tj170f01M1BaseForm)obj;
			}
			else
			{
				return false;
