...
{
  /// <summary>
  /// フォーム：Tj170f01 項目：Btnsyohingun2_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tj170f01Codeex_Btnsyohingun2_cd : StandardBaseCodeex
	{
		public Tj170f01Codeex_Btnsyohingun2_cd()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			context.Condition.AddExtItemID("Syohingun1_cd");
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// を設定してください。
			// 拡張方法の詳細はマニュアルおよびサンプルを参照してください。
			context.Condition.AddFindKey("Syohingun1_cd", "GRPCD", SearchItemType.Front);
