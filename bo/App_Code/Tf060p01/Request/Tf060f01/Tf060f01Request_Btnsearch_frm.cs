...
{
  /// <summary>
  /// Tf060f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tf060f01Request_Btnsearch : Tf060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf060f01Request_Btnsearch Me = new Tf060f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf060f01Request_Btnsearch()
		{
