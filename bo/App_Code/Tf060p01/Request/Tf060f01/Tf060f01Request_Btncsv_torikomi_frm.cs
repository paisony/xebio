namespace com.xebio.bo.Tf060p01.Request.Tf060f01
{
  /// <summary>
  /// Tf060f01Request_Btncsv_torikomi の概要の説明です。
  /// </summary>
  public sealed class Tf060f01Request_Btncsv_torikomi : Tf060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf060f01Request_Btncsv_torikomi Me = new Tf060f01Request_Btncsv_torikomi();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf060f01Request_Btncsv_torikomi()
		{
