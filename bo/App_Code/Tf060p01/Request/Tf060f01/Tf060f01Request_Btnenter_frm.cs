...
{
  /// <summary>
  /// Tf060f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tf060f01Request_Btnenter : Tf060f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf060f01Request_Btnenter Me = new Tf060f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf060f01Request_Btnenter()
		{
