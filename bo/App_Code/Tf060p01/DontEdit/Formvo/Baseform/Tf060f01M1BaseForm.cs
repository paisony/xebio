...
{
  /// <summary>
  /// Tf060f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tf060f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tf060f01M1BaseForm compare = null;
			if (obj is Tf060f01M1BaseForm)
			{
				compare = (Tf060f01M1BaseForm)obj;
			}
			else
			{
				return false;
