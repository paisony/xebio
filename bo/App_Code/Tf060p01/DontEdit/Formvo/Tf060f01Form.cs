using com.xebio.bo.Tf060p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tf060p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tf060f01Form : Tf060f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tf060p01","Tf060f01");
