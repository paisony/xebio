...
{
  /// <summary>
  /// Td040f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Td040f01Request_Btnprint : Td040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td040f01Request_Btnprint Me = new Td040f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td040f01Request_Btnprint()
		{
