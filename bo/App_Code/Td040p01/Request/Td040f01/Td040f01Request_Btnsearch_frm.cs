...
{
  /// <summary>
  /// Td040f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Td040f01Request_Btnsearch : Td040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td040f01Request_Btnsearch Me = new Td040f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td040f01Request_Btnsearch()
		{
