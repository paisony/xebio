using com.xebio.bo.Td040p01.Formvo.Baseform;
...
namespace com.xebio.bo.Td040p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Td040f01Form : Td040f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Td040p01","Td040f01");
