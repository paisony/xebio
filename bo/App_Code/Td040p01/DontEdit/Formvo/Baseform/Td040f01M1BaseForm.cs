...
{
  /// <summary>
  /// Td040f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td040f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Td040f01M1BaseForm compare = null;
			if (obj is Td040f01M1BaseForm)
			{
				compare = (Td040f01M1BaseForm)obj;
			}
			else
			{
				return false;
