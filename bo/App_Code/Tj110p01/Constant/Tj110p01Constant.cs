namespace com.xebio.bo.Tj110p01.Constant
{
  /// <summary>
  /// Tj110p01の定数を定義するクラスです。
  /// </summary>
  public static class Tj110p01Constant
	{
		#region プログラムID
		/// <summary>
		/// プログラムID
		/// </summary>
		public const string PGID = "Tj110p01";
		#endregion
		...
		/// 一覧画面フォームID
		/// </summary>
		public const string FORMID_01 = "Tj110f01";
		...
		/// 棚卸取漏れ/欠番検索(カウント用)
		/// </summary>
		public const string ORACLE_PACKAGE_01_COUNT = "MdInventoryNew_x.countInventoryMissingSearch";

		/// <summary>
		/// 棚卸取漏れ/欠番検索(検索)
		/// </summary>
		public const string ORACLE_PACKAGE_01 = "MdInventoryNew_x.searchInventoryMissingSearch";
		...
		/// 初期表示_フェイスNoFROMTO取得
		/// </summary>
		public const string SQL_ID_01 = "Tj110P01-01";
		/// <summary>
		/// 棚卸取漏れ欠番検索(V) 確定ボタン
		/// 棚卸欠番TBL]削除
		/// </summary>
		public const string SQL_ID_02 = "TJ110P01-02";
		/// <summary>
		/// 棚卸取漏れ欠番検索(V) 確定ボタン
		/// 棚卸確定TBL(H)存在チェック
		/// </summary>
		public const string SQL_ID_03 = "TJ110P01-03";
		...
		/// 棚卸確定TBL(H)存在チェック
		/// </summary>
		public const string SQL_ID_03_REP_ADD_WHERE = "REP_ADD_WHERE";
