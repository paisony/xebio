...
{
  /// <summary>
  /// Tj110f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tj110f01Request_Btnprint : Tj110f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj110f01Request_Btnprint Me = new Tj110f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj110f01Request_Btnprint()
		{
