...
namespace com.xebio.bo.Tj110p01.Request.Tj110f01
{
  /// <summary>
  /// Tj110f01Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tj110f01Request_Btnzenstk : Tj110f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj110f01Request_Btnzenstk Me = new Tj110f01Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj110f01Request_Btnzenstk()
		{
