...
namespace com.xebio.bo.Tj110p01.Formvo.Baseform
{
  /// <summary>
  /// Tj110f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj110f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tj110f01M1BaseForm compare = null;
			if (obj is Tj110f01M1BaseForm)
			{
				compare = (Tj110f01M1BaseForm)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Tj110p01.Formvo.Tj110f01M1Formのハッシュ コード。</returns>
