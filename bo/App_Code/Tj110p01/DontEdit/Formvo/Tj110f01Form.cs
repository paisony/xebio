using com.xebio.bo.Tj110p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Tj110f01のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tj110f01Form : Tj110f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tj110p01","Tj110f01");
