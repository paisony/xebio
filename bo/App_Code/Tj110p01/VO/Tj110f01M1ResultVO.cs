...
{
  /// <summary>
  /// Tj110f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tj110f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tj110f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tj110f01M1ResultVO compare = null;
			if (obj is Tj110f01M1ResultVO)
			{
				compare = (Tj110f01M1ResultVO)obj;
			}
			else
			{
				return false;
