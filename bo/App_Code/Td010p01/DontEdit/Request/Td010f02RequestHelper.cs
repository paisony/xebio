...
{
  /// <summary>
  /// Td010f02RequestHelper の概要の説明です。
  /// </summary>
  public static class Td010f02RequestHelper
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public static void GetRequestValue(IPageContext pageContext)
		{
			...
			//FormVOを取得する
			Td010f02Form formVO = (Td010f02Form)pageContext.GetFormVO();
		...
		public static void CopyForm(IPageContext pageContext)
		{
			...
			{
				Td010f02M1Form td010f02M1Form = (Td010f02M1Form)m1List.GetRowAt(i);
							
				if (paramCol["M1rowno"][i].UnformatValue != null)
				{
					td010f02M1Form.M1rowno = paramCol["M1rowno"][i].UnformatValue;
				}
				if (paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue != null)
				{
					td010f02M1Form.M1hinsyu_ryaku_nm = paramCol["M1hinsyu_ryaku_nm"][i].UnformatValue;
				}
				if (paramCol["M1jisya_hbn"][i].UnformatValue != null)
				{
					td010f02M1Form.M1jisya_hbn = paramCol["M1jisya_hbn"][i].UnformatValue;
				}
				if (paramCol["M1maker_hbn"][i].UnformatValue != null)
				{
					td010f02M1Form.M1maker_hbn = paramCol["M1maker_hbn"][i].UnformatValue;
				}
				if (paramCol["M1syonmk"][i].UnformatValue != null)
				{
					td010f02M1Form.M1syonmk = paramCol["M1syonmk"][i].UnformatValue;
				}
				if (paramCol["M1iro_nm"][i].UnformatValue != null)
				{
					td010f02M1Form.M1iro_nm = paramCol["M1iro_nm"][i].UnformatValue;
				}
				if (paramCol["M1size_nm"][i].UnformatValue != null)
				{
					td010f02M1Form.M1size_nm = paramCol["M1size_nm"][i].UnformatValue;
				}
				if (paramCol["M1scan_cd"][i].UnformatValue != null)
				{
					td010f02M1Form.M1scan_cd = paramCol["M1scan_cd"][i].UnformatValue;
				}
				if (paramCol["M1suryo"][i].UnformatValue != null)
				{
					td010f02M1Form.M1suryo = paramCol["M1suryo"][i].UnformatValue;
				}
				if (paramCol["M1gen_tnk"][i].UnformatValue != null)
				{
					td010f02M1Form.M1gen_tnk = paramCol["M1gen_tnk"][i].UnformatValue;
				}
				if (paramCol["M1genkakin"][i].UnformatValue != null)
				{
					td010f02M1Form.M1genkakin = paramCol["M1genkakin"][i].UnformatValue;
				}
				if (paramCol["M1suryo_hdn"][i].UnformatValue != null)
				{
					td010f02M1Form.M1suryo_hdn = paramCol["M1suryo_hdn"][i].UnformatValue;
				}
				if (paramCol["M1genkakin_hdn"][i].UnformatValue != null)
				{
					td010f02M1Form.M1genkakin_hdn = paramCol["M1genkakin_hdn"][i].UnformatValue;
				}
				if (paramCol["M1selectorcheckbox"][i].UnformatValue != null)
				{
					td010f02M1Form.M1selectorcheckbox = paramCol["M1selectorcheckbox"][i].UnformatValue;
				}
				if (paramCol["M1entersyoriflg"][i].UnformatValue != null)
				{
					td010f02M1Form.M1entersyoriflg = paramCol["M1entersyoriflg"][i].UnformatValue;
				}
				if (paramCol["M1dtlirokbn"][i].UnformatValue != null)
				{
					td010f02M1Form.M1dtlirokbn = paramCol["M1dtlirokbn"][i].UnformatValue;
				}
			}
			if(StandardBaseCheckManager.CheckUseSelfCustomize()){
				// カード部カスタム項目の入力値をFormVOにコピーする
		...
		public static void ValidateCardInputValue(Td010f02Form formVO, StandardCheckManager checker)
		{
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1InputValue(Td010f02Form formVO, StandardCheckManager checker)
		{
			// SCSubBasePageの取得
			...
			int i = 0;
			IDataList m1List = formVO.GetList("M1");
			foreach (Td010f02M1Form td010f02M1Form in m1List.GetCheckRowList())
			{
				// 明細「M1」上のカスタム項目の入力チェックを実行
				scPage.CheckListItems("M1", checker, td010f02M1Form, i, m1List);
				if (td010f02M1Form.M1rowno != null)
				{
					checker.DoCheck("M1rowno", td010f02M1Form.M1rowno, i, m1List);
				}
				if (td010f02M1Form.M1hinsyu_ryaku_nm != null)
				{
					checker.DoCheck("M1hinsyu_ryaku_nm", td010f02M1Form.M1hinsyu_ryaku_nm, i, m1List);
				}
				if (td010f02M1Form.M1jisya_hbn != null)
				{
					checker.DoCheck("M1jisya_hbn", td010f02M1Form.M1jisya_hbn, i, m1List);
				}
				if (td010f02M1Form.M1maker_hbn != null)
				{
					checker.DoCheck("M1maker_hbn", td010f02M1Form.M1maker_hbn, i, m1List);
				}
				if (td010f02M1Form.M1syonmk != null)
				{
					checker.DoCheck("M1syonmk", td010f02M1Form.M1syonmk, i, m1List);
				}
				if (td010f02M1Form.M1iro_nm != null)
				{
					checker.DoCheck("M1iro_nm", td010f02M1Form.M1iro_nm, i, m1List);
				}
				if (td010f02M1Form.M1size_nm != null)
				{
					checker.DoCheck("M1size_nm", td010f02M1Form.M1size_nm, i, m1List);
				}
				if (td010f02M1Form.M1scan_cd != null)
				{
					checker.DoCheck("M1scan_cd", td010f02M1Form.M1scan_cd, i, m1List);
				}
				if (td010f02M1Form.M1suryo != null)
				{
					checker.DoCheck("M1suryo", td010f02M1Form.M1suryo, i, m1List);
				}
				if (td010f02M1Form.M1gen_tnk != null)
				{
					checker.DoCheck("M1gen_tnk", td010f02M1Form.M1gen_tnk, i, m1List);
				}
				if (td010f02M1Form.M1genkakin != null)
				{
					checker.DoCheck("M1genkakin", td010f02M1Form.M1genkakin, i, m1List);
				}
				if (td010f02M1Form.M1suryo_hdn != null)
				{
					checker.DoCheck("M1suryo_hdn", td010f02M1Form.M1suryo_hdn, i, m1List);
				}
				if (td010f02M1Form.M1genkakin_hdn != null)
				{
					checker.DoCheck("M1genkakin_hdn", td010f02M1Form.M1genkakin_hdn, i, m1List);
				}
				if (td010f02M1Form.M1selectorcheckbox != null)
				{
					checker.DoCheck("M1selectorcheckbox", td010f02M1Form.M1selectorcheckbox, i, m1List);
				}
				if (td010f02M1Form.M1entersyoriflg != null)
				{
					checker.DoCheck("M1entersyoriflg", td010f02M1Form.M1entersyoriflg, i, m1List);
				}
				if (td010f02M1Form.M1dtlirokbn != null)
				{
					checker.DoCheck("M1dtlirokbn", td010f02M1Form.M1dtlirokbn, i, m1List);
				}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateCardCodeValue(Td010f02Form formVO, StandardCodeCheckManager checker)
		{
		}
		...
		/// <param name="formVO">フォームVO</param>
		/// <param name="checker">チェックマネージャ</param>
		public static void ValidateM1CodeValue(Td010f02Form formVO, StandardCodeCheckManager checker)
		{
		}
	}
}
