...
{
  /// <summary>
  /// Td010f02 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td010f02M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Td010f02M1BaseForm compare = null;
			if (obj is Td010f02M1BaseForm)
			{
				compare = (Td010f02M1BaseForm)obj;
			}
			else
			{
				return false;
