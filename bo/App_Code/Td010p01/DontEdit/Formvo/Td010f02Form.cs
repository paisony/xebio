using com.xebio.bo.Td010p01.Formvo.Baseform;
...
{
  /// <summary>
  /// Td010f02のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Td010f02Form : Td010f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Td010p01","Td010f02");
