...
{
  /// <summary>
  /// Td010f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Td010f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Td010f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Td010f01M1ResultVO compare = null;
			if (obj is Td010f01M1ResultVO)
			{
				compare = (Td010f01M1ResultVO)obj;
			}
			else
			{
				return false;
