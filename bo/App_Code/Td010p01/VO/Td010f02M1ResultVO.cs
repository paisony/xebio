...
{
  /// <summary>
  /// Td010f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Td010f02M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Td010f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Td010f02M1ResultVO compare = null;
			if (obj is Td010f02M1ResultVO)
			{
				compare = (Td010f02M1ResultVO)obj;
			}
			else
			{
				return false;
		...
		/// </summary>
		/// <returns>現在のcom.xebio.bo.Td010p01.Formvo.Td010f02M1Formのハッシュ コード。</returns>
