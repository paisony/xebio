namespace com.xebio.bo.Td010p01.Request.Td010f01
{
  /// <summary>
  /// Td010f01Request_M1kanri_no の概要の説明です。
  /// </summary>
  public sealed class Td010f01Request_M1kanri_no : Td010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td010f01Request_M1kanri_no Me = new Td010f01Request_M1kanri_no();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td010f01Request_M1kanri_no()
		{
