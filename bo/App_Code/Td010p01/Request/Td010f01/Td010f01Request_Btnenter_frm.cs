...
{
  /// <summary>
  /// Td010f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Td010f01Request_Btnenter : Td010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td010f01Request_Btnenter Me = new Td010f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td010f01Request_Btnenter()
		{
