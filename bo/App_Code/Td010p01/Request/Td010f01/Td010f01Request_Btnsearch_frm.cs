...
{
  /// <summary>
  /// Td010f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Td010f01Request_Btnsearch : Td010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td010f01Request_Btnsearch Me = new Td010f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td010f01Request_Btnsearch()
		{
