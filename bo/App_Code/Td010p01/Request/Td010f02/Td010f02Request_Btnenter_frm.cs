...
{
  /// <summary>
  /// Td010f02Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Td010f02Request_Btnenter : Td010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td010f02Request_Btnenter Me = new Td010f02Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td010f02Request_Btnenter()
		{
