...
namespace com.xebio.bo.Td010p01.Request.Td010f02
{
  /// <summary>
  /// Td010f02Request_Btnrowins の概要の説明です。
  /// </summary>
  public sealed class Td010f02Request_Btnrowins : Td010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td010f02Request_Btnrowins Me = new Td010f02Request_Btnrowins();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td010f02Request_Btnrowins()
		{
...
//
		...
		public override void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//明細部コード存在チェック
			Td010f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
