...
{
  /// <summary>
  /// Td010f02Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Td010f02Request_Btnrowdel : Td010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Td010f02Request_Btnrowdel Me = new Td010f02Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Td010f02Request_Btnrowdel()
		{
