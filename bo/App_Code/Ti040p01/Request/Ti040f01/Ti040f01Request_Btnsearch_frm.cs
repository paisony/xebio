...
{
  /// <summary>
  /// Ti040f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Ti040f01Request_Btnsearch : Ti040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ti040f01Request_Btnsearch Me = new Ti040f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ti040f01Request_Btnsearch()
		{
