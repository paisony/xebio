...
{
  /// <summary>
  /// Ti040f01Request_Btnrowdel の概要の説明です。
  /// </summary>
  public sealed class Ti040f01Request_Btnrowdel : Ti040f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Ti040f01Request_Btnrowdel Me = new Ti040f01Request_Btnrowdel();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Ti040f01Request_Btnrowdel()
		{
