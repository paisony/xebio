...
namespace com.xebio.bo.Ti040p01.VO
{
  /// <summary>
  /// Ti040f01 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Ti040f01M1ResultVO : StandardBaseVO
	{
		...
		/// インスタンスを生成します。
		/// </summary>
		public Ti040f01M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Ti040f01M1ResultVO compare = null;
			if (obj is Ti040f01M1ResultVO)
			{
				compare = (Ti040f01M1ResultVO)obj;
			}
			else
			{
				return false;
