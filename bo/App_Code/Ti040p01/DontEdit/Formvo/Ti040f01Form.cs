using com.xebio.bo.Ti040p01.Formvo.Baseform;
...
namespace com.xebio.bo.Ti040p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Ti040f01Form : Ti040f01BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Ti040p01","Ti040f01");
