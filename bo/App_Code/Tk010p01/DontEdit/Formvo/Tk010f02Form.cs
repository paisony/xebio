using com.xebio.bo.Tk010p01.Formvo.Baseform;
...
namespace com.xebio.bo.Tk010p01.Formvo
{
  ...
  /// </summary>
  [Serializable]
	public class Tk010f02Form : Tk010f02BaseForm
	{
		...
		{
			//明細設計情報を取得
			IFormInfo formInfo = FormInfoManager.GetFormInfo("Tk010p01","Tk010f02");
