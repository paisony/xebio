...
{
  /// <summary>
  /// Tk010f01 明細M1のFormオブジェクトです。
  /// </summary>
  [Serializable]
	public class Tk010f01M1BaseForm : StandardBaseM1Form
	{
		...
		{
			Tk010f01M1BaseForm compare = null;
			if (obj is Tk010f01M1BaseForm)
			{
				compare = (Tk010f01M1BaseForm)obj;
			}
			else
			{
				return false;
