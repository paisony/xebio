...
{
  /// <summary>
  /// Tk010f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tk010f01Request_Btnprint : Tk010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk010f01Request_Btnprint Me = new Tk010f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk010f01Request_Btnprint()
		{
