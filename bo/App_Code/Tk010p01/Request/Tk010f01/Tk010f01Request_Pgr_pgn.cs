...
{
  /// <summary>
  /// Tk010f01Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tk010f01Request_Pgr : Tk010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk010f01Request_Pgr Me = new Tk010f01Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk010f01Request_Pgr()
		{
