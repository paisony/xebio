...
{
  /// <summary>
  /// Tk010f01Request_Btnzenstk の概要の説明です。
  /// </summary>
  public sealed class Tk010f01Request_Btnzenstk : Tk010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk010f01Request_Btnzenstk Me = new Tk010f01Request_Btnzenstk();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk010f01Request_Btnzenstk()
		{
