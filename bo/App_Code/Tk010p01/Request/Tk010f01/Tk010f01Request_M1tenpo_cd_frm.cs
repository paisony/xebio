...
{
  /// <summary>
  /// Tk010f01Request_M1tenpo_cd の概要の説明です。
  /// </summary>
  public sealed class Tk010f01Request_M1tenpo_cd : Tk010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk010f01Request_M1tenpo_cd Me = new Tk010f01Request_M1tenpo_cd();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk010f01Request_M1tenpo_cd()
		{
