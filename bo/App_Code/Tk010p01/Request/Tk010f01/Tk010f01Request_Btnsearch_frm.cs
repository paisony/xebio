...
{
  /// <summary>
  /// Tk010f01Request_Btnsearch の概要の説明です。
  /// </summary>
  public sealed class Tk010f01Request_Btnsearch : Tk010f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk010f01Request_Btnsearch Me = new Tk010f01Request_Btnsearch();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk010f01Request_Btnsearch()
		{
