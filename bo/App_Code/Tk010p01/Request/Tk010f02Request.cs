...
{
  /// <summary>
  /// Tk010f02Request の概要の説明です。
  /// </summary>
  public abstract class Tk010f02Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tk010f02RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tk010f02RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tk010f02RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tk010f02RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tk010f02RequestHelper.ValidateCardInputValue(formVO, checker);
			//明細部の入力項目
			Tk010f02RequestHelper.ValidateM1InputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tk010f02RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
			
			//明細部コード存在チェック
			Tk010f02RequestHelper.ValidateM1CodeValue(formVO, codeChecker);
