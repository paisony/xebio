...
{
  /// <summary>
  /// Tk010f02Request_Btnikkatsukyakka の概要の説明です。
  /// </summary>
  public sealed class Tk010f02Request_Btnikkatsukyakka : Tk010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk010f02Request_Btnikkatsukyakka Me = new Tk010f02Request_Btnikkatsukyakka();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk010f02Request_Btnikkatsukyakka()
		{
