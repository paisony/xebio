...
{
  /// <summary>
  /// Tk010f02Request_Btnback の概要の説明です。
  /// </summary>
  public sealed class Tk010f02Request_Btnback : Tk010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk010f02Request_Btnback Me = new Tk010f02Request_Btnback();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk010f02Request_Btnback()
		{
