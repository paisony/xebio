...
{
  /// <summary>
  /// Tk010f02Request_Pgr の概要の説明です。
  /// </summary>
  public sealed class Tk010f02Request_Pgr : Tk010f02Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tk010f02Request_Pgr Me = new Tk010f02Request_Pgr();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tk010f02Request_Pgr()
		{
