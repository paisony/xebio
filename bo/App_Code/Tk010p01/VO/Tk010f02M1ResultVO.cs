...
{
  /// <summary>
  /// Tk010f02 明細M1のResultVOクラスです。
  ///
  /// </summary>
  [Serializable]
	public class Tk010f02M1ResultVO : StandardBaseVO
	{
		...
		/// <summary>
		/// 項目「M1HYOKASONRIYU()」の値を取得または設定する。
		/// </summary>
		...
		/// インスタンスを生成します。
		/// </summary>
		public Tk010f02M1ResultVO() : base()
		{
		}
		#endregion
		...
		{
			Tk010f02M1ResultVO compare = null;
			if (obj is Tk010f02M1ResultVO)
			{
				compare = (Tk010f02M1ResultVO)obj;
			}
			else
			{
				return false;
