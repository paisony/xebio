...
{
  /// <summary>
  /// フォーム：Tk010f02 項目：M1hyokasonsyubetsu_kb の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tk010f02Codeex_M1hyokasonsyubetsu_kb : StandardBaseCodeex
	{
		public Tk010f02Codeex_M1hyokasonsyubetsu_kb()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			// 項目追加
			context.Condition.AddFindKey("SIKIBETSU_CD = '" + Tk010p01Constant.MEISHO_SIKIBETSU_CD_SYUBETSU + "'");
