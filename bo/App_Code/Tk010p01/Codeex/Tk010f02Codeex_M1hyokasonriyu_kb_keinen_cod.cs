...
namespace com.xebio.bo.Tk010p01.Codeex
{
  /// <summary>
  /// フォーム：Tk010f02 項目：M1hyokasonriyu_kb_keinen の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Tk010f02Codeex_M1hyokasonriyu_kb_keinen : StandardBaseCodeex
	{
		public Tk010f02Codeex_M1hyokasonriyu_kb_keinen()
		{
		}
		...
		public override void Initialize(ICodeContext context)
		{
			...
			context.Condition.AddFindKey("SIKIBETSU_CD = '" + Tk010p01Constant.MEISHO_SIKIBETSU_CD_RIYU + "'");
			context.Condition.AddFindKey("MEISYO_CD = '" + ConditionHyokason_riyiu.VALUE_HYOKASON_RIYIU12 + "'");
