namespace com.xebio.bo.Tj140p01.Request.Tj140f01
{
  /// <summary>
  /// Tj140f01Request_Btnenter の概要の説明です。
  /// </summary>
  public sealed class Tj140f01Request_Btnenter : Tj140f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tj140f01Request_Btnenter Me = new Tj140f01Request_Btnenter();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tj140f01Request_Btnenter()
		{
