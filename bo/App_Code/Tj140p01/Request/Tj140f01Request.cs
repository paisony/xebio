...
{
  /// <summary>
  /// Tj140f01Request の概要の説明です。
  /// </summary>
  public abstract class Tj140f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tj140f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tj140f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tj140f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tj140f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tj140f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tj140f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
