namespace com.xebio.bo.Aa020p01.Request.Aa020f01
{
  /// <summary>
  /// Aa020f01Request_Btnseal の概要の説明です。
  /// </summary>
  public sealed class Aa020f01Request_Btnseal : Aa020f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Aa020f01Request_Btnseal Me = new Aa020f01Request_Btnseal();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Aa020f01Request_Btnseal()
		{
