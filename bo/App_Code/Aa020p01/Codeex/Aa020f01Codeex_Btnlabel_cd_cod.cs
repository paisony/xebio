...
namespace com.xebio.bo.Aa020p01.Codeex
{
  /// <summary>
  /// フォーム：Aa020f01 項目：Btnlabel_cd の拡張コード参照クラスです。
  /// </summary>
  [Serializable]
	public class Aa020f01Codeex_Btnlabel_cd : StandardBaseCodeex
	{
		public Aa020f01Codeex_Btnlabel_cd()
		{
		}
		...
		public override void InitSearch(ICodeContext context)
		{
			...
			// ヘッダ店舗コードを検索条件に追加
			context.Condition.AddFindKey("Head_tenpo_cd", "TENPO_CD", SearchItemType.End);
