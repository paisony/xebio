namespace com.xebio.bo.Tf050p01.Request.Tf050f01
{
  /// <summary>
  /// Tf050f01Request_Btnprint の概要の説明です。
  /// </summary>
  public sealed class Tf050f01Request_Btnprint : Tf050f01Request
	{
		/// <summary>
		/// このクラス唯一のインスタンス。
		/// </summary>
		public static readonly Tf050f01Request_Btnprint Me = new Tf050f01Request_Btnprint();

		/// <summary>
		/// インスタンスを生成します。
		/// </summary>
		private Tf050f01Request_Btnprint()
		{
