...
{
  /// <summary>
  /// Tf050f01Request の概要の説明です。
  /// </summary>
  public abstract class Tf050f01Request:StandardBaseRequest, IActionPreProcessor
	{
		/// <summary>
		/// 入力値を取得します。
		/// </summary>
		...
		public virtual void DoGetRequestValue(IPageContext pageContext)
		{
			...
			Tf050f01RequestHelper.GetRequestValue(pageContext);
		}
		...
		{
			Tf050f01RequestHelper.ExtItemInfo(pageContext);
		}
		...
		{
			Tf050f01RequestHelper.Unformat(pageContext);
		}
		...
		{
			Tf050f01RequestHelper.CopyForm(pageContext);
		}
		...
		public virtual void DoValidateInputValue(IPageContext pageContext)
		{
			...
			//カード部の入力項目
			Tf050f01RequestHelper.ValidateCardInputValue(formVO, checker);
		...
		public virtual void DoValidateCodeValue(IPageContext pageContext)
		{
			...
			//カード部コード存在チェック
			Tf050f01RequestHelper.ValidateCardCodeValue(formVO, codeChecker);
