...
namespace com.xebio.bo.Tb030p01.Page
{
  ...
  /// Tb030p01の初期化ページです。
  /// </summary>
  public partial class Tb030p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tb030p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tb030f01", true);
					//efm.SetItemInfoFlg(pgId, "Tb030f02", true);
				}
				...
				{
					// [入荷予定日ＦＲＯＭ]にフォーカスを当てる。
					focusItem = "Nyukayotei_ymd_from";
				}
