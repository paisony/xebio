<%@ Page language="c#" CodeFile="tb030f02.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tb030p01.Page.Tb030f02Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tb030p01" FormId="tb030f02" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tb030f02.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tb030p01" FormId="tb030f02" runat="server" />
	<!-- Js業務部品のインポート --->
...
<body>
	<form id="Tb030f02" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tb030p01" PgName="仕入入荷確定" FormId="tb030f02" FormName="仕入入荷確定 明細" ></uc:Header>
					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td class="last"><asp:TextBox ID="Siiresaki_cd" CssClass="inpReadonlyLeft inpRONum4" runat="server"></asp:TextBox><asp:TextBox ID="Siiresaki_ryaku_nm1" CssClass="inpReadonlyLeft inpROZenkaku10 inpRORightNm" runat="server"></asp:TextBox></td>
					...
					<%-- 明細ヘッダ --%>
						<div class="str-result-hdg-01">
							...
							<div style="display:none">
								<div class="col14">
									<asp:Label ID="M1kensu_hdn_lbl" runat="server"></asp:Label>
								</div>
								<div class="col15">
									...
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col4 detail_left">
											...
											<div>
												...
												<asp:TextBox ID="M1syonmk" CssClass="inpReadonlyLeft inpROHankaku30 tooltip" runat="server"></asp:TextBox>
											</div>
										</div>
						...
						<div class="str-result-ftr-01 adjust-elem-next">
							...
							<div class="col6 detail_center">&nbsp;</div>
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<asp:Label ID="Siiresaki_ryaku_nm1_lbl" runat="server"></asp:Label>
