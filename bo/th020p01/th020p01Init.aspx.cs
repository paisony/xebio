...
namespace com.xebio.bo.Th020p01.Page
{
  ...
  /// Th020p01の初期化ページです。
  /// </summary>
  public partial class Th020p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Th020p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Th020f01", true);
					//efm.SetItemInfoFlg(pgId, "Th020f02", true);
					//efm.SetItemInfoFlg(pgId, "Th020f03", true);
					//efm.SetItemInfoFlg(pgId, "Th020f04", true);
				}
