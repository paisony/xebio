...
function RunV2004(CTLname) {
	// 丸め処理部品を起動
	formatScanCd(getAdvControlFromItemID(CTLname));
 	...
 	// 名称取得部品
 	V02004(condition, result, getAdvControlFromItemID(CTLname), false, 0);
}
