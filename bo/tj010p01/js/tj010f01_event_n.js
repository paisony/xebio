...
function onSubmit() {
	...
	switch (AdvGB_LastClickItemNm.toUpperCase()) {
		...
		case "Btnenter".toUpperCase():
			...
			if (getAdvControlFromItemID("Tanaorosi_sosin_jyotai")[0].checked) {
				var msg = getMessage("I105");
			} else if (getAdvControlFromItemID("Tanaorosi_sosin_jyotai")[1].checked) {
