<%@ Page Language="c#" CodeFile="tj010f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tj010p01.Page.Tj010f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tj010p01" FormId="tj010f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tj010f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tj010p01" FormId="tj010f01" runat="server" />
...
<body>
	<form id="Tj010f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">

			<uc:Header ID="header" runat="server" PgId="tj010p01" PgName="棚卸送信処理(V)" FormId="tj010f01" FormName="棚卸送信処理"></uc:Header>
