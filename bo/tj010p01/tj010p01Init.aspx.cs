...
namespace com.xebio.bo.Tj010p01.Page
{
  ...
  /// Tj010p01の初期化ページです。
  /// </summary>
  public partial class Tj010p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj010p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj010f01", true);
				}
			    ...
			    {
			        // [棚卸送信状態]にフォーカスを当てる。
					// ここでのラジオボタンへのフォーカス設定が不可能なため該当コードを{tj010f01.aspx.cs_Attribute設定}に記載
