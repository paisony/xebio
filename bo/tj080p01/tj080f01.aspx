<%@ Page language="c#" CodeFile="tj080f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tj080p01.Page.Tj080f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tj080p01" FormId="tj080f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tj080f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tj080p01" FormId="tj080f01" runat="server" />
...
<body>
	<form id="Tj080f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tj080p01" PgName="棚卸状況確認" FormId="tj080f01" FormName="棚卸状況確認" ></uc:Header>
									...
									<div class="inner">
										<table>
											...
											<tr>
												<th scope="col">
													<span class="tbl-hdg">
														<asp:Label ID="Sosin_ymd_from_lbl" runat="server">送信日</asp:Label>
													</span>
												</th>
												<td colspan="2">
					...
					<%-- 明細ヘッダ --%>
						<div class="str-result-hdg-01">
							...
							<div style="display:none">
								...
								<div class="col6">
									<asp:Label ID="M1tenpo_kakutei_jyokyo_nm_lbl" runat="server"></asp:Label>
								</div>
								<div class="col8">
									<asp:Label ID="M1md_sosin_jyokyo_nm_lbl" runat="server"></asp:Label>
								</div>
								...
								<ItemTemplate>
									<div class="str-result-item-01">
										...
										<div class="col4 detail_left">
											...
											<asp:TextBox ID="M1tenpo_kakutei_jyokyo_nm" CssClass="inpReadonlyLeft inpROZenkaku6 tooltip" runat="server"></asp:TextBox>
										</div>
										<div class="col5 detail_left">
											...
											<!--- 「ｍ１ｍｄ送信状況名称」テキストボックスリードオンリー --->
											<asp:TextBox ID="M1md_sosin_jyokyo_nm" CssClass="inpReadonlyLeft inpROZenkaku6 tooltip" runat="server"></asp:TextBox>
										</div>
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<asp:Label ID="Konkai_flg_lbl" runat="server">今回フラグ</asp:Label>
