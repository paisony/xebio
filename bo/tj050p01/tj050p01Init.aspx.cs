...
namespace com.xebio.bo.Tj050p01.Page
{
  ...
  /// Tj050p01の初期化ページです。
  /// </summary>
  public partial class Tj050p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj050p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj050f01", true);
				}
				...
				{
					// [棚卸送信状態]にフォーカスを当てる。
					// ここでのラジオボタンへのフォーカス設定が不可能のため該当コードを{tj050f01.aspx.cs_Attribute設定}に記載
