<%@ Page language="c#" CodeFile="tj100f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tj100p01.Page.Tj100f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tj100p01" FormId="tj100f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tj100f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tj100p01" FormId="tj100f01" runat="server" />
	<!-- Js業務部品のインポート --->
	...
	<script type="text/javascript" src="../pjcommon/businessCommon/js/C05018.js" charset="UTF-8"></script><!-- 棚卸欠番用 検索条件転送処理 -->


</head>
<%--  --%>
<body>
	<form id="Tj100f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tj100p01" PgName="棚卸取漏れ欠番検索(V)" FormId="tj100f01" FormName="棚卸取漏れ欠番検索" ></uc:Header>
									...
									<div class="inner">
										<table>
											...
											<tr>
												...
												<!--- 「フェイス№1from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№1to」一行テキストボックス（セパレート日付以外） --->
												<!--- 「フェイス№2from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№2to」一行テキストボックス（セパレート日付以外） --->
												<!--- 「フェイス№3from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№3to」一行テキストボックス（セパレート日付以外） --->
												<!--- 「フェイス№4from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№4to」一行テキストボックス（セパレート日付以外） --->
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from1" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to1" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from2" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to2" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from3" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to3" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from4" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to4" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
											</tr>
											<tr>
												<!--- 「フェイス№5from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№5to」一行テキストボックス（セパレート日付以外） --->
												<!--- 「フェイス№6from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№6to」一行テキストボックス（セパレート日付以外） --->
												<!--- 「フェイス№7from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№7to」一行テキストボックス（セパレート日付以外） --->
												<!--- 「フェイス№8from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№8to」一行テキストボックス（セパレート日付以外） --->
												<!--- 「フェイス№9from」一行テキストボックス（セパレート日付以外） ---><!--- 「フェイス№9to」一行テキストボックス（セパレート日付以外） --->
												<td></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from5" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to5" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from6" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to6" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from7" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to7" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from8" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to8" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
												<td><span class="tbl-hdg" style="display:none;">&nbsp;</span><md:MDTextBox ID="Face_no_from9" CssClass="inpFaceNo" runat="server"></md:MDTextBox><span class="label-fromto">～</span><md:MDTextBox ID="Face_no_to9" CssClass="inpFaceNo" runat="server"></md:MDTextBox></td>
											</tr>
										</table>
									<!-- /inner --></div>
								<!-- /str-form-02 --></div>
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<asp:Label ID="Face_no_from1_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to1_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_from2_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to2_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_from3_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to3_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_from4_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to4_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_from5_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to5_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_from6_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to6_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_from7_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to7_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_from8_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to8_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_from9_lbl" runat="server"></asp:Label>
			<asp:Label ID="Face_no_to9_lbl" runat="server"></asp:Label>
