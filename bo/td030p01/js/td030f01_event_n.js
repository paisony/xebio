...
function onLoad() {
	...
	// 伝票状態が空白/確定/ﾏﾆｭｱﾙ返品の場合は選択可、それ以外は選択不可とする。
	if (getAdvControlFromItemID("Denpyo_jyotai").value == "-1"
		|| getAdvControlFromItemID("Denpyo_jyotai").value == "1"
		|| getAdvControlFromItemID("Denpyo_jyotai").value == "3") {
//		selectorCheckBox = '';
	} else {
