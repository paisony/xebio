...
namespace com.xebio.bo.Tb090p01.Page
{
  ...
  /// Tb090p01の初期化ページです。
  /// </summary>
  public partial class Tb090p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tb090p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tb090f01", true);
					//efm.SetItemInfoFlg(pgId, "Tb090f02", true);
				}
				...
				{
					// [元伝票番号ＦＲＯＭ]にフォーカスを当てる。
					focusItem = "Motodenpyo_bango_from";
				}
