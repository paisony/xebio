<%@ Page language="c#" CodeFile="tb090f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tb090p01.Page.Tb090f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tb090p01" FormId="tb090f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tb090f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tb090p01" FormId="tb090f01" runat="server" />
...
<body>
	<form id="Tb090f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tb090p01" PgName="仕入伝票訂正" FormId="tb090f01" FormName="仕入伝票訂正 一覧" ></uc:Header>
									...
									<div class="inner">
										<table>
											...
											<tbody>
												<tr>
													<th>
														<span class="tbl-hdg"><asp:Label ID="Motodenpyo_bango_from_lbl" runat="server">元伝票番号ＦＲＯＭ</asp:Label></span>
													</th>
													...
													<th>
														<span class="tbl-hdg"><asp:Label ID="Nyukayotei_ymd_from_lbl" runat="server">入荷予定日ＦＲＯＭ</asp:Label></span>
													</th>
													...
													<th>
														<span class="tbl-hdg"><asp:Label ID="Siire_kakutei_ymd_from_lbl" runat="server">仕入確定日ＦＲＯＭ</asp:Label></span>
													</th>
												...
												<tr>
													...
													<th>
														<span class="tbl-hdg"><asp:Label ID="Bumon_cd_from_lbl" runat="server">部門ＦＲＯＭ</asp:Label></span>
													</th>
												...
												<tr>
													<th class="last">
														<span class="tbl-hdg"><asp:Label ID="Kakutei_sb_lbl" runat="server">確定種別</asp:Label></span>
													</th>
													<!--- 「確定種別」ドロップダウンリスト --->
													<td class="last" colspan="5">
														<md:MDConditionDDList ID="Kakutei_sb" ConditionName="siire_kakutei_jotai" CssClass="slt-kakutei" runat="server"></md:MDConditionDDList>
				...
				<div class="inner">
					...
					<%-- 明細ヘッダ --%>
						<div class="str-result-hdg-01">
							...
							<div class="col13">
								<asp:Label ID="M1kakutei_sb_nm_lbl" runat="server">確定種別</asp:Label>
							</div>
							<div class="col14">
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col3 detail_left">
											...
											<asp:TextBox ID="M1siiresaki_cd" CssClass="inpReadonlyRight inpRONum4" runat="server"></asp:TextBox><asp:TextBox ID="M1siiresaki_ryaku_nm" CssClass="inpReadonlyLeft inpRORightNm inpROHankaku10 tooltip" runat="server"></asp:TextBox>
										</div>
										...
										<div class="col13 detail_left">
											<!--- 「ｍ１確定種別名称」テキストボックスリードオンリー --->
											<asp:TextBox ID="M1kakutei_sb_nm" CssClass="inpReadonlyLeft inpROZenkaku5 tooltip" runat="server"></asp:TextBox>
										</div>
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<asp:Label ID="Nyukayotei_ymd_to_lbl" runat="server">入荷予定日ＴＯ</asp:Label>
			<asp:Label ID="Siire_kakutei_ymd_to_lbl" runat="server">仕入確定日ＴＯ</asp:Label>
