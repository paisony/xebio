...
namespace com.xebio.bo.Ta010p01.Page
{
  ...
  /// Ta010p01の初期化ページです。
  /// </summary>
  public partial class Ta010p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Ta010p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Ta010f01", true);
					//efm.SetItemInfoFlg(pgId, "Ta010f02", true);
				}
