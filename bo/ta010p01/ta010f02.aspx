<%@ Page language="c#" CodeFile="ta010f02.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Ta010p01.Page.Ta010f02Page" %>
...
<head>
	...
	<title id="Windowtitle" runat="server">補充依頼入力</title>
	<!--- キャッシュの無効化設定 --->
	<adv:NoCache ID="NoCache1" runat="server" />

	<!--- スクリプトヘルパー、項目テーブル、業務スクリプトのインポート --->
	<adv:SetHeader ID="SetHeader1" PgId="ta010p01" FormId="ta010f02" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/ta010f02.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="ta010p01" FormId="ta010f02" runat="server" />
...
<body>
	<form id="Ta010f02" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="ta010p01" PgName="補充依頼入力" FormId="ta010f02" FormName="補充依頼入力 明細" ></uc:Header>
					...
					<table>
						...
						<tbody>
							<tr>
								<!--- 「区分コード」 --->
								<!--- 「区分コード」ドロップダウンリスト --->
								<th><span class="tbl-hdg"><asp:Label ID="Kbn_cd_lbl" runat="server">区分</asp:Label></span></th>
								<td>
									<md:MDConditionDDList ID="Kbn_cd" ConditionName="hojuirai_kbn" CssClass="slt-ddl slt-kbn" runat="server"></md:MDConditionDDList>
									<span class="select-arrow"></span>
								</td>
								<!--- 「発注日」 --->
								<!--- 「発注日」テキストボックスリードオンリー --->
								<th><span class="tbl-hdg"><asp:Label ID="Hattyu_ymd_lbl" runat="server">発注日</asp:Label></span></th>
								<td>
									<asp:TextBox ID="Hattyu_ymd" CssClass="inpReadonlyLeft inpRODate" runat="server"></asp:TextBox>
								</td>
								<!--- 「担当者」 --->
								...
								<!--- 「依頼理由コード」 --->
											<!--- 「依頼理由コード」ドロップダウンリスト --->
								<th><span class="tbl-hdg"><asp:Label ID="Irairiyu_cd1_lbl" runat="server">依頼理由</asp:Label></span></th>
								<td>
									<md:MDCodeCondition ID="Irairiyu_cd1" FormID="Ta010f02" PgID="Ta010p01" CssClass="slt-ddl slt-riyu" runat="server"></md:MDCodeCondition>
									<span class="select-arrow"></span>
									<md:MDCodeCondition ID="Irairiyu_cd2" FormID="Ta010f02" PgID="Ta010p01" CssClass="slt-ddl slt-riyu" runat="server"></md:MDCodeCondition>
									<span class="select-arrow"></span>
								</td>
							</tr>
						</tbody>
					...
					<%-- 明細ヘッダ --%>
						<div class="str-result-hdg-01">
							...
							<div class="col4">
								...
								<div class="col4-1 headcell"><asp:Label ID="M1jido_su_lbl" runat="server">自動定数</asp:Label></div>
								<div class="col4-2 headcell"><asp:Label ID="M1haibunkano_su_lbl" runat="server">配可数</asp:Label></div>
							</div>
							<div class="col5">
								<div><asp:Label ID="M1jisya_hbn_lbl" runat="server">自社品番</asp:Label></div>
								<div><asp:Label ID="M1irai_syukei_lbl" runat="server">依頼集計</asp:Label></div>
							</div>
							<div class="col6">
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col5 detail_center">
											...
											<!--- 「ｍ１依頼集計」テキストボックスリードオンリー --->
											<div><asp:TextBox ID="M1irai_syukei" CssClass="inpReadonlyRight inpRONumCma7" runat="server"></asp:TextBox></div>
										</div>
						...
						<div class="str-result-ftr-01 adjust-elem-next">
							...
							<div class="col5 detail_center">&nbsp;</div>
							<div class="col6 detail_left">&nbsp;</div>
							<div class="col7 detail_left">&nbsp;</div>
							<div class="col8 detail_ftr_title">合計</div>
							<!--- 「合計依頼数量」テキストボックスリードオンリー --->
							<div class="col9 detail_ftr"><span><asp:TextBox ID="Gokei_irai_su" CssClass="inpReadonlyRight inpRONumCma9" runat="server"></asp:TextBox></span></div>
							<!--- 「合計原価金額」テキストボックスリードオンリー --->
							<div class="col10 detail_ftr"><span><asp:TextBox ID="Gokei_genkakin" CssClass="inpReadonlyRight inpRONumCma9" runat="server"></asp:TextBox></span></div>
