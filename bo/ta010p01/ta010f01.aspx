<%@ Page language="c#" CodeFile="ta010f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Ta010p01.Page.Ta010f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="ta010p01" FormId="ta010f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/ta010f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="ta010p01" FormId="ta010f01" runat="server" />
...
<body>
	<form id="Ta010f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="ta010p01" PgName="補充依頼入力" FormId="ta010f01" FormName="補充依頼入力 一覧" ></uc:Header>
									...
									<div class="inner">
										...
										<table>
											...
											<tr>
												<!--- 「区分コード」 --->
												<th>
													<span class="tbl-hdg"><asp:Label ID="Kbn_cd_lbl" runat="server">区分</asp:Label></span>
												</th>
												<!--- 「区分コード」ドロップダウンリスト --->
												<td>
													<md:MDConditionDDList ID="Kbn_cd" ConditionName="hojuirai_kbn" CssClass="slt-ddl slt-kbn" runat="server" onserverclick="OnDDLKBN_CLICK"></md:MDConditionDDList>
													<span class="select-arrow"></span>
												</td>
												<!--- 「発注日」 --->
												<th>
													<span class="tbl-hdg"><asp:Label ID="Hattyu_ymd_from_lbl" runat="server">発注日</asp:Label></span>
												</th>
												<!--- 「発注日from」一行テキストボックス（セパレート日付以外） --->
												<!--- 「発注日to」一行テキストボックス（セパレート日付以外） --->
												<td>
													<span class="icon-in"><md:MDTextBox ID="Hattyu_ymd_from" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox></span>
													<span class="label-fromto">～</span>
													<span class="icon-in"><md:MDTextBox ID="Hattyu_ymd_to" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox></span>
												</td>
												<!--- 「担当者コード」 --->
												<th>
											...
											<tr>
												...
												<!--- 「依頼理由コード」ドロップダウンリスト --->
												<td>
													<md:MDCodeCondition ID="Irairiyu_cd1" FormID="Ta010f01" PgID="Ta010p01" CssClass="slt-ddl slt-riyu" runat="server"></md:MDCodeCondition>
													<span class="select-arrow"></span>
													<md:MDCodeCondition ID="Irairiyu_cd2" FormID="Ta010f01" PgID="Ta010p01" CssClass="slt-ddl slt-riyu" runat="server"></md:MDCodeCondition>
													<span class="select-arrow"></span>
												</td>
												<!--- 「申請状態」 --->
												<th>
					...
					<%-- 明細ヘッダ --%>
						<div class="str-result-hdg-01">
							...
							<div style="display:none">
								...
								<asp:Label ID="Btnenter_lbl" runat="server"></asp:Label>
							</div>
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col2 detail_left">
											...
											<asp:TextBox ID="M1hojuirai_kbn_nm" CssClass="inpReadonlyLeft inpRORightNm inpROZenkaku10 tooltip" runat="server"></asp:TextBox>
										</div>
