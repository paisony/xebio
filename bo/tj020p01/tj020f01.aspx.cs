...
using com.xebio.bo.Tj020p01.Facade;
...
namespace com.xebio.bo.Tj020p01.Page
{
  ...
  /// Tj020f01のコードビハインドです。
  /// </summary>
  public partial class Tj020f01Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Tj020f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tj020f01Facade().DoLoad(facadeContext);
								#region 共通ヘッダ処理

								// 一覧画面共通処理 ----------
								LoginInfoVO loginInfVO = LoginInfoUtil.GetLoginInfo();
								Tj020f01Form Tj020f01Form = (Tj020f01Form)facadeContext.FormVO;
								ControlHeaderStoreCls.InitialSetHeaderStore<Tj020f01Form>(loginInfVO, Tj020f01Form);
								// 一覧画面共通処理 ----------
				...
				*/
				...
				if (pageContext != null)
				{
					string msg = InfoMsgCls.GetWarningMsg(pageContext, Tj020p01Constant.PGID);
		...
		protected virtual void OnBTNENTER_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Tj020f01Facade().DoBTNENTER_FRM(facadeContext);
				...
				{
					// インフォメッセージの表示
					InfoMsgCls.showLoadMsg(pageContext, 1, Tj020p01Constant.PGID);
				}
				// インフォメッセージ ----------------------------------------------------------------------	
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Tj020f01Form tj020f01Form = (Tj020f01Form)pageContext.GetFormVO();

						//カード部データを表示する
						RenderCard(tj020f01Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// カードデータを表示する
		/// </summary>
		/// <param name="tj020f01Form">画面FormVO</param>
		/// <param name="formInfo">画面情報</param>
		/// <param name="formResource">画面リソース</param>
		/// <param name="lang">言語設定</param>
		private void RenderCard(
			Tj020f01Form tj020f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tj020f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tj020f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Tanaorosi_sosin_jyotai,
				DataFormatUtil.GetFormatItem(tj020f01Form.Tanaorosi_sosin_jyotai,formInfo["Tanaorosi_sosin_jyotai"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tj020f01Form)base.GetPageContext().GetFormVO());
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tj020f01_Titlebar", lang);
				header.FormName = formResource.GetString("Tj020f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
