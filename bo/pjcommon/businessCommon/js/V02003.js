 ...
 *  		var condition = {
 *  			 "SCAN_CD"			: getAdvControlFromItemID("M1jisya_hbn", lineNo)
...
function V02003(condition
	...
	V02003_INNER(condition, result, calcF, row);

}

function V02003_INNER(condition, result, calcF, row) {
	searchCommonInner_RO_BO(condition, result, calcF, row, "V02003.aspx");
}
