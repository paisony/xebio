/**
 * V02012 ブランドマスタ取得取得
 *   呼出し例： V02012(getAdvControlFromItemID("id1"), getAdvControlFromItemID("name"), getAdvControlFromItemID("errId1"));
 ...
 */
function V02012_MAIN(idCTL1, nameCTL, errCTL1, delFlg) {
...
//	onBlur_adv(idCTL1);
	...
	V02012_INNER(condition, result, readOnly);
}
function V02012(idCTL1, nameCTL, errCTL1) {
	V02012_MAIN(idCTL1, nameCTL, errCTL1, 1);
}

function V02012_INNER(condition, result, readOnly) {
	searchCommonInner_RO(condition, result, readOnly, "V02012.aspx");
}
