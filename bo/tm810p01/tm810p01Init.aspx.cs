...
namespace com.xebio.bo.Tm810p01.Page
{
  ...
  /// Tm810p01の初期化ページです。
  /// </summary>
  public partial class Tm810p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tm810f01", true);
				}
                ...
                //遷移元のプログラムIDをqueryListに追加する
                queryList.Add("prePgId", prePgId);
