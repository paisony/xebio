<%@ Page language="c#" CodeFile="tj090f02.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tj090p01.Page.Tj090f02Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tj090p01" FormId="tj090f02" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tj090f02.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tj090p01" FormId="tj090f02" runat="server" />
...
<body>
	<form id="Tj090f02" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tj090p01" PgName="棚卸アンマッチ検索" FormId="tj090f02" FormName="棚卸アンマッチ検索 明細" ></uc:Header>
					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td class="last">
									<!--- 「フェイス№」テキストボックスリードオンリー --->
									<asp:TextBox ID="Face_no" CssClass="inpReadonlyRight inpRONum5" runat="server"></asp:TextBox>
								</td>
								...
								<td class="last">
									<!--- 「棚段」テキストボックスリードオンリー --->
									<asp:TextBox ID="Tana_dan" CssClass="inpReadonlyRight inpRONum2" runat="server"></asp:TextBox>
								</td>
								<th scope="col" class="last">
									<span class="tbl-hdg">
							...
							<tr class="last">
								...
								<th scope="col" class="last">
									<span class="tbl-hdg">
										<asp:Label ID="Riyucomment_nm_lbl" runat="server">棚卸理由</asp:Label>
									</span>
								</th>
