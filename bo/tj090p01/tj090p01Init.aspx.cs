...
namespace com.xebio.bo.Tj090p01.Page
{
  ...
  /// Tj090p01の初期化ページです。
  /// </summary>
  public partial class Tj090p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj090p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj090f01", true);
					//efm.SetItemInfoFlg(pgId, "Tj090f02", true);
				}
                ...
                {
                    // [ラベル発行機ｉｄｆｒｏｍ]にフォーカスを当てる。
                    focusItem = "Face_no_from";
                }
