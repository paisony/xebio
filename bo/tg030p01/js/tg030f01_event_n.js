	...
	function onChange(ev) {
		...
		switch (eventTargetName.toUpperCase()) {
			...
			case "Tantosya_cd".toUpperCase():	// 担当者コード
				// 名称取得部品を起動
				V02005(getAdvControlFromItemID("Tantosya_cd"), getAdvControlFromItemID("Hanbaiin_nm"), getAdvControlFromItemID("Tantosya_cd"));
				break;
