...
using com.xebio.bo.Tg030p01.Facade;
...
namespace com.xebio.bo.Tg030p01.Page
{
  ...
  /// Tg030f01のコードビハインドです。
  /// </summary>
  public partial class Tg030f01Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Tg030f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tg030f01Facade().DoLoad(facadeContext);
								...
								ControlHeaderStoreCls.InitialSetHeaderStore<Tg030f01Form>(loginInfVO, Tg030f01Form);
								//// 一覧画面共通処理 ----------
				...
				*/
				...
				if (pageContext != null)
				{
					string msg = BoSystemLabelUtil.GetScriptLabelPrint(pageContext, Tg030p01Constant.PGID);
		...
		protected virtual void OnBTNSEAL_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Tg030f01Facade().DoBTNSEAL_FRM(facadeContext);
				...
				// CSVファイル名を取得
				string csvNm = (string)facadeContext.GetUserObject(Tg030p01Constant.FCDUO_SEAL_CSVFLNM);

				// シールレイアウト
				List<string> layout = (List<string>)facadeContext.GetUserObject(Tg030p01Constant.FCDUO_SEAL_LAYOUTNM);

				// シール発行スクリプトの出力
				BoSystemLabelUtil.createScriptLabelPrint(pageContext, Tg030p01Constant.PGID, layout, csvNm);
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Tg030f01Form tg030f01Form = (Tg030f01Form)pageContext.GetFormVO();

						//カード部データを表示する
						RenderCard(tg030f01Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// カードデータを表示する
		/// </summary>
		/// <param name="tg030f01Form">画面FormVO</param>
		/// <param name="formInfo">画面情報</param>
		/// <param name="formResource">画面リソース</param>
		/// <param name="lang">言語設定</param>
		private void RenderCard(
			Tg030f01Form tg030f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tg030f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tg030f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Maisu,
				DataFormatUtil.GetFormatItem(tg030f01Form.Maisu,formInfo["Maisu"]));
			ControlUtil.SetControlValue(Tantosya_cd,
				DataFormatUtil.GetFormatItem(tg030f01Form.Tantosya_cd,formInfo["Tantosya_cd"]));
			ControlUtil.SetControlValue(Hanbaiin_nm,
				DataFormatUtil.GetFormatItem(tg030f01Form.Hanbaiin_nm,formInfo["Hanbaiin_nm"]));
			ControlUtil.SetControlValue(Tantosya_cd2,
				DataFormatUtil.GetFormatItem(tg030f01Form.Tantosya_cd2,formInfo["Tantosya_cd2"]));
			ControlUtil.SetControlValue(Label_cd,
				DataFormatUtil.GetFormatItem(tg030f01Form.Label_cd,formInfo["Label_cd"]));
			ControlUtil.SetControlValue(Label_ip,
				DataFormatUtil.GetFormatItem(tg030f01Form.Label_ip,formInfo["Label_ip"]));
			ControlUtil.SetControlValue(Label_nm,
				DataFormatUtil.GetFormatItem(tg030f01Form.Label_nm,formInfo["Label_nm"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tg030f01Form)base.GetPageContext().GetFormVO());
		...
		private void SetCardCaption(FormResource formResource, string lang)
		{
			...
			ControlUtil.SetControlValue(Tantosya_cd2_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Tantosya_cd2", lang), base.GetPageContext().FormInfo["Tantosya_cd2"]));
				DataFormatUtil.SetMustColorCaption(Tantosya_cd2_lbl, base.GetPageContext().FormInfo["Tantosya_cd2"]);
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tg030f01_Titlebar", lang);
				header.FormName = formResource.GetString("Tg030f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
