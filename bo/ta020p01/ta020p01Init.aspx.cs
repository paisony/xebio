...
namespace com.xebio.bo.Ta020p01.Page
{
  ...
  /// Ta020p01の初期化ページです。
  /// </summary>
  public partial class Ta020p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Ta020p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Ta020f01", true);
					//efm.SetItemInfoFlg(pgId, "Ta020f02", true);
				}
