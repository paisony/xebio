...
namespace com.xebio.bo.Th010p01.Page
{
  ...
  /// Th010p01の初期化ページです。
  /// </summary>
  public partial class Th010p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Th010p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Th010f01", true);
					//efm.SetItemInfoFlg(pgId, "Th010f02", true);
					//efm.SetItemInfoFlg(pgId, "Th010f03", true);
				}
