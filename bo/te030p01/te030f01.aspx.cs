...
using com.xebio.bo.Te030p01.Facade;
...
namespace com.xebio.bo.Te030p01.Page
{
  /// <summary>
  /// Te030f01のコードビハインドです。
  /// </summary>
  public partial class Te030f01Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Te030f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Te030f01Facade().DoLoad(facadeContext);
								...
								ControlHeaderStoreCls.InitialSetHeaderStore<Te030f01Form>(loginInfVO, te030f01Form);
								// 一覧画面共通処理 ----------
		...
		protected virtual void OnBTNPRINT_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Te030f01Facade().DoBTNPRINT_FRM(facadeContext);

				Te030f01Form f01VO = (Te030f01Form)facadeContext.FormVO;

				// PDFファイル名を取得
				pdfNm = (string)facadeContext.GetUserObject(Te030p01Constant.FCDUO_RRT_FLNM);
			...
			string serverPath = string.Format("{0}{1}{2}",
											FilePathManager.GetOutFilePath(Te030p01Constant.PGID),
											Path.DirectorySeparatorChar,
											pdfNm
											);
			// クライアントファイル名
			string clientNm = string.Format("{0}.{1}",
											BoSystemReport.CreateFileName(BoSystemConstant.REPORTNM_IDOUSYUKKASAILIST, 2),
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Te030f01Form te030f01Form = (Te030f01Form)pageContext.GetFormVO();

						//カード部データを表示する
						RenderCard(te030f01Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// カードデータを表示する
		/// </summary>
		/// <param name="te030f01Form">画面FormVO</param>
		/// <param name="formInfo">画面情報</param>
		/// <param name="formResource">画面リソース</param>
		/// <param name="lang">言語設定</param>
		private void RenderCard(
			Te030f01Form te030f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(te030f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(te030f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Shuturyoku_kbn,
				DataFormatUtil.GetFormatItem(te030f01Form.Shuturyoku_kbn,formInfo["Shuturyoku_kbn"]));
			ControlUtil.SetControlValue(Jyuryo_ymd_from,
				DataFormatUtil.GetFormatItem(te030f01Form.Jyuryo_ymd_from,formInfo["Jyuryo_ymd_from"]));
			ControlUtil.SetControlValue(Jyuryo_ymd_to,
				DataFormatUtil.GetFormatItem(te030f01Form.Jyuryo_ymd_to,formInfo["Jyuryo_ymd_to"]));
			ControlUtil.SetControlValue(Jyuryo_ymd_hdn,
				DataFormatUtil.GetFormatItem(te030f01Form.Jyuryo_ymd_hdn,formInfo["Jyuryo_ymd_hdn"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Te030f01Form)base.GetPageContext().GetFormVO());
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Te030f01_Titlebar", lang);
				header.FormName = formResource.GetString("Te030f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
