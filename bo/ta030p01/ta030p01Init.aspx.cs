...
namespace com.xebio.bo.Ta030p01.Page
{
  ...
  /// Ta030p01の初期化ページです。
  /// </summary>
  public partial class Ta030p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Ta030p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Ta030f01", true);
					//efm.SetItemInfoFlg(pgId, "Ta030f02", true);
				}
