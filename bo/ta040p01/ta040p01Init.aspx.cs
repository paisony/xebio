...
namespace com.xebio.bo.Ta040p01.Page
{
  ...
  /// Ta040p01の初期化ページです。
  /// </summary>
  public partial class Ta040p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Ta040p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Ta040f01", true);
					//efm.SetItemInfoFlg(pgId, "Ta040f02", true);
				}
