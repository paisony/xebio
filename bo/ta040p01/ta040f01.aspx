<%@ Page language="c#" CodeFile="ta040f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Ta040p01.Page.Ta040f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="ta040p01" FormId="ta040f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/ta040f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="ta040p01" FormId="ta040f01" runat="server" />
...
<body>
	<form id="Ta040f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
			<uc:Header ID="header" runat="server" PgId="ta040p01" PgName="補充依頼状況照会" FormId="ta040f01" FormName="補充依頼状況照会 一覧" ></uc:Header>
			<!------------------------------------------
				□ヘッダー部
			-------------------------------------------->
								        ...
								        <table>
									        ...
									        <tbody>
										        <tr>
						    					    ...
						    					    <td>
							    					    <!--- 「変更区分」ドロップダウンリスト --->
								    				    <md:MDConditionDDList ID="Henko_kbn" ConditionName="henko_kbn" CssClass="slt-kbn" runat="server"></md:MDConditionDDList>
					...
					<%-- 明細ヘッダ --%>
						<div class="str-result-hdg-01">
							...
							<div class="col4 detail_center">
								<asp:Label ID="M1hattyu_su_lbl" runat="server">発注数量</asp:Label>
							</div>
							<div class="col5 detail_right">
								<asp:Label ID="M1haibun_su_lbl" runat="server">配分数量</asp:Label>
							</div>
							<div class="col6 detail_righ">
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col4 detail_right">
											...
											<asp:TextBox ID="M1hattyu_su" CssClass="inpReadonlyRight inpRONumCma9" runat="server"></asp:TextBox>
										</div>
										<div class="col5 detail_right">
											<!--- 「ｍ１配分数量」テキストボックスリードオンリー --->
											<asp:TextBox ID="M1haibun_su" CssClass="inpReadonlyRight inpRONumCma9" runat="server"></asp:TextBox>
										</div>
