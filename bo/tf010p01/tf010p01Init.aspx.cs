...
namespace com.xebio.bo.Tf010p01.Page
{
  ...
  /// Tf010p01の初期化ページです。
  /// </summary>
  public partial class Tf010p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tf010p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tf010f01", true);
					//efm.SetItemInfoFlg(pgId, "Tf010f02", true);
				}
