...
namespace com.xebio.bo.Tj070p01.Page
{
  ...
  /// Tj070p01の初期化ページです。
  /// </summary>
  public partial class Tj070p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj070p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj070f01", true);
				}
				...
				{
					// [店舗確定状況]にフォーカスを当てる。
					focusItem = "Tenpo_kakutei_jyokyo";
				}
