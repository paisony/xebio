...
namespace com.xebio.bo.Tj120p01.Page
{
  ...
  /// Tj120p01の初期化ページです。
  /// </summary>
  public partial class Tj120p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj120p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj120f01", true);
					//efm.SetItemInfoFlg(pgId, "Tj120f02", true);
				}
