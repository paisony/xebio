<%@ Page language="c#" CodeFile="tj120f02.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tj120p01.Page.Tj120f02Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tj120p01" FormId="tj120f02" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tj120f02.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tj120p01" FormId="tj120f02" runat="server" />
...
<body>
	<form id="Tj120f02" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tj120p01" PgName="棚卸重複検索(V)" FormId="tj120f02" FormName="棚卸重複検索 明細" ></uc:Header>
			<!------------------------------------------
				□ヘッダー部
			-------------------------------------------->
