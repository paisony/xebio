...
using com.xebio.bo.Tk040p01.Facade;
...
namespace com.xebio.bo.Tk040p01.Page
{
  ...
  /// Tk040f01のコードビハインドです。
  /// </summary>
  public partial class Tk040f01Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Tk040f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tk040f01Facade().DoLoad(facadeContext);
								...
								ControlHeaderStoreCls.InitialSetHeaderStore<Tk040f01Form>(loginInfVO, tk040f01Form);
								// 一覧画面共通処理 ----------
		...
		protected virtual void OnBTNSEARCH_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Tk040f01Facade().DoBTNSEARCH_FRM(facadeContext);
		...
		protected virtual void OnBTNPRINT_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tk040f01Facade().DoBTNPRINT_FRM(facadeContext);
				...
				// PDFファイル名を取得
				pdfNm = (string)facadeContext.GetUserObject(Tk040p01Constant.FCDUO_RRT_FLNM);				
			...
			string serverPath = string.Format("{0}{1}{2}",
											FilePathManager.GetOutFilePath(Tk040p01Constant.PGID),
											Path.DirectorySeparatorChar,
											pdfNm
											);
			// クライアントファイル名
			string clientNm = string.Format("{0}.{1}",
											BoSystemReport.CreateFileName(BoSystemConstant.REPORTNM_LOCATIONLIST,2),
		...
		protected virtual void OnPGR_PGN(object sender, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tk040f01Facade().DoPGR_PGN(facadeContext, pageindex);
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					...
					//{
						...
						//FormVOを取得する
						Tk040f01Form tk040f01Form = (Tk040f01Form)pageContext.GetFormVO();

						//明細ページ情報を表示する
						ShowListPageInfo(tk040f01Form);
			
						//明細部データを表示する
						RenderList(tk040f01Form, pageContext.FormInfo, formResource, lang);

						//カード部データを表示する
						RenderCard(tk040f01Form, pageContext.FormInfo, formResource, lang);
					//}
		...
		/// 明細ページ情報を表示する。
		/// </summary>
		/// <param name="tk040f01Form">画面FormVO</param>
		private void ShowListPageInfo(Tk040f01Form tk040f01Form)
		{
			//M1明細ページ情報を表示する。
			ShowM1ListPageInfo(tk040f01Form.GetList("M1"));
		...
		private void RenderList(
			Tk040f01Form tk040f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			//画面のM1明細部データを設定する。
			RenderM1List(tk040f01Form, formInfo, formResource, lang);
			//M1明細部のページャーにページ情報を設定する。
			RenderM1Pager(tk040f01Form);
		...
		{
			//M1明細部データソースを設定する。
			M1.DataSource = tk040f01Form.GetPageViewList("M1");
			M1.DataBind();
			...
			{
				Tk040f01M1Form tk040f01M1Form = (Tk040f01M1Form)m1DataList[index];
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1rowno"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1rowno,formInfo["M1rowno"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumon_cd"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1bumon_cd,formInfo["M1bumon_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumonkana_nm"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1bumonkana_nm,formInfo["M1bumonkana_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hinsyu_ryaku_nm"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1hinsyu_ryaku_nm,formInfo["M1hinsyu_ryaku_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1burando_nm"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1burando_nm,formInfo["M1burando_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisya_hbn"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1jisya_hbn,formInfo["M1jisya_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1maker_hbn"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1maker_hbn,formInfo["M1maker_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syonmk"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1syonmk,formInfo["M1syonmk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hanbaikanryo_ymd"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1hanbaikanryo_ymd,formInfo["M1hanbaikanryo_ymd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1iro_nm"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1iro_nm,formInfo["M1iro_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1size_nm"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1size_nm,formInfo["M1size_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1scan_cd"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1scan_cd,formInfo["M1scan_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1face_no"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1face_no,formInfo["M1face_no"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1tana_dan"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1tana_dan,formInfo["M1tana_dan"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1tanaorosi_su"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1tanaorosi_su,formInfo["M1tanaorosi_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1selectorcheckbox"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1selectorcheckbox,formInfo["M1selectorcheckbox"]));
				((System.Web.UI.WebControls.CheckBox)M1.Items[index].FindControl("M1selectorcheckbox")).Text =
					formResource.GetString("M1selectorcheckbox", lang);
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1entersyoriflg"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1entersyoriflg,formInfo["M1entersyoriflg"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1dtlirokbn"),
					DataFormatUtil.GetFormatItem(tk040f01M1Form.M1dtlirokbn,formInfo["M1dtlirokbn"]));
			...
			//M1明細部標題を設定する。
				...
				// (M1.HeaderRow.FindControl("M1tanaorosi_su") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1tanaorosi_su", lang), base.GetPageContext().FormInfo["M1tanaorosi_su"]);
		...
		/// </summary>
		/// <param name="tk040f01Form">画面FormVO</param>
		private void RenderM1Pager(Tk040f01Form tk040f01Form)
		{
			Pgr.VirtualItemCount = tk040f01Form.GetList("M1").RecordCount;
			Pgr.CurrentPageIndex = tk040f01Form.GetList("M1").PageNo - 1;
			Pgr.PageSize = tk040f01Form.GetList("M1").DispRow;
		}
		#endregion
		#endregion
			...
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tk040f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tk040f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Bumon_cd_from,
				DataFormatUtil.GetFormatItem(tk040f01Form.Bumon_cd_from,formInfo["Bumon_cd_from"]));
			ControlUtil.SetControlValue(Bumon_nm_from,
				DataFormatUtil.GetFormatItem(tk040f01Form.Bumon_nm_from,formInfo["Bumon_nm_from"]));
			ControlUtil.SetControlValue(Bumon_cd_to,
				DataFormatUtil.GetFormatItem(tk040f01Form.Bumon_cd_to,formInfo["Bumon_cd_to"]));
			ControlUtil.SetControlValue(Bumon_nm_to,
				DataFormatUtil.GetFormatItem(tk040f01Form.Bumon_nm_to,formInfo["Bumon_nm_to"]));
			ControlUtil.SetControlValue(Hanbaikanryo_ymd_from,
				DataFormatUtil.GetFormatItem(tk040f01Form.Hanbaikanryo_ymd_from,formInfo["Hanbaikanryo_ymd_from"]));
			ControlUtil.SetControlValue(Hanbaikanryo_ymd_to,
				DataFormatUtil.GetFormatItem(tk040f01Form.Hanbaikanryo_ymd_to,formInfo["Hanbaikanryo_ymd_to"]));
			ControlUtil.SetControlValue(Old_jisya_hbn,
				DataFormatUtil.GetFormatItem(tk040f01Form.Old_jisya_hbn,formInfo["Old_jisya_hbn"]));
			ControlUtil.SetControlValue(Old_jisya_hbn2,
				DataFormatUtil.GetFormatItem(tk040f01Form.Old_jisya_hbn2,formInfo["Old_jisya_hbn2"]));
			ControlUtil.SetControlValue(Old_jisya_hbn3,
				DataFormatUtil.GetFormatItem(tk040f01Form.Old_jisya_hbn3,formInfo["Old_jisya_hbn3"]));
			ControlUtil.SetControlValue(Old_jisya_hbn4,
				DataFormatUtil.GetFormatItem(tk040f01Form.Old_jisya_hbn4,formInfo["Old_jisya_hbn4"]));
			ControlUtil.SetControlValue(Old_jisya_hbn5,
				DataFormatUtil.GetFormatItem(tk040f01Form.Old_jisya_hbn5,formInfo["Old_jisya_hbn5"]));
			ControlUtil.SetControlValue(Scan_cd,
				DataFormatUtil.GetFormatItem(tk040f01Form.Scan_cd,formInfo["Scan_cd"]));
			ControlUtil.SetControlValue(Scan_cd2,
				DataFormatUtil.GetFormatItem(tk040f01Form.Scan_cd2,formInfo["Scan_cd2"]));
			ControlUtil.SetControlValue(Scan_cd3,
				DataFormatUtil.GetFormatItem(tk040f01Form.Scan_cd3,formInfo["Scan_cd3"]));
			ControlUtil.SetControlValue(Scan_cd4,
				DataFormatUtil.GetFormatItem(tk040f01Form.Scan_cd4,formInfo["Scan_cd4"]));
			ControlUtil.SetControlValue(Scan_cd5,
				DataFormatUtil.GetFormatItem(tk040f01Form.Scan_cd5,formInfo["Scan_cd5"]));
			ControlUtil.SetControlValue(Searchcnt,
				DataFormatUtil.GetFormatItem(tk040f01Form.Searchcnt,formInfo["Searchcnt"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tk040f01Form)base.GetPageContext().GetFormVO());
			...
			Tk040f01Form formVO = (Tk040f01Form)base.GetPageContext().GetFormVO();
		...
		private void SetCardCaption(FormResource formResource, string lang)
		{
		  ...
		  ControlUtil.SetControlValue(Hanbaikanryo_ymd_from_lbl, "販売完了日");
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tk040f01_Titlebar", lang);
				header.FormName = formResource.GetString("Tk040f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
