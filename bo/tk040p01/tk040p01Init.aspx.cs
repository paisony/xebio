...
namespace com.xebio.bo.Tk040p01.Page
{
  /// <summary>
  /// Tk040p01の初期化ページです。
  /// </summary>
  public partial class Tk040p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tk040p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tk040f01", true);
				}
				...
				{
					// [部門コードfrom]にフォーカスを当てる。
					focusItem = "Bumon_cd_from";
				}
