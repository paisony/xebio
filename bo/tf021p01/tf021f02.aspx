<%@ Page language="c#" CodeFile="tf021f02.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tf021p01.Page.Tf021f02Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tf021p01" FormId="tf021f02" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tf021f02.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tf021p01" FormId="tf021f02" runat="server" />
...
<body>
	<form id="Tf021f02" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tf021p01" PgName="商品経費振替申請" FormId="tf021f02" FormName="商品経費振替申請 明細" ></uc:Header>
						...
						<tbody>
							<tr>
								...
								<td class="last" colspan="3">
									...
									<md:MDCodeCondition ID="Sinseiriyu_kb" FormID="Tf021f02" PgID="Tf021p01" CssClass="slt-sinseiRiyu" runat="server"></md:MDCodeCondition>
									<span class="select-arrow"></span>
									<md:MDTextBox ID="Sinseiriyu" CssClass="inpSinseiRiyu" runat="server"></md:MDTextBox>
								</td>
							</tr>
							<tr>
								<th class="last"><span class="tbl-hdg"><asp:Label ID="Denpyo_bango_lbl" runat="server">伝票番号</asp:Label></span></th>
								<!--- 「伝票番号」テキストボックスリードオンリー --->
								<td class="last"><asp:TextBox ID="Denpyo_bango" CssClass="inpReadonlyLeft inpRONum8" runat="server"></asp:TextBox></td>
								<th class="last"><span class="tbl-hdg"><asp:Label ID="Kanri_no_lbl" runat="server">管理No</asp:Label></span></th>
								<!--- 「管理no」テキストボックスリードオンリー --->
								<td class="last"><asp:TextBox ID="Kanri_no" CssClass="inpReadonlyLeft inpRONum8" runat="server"></asp:TextBox></td>
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col3 detail_left">
											...
											<div class="detail_center"><asp:TextBox ID="M1jisya_hbn" CssClass="inpReadonlyCenter inpRONum8 tooltip" runat="server"></asp:TextBox></div>
										</div>
