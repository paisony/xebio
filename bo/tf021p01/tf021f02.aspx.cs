...
namespace com.xebio.bo.Tf021p01.Page
{
  ...
  /// Tf021f02のコードビハインドです。
  /// </summary>
  public partial class Tf021f02Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Tf021f02Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tf021f02Facade().DoLoad(facadeContext);
								break;
						}
					}
					else
		...
		protected virtual void OnBTNBACK_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Tf021f02Facade().DoBTNBACK_FRM(facadeContext);
			...
			if (!BoSystemConstant.MODE_INSERT.Equals(formVo.Stkmodeno))
			{
				...
				// 選択された伝票番号にフォーカス設定
				Tf021f02Form f02VO = (Tf021f02Form)pageContext.GetFormVO(Tf021p01Constant.PGID, Tf021p01Constant.FORMID_02);
				string tableID = (string)((Tf021f01M1Form)f02VO.Dictionary[Tf021p01Constant.DIC_M1SELECTVO]).Dictionary[Tf021p01Constant.DIC_M1TBLFLG];
				...
				focusMno = (string)((Tf021f02Form)pageContext.GetFormVO(Tf021p01Constant.PGID, Tf021p01Constant.FORMID_02)).Dictionary[Tf021p01Constant.DIC_M1SELECTROWIDX];
		...
		protected virtual void OnBTNROWINS_MADD(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tf021f02Facade().DoBTNROWINS_MADD(facadeContext);
		...
		protected virtual void OnBTNPAGEINS_MINSX(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tf021f02Facade().DoBTNPAGEINS_MINSX(facadeContext);
		...
		protected virtual void OnBTNROWDEL_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tf021f02Facade().DoBTNROWDEL_FRM(facadeContext);
				...
				// フォーカス行をコードビハインドに戻す
				lastRow = (decimal)facadeContext.GetUserObject(Tf021p01Constant.FCDUO_FOCUSROW);
		...
		protected virtual void OnBTNCSV_TORIKOMI_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
//				new Tf021f02Facade().DoBTNCSV_TORIKOMI_FRM(facadeContext);
				...
				if (Session[OpenTm050p01Cls.KEY_CSV_IMPORT_RESULT] != null)
				{
					...
					facadeContext.SetUserObject(Tf021p01Constant.DIC_CSV_IMPORT_RESULT, Session[OpenTm050p01Cls.KEY_CSV_IMPORT_RESULT]);

					new Tf021f02Facade().DoBTNCSV_TORIKOMI_FRM(facadeContext);

					focusMno = facadeContext.GetUserObject(Tf021p01Constant.DIC_FOCUS_INDEX).ToString();
				}
				else
				{
					#region CSV取込画面起動パラメータ設定
					// フォームオブジェクト取得
					Tf021f02Form form = (Tf021f02Form)pageContext.GetFormVO();

					// 画面ID
					string formId = Tf021p01Constant.FORMID_02;
					...
					form.Dictionary[Tf021p01Constant.DIC_CSV_CHECK_INFO] = csvCheckInfoVO;
					#endregion
...
//			base.Forward(pageContext, queryList);
		...
		protected virtual void OnPGR_PGN(object sender, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tf021f02Facade().DoPGR_PGN(facadeContext, pageindex);
		...
		protected virtual void OnBTNENTER_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tf021f02Facade().DoBTNENTER_FRM(facadeContext);
				...
				Tf021f02Form formVo = (Tf021f02Form)base.GetPageContext().GetFormVO();
			...
			if (!BoSystemConstant.MODE_INSERT.Equals(((Tf021f02Form)base.GetPageContext().GetFormVO()).Stkmodeno))
			{
				// 選択された管理Noにフォーカス設定
				Tf021f02Form f02VO = (Tf021f02Form)pageContext.GetFormVO(Tf021p01Constant.PGID, Tf021p01Constant.FORMID_02);
				string tableID = (string)((Tf021f01M1Form)f02VO.Dictionary[Tf021p01Constant.DIC_M1SELECTVO]).Dictionary[Tf021p01Constant.DIC_M1TBLFLG];
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Tf021f02Form tf021f02Form = (Tf021f02Form)pageContext.GetFormVO();

						//明細ページ情報を表示する
						ShowListPageInfo(tf021f02Form);
			
						//明細部データを表示する
						RenderList(tf021f02Form, pageContext.FormInfo, formResource, lang);

						//カード部データを表示する
						RenderCard(tf021f02Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// 明細ページ情報を表示する。
		/// </summary>
		/// <param name="tf021f02Form">画面FormVO</param>
		private void ShowListPageInfo(Tf021f02Form tf021f02Form)
		{
			//M1明細ページ情報を表示する。
			ShowM1ListPageInfo(tf021f02Form.GetList("M1"));
		...
		private void RenderList(
			Tf021f02Form tf021f02Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			//画面のM1明細部データを設定する。
			RenderM1List(tf021f02Form, formInfo, formResource, lang);
			//M1明細部のページャーにページ情報を設定する。
			RenderM1Pager(tf021f02Form);
		...
		{
			//M1明細部データソースを設定する。
			M1.DataSource = tf021f02Form.GetPageViewList("M1");
			M1.DataBind();
			...
			{
				Tf021f02M1Form tf021f02M1Form = (Tf021f02M1Form)m1DataList[index];
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1rowno"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1rowno,formInfo["M1rowno"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumon_cd"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1bumon_cd,formInfo["M1bumon_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumonkana_nm"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1bumonkana_nm,formInfo["M1bumonkana_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1burando_nm"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1burando_nm,formInfo["M1burando_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1maker_hbn"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1maker_hbn,formInfo["M1maker_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1iro_nm"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1iro_nm,formInfo["M1iro_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1scan_cd"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1scan_cd,formInfo["M1scan_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1suryo"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1suryo,formInfo["M1suryo"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1gen_tnk"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1gen_tnk,formInfo["M1gen_tnk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1genka_kin"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1genka_kin,formInfo["M1genka_kin"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hinsyu_ryaku_nm"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1hinsyu_ryaku_nm,formInfo["M1hinsyu_ryaku_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisya_hbn"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1jisya_hbn,formInfo["M1jisya_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syonmk"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1syonmk,formInfo["M1syonmk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1size_nm"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1size_nm,formInfo["M1size_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1genbaika_tnk"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1genbaika_tnk,formInfo["M1genbaika_tnk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1gokeibaika_kin"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1gokeibaika_kin,formInfo["M1gokeibaika_kin"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1suryo_hdn"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1suryo_hdn,formInfo["M1suryo_hdn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1genka_kin_hdn"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1genka_kin_hdn,formInfo["M1genka_kin_hdn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1selectorcheckbox"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1selectorcheckbox,formInfo["M1selectorcheckbox"]));
				((System.Web.UI.WebControls.CheckBox)M1.Items[index].FindControl("M1selectorcheckbox")).Text =
					formResource.GetString("M1selectorcheckbox", lang);
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1entersyoriflg"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1entersyoriflg,formInfo["M1entersyoriflg"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1dtlirokbn"),
					DataFormatUtil.GetFormatItem(tf021f02M1Form.M1dtlirokbn,formInfo["M1dtlirokbn"]));
		...
		/// </summary>
		/// <param name="tf021f02Form">画面FormVO</param>
		private void RenderM1Pager(Tf021f02Form tf021f02Form)
		{
			Pgr.VirtualItemCount = tf021f02Form.GetList("M1").RecordCount;
			Pgr.CurrentPageIndex = tf021f02Form.GetList("M1").PageNo - 1;
			Pgr.PageSize = tf021f02Form.GetList("M1").DispRow;
		}
		#endregion
		#endregion
			...
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tf021f02Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tf021f02Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Stkmodeno,
				DataFormatUtil.GetFormatItem(tf021f02Form.Stkmodeno,formInfo["Stkmodeno"]));
			ControlUtil.SetControlValue(Add_ymd,
				DataFormatUtil.GetFormatItem(tf021f02Form.Add_ymd,formInfo["Add_ymd"]));
			ControlUtil.SetControlValue(Apply_ymd,
				DataFormatUtil.GetFormatItem(tf021f02Form.Apply_ymd,formInfo["Apply_ymd"]));
			ControlUtil.SetControlValue(Sinseiriyu_kb,
				DataFormatUtil.GetFormatItem(tf021f02Form.Sinseiriyu_kb,formInfo["Sinseiriyu_kb"]));
			ControlUtil.SetControlValue(Sinseiriyu,
				DataFormatUtil.GetFormatItem(tf021f02Form.Sinseiriyu,formInfo["Sinseiriyu"]));
			ControlUtil.SetControlValue(Denpyo_bango,
				DataFormatUtil.GetFormatItem(tf021f02Form.Denpyo_bango,formInfo["Denpyo_bango"]));
			ControlUtil.SetControlValue(Kanri_no,
				DataFormatUtil.GetFormatItem(tf021f02Form.Kanri_no,formInfo["Kanri_no"]));
			ControlUtil.SetControlValue(Kamoku_cd,
				DataFormatUtil.GetFormatItem(tf021f02Form.Kamoku_cd,formInfo["Kamoku_cd"]));
			ControlUtil.SetControlValue(Kamoku_nm,
				DataFormatUtil.GetFormatItem(tf021f02Form.Kamoku_nm,formInfo["Kamoku_nm"]));
			ControlUtil.SetControlValue(Kyakkariyu,
				DataFormatUtil.GetFormatItem(tf021f02Form.Kyakkariyu,formInfo["Kyakkariyu"]));
			ControlUtil.SetControlValue(Gyomuringi_no,
				DataFormatUtil.GetFormatItem(tf021f02Form.Gyomuringi_no,formInfo["Gyomuringi_no"]));
			ControlUtil.SetControlValue(Jyuri_no,
				DataFormatUtil.GetFormatItem(tf021f02Form.Jyuri_no,formInfo["Jyuri_no"]));
			ControlUtil.SetControlValue(Syonin_flg_nm,
				DataFormatUtil.GetFormatItem(tf021f02Form.Syonin_flg_nm,formInfo["Syonin_flg_nm"]));
			ControlUtil.SetControlValue(Gokei_suryo,
				DataFormatUtil.GetFormatItem(tf021f02Form.Gokei_suryo,formInfo["Gokei_suryo"]));
			ControlUtil.SetControlValue(Genka_kin_gokei,
				DataFormatUtil.GetFormatItem(tf021f02Form.Genka_kin_gokei,formInfo["Genka_kin_gokei"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tf021f02Form)base.GetPageContext().GetFormVO());
			...
			// 一覧画面選択行のVO
			Tf021f01M1Form f01M1Form = (Tf021f01M1Form)formVo.Dictionary[Tf021p01Constant.DIC_M1SELECTVO];
			...
			// [選択モードNo]が「申請前修正」の場合
			else if (BoSystemConstant.MODE_SINSEIMAEUPD.Equals(formVo.Stkmodeno))
			{
				// ページ追加ボタンを非表示とする。
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tf021f02_Titlebar", lang);
				header.FormName = formResource.GetString("Tf021f02_FormCaption", lang);
			}
		}
		#endregion
		#endregion
