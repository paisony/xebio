<%@ Page language="c#" CodeFile="tf021f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Tf021p01.Page.Tf021f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="tf021p01" FormId="tf021f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/tf021f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="tf021p01" FormId="tf021f01" runat="server" />
...
<body>
	<form id="Tf021f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="tf021p01" PgName="商品経費振替申請" FormId="tf021f01" FormName="商品経費振替申請 一覧" ></uc:Header>
		...
		--------------------------------------------------------------------->
			...
			<div class="str-tab-menu clearfix">
				<ul class="tab-list">
					...
					<li>
						<!--- 「モード申請前取消ボタン」リンク --->
						<a id="Btnmodesinseimaetorikesi" href="#tab35" class="" runat="server">申請前取消</a>
					</li>
					<li>
						<!--- 「モード申請後取消ボタン」リンク --->
						<a id="Btnmodesinseigotorikesi" href="#tab36" class="" runat="server">申請後取消</a>
					</li>
					<li>
						<!--- 「モード照会ボタン」リンク --->
			...
			<div id="tab35" class="str-tab-cont"></div>
			<div id="tab36" class="str-tab-cont"></div>
										...
										<table>
											...
											<tbody>
												...
												<tr>
													...
													<th>
														<span class="tbl-hdg"><asp:Label ID="Kanri_no_from_lbl" runat="server">管理No</asp:Label></span>
													</th>
													<td>
														<!--- 「管理noｆｒｏｍ」一行テキストボックス（セパレート日付以外） --->
														<!--- 「管理noｔｏ」一行テキストボックス（セパレート日付以外） --->
														<md:MDTextBox ID="Kanri_no_from" CssClass="inpKanriNo" runat="server"></md:MDTextBox>
														<span class="label-fromto">～</span>
														<md:MDTextBox ID="Kanri_no_to" CssClass="inpKanriNo" runat="server"></md:MDTextBox>
													</td>
												</tr>
												<tr>
													<th>
					...
					<div class="str-result-01">
						...
						<div class="str-result-hdg-01">
							...
							<div class="col4">
								...
								<div><asp:Label ID="M1kanri_no_lbl" runat="server">管理No</asp:Label></div>
							</div>
							...
							<div class="col9">
								<div><asp:Label ID="M1gyomuringi_no_lbl" runat="server">業務稟議No</asp:Label></div>
								<div><asp:Label ID="M1jyuri_no_lbl" runat="server">受理番号</asp:Label></div>
							</div>
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01" runat="server">
										...
										<div class="col2 detail_center">
											...
											<div><asp:TextBox ID="M1add_ymd" CssClass="inpReadonlyCenter inpRODate" runat="server"></asp:TextBox></div>
										...
										<div class="col4 detail_center">
											<!--- 「Ｍ１伝票番号リンク」ボタン --->
											<!--- 「Ｍ１管理NOリンク」ボタン --->
											<div><input type="button" id="M1denpyo_bango" value="伝票番号" onserverclick="OnM1DENPYO_BANGO_FRM" runat="server" class="meisaiLink"/></div>
											<div><input type="button" id="M1kanri_no" value="管理No" onserverclick="OnM1KANRI_NO_FRM" runat="server" class="meisaiLink"/></div>
										</div>
										...
										<div class="col9 detail_center">
											<!--- 「ｍ１業務稟議no」一行テキストボックス（セパレート日付以外） --->
											<!--- 「ｍ１受理番号」テキストボックスリードオンリー --->
											<div><md:MDTextBox ID="M1gyomuringi_no" CssClass="inpRingiNo inpDetail" runat="server"></md:MDTextBox></div>
											<div><asp:TextBox ID="M1jyuri_no" CssClass="inpReadonlyLeft inpROHankaku10" runat="server"></asp:TextBox></div>
										</div>
										<!--- 「ｍ１承認状態名称」テキストボックスリードオンリー --->
										<div class="col10 col_2dan detail_left"><asp:TextBox ID="M1syonin_flg_nm" CssClass="inpReadonlyLeft inpROZenkaku3" runat="server"></asp:TextBox></div>
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<asp:Label ID="Kanri_no_to_lbl" runat="server">管理NoＴＯ</asp:Label>
