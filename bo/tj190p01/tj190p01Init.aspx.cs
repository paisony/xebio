...
namespace com.xebio.bo.Tj190p01.Page
{
  ...
  /// Tj190p01の初期化ページです。
  /// </summary>
  public partial class Tj190p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tj190p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tj190f01", true);
					//efm.SetItemInfoFlg(pgId, "Tj190f02", true);
				}
