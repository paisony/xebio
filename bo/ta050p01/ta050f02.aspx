<%@ Page language="c#" CodeFile="ta050f02.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Ta050p01.Page.Ta050f02Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="ta050p01" FormId="ta050f02" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/ta050f02.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="ta050p01" FormId="ta050f02" runat="server" />
...
<body>
	<form id="Ta050f02" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="ta050p01" PgName="単品レポート状況照会" FormId="ta050f02" FormName="単品レポート状況照会 明細" ></uc:Header>
				...
				<div class="inner">
					...
					<%-- 明細ヘッダ --%>
						<div class="str-result-hdg-01">
							...
							<div class="col7 col_2dan detail_right">
								<div><asp:Label ID="M1irai_su_lbl" runat="server">依頼数量</asp:Label></div>
							</div>
							...
							<div style="display:none">
								...
								<div class="col14">
									<asp:Label ID="M1comment_nm2_lbl" runat="server"></asp:Label>
								</div>
							</div>
							<!--- 隠し項目エリア↑↑↑↑↑↑↑↑↑↑↑↑↑ --->
								...
								<ItemTemplate>
									<div class="str-result-item-01">
										...
										<div class="col9">
											...
											<div><asp:TextBox ID="M1comment_nm" CssClass="inpReadonlyLeft inpROZenkaku20" runat="server"></asp:TextBox></div>
											<div><asp:TextBox ID="M1comment_nm2" CssClass="inpReadonlyLeft inpROZenkaku20" runat="server"></asp:TextBox></div>
                                        </div>
										<!--- 隠し項目エリア↓↓↓↓↓↓↓↓↓↓↓↓↓ --->
										<div style="display: none">
											<div class="col14">
					...
					<div class="str-result-ftr-01 adjust-elem-next">
						...
						<!--- 「合計依頼数量」テキストボックスリードオンリー --->
							<span><asp:TextBox ID="Gokei_irai_su" CssClass="inpReadonlyRight inpRONumCma9" runat="server"></asp:TextBox></span></div>
						<div class="col8 detail_ftr">
							<!--- 「合計原価金額」テキストボックスリードオンリー --->
							<span><asp:TextBox ID="Gokei_genkakin" CssClass="inpReadonlyRight inpRONumCma9" runat="server"></asp:TextBox></span></div>
