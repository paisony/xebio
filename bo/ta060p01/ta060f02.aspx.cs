...
namespace com.xebio.bo.Ta060p01.Page
{
  ...
  /// Ta060f02のコードビハインドです。
  /// </summary>
  public partial class Ta060f02Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Ta060f02Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Ta060f02Facade().DoLoad(facadeContext);
								break;
						}
					}
					else
		...
		protected virtual void OnBTNBACK_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Ta060f02Facade().DoBTNBACK_FRM(facadeContext);
            ...
            focusMno = (string)((Ta060f02Form)pageContext.GetFormVO(Ta060p01Constant.PGID, Ta060p01Constant.FORMID_02)).Dictionary[Ta060p01Constant.DIC_M1SELCETROWIDX];
		...
		protected virtual void OnPGR_PGN(object sender, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Ta060f02Facade().DoPGR_PGN(facadeContext, pageindex);
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					...
					//{
						...
						//FormVOを取得する
						Ta060f02Form ta060f02Form = (Ta060f02Form)pageContext.GetFormVO();

						//明細ページ情報を表示する
						ShowListPageInfo(ta060f02Form);
			
						//明細部データを表示する
						RenderList(ta060f02Form, pageContext.FormInfo, formResource, lang);

						//カード部データを表示する
						RenderCard(ta060f02Form, pageContext.FormInfo, formResource, lang);
					//}
		...
		/// 明細ページ情報を表示する。
		/// </summary>
		/// <param name="ta060f02Form">画面FormVO</param>
		private void ShowListPageInfo(Ta060f02Form ta060f02Form)
		{
			//M1明細ページ情報を表示する。
			ShowM1ListPageInfo(ta060f02Form.GetList("M1"));
		...
		private void RenderList(
			Ta060f02Form ta060f02Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			//画面のM1明細部データを設定する。
			RenderM1List(ta060f02Form, formInfo, formResource, lang);
			//M1明細部のページャーにページ情報を設定する。
			RenderM1Pager(ta060f02Form);
		...
		{
			//M1明細部データソースを設定する。
			M1.DataSource = ta060f02Form.GetPageViewList("M1");
			M1.DataBind();
			...
			{
				Ta060f02M1Form ta060f02M1Form = (Ta060f02M1Form)m1DataList[index];
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1rowno"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1rowno,formInfo["M1rowno"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hinsyu_ryaku_nm"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1hinsyu_ryaku_nm,formInfo["M1hinsyu_ryaku_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1burando_nm"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1burando_nm,formInfo["M1burando_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisya_hbn"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1jisya_hbn,formInfo["M1jisya_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syohin_zokusei"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1syohin_zokusei,formInfo["M1syohin_zokusei"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1maker_hbn"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1maker_hbn,formInfo["M1maker_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syonmk"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1syonmk,formInfo["M1syonmk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1iro_nm"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1iro_nm,formInfo["M1iro_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1size_nm"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1size_nm,formInfo["M1size_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1scan_cd"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1scan_cd,formInfo["M1scan_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1irai_su"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1irai_su,formInfo["M1irai_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1genkakin"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1genkakin,formInfo["M1genkakin"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1comment_nm"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1comment_nm,formInfo["M1comment_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1comment_nm2"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1comment_nm2,formInfo["M1comment_nm2"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1selectorcheckbox"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1selectorcheckbox,formInfo["M1selectorcheckbox"]));
				((System.Web.UI.WebControls.CheckBox)M1.Items[index].FindControl("M1selectorcheckbox")).Text =
					formResource.GetString("M1selectorcheckbox", lang);
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1entersyoriflg"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1entersyoriflg,formInfo["M1entersyoriflg"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1dtlirokbn"),
					DataFormatUtil.GetFormatItem(ta060f02M1Form.M1dtlirokbn,formInfo["M1dtlirokbn"]));
			...
			//M1明細部標題を設定する。
				...
				// (M1.HeaderRow.FindControl("M1comment_nm2") as Label).Text = 
					// DataFormatUtil.GetFormatListCaption(formResource.GetString("M1comment_nm2", lang), base.GetPageContext().FormInfo["M1comment_nm2"]);
		...
		/// </summary>
		/// <param name="ta060f02Form">画面FormVO</param>
		private void RenderM1Pager(Ta060f02Form ta060f02Form)
		{
			Pgr.VirtualItemCount = ta060f02Form.GetList("M1").RecordCount;
			Pgr.CurrentPageIndex = ta060f02Form.GetList("M1").PageNo - 1;
			Pgr.PageSize = ta060f02Form.GetList("M1").DispRow;
		}
		#endregion
		#endregion
			...
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(ta060f02Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(ta060f02Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Henko_kbn_nm,
				DataFormatUtil.GetFormatItem(ta060f02Form.Henko_kbn_nm,formInfo["Henko_kbn_nm"]));
			ControlUtil.SetControlValue(Bumon_cd,
				DataFormatUtil.GetFormatItem(ta060f02Form.Bumon_cd,formInfo["Bumon_cd"]));
			ControlUtil.SetControlValue(Bumon_nm,
				DataFormatUtil.GetFormatItem(ta060f02Form.Bumon_nm,formInfo["Bumon_nm"]));
			ControlUtil.SetControlValue(Kessai_ymd,
				DataFormatUtil.GetFormatItem(ta060f02Form.Kessai_ymd,formInfo["Kessai_ymd"]));
			ControlUtil.SetControlValue(Gokei_irai_su,
				DataFormatUtil.GetFormatItem(ta060f02Form.Gokei_irai_su,formInfo["Gokei_irai_su"]));
			ControlUtil.SetControlValue(Gokei_genkakin,
				DataFormatUtil.GetFormatItem(ta060f02Form.Gokei_genkakin,formInfo["Gokei_genkakin"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Ta060f02Form)base.GetPageContext().GetFormVO());
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Ta060f02_Titlebar", lang);
				header.FormName = formResource.GetString("Ta060f02_FormCaption", lang);
			}
		}
		#endregion
		#endregion
