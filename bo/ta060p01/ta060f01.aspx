<%@ Page language="c#" CodeFile="ta060f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Ta060p01.Page.Ta060f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="ta060p01" FormId="ta060f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/ta060f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="ta060p01" FormId="ta060f01" runat="server" />
...
<body>
	<form id="Ta060f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="ta060p01" PgName="出荷要望状況照会" FormId="ta060f01" FormName="出荷要望状況照会 一覧" ></uc:Header>
										...
										<table>
											...
											<tbody>
												<tr>
													...
													<td>
														<!--- 「変更区分」ドロップダウンリスト --->
														<md:MDConditionDDList ID="Henko_kbn" ConditionName="henko_kbn3" CssClass="slt-kbn" runat="server"></md:MDConditionDDList>
