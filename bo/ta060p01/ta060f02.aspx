<%@ Page language="c#" CodeFile="ta060f02.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Ta060p01.Page.Ta060f02Page" %>
...
<head>
	...
	<title id="Windowtitle" runat="server">出荷要望状況照会</title>
	<!--- キャッシュの無効化設定 --->
	<adv:NoCache ID="NoCache1" runat="server" />

	<!--- スクリプトヘルパー、項目テーブル、業務スクリプトのインポート --->
	<adv:SetHeader ID="SetHeader1" PgId="ta060p01" FormId="ta060f02" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/ta060f02.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="ta060p01" FormId="ta060f02" runat="server" />
...
<body>
	<form id="Ta060f02" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="ta060p01" PgName="出荷要望状況照会" FormId="ta060f02" FormName="出荷要望状況照会 明細" ></uc:Header>
					...
					<tbody>
						<tr>
							...
							<td class ="last">
								...
								<asp:TextBox ID="Henko_kbn_nm" CssClass="inpReadonlyLeft inpROZenkaku2" runat="server"></asp:TextBox>
							</td>
							<th class = "last">
							...
							<td class = "last">
								...
								<!--- 「部門名」テキストボックスリードオンリー --->
								<asp:TextBox ID="Bumon_cd" CssClass="inpReadonlyLeft inpRONum4" runat="server"></asp:TextBox><asp:TextBox ID="Bumon_nm" CssClass="inpReadonlyLeft inpROZenkaku10 inpRORightNm" runat="server"></asp:TextBox>
							</td>
							<th class = "last">
					...
					<%-- 明細ヘッダ --%>
						<div class="str-result-hdg-01">
							...
							<div class="col9 col_2dan">
								<div><asp:Label ID="M1comment_nm_lbl" runat="server">コメント</asp:Label></div>
								<div><asp:Label ID="M1comment_nm2_lbl" runat="server"></asp:Label></div>
							</div>
							<!--- 隠し項目エリア↓↓↓↓↓↓↓↓↓↓↓↓↓ --->
									...
									<div class="str-result-item-01">
										...
										<div class="col3 detail_center">
											...
											<div class="detail_left">
												...
												<asp:TextBox ID="M1syohin_zokusei" CssClass="inpReadonlyLeft inpROHankaku3 tooltipt" runat="server"></asp:TextBox>
											</div>
										</div>
										...
										<div class="col7 col_2dan detail_right">
											...
											<asp:TextBox ID="M1irai_su" CssClass="inpReadonlyRight inpRONumCma7" runat="server"></asp:TextBox>
										</div>
										...
										<div class="col9">
											...
											<div>
												<!--- 「ｍ１コメント２」テキストボックスリードオンリー --->
												<asp:TextBox ID="M1comment_nm2" CssClass="inpReadonlyLeft inpROZenkaku20" runat="server"></asp:TextBox>
											</div>
										</div>
										<!--- 隠し項目エリア↓↓↓↓↓↓↓↓↓↓↓↓↓ --->
										<div style="display: none">
						...
						<!-- /str-result-item-wrap --></div>
					        <div class="str-result-ftr-01 adjust-elem-next">
					    	    ...
					    	    <div class="col6 detail_ftr_title"><span>合計</span></div>
						        <div class="col7 detail_ftr">
							        <!--- 「合計依頼数量」テキストボックスリードオンリー --->
							        <asp:TextBox ID="Gokei_irai_su" CssClass="inpReadonlyRight inpRONumCma9" runat="server"></asp:TextBox></div>
						        <div class="col8 detail_ftr">
							        <!--- 「合計原価金額」テキストボックスリードオンリー --->
							        <asp:TextBox ID="Gokei_genkakin" CssClass="inpReadonlyRight inpRONumCma9" runat="server"></asp:TextBox></div>
	...
	<!-- /wrap --></div>	
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<asp:Label ID="Gokei_irai_su_lbl" runat="server"></asp:Label>
