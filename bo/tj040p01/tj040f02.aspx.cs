...
namespace com.xebio.bo.Tj040p01.Page
{
  ...
  /// Tj040f02のコードビハインドです。
  /// </summary>
  public partial class Tj040f02Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Tj040f02Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Tj040f02Facade().DoLoad(facadeContext);
								break;
						}
					}
                    else
		...
		protected virtual void OnBTNBACK_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Tj040f02Facade().DoBTNBACK_FRM(facadeContext);
			...
			// 選択された管理Noにフォーカス設定
			focusItem = "M1face_no";
			focusMno = (string)((Tj040f02Form)pageContext.GetFormVO(Tj040p01Constant.PGID, Tj040p01Constant.FORMID_02)).Dictionary[Tj040p01Constant.DIC_M1SELCETROWIDX];
		...
		protected virtual void OnBTNPRINT_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tj040f02Facade().DoBTNPRINT_FRM(facadeContext);
		...
		protected virtual void OnPGR_PGN(object sender, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Tj040f02Facade().DoPGR_PGN(facadeContext, pageindex);
		...
		protected virtual void OnBTNENTER_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				new Tj040f02Facade().DoBTNENTER_FRM(facadeContext);
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Tj040f02Form tj040f02Form = (Tj040f02Form)pageContext.GetFormVO();

						//明細ページ情報を表示する
						ShowListPageInfo(tj040f02Form);
			
						//明細部データを表示する
						RenderList(tj040f02Form, pageContext.FormInfo, formResource, lang);

						//カード部データを表示する
						RenderCard(tj040f02Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// 明細ページ情報を表示する。
		/// </summary>
		/// <param name="tj040f02Form">画面FormVO</param>
		private void ShowListPageInfo(Tj040f02Form tj040f02Form)
		{
			//M1明細ページ情報を表示する。
			ShowM1ListPageInfo(tj040f02Form.GetList("M1"));
		...
		private void RenderList(
			Tj040f02Form tj040f02Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			//画面のM1明細部データを設定する。
			RenderM1List(tj040f02Form, formInfo, formResource, lang);
			//M1明細部のページャーにページ情報を設定する。
			RenderM1Pager(tj040f02Form);
		...
		{
			//M1明細部データソースを設定する。
			M1.DataSource = tj040f02Form.GetPageViewList("M1");
			M1.DataBind();
			...
			{
				Tj040f02M1Form tj040f02M1Form = (Tj040f02M1Form)m1DataList[index];
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1rowno"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1rowno,formInfo["M1rowno"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumon_cd"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1bumon_cd,formInfo["M1bumon_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumonkana_nm"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1bumonkana_nm,formInfo["M1bumonkana_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hinsyu_ryaku_nm"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1hinsyu_ryaku_nm,formInfo["M1hinsyu_ryaku_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1burando_nm"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1burando_nm,formInfo["M1burando_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisya_hbn"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1jisya_hbn,formInfo["M1jisya_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1maker_hbn"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1maker_hbn,formInfo["M1maker_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syonmk"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1syonmk,formInfo["M1syonmk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1iro_nm"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1iro_nm,formInfo["M1iro_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1size_nm"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1size_nm,formInfo["M1size_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1scan_cd"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1scan_cd,formInfo["M1scan_cd"]));
				//ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hyoji_syohin_cd"),
				//	DataFormatUtil.GetFormatItem(tj040f02M1Form.M1hyoji_syohin_cd,formInfo["M1hyoji_syohin_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1scan_su"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1scan_su,formInfo["M1scan_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1teisei_suryo"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1teisei_suryo,formInfo["M1teisei_suryo"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1teisei_suryo_hdn"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1teisei_suryo_hdn,formInfo["M1teisei_suryo_hdn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1gokei_suryo"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1gokei_suryo,formInfo["M1gokei_suryo"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1selectorcheckbox"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1selectorcheckbox,formInfo["M1selectorcheckbox"]));
				((System.Web.UI.WebControls.CheckBox)M1.Items[index].FindControl("M1selectorcheckbox")).Text =
					formResource.GetString("M1selectorcheckbox", lang);
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1entersyoriflg"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1entersyoriflg,formInfo["M1entersyoriflg"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1dtlirokbn"),
					DataFormatUtil.GetFormatItem(tj040f02M1Form.M1dtlirokbn,formInfo["M1dtlirokbn"]));

				if ("0".Equals(tj040f02M1Form.M1hyoji_syohin_cd))
				{
					ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hyoji_syohin_cd"),
						DataFormatUtil.GetFormatItem(string.Empty, formInfo["M1hyoji_syohin_cd"]));
				}
				else
				{
					ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hyoji_syohin_cd"),
		...
		/// </summary>
		/// <param name="tj040f02Form">画面FormVO</param>
		private void RenderM1Pager(Tj040f02Form tj040f02Form)
		{
			Pgr.VirtualItemCount = tj040f02Form.GetList("M1").RecordCount;
			Pgr.CurrentPageIndex = tj040f02Form.GetList("M1").PageNo - 1;
			Pgr.PageSize = tj040f02Form.GetList("M1").DispRow;
		}
		#endregion
		#endregion
			...
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(tj040f02Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(tj040f02Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Modeno,
				DataFormatUtil.GetFormatItem(tj040f02Form.Modeno,formInfo["Modeno"]));
			ControlUtil.SetControlValue(Stkmodeno,
				DataFormatUtil.GetFormatItem(tj040f02Form.Stkmodeno,formInfo["Stkmodeno"]));
			ControlUtil.SetControlValue(Face_no,
				DataFormatUtil.GetFormatItem(tj040f02Form.Face_no,formInfo["Face_no"]));
			ControlUtil.SetControlValue(Tana_dan,
				DataFormatUtil.GetFormatItem(tj040f02Form.Tana_dan,formInfo["Tana_dan"]));
			ControlUtil.SetControlValue(Kai_su,
				DataFormatUtil.GetFormatItem(tj040f02Form.Kai_su,formInfo["Kai_su"]));
			ControlUtil.SetControlValue(Tensutanaorosi_su,
				DataFormatUtil.GetFormatItem(tj040f02Form.Tensutanaorosi_su,formInfo["Tensutanaorosi_su"]));
			ControlUtil.SetControlValue(Teisei_suryo,
				DataFormatUtil.GetFormatItem(tj040f02Form.Teisei_suryo,formInfo["Teisei_suryo"]));
			ControlUtil.SetControlValue(Teisei_suryo_hdn,
				DataFormatUtil.GetFormatItem(tj040f02Form.Teisei_suryo_hdn,formInfo["Teisei_suryo_hdn"]));
			ControlUtil.SetControlValue(Gokei_suryo,
				DataFormatUtil.GetFormatItem(tj040f02Form.Gokei_suryo,formInfo["Gokei_suryo"]));
			ControlUtil.SetControlValue(Tenpo_gyosya_kb,
				DataFormatUtil.GetFormatItem(tj040f02Form.Tenpo_gyosya_kb,formInfo["Tenpo_gyosya_kb"]));
			ControlUtil.SetControlValue(Tenpo_gyosya_nm,
				DataFormatUtil.GetFormatItem(tj040f02Form.Tenpo_gyosya_nm,formInfo["Tenpo_gyosya_nm"]));
			ControlUtil.SetControlValue(Nyuryokutan_cd,
				DataFormatUtil.GetFormatItem(tj040f02Form.Nyuryokutan_cd,formInfo["Nyuryokutan_cd"]));
			ControlUtil.SetControlValue(Nyuryokutan_nm,
				DataFormatUtil.GetFormatItem(tj040f02Form.Nyuryokutan_nm,formInfo["Nyuryokutan_nm"]));
			ControlUtil.SetControlValue(Teiseitan_cd,
				DataFormatUtil.GetFormatItem(tj040f02Form.Teiseitan_cd,formInfo["Teiseitan_cd"]));
			ControlUtil.SetControlValue(Teiseitan_nm,
				DataFormatUtil.GetFormatItem(tj040f02Form.Teiseitan_nm,formInfo["Teiseitan_nm"]));
			ControlUtil.SetControlValue(Nyuryoku_ymd,
				DataFormatUtil.GetFormatItem(tj040f02Form.Nyuryoku_ymd,formInfo["Nyuryoku_ymd"]));
			ControlUtil.SetControlValue(Sosin_ymd,
				DataFormatUtil.GetFormatItem(tj040f02Form.Sosin_ymd,formInfo["Sosin_ymd"]));
			ControlUtil.SetControlValue(Riyu_cd,
				DataFormatUtil.GetFormatItem(tj040f02Form.Riyu_cd,formInfo["Riyu_cd"]));
			ControlUtil.SetControlValue(Gokeiscan_su,
				DataFormatUtil.GetFormatItem(tj040f02Form.Gokeiscan_su,formInfo["Gokeiscan_su"]));
			ControlUtil.SetControlValue(Gokeiteisei_suryo,
				DataFormatUtil.GetFormatItem(tj040f02Form.Gokeiteisei_suryo,formInfo["Gokeiteisei_suryo"]));
			ControlUtil.SetControlValue(All_gokei_suryo,
				DataFormatUtil.GetFormatItem(tj040f02Form.All_gokei_suryo,formInfo["All_gokei_suryo"]));
		...
		protected override void SetItems()
		{
			...
			//
            // 理由コードに空白を追加
            Riyu_cd.Items.Insert(0, new ListItem("", BoSystemConstant.DROPDOWNLIST_MISENTAKU));
        }
		#endregion
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Tj040f02Form)base.GetPageContext().GetFormVO());
            ...
            Tj040f02Form formVO = (Tj040f02Form)base.GetPageContext().GetFormVO();

            // [選択モードNO]が「修正」以外の場合
			if (!BoSystemString.Nvl(formVO.Stkmodeno).Equals(BoSystemConstant.MODE_UPD))
            {
                // フェイス№使用不可
                ControlCls.Disable(Face_no, true);
                // 棚段使用不可
                ControlCls.Disable(Tana_dan, true);
                // 訂正数量使用不可
                ControlCls.Disable(Teisei_suryo, true);
                // 理由コード使用不可
                ControlCls.Disable(Riyu_cd, true);
            ...
            {
                // フェイス№使用不可
                ControlCls.Disable(Face_no, false);
                // 棚段使用不可
                ControlCls.Disable(Tana_dan, false);
                // 訂正数量使用不可
                ControlCls.Disable(Teisei_suryo, false);
                // 理由コード使用不可
                ControlCls.Disable(Riyu_cd, false);
		...
		private void SetCardCaption(FormResource formResource, string lang)
		{
			...
			ControlUtil.SetControlValue(Teisei_suryo_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Teisei_suryo", lang), base.GetPageContext().FormInfo["Teisei_suryo"]));
				DataFormatUtil.SetMustColorCaption(Teisei_suryo_lbl, base.GetPageContext().FormInfo["Teisei_suryo"]);
			...
			ControlUtil.SetControlValue(Tenpo_gyosya_nm_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Tenpo_gyosya_nm", lang), base.GetPageContext().FormInfo["Tenpo_gyosya_nm"]));
				DataFormatUtil.SetMustColorCaption(Tenpo_gyosya_nm_lbl, base.GetPageContext().FormInfo["Tenpo_gyosya_nm"]);
			...
			ControlUtil.SetControlValue(Teiseitan_cd_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Teiseitan_cd", lang), base.GetPageContext().FormInfo["Teiseitan_cd"]));
				DataFormatUtil.SetMustColorCaption(Teiseitan_cd_lbl, base.GetPageContext().FormInfo["Teiseitan_cd"]);
			ControlUtil.SetControlValue(Teiseitan_nm_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Teiseitan_nm", lang), base.GetPageContext().FormInfo["Teiseitan_nm"]));
				DataFormatUtil.SetMustColorCaption(Teiseitan_nm_lbl, base.GetPageContext().FormInfo["Teiseitan_nm"]);
			...
			ControlUtil.SetControlValue(Sosin_ymd_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Sosin_ymd", lang), base.GetPageContext().FormInfo["Sosin_ymd"]));
				DataFormatUtil.SetMustColorCaption(Sosin_ymd_lbl, base.GetPageContext().FormInfo["Sosin_ymd"]);
			ControlUtil.SetControlValue(Riyu_cd_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Riyu_cd", lang), base.GetPageContext().FormInfo["Riyu_cd"]));
				DataFormatUtil.SetMustColorCaption(Riyu_cd_lbl, base.GetPageContext().FormInfo["Riyu_cd"]);
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Tj040f02_Titlebar", lang);
				header.FormName = formResource.GetString("Tj040f02_FormCaption", lang);
			}
		}
		#endregion
		#endregion
