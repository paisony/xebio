...
namespace com.xebio.bo.Te070p01.Page
{
  ...
  /// Te070p01の初期化ページです。
  /// </summary>
  public partial class Te070p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Te070p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Te070f01", true);
					//efm.SetItemInfoFlg(pgId, "Te070f02", true);
				}
