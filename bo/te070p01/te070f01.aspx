<%@ Page language="c#" CodeFile="te070f01.aspx.cs" AutoEventWireup="false" Inherits="com.xebio.bo.Te070p01.Page.Te070f01Page" %>
...
<head>
	...
	<adv:SetHeader ID="SetHeader1" PgId="te070p01" FormId="te070f01" runat="server" />

	<!-- link css -->
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/base.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/parts.css">
	<link rel="stylesheet" type="text/css" href="../pjcommon/boStyle/jquery-ui.css">
	<link rel="stylesheet" type="text/css" href="./css/te070f01.css">
	<!-- スクリプトのインポート -->
	<std:SetCustomHeader ID="SetHeader2" PgId="te070p01" FormId="te070f01" runat="server" />
...
<body>
	<form id="Te070f01" method="post" runat="server" onload="Page_Load" onprerender="RenderForm" class="form-02">
		<div id="wrap">
						
			<uc:Header ID="header" runat="server" PgId="te070p01" PgName="移動入荷検索" FormId="te070f01" FormName="移動入荷検索 一覧" ></uc:Header>
		...
		--------------------------------------------------------------------->
				...
				<div class="str-search-01">
					...
					<div class="inner-02">
						...
						<p class="required"><span class="required2">*付いている項目はいずれか一つの項目が必須入力になります。</span></p>
						<table class="search-table">
							<tr>
								<td class="search-table-tdleft">
									<div class="str-form-02">
										<div class="inner">
											<table>
												...
												<tbody>
													<tr>
														<th scope="col"><span class="tbl-hdg"><asp:Label ID="Denpyo_jyotai_lbl" runat="server">伝票状態</asp:Label><span class="required2">*</span></span></th>
														<td>
															<!--- 「伝票状態」ドロップダウンリスト --->
															<md:MDConditionDDList ID="Denpyo_jyotai" ConditionName="idonyuka_denpyo_jotai" CssClass="slt-denpyo" runat="server"></md:MDConditionDDList>
														...
														<td>
															...
															<label><span class="icon-in"><md:MDTextBox ID="Syukka_ymd_from" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox></span><span class="label-fromto">～</span><span class="icon-in"><md:MDTextBox ID="Syukka_ymd_to" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox></span></label>
														</td>
														<th scope="col">
															<span class="tbl-hdg"><asp:Label ID="Jyuryo_ymd_from_lbl" runat="server">入荷日ＦＲＯＭ</asp:Label></span>
														</th>
														<td>
															<!--- 「入荷日ｆｒｏｍ」一行テキストボックス（セパレート日付以外） --->
															<!--- 「入荷日ｔｏ」一行テキストボックス（セパレート日付以外） --->
															<label><span class="icon-in"><md:MDTextBox ID="Jyuryo_ymd_from" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox></span><span class="label-fromto">～</span><span class="icon-in"><md:MDTextBox ID="Jyuryo_ymd_to" CssClass="inpSerch inpDt datepicker" runat="server"></md:MDTextBox></span></label>
														</td>
													</tr>
													<tr>
														<th scope="col">
														...
														<th scope="col">
															<span class="tbl-hdg"><asp:Label ID="Syukkaten_cd_lbl" runat="server">出荷店</asp:Label></span><span class="required2">*</span>
														</th>
														<td>
															<!--- 「出荷店コード」一行テキストボックス（セパレート日付以外） --->
															<!--- 「出荷店舗コードボタン」ボタン --->
															<!--- 「出荷店名称」テキストボックスリードオンリー --->
															<span class="icon-in"><md:MDTextBox ID="Syukkaten_cd" CssClass="inpSerch inpTenpo" runat="server"></md:MDTextBox><input type="button" id="Btnsyukkatencd" name="Btnsyukkatencd" value="" runat="server" class="icon-search"/></span><asp:TextBox ID="Syukkaten_nm" CssClass="inpReadonlyLeft inpROZenkaku15 " runat="server"></asp:TextBox>
														</td>
														<th scope="col">
															<span class="tbl-hdg">
																<asp:Label ID="Denpyo_bango_from_lbl" runat="server">伝票番号FROM</asp:Label>
															</span>
														</th>
														<!--- 「伝票番号from」一行テキストボックス（セパレート日付以外） --->	
														<!--- 「伝票番号to」一行テキストボックス（セパレート日付以外） --->
														<td>
															<label><span class="icon-in"><md:MDTextBox ID="Denpyo_bango_from" CssClass="inpDenpyo" runat="server"></md:MDTextBox></span><span class="label-fromto">～</span><span class="icon-in"><md:MDTextBox ID="Denpyo_bango_to" CssClass="inpDenpyo" runat="server"></md:MDTextBox></span></label>
														</td>
													</tr>
													<tr>
														<th scope="col">
															<span class="tbl-hdg">
																<asp:Label ID="Scm_cd_lbl" runat="server">SCMコード</asp:Label></span>
														</th>
														<td>
															<!--- 「scmコード」一行テキストボックス（セパレート日付以外） --->
															<md:MDTextBox ID="Scm_cd" CssClass="inpDetail inpSCM" runat="server"></md:MDTextBox>
														</td>
														<th scope="col">
								...
								<ItemTemplate>
									<div id="M1Row" class="str-result-item-01 " runat="server">
										...
										<div class="col2 detail_center">
											<!--- 「ｍ１会社コード」テキストボックスリードオンリー --->
											<asp:TextBox ID="M1kaisya_cd" CssClass="inpReadonlyLeft inpROHankaku2 " runat="server"></asp:TextBox>
										</div>
		...
		<div id="hiddenElements" style="display:none" runat="server">
			...
			<asp:Label ID="Denpyo_bango_to_lbl" runat="server">伝票番号TO</asp:Label>
