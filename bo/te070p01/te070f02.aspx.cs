...
namespace com.xebio.bo.Te070p01.Page
{
  ...
  /// Te070f02のコードビハインドです。
  /// </summary>
  public partial class Te070f02Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
                    ...
                    {
                        pageContext.SetFormVO(new Te070f02Form());
                        switch (commandInfo.ActionMode)
                        {
                            ...
                            case "UPD":
                                ...
                                new Te070f02Facade().DoLoad(facadeContext);
                                break;
                        }
                    }
                    else
		...
		protected virtual void OnBTNBACK_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Te070f02Facade().DoBTNBACK_FRM(facadeContext);
           ...
           // フォーカス設定用変数
            ...
            focusMno = (string)((Te070f02Form)pageContext.GetFormVO(Te070p01Constant.PGID, Te070p01Constant.FORMID_02)).Dictionary[Te070p01Constant.DIC_M1SELCETROWIDX];
		...
		protected virtual void OnPGR_PGN(object sender, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Te070f02Facade().DoPGR_PGN(facadeContext, pageindex);
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					...
					//{
						...
						//FormVOを取得する
						Te070f02Form te070f02Form = (Te070f02Form)pageContext.GetFormVO();

						//明細ページ情報を表示する
						ShowListPageInfo(te070f02Form);
			
						//明細部データを表示する
						RenderList(te070f02Form, pageContext.FormInfo, formResource, lang);

						//カード部データを表示する
						RenderCard(te070f02Form, pageContext.FormInfo, formResource, lang);
					//}
		...
		/// 明細ページ情報を表示する。
		/// </summary>
		/// <param name="te070f02Form">画面FormVO</param>
		private void ShowListPageInfo(Te070f02Form te070f02Form)
		{
			//M1明細ページ情報を表示する。
			ShowM1ListPageInfo(te070f02Form.GetList("M1"));
		...
		private void RenderList(
			Te070f02Form te070f02Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			//画面のM1明細部データを設定する。
			RenderM1List(te070f02Form, formInfo, formResource, lang);
			//M1明細部のページャーにページ情報を設定する。
			RenderM1Pager(te070f02Form);
		...
		{
			//M1明細部データソースを設定する。
			M1.DataSource = te070f02Form.GetPageViewList("M1");
			M1.DataBind();
			...
			{
				Te070f02M1Form te070f02M1Form = (Te070f02M1Form)m1DataList[index];
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1rowno"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1rowno,formInfo["M1rowno"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumon_cd"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1bumon_cd,formInfo["M1bumon_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumonkana_nm"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1bumonkana_nm,formInfo["M1bumonkana_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hinsyu_ryaku_nm"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1hinsyu_ryaku_nm,formInfo["M1hinsyu_ryaku_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1burando_nm"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1burando_nm,formInfo["M1burando_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisya_hbn"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1jisya_hbn,formInfo["M1jisya_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1maker_hbn"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1maker_hbn,formInfo["M1maker_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syonmk"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1syonmk,formInfo["M1syonmk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1iro_nm"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1iro_nm,formInfo["M1iro_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1size_nm"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1size_nm,formInfo["M1size_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1scan_cd"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1scan_cd,formInfo["M1scan_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1yotei_su"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1yotei_su,formInfo["M1yotei_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1kakutei_su"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1kakutei_su,formInfo["M1kakutei_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1gen_tnk"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1gen_tnk,formInfo["M1gen_tnk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1genka_kin"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1genka_kin,formInfo["M1genka_kin"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1selectorcheckbox"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1selectorcheckbox,formInfo["M1selectorcheckbox"]));
				((System.Web.UI.WebControls.CheckBox)M1.Items[index].FindControl("M1selectorcheckbox")).Text =
					formResource.GetString("M1selectorcheckbox", lang);
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1entersyoriflg"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1entersyoriflg,formInfo["M1entersyoriflg"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1dtlirokbn"),
					DataFormatUtil.GetFormatItem(te070f02M1Form.M1dtlirokbn,formInfo["M1dtlirokbn"]));
		...
		/// </summary>
		/// <param name="te070f02Form">画面FormVO</param>
		private void RenderM1Pager(Te070f02Form te070f02Form)
		{
			Pgr.VirtualItemCount = te070f02Form.GetList("M1").RecordCount;
			Pgr.CurrentPageIndex = te070f02Form.GetList("M1").PageNo - 1;
			Pgr.PageSize = te070f02Form.GetList("M1").DispRow;
		}
		#endregion
		#endregion
			...
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(te070f02Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(te070f02Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Denpyo_bango,
				DataFormatUtil.GetFormatItem(te070f02Form.Denpyo_bango,formInfo["Denpyo_bango"]));
			ControlUtil.SetControlValue(Scm_cd,
				DataFormatUtil.GetFormatItem(te070f02Form.Scm_cd,formInfo["Scm_cd"]));
			ControlUtil.SetControlValue(Nyukatan_cd,
				DataFormatUtil.GetFormatItem(te070f02Form.Nyukatan_cd,formInfo["Nyukatan_cd"]));
			ControlUtil.SetControlValue(Nyukatan_nm,
				DataFormatUtil.GetFormatItem(te070f02Form.Nyukatan_nm,formInfo["Nyukatan_nm"]));
			ControlUtil.SetControlValue(Jyuryo_ymd,
				DataFormatUtil.GetFormatItem(te070f02Form.Jyuryo_ymd,formInfo["Jyuryo_ymd"]));
			ControlUtil.SetControlValue(Kaisya_cd,
				DataFormatUtil.GetFormatItem(te070f02Form.Kaisya_cd,formInfo["Kaisya_cd"]));
			ControlUtil.SetControlValue(Kaisya_nm,
				DataFormatUtil.GetFormatItem(te070f02Form.Kaisya_nm,formInfo["Kaisya_nm"]));
			ControlUtil.SetControlValue(Syukkaten_cd,
				DataFormatUtil.GetFormatItem(te070f02Form.Syukkaten_cd,formInfo["Syukkaten_cd"]));
			ControlUtil.SetControlValue(Syukkaten_nm,
				DataFormatUtil.GetFormatItem(te070f02Form.Syukkaten_nm,formInfo["Syukkaten_nm"]));
			ControlUtil.SetControlValue(Syukkatan_cd,
				DataFormatUtil.GetFormatItem(te070f02Form.Syukkatan_cd,formInfo["Syukkatan_cd"]));
			ControlUtil.SetControlValue(Syukkatan_nm,
				DataFormatUtil.GetFormatItem(te070f02Form.Syukkatan_nm,formInfo["Syukkatan_nm"]));
			ControlUtil.SetControlValue(Syukka_ymd,
				DataFormatUtil.GetFormatItem(te070f02Form.Syukka_ymd,formInfo["Syukka_ymd"]));
			ControlUtil.SetControlValue(Denpyo_jyotainm,
				DataFormatUtil.GetFormatItem(te070f02Form.Denpyo_jyotainm,formInfo["Denpyo_jyotainm"]));
			ControlUtil.SetControlValue(Syorinm,
				DataFormatUtil.GetFormatItem(te070f02Form.Syorinm,formInfo["Syorinm"]));
			ControlUtil.SetControlValue(Syoriymd,
				DataFormatUtil.GetFormatItem(te070f02Form.Syoriymd,formInfo["Syoriymd"]));
			ControlUtil.SetControlValue(Syori_tm,
				DataFormatUtil.GetFormatItem(te070f02Form.Syori_tm,formInfo["Syori_tm"]));
			ControlUtil.SetControlValue(Gokeiyotei_su,
				DataFormatUtil.GetFormatItem(te070f02Form.Gokeiyotei_su,formInfo["Gokeiyotei_su"]));
			ControlUtil.SetControlValue(Gokeikakutei_su,
				DataFormatUtil.GetFormatItem(te070f02Form.Gokeikakutei_su,formInfo["Gokeikakutei_su"]));
			ControlUtil.SetControlValue(Genka_kin_gokei,
				DataFormatUtil.GetFormatItem(te070f02Form.Genka_kin_gokei,formInfo["Genka_kin_gokei"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Te070f02Form)base.GetPageContext().GetFormVO());
            ...
            Te070f02Form form2Vo = (Te070f02Form)base.GetPageContext().GetFormVO();
            IList m1DataList = form2Vo.GetPageViewList("M1");

            // 一覧画面の選択明細行情報取得
            Te070f01M1Form prevM1Vo = (Te070f01M1Form)form2Vo.Dictionary[Te070p01Constant.DIC_M1SELCETVO];
            ...
            for (int index = 0; index < M1.Items.Count; index++)
            {
                ...
                Te070f02M1Form f02m1VO = (Te070f02M1Form)m1DataList[index];
                String kakuteiflg = prevM1Vo.Dictionary[Te070p01Constant.DIC_M1KAKUTEI_FLG].ToString();
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Te070f02_Titlebar", lang);
				header.FormName = formResource.GetString("Te070f02_FormCaption", lang);
			}
		}
		#endregion
		#endregion
