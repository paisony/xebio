...
namespace com.xebio.bo.Tg040p01.Page
{
  ...
  /// Tg040p01の初期化ページです。
  /// </summary>
  public partial class Tg040p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tg040p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tg040f01", true);
					//efm.SetItemInfoFlg(pgId, "Tg040f02", true);
				}
