...
using com.xebio.bo.Te100p01.Facade;
...
namespace com.xebio.bo.Te100p01.Page
{
  /// <summary>
  /// Te100f01のコードビハインドです。
  /// </summary>
  public partial class Te100f01Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Te100f01Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Te100f01Facade().DoLoad(facadeContext);
                                ...
                                ControlHeaderStoreCls.InitialSetHeaderStore<Te100f01Form>(loginInfVO, te100f01Form);
                                // 一覧画面共通処理 ----------
		...
		protected virtual void OnBTNPRINT_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Te100f01Facade().DoBTNPRINT_FRM(facadeContext);

				Te100f01Form f01VO = (Te100f01Form)facadeContext.FormVO;

				// PDFファイル名を取得
				pdfNm = (string)facadeContext.GetUserObject(Te100p01Constant.FCDUO_RRT_FLNM);
			...
			string serverPath = string.Format("{0}{1}{2}",
											FilePathManager.GetOutFilePath(Te100p01Constant.PGID),
			...
			{
				reportNm = BoSystemConstant.REPORTNM_IDOUNYUKAYOTEIMISONZAILIST_X;
			}
			else
			{
				reportNm = BoSystemConstant.REPORTNM_IDOUNYUKAYOTEIMISONZAILIST_V;
			}
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					if (!MessageDisplayUtil.HasError(pageContext))
					{
						...
						//FormVOを取得する
						Te100f01Form te100f01Form = (Te100f01Form)pageContext.GetFormVO();

						//カード部データを表示する
						RenderCard(te100f01Form, pageContext.FormInfo, formResource, lang);
					}
		...
		/// カードデータを表示する
		/// </summary>
		/// <param name="te100f01Form">画面FormVO</param>
		/// <param name="formInfo">画面情報</param>
		/// <param name="formResource">画面リソース</param>
		/// <param name="lang">言語設定</param>
		private void RenderCard(
			Te100f01Form te100f01Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(te100f01Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(te100f01Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Add_ymd_from,
				DataFormatUtil.GetFormatItem(te100f01Form.Add_ymd_from,formInfo["Add_ymd_from"]));
			ControlUtil.SetControlValue(Add_ymd_to,
				DataFormatUtil.GetFormatItem(te100f01Form.Add_ymd_to,formInfo["Add_ymd_to"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Te100f01Form)base.GetPageContext().GetFormVO());
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Te100f01_Titlebar", lang);
				header.FormName = formResource.GetString("Te100f01_FormCaption", lang);
			}
		}
		#endregion
		#endregion
