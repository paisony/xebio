...
namespace com.xebio.bo.Td050p01.Page
{
  ...
  /// Td050p01の初期化ページです。
  /// </summary>
  public partial class Td050p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Td050p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Td050f01", true);
					//efm.SetItemInfoFlg(pgId, "Td050f02", true);
				}
