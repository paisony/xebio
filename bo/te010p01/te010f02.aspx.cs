...
namespace com.xebio.bo.Te010p01.Page
{
  ...
  /// Te010f02のコードビハインドです。
  /// </summary>
  public partial class Te010f02Page : StandardBasePage
	{
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if(!IsPostBack)
				{
					...
					{
						pageContext.SetFormVO(new Te010f02Form());
						switch(commandInfo.ActionMode)
						{
							...
							case "UPD":
								...
								new Te010f02Facade().DoLoad(facadeContext);
								break;
						}
					}
					else
		...
		protected virtual void OnBTNBACK_FRM(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				InitFacadeContext(facadeContext);
				new Te010f02Facade().DoBTNBACK_FRM(facadeContext);
			...
			focusMno = (string)((Te010f02Form)pageContext.GetFormVO(Te010p01Constant.PGID, Te010p01Constant.FORMID_02)).Dictionary[Te010p01Constant.DIC_M1SELCETROWIDX];
		...
		protected virtual void OnPGR_PGN(object sender, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			...
			try
			{
				...
				IFacadeContext facadeContext = FacadeContextFactory.GetFacadeContext(pageContext);
				InitFacadeContext(facadeContext);
				new Te010f02Facade().DoPGR_PGN(facadeContext, pageindex);
			...
			if(!base.IsPostBack || base.IsPageValid)
			{
				...
				if(pageContext != null && pageContext.GetFormVO()!=null)
				{
					...
					// エラー時の画面表示対応 --------------------------------  end
						...
						//FormVOを取得する
						Te010f02Form te010f02Form = (Te010f02Form)pageContext.GetFormVO();

						//明細ページ情報を表示する
						ShowListPageInfo(te010f02Form);
			
						//明細部データを表示する
						RenderList(te010f02Form, pageContext.FormInfo, formResource, lang);

						//カード部データを表示する
						RenderCard(te010f02Form, pageContext.FormInfo, formResource, lang);
					// エラー時の画面表示対応 --------------------------------  str
					//}
					// エラー時の画面表示対応 --------------------------------  end
		...
		/// 明細ページ情報を表示する。
		/// </summary>
		/// <param name="te010f02Form">画面FormVO</param>
		private void ShowListPageInfo(Te010f02Form te010f02Form)
		{
			//M1明細ページ情報を表示する。
			ShowM1ListPageInfo(te010f02Form.GetList("M1"));
		...
		private void RenderList(
			Te010f02Form te010f02Form,
			IFormInfo formInfo,
			FormResource formResource,
			string lang)
		{
			//画面のM1明細部データを設定する。
			RenderM1List(te010f02Form, formInfo, formResource, lang);
			//M1明細部のページャーにページ情報を設定する。
			RenderM1Pager(te010f02Form);
		...
		{
			//M1明細部データソースを設定する。
			M1.DataSource = te010f02Form.GetPageViewList("M1");
			M1.DataBind();
			...
			{
				Te010f02M1Form te010f02M1Form = (Te010f02M1Form)m1DataList[index];
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1rowno"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1rowno,formInfo["M1rowno"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumon_cd"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1bumon_cd,formInfo["M1bumon_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1bumonkana_nm"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1bumonkana_nm,formInfo["M1bumonkana_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1hinsyu_ryaku_nm"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1hinsyu_ryaku_nm,formInfo["M1hinsyu_ryaku_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1burando_nm"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1burando_nm,formInfo["M1burando_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1jisya_hbn"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1jisya_hbn,formInfo["M1jisya_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1maker_hbn"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1maker_hbn,formInfo["M1maker_hbn"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syonmk"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1syonmk,formInfo["M1syonmk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1iro_nm"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1iro_nm,formInfo["M1iro_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1size_nm"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1size_nm,formInfo["M1size_nm"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1scan_cd"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1scan_cd,formInfo["M1scan_cd"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1syukka_su"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1syukka_su,formInfo["M1syukka_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1kakutei_su"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1kakutei_su,formInfo["M1kakutei_su"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1gen_tnk"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1gen_tnk,formInfo["M1gen_tnk"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1genkakin"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1genkakin,formInfo["M1genkakin"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1selectorcheckbox"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1selectorcheckbox,formInfo["M1selectorcheckbox"]));
				((System.Web.UI.WebControls.CheckBox)M1.Items[index].FindControl("M1selectorcheckbox")).Text =
					formResource.GetString("M1selectorcheckbox", lang);
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1entersyoriflg"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1entersyoriflg,formInfo["M1entersyoriflg"]));
				ControlUtil.SetControlValue(M1.Items[index].FindControl("M1dtlirokbn"),
					DataFormatUtil.GetFormatItem(te010f02M1Form.M1dtlirokbn,formInfo["M1dtlirokbn"]));
		...
		/// </summary>
		/// <param name="te010f02Form">画面FormVO</param>
		private void RenderM1Pager(Te010f02Form te010f02Form)
		{
			Pgr.VirtualItemCount = te010f02Form.GetList("M1").RecordCount;
			Pgr.CurrentPageIndex = te010f02Form.GetList("M1").PageNo - 1;
			Pgr.PageSize = te010f02Form.GetList("M1").DispRow;
		}
		#endregion
		#endregion
			...
			string lang)
		{
			...
			ControlUtil.SetControlValue(Head_tenpo_cd,
				DataFormatUtil.GetFormatItem(te010f02Form.Head_tenpo_cd,formInfo["Head_tenpo_cd"]));
			ControlUtil.SetControlValue(Head_tenpo_nm,
				DataFormatUtil.GetFormatItem(te010f02Form.Head_tenpo_nm,formInfo["Head_tenpo_nm"]));
			ControlUtil.SetControlValue(Denpyo_bango,
				DataFormatUtil.GetFormatItem(te010f02Form.Denpyo_bango,formInfo["Denpyo_bango"]));
			ControlUtil.SetControlValue(Siji_bango,
				DataFormatUtil.GetFormatItem(te010f02Form.Siji_bango,formInfo["Siji_bango"]));
			ControlUtil.SetControlValue(Scm_cd,
				DataFormatUtil.GetFormatItem(te010f02Form.Scm_cd,formInfo["Scm_cd"]));
			ControlUtil.SetControlValue(Shukkariyu_nm,
				DataFormatUtil.GetFormatItem(te010f02Form.Shukkariyu_nm,formInfo["Shukkariyu_nm"]));
			ControlUtil.SetControlValue(Syukkatan_cd,
				DataFormatUtil.GetFormatItem(te010f02Form.Syukkatan_cd,formInfo["Syukkatan_cd"]));
			ControlUtil.SetControlValue(Syukkatan_nm,
				DataFormatUtil.GetFormatItem(te010f02Form.Syukkatan_nm,formInfo["Syukkatan_nm"]));
			ControlUtil.SetControlValue(Syukka_ymd,
				DataFormatUtil.GetFormatItem(te010f02Form.Syukka_ymd,formInfo["Syukka_ymd"]));
			ControlUtil.SetControlValue(Kaisya_cd,
				DataFormatUtil.GetFormatItem(te010f02Form.Kaisya_cd,formInfo["Kaisya_cd"]));
			ControlUtil.SetControlValue(Kaisya_nm,
				DataFormatUtil.GetFormatItem(te010f02Form.Kaisya_nm,formInfo["Kaisya_nm"]));
			ControlUtil.SetControlValue(Jyuryoten_cd,
				DataFormatUtil.GetFormatItem(te010f02Form.Jyuryoten_cd,formInfo["Jyuryoten_cd"]));
			ControlUtil.SetControlValue(Juryoten_nm,
				DataFormatUtil.GetFormatItem(te010f02Form.Juryoten_nm,formInfo["Juryoten_nm"]));
			ControlUtil.SetControlValue(Nyukatan_cd,
				DataFormatUtil.GetFormatItem(te010f02Form.Nyukatan_cd,formInfo["Nyukatan_cd"]));
			ControlUtil.SetControlValue(Nyukatan_nm,
				DataFormatUtil.GetFormatItem(te010f02Form.Nyukatan_nm,formInfo["Nyukatan_nm"]));
			ControlUtil.SetControlValue(Jyuryo_ymd,
				DataFormatUtil.GetFormatItem(te010f02Form.Jyuryo_ymd,formInfo["Jyuryo_ymd"]));
			ControlUtil.SetControlValue(Syorinm,
				DataFormatUtil.GetFormatItem(te010f02Form.Syorinm,formInfo["Syorinm"]));
			ControlUtil.SetControlValue(Syoriymd,
				DataFormatUtil.GetFormatItem(te010f02Form.Syoriymd,formInfo["Syoriymd"]));
			ControlUtil.SetControlValue(Syori_tm,
				DataFormatUtil.GetFormatItem(te010f02Form.Syori_tm,formInfo["Syori_tm"]));
			ControlUtil.SetControlValue(Syukkasuryo_gokei,
				DataFormatUtil.GetFormatItem(te010f02Form.Syukkasuryo_gokei,formInfo["Syukkasuryo_gokei"]));
			ControlUtil.SetControlValue(Gokeikakutei_su,
				DataFormatUtil.GetFormatItem(te010f02Form.Gokeikakutei_su,formInfo["Gokeikakutei_su"]));
			ControlUtil.SetControlValue(Genka_kin_gokei,
				DataFormatUtil.GetFormatItem(te010f02Form.Genka_kin_gokei,formInfo["Genka_kin_gokei"]));
		...
		protected override void SetAttribute()
		{
			...
			// UIScreenController controller = new UIScreenController((Te010f02Form)base.GetPageContext().GetFormVO());
		...
		private void SetCardCaption(FormResource formResource, string lang)
		{
			...
			ControlUtil.SetControlValue(Shukkariyu_nm_lbl, 
				DataFormatUtil.GetFormatCaption(formResource.GetString("Shukkariyu_nm", lang), base.GetPageContext().FormInfo["Shukkariyu_nm"]));
				DataFormatUtil.SetMustColorCaption(Shukkariyu_nm_lbl, base.GetPageContext().FormInfo["Shukkariyu_nm"]);
		...
		private void SetOtherCaption(FormResource formResource, string lang)
		{
			...
			{
				Windowtitle.InnerText = formResource.GetString("Te010f02_Titlebar", lang);
				header.FormName = formResource.GetString("Te010f02_FormCaption", lang);
			}
		}
		#endregion
		#endregion
