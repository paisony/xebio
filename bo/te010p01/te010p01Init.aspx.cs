...
namespace com.xebio.bo.Te010p01.Page
{
  ...
  /// Te010p01の初期化ページです。
  /// </summary>
  public partial class Te010p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Te010p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Te010f01", true);
					//efm.SetItemInfoFlg(pgId, "Te010f02", true);
				}
