...
namespace com.xebio.bo.Tg010p01.Page
{
  ...
  /// Tg010p01の初期化ページです。
  /// </summary>
  public partial class Tg010p01InitPage : StandardBasePage
	{
		#region メソッド
		...
		protected new void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				...
				fm.SetProgramVO(pgId, new Tg010p01PgForm());
				...
				if(base.CheckUseSelfCustomize()){
					...
					//して下さい。
					//セルフカスタマイズを使用する場合も下の行を有効にしてください。
					//efm.SetItemInfoFlg(pgId, "Tg010f01", true);
				}
				...
				{
					// [モードスキャンコードボタン]にフォーカスを当てる。
					focusItem = "Btnmodescancd";
				}
